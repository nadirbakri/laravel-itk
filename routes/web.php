...
Route::get('loan_code/all/api', 'DataController@dataLoanCodeAllAPI');
Route::get('loan_code/func/api', 'DataController@dataLoanCodeFuncAPI');
Route::get('loan_code/function/api', 'DataController@dataLoanCodeFunctionAPI');
...
Route::get('change_reason_code/api', 'DataController@dataChangeReasonCodeAPI');
