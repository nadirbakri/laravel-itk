	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('personel_level.list')); ?></span>
			</a>
		</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    var table = $('#level_table').DataTable({
        ...
        orderCellsTop: true,
        ajax: {
            url: "<?php echo e(url('personnel/level/table')); ?>",
            cache: false
        },
    ...
    $('#level_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('personnel/level/detail_data')); ?>", { 'levelType' : null, 'levelCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('personnel/level/detail_data')); ?>", { 'levelType' : data.levelType, 'levelCode' : data[0].levelCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('personnel/level/status')); ?>",
                type: "GET",
    ...
    $('#level_table tbody').on('click', 'tr td:not(:first-child)', function () {
        ...
        $.redirect("<?php echo e(url('personnel/level/detail_data')); ?>", { 'levelType' : data.levelType, 'levelCode' : data.levelCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_level.blade.php ENDPATH**/ ?>