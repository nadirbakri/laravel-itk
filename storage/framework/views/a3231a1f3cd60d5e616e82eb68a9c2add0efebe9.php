...
<head>
    <title><?php echo e(__('utilities_menu_master.judul')); ?></title>
...
<body>
    <div class="div-utilities">
        <div class="div-title">
            <a href="<?php echo e(url('utilities')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('utilities_menu_master.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="menu_master_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="group_id"><?php echo e(__('utilities_menu_master.label_group_id')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="menu_title"><?php echo e(__('utilities_menu_master.label_menu_title')); ?></label>
                            <input type="text" class="form-control" id="menu_title" name="menu_title"
                                placeholder="<?php echo e(__('utilities_menu_master.label_menu_title')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-configure-menu" id="btn-configure-menu"
                            ...
                            <?php echo e(__('utilities_menu_master.btn_configure_menu')); ?>
                    ...
                    <div class="col-4">
                        <button type="button" class="btn btn-primary" name="btn-copy-to-another-group"
                            ...
                            <?php echo e(__('utilities_menu_master.btn_copy_to_another_group')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_menu_master.btn_configure_menu')); ?></h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                <label for="module"><?php echo e(__('utilities_menu_master.label_module')); ?></label>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-primary w-25" id="btn-save-configure-menu"><i
                            class="fa fa-floppy-o"></i> <?php echo e(__('utilities_menu_master.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('utilities_menu_master.btn_cancel')); ?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="modal_copy_to_another_group"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_menu_master.btn_copy_to_another_group')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="copy_to_another_group_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label><?php echo e(__('utilities_menu_master.label_copy_from')); ?></label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_id_copy_from"><?php echo e(__('utilities_menu_master.label_group_id')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_name_copy_from"><?php echo e(__('utilities_menu_master.label_group_name')); ?></label>
                                    <input type="text" class="form-control" id="group_name_copy_from"
                                        name="group_name_copy_from"
                                        placeholder="<?php echo e(__('utilities_menu_master.label_group_name')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label><?php echo e(__('utilities_menu_master.label_copy_destination')); ?></label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_id_copy_destination"><?php echo e(__('utilities_menu_master.label_group_id')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_name_copy_destination"><?php echo e(__('utilities_menu_master.label_group_name')); ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('utilities_menu_master.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function load_table_menu_master(groupAccessID = '') {
            table = $('#menu_master_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('utilities/menu_master/table')); ?>",
                    data: {
        ...
        function load_table_configure_menu(groupAccessID = '', moduleID = '') {
            table = $('#configure_menu_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('utilities/menu_master/configure_menu/table')); ?>",
                    data: {
                        groupAccessID: groupAccessID,
                        moduleID: moduleID
                    }
        ...
        $(document).on("change", "input[name='allow_access_menu_master[]']", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('utilities/menu_master/proses')); ?>",
                headers: {
        ...
        function loadDataGroupID(fieldName = '') {
            ...
            $(fieldName).select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/group_user_access/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('utilities/menu_master')); ?>";
        });
        ...
        $('#configure_menu_form').on('submit', function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('utilities/menu_master/configure_menu/proses')); ?>",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                dataType: 'json',
                ...
                success: function (response) {
                    if (response.status == "true") {
                        ...
                        $("#btn-save-configure-menu").html(
                            '<i class="fa fa-floppy-o"></i> <?php echo e(__("utilities_menu_master.btn_save")); ?>'
                        );
        ...
        if ($("#copy_to_another_group_form").length > 0) {
            $("#copy_to_another_group_form").validate({
                ...
                messages: {
                    group_id_copy_from: {
                        required: "<?php echo e(__('utilities_menu_master.group_id_required')); ?>",
                    },
                    group_id_copy_destination: {
                        required: "<?php echo e(__('utilities_menu_master.group_id_required')); ?>",
                    }
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/menu_master/copy_to_another_group/proses')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_menu_master.blade.php ENDPATH**/ ?>