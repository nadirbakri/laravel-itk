...
<html lang="en">
<head>
<title><?php echo e(__('payroll_monthly_jamsostek_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_monthly_jamsostek_report.judul_form')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="jamsostek_period"><?php echo e(__('payroll_monthly_jamsostek_report.label_jamsostek_period')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <label for="form2"><?php echo e(__('payroll_monthly_jamsostek_report.label_formulir_2')); ?></label>
                            <br>
                            <input type="radio" id="form1a" name="jamsostek_report_type" value="formulir1a">
                            <label for="form1a"><?php echo e(__('payroll_monthly_jamsostek_report.label_formulir_1a')); ?></label>
                            <br>
                            <input type="radio" id="form1b" name="jamsostek_report_type" value="formulir1b">
                            <label for="form1b"><?php echo e(__('payroll_monthly_jamsostek_report.label_formulir_1b')); ?></label>
                            <br>
                            <input type="radio" id="form2a" name="jamsostek_report_type" value="formulir2a">
                            <label for="form2a"><?php echo e(__('payroll_monthly_jamsostek_report.label_formulir_2a')); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="kekurangan_kelebihan"><?php echo e(__('payroll_monthly_jamsostek_report.label_kelebihan_kekurangan')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="jkk"><?php echo e(__('payroll_monthly_jamsostek_report.label_JKK')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="jht"><?php echo e(__('payroll_monthly_jamsostek_report.label_JHT')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="jk"><?php echo e(__('payroll_monthly_jamsostek_report.label_JK')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="jp"><?php echo e(__('payroll_monthly_jamsostek_report.label_JP')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="jdi"><?php echo e(__('payroll_monthly_jamsostek_report.label_JDI')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorize_code_from"><?php echo e(__('payroll_monthly_jamsostek_report.label_group_authorize_code')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorize_code_to form-check-label"><?php echo e(__('payroll_monthly_jamsostek_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_bpjs_code"><?php echo e(__('payroll_monthly_jamsostek_report.label_group_bpjs')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" id="btn-print" style="width:100%">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_monthly_jamsostek_report.label_print')); ?>
        ...
        $('#monthly_jamsostek_report_form').validate({
            submitHandler: function(form){
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('payroll/monthly_jamsostek_report/print')); ?>",
                    type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_monthly_jamsostek_report.blade.php ENDPATH**/ ?>