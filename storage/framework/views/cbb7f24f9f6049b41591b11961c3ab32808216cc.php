...
<html>
<head>
    <title><?php echo e(__('payroll_loan_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_loan_report.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_loan_report.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_loan_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="loan_type_from form-check-label"><?php echo e(__('payroll_loan_report.label_loan_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="loan_type_to form-check-label"><?php echo e(__('payroll_loan_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_type form-check-label"><?php echo e(__('payroll_loan_report.label_report_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="type_loan_report" name="report_type" value="L" checked>
                            <label for="type_loan_report"><?php echo e(__('payroll_loan_report.label_loan_report')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="type_loan_payment" name="report_type" value="P">
                            <label for="type_loan_payment"><?php echo e(__('payroll_loan_report.label_loan_payment')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="type_summary_report"><?php echo e(__('payroll_loan_report.label_summary_report')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="type_detail_report" name="report_type" value="D">
                            <label for="type_detail_report"><?php echo e(__('payroll_loan_report.label_detail_report')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="type_loan_schedule"><?php echo e(__('payroll_loan_report.label_loan_schedule')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row" id="div_loan_type">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="loan_type_one form-check-label"><?php echo e(__('payroll_loan_report.label_loan_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('payroll_loan_report.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_loan_report.label_group_authorized_code')); ?> <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_loan_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_loan_report.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_loan_report.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_loan_report.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_loan_report.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="btn-send-to" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_loan_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_loan_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function loadDataLoanCode(field = '') {
            ...
            $(field).select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/loan_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataFirstLastAllLoanCode(field = '', func = '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/loan_code/func/api')); ?>",
                data: {
                    'func': func
                }
            }).then(function (data) {
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/loan_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/loan_report/print')); ?>",
                            type: "POST",
                            data: $('#loan_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_loan_report.blade.php ENDPATH**/ ?>