...
<head>
    <title><?php echo e(__('personel_evaluation_report.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_evaluation_report.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="evaluation_report_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_evaluation_report.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_evaluation_report.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period_from"><?php echo e(__('personel_evaluation_report.label_evaluation_period_from')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period_from" name="period_from"
                                    placeholder="<?php echo e(__('personel_evaluation_report.label_evaluation_period_from')); ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period_to"><?php echo e(__('personel_evaluation_report.label_evaluation_period_to')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period_to" name="period_to"
                                    placeholder="<?php echo e(__('personel_evaluation_report.label_evaluation_period_to')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                    ...
                    <div class="form-group ml-3">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label"
                                for="include_resign"><?php echo e(__('personel_evaluation_report.label_include_resign')); ?></label>
                        </div>
                    </div>
                </div>    
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('personel_evaluation_report.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('personel_evaluation_report.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('personel_evaluation_report.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('personel_evaluation_report.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('personel_evaluation_report.label_location')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('personel_evaluation_report.btn_print')); ?>
            ...
            $("#evaluation_report_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/evaluation_report/print')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_evaluation_report.blade.php ENDPATH**/ ?>