...
<head>
    <title><?php echo e(__('personel_print_letter.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('personel_print_letter.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="print_letter_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="letter_type"><?php echo e(__('personel_print_letter.label_letter_type')); ?></label>
                            <select class="form-control select2" id="letter_type" name="letter_type"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="letter_date"><?php echo e(__('personel_print_letter.label_letter_date')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="letter_date" name="letter_date"
                                    placeholder="<?php echo e(__('personel_print_letter.label_letter_date')); ?>">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no"><?php echo e(__('personel_print_letter.label_employee_no')); ?></label>
                            <select class="form-control select2" id="employee_no" name="employee_no"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="reference"><?php echo e(__('personel_print_letter.label_reference')); ?></label>
                            <input type="number" class="form-control" id="reference" name="reference"
                                placeholder="<?php echo e(__('personel_print_letter.label_reference')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print" id="btn-print"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('personel_print_letter.btn_print')); ?>
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-list-data" id="btn-list-data"
                            ...
                            <i class="fa fa-list"></i> <?php echo e(__('personel_print_letter.btn_list_data')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_print_letter.title_modal_list_data')); ?></h5>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_print_letter.btn_back')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        function load_table_list_detail() {
            table = $('#list_letter_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/print_letter/table')); ?>"
                },
        ...
        function loadDataLetterType() {
            ...
            $('#letter_type').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/letter_type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        if ($("#print_letter_form").length > 0) {
            $("#print_letter_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/print_letter/print')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-print").html(
                                    '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_print_letter.btn_print")); ?>'
                                );
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_print_letter.blade.php ENDPATH**/ ?>