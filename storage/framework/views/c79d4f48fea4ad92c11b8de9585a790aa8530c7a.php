    ...
    <div class="div-payroll">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('payroll_periodical_report.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="periodical_report_form" method="post">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_name"><?php echo e(__('payroll_periodical_report.label_report_name')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="grand_total"><?php echo e(__('payroll_periodical_report.label_grand_total')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from"><?php echo e(__('payroll_periodical_report.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('payroll_periodical_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('payroll_periodical_report.label_period')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('payroll_periodical_report.label_period')); ?>">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="cost_center"><?php echo e(__('payroll_periodical_report.label_cost_center')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="cost_center_code_to"><?php echo e(__('payroll_periodical_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="multi_cost_center"><?php echo e(__('payroll_periodical_report.label_multi_cost_center')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_status"><?php echo e(__('payroll_periodical_report.label_report_status')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="actual" name="report_status" value="Actual" checked>
                            <label for="actual"><?php echo e(__('payroll_periodical_report.label_actual')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="reconsiliation" name="report_status" value="Reconsiliation">
                            <label for="reconsiliation"><?php echo e(__('payroll_periodical_report.label_reconsiliation')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_type"><?php echo e(__('payroll_periodical_report.label_report_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="detail" name="report_type" value="Detail" checked>
                            <label for="detail"><?php echo e(__('payroll_periodical_report.label_detail')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="summary" name="report_type" value="Summary">
                            <label for="summary"><?php echo e(__('payroll_periodical_report.label_summary')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code"><?php echo e(__('payroll_periodical_report.label_group_authorized_code')); ?> <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to"><?php echo e(__('payroll_periodical_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="display_line"><?php echo e(__('payroll_periodical_report.label_display_line')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="print_signature"><?php echo e(__('payroll_periodical_report.label_print_signature')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_periodical_report.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_periodical_report.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_periodical_report.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_periodical_report.btn_preview')); ?>
                    ...
                    <div class="col-3 desc" id="send-to-report">
                        <div class="dropdown">
                            <button style="width: 100%;" class="btn btn-primary dropdown-toggle" id="btn-send-to" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-print"></i> <?php echo e(__('payroll_periodical_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_periodical_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function loadDataFirstLastAllCostCenterCode(field = '', func = '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/cost_center/all/api')); ?>",
                data: {
                    'func': func
                }
            }).then(function (data) {
        ...
        function loadDataFirstLastGroupAuthorized(field = '', func = ''){
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/group_authorize/func/api')); ?>",
                data: {
                    'func': func,
                    'module': 'PY'
                }
        ...
        function loadDataReportName() {
            ...
            $('#report_name').on('select2:open', function (e) {
                if (!headerIsAppend) {
                    html = '<div class="row">' +
                        '<div class="col-6"><b>Report Code</b></div>' +
            ...
            var $reportName = $('#report_name').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/report_format/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        function loadDataFirstLastAllPosition() {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/position/func/api')); ?>",
            }).then(function (data) {
        ...
        function loadDataFirstLastAllRanking() {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/ranking/func/api')); ?>",
            }).then(function (data) {
        ...
        function loadDataPositionCode() {
            ...
            $('#position').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/position/all/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataRankingCode() {
            ...
            $('#ranking').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/ranking/all/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/periodical_report/excel/print')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/periodical_report/print')); ?>",
                            type: "POST",
                            data: $('#periodical_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send').prop("disabled", false);
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project_azure\resources\views/payroll/py_periodical_report.blade.php ENDPATH**/ ?>