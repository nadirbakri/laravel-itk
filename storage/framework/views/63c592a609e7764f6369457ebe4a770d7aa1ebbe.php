...
<html>
<head>
    <title><?php echo e(__('export_workflow.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="export_workflow_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-export-workflow">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('export_workflow.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_workflow.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_workflow.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_workflow.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_workflow.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_workflow.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="workflow_type"><?php echo e(__('export_workflow.label_workflow_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_workflow.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_workflow.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
loadDataFirstLastAllBusinessUnit();
    ...
    //     });
        ...
        $("#btn-preview").click(function () {
            ...
            $("#export_workflow_form").submit();
        });

        if ($("#export_workflow_form").length > 0) {
            $("#export_workflow_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/export_workflow/print')); ?>",
                        type: "POST",
                        data: $('#export_workflow_form').serialize(),
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_Workflow.blade.php ENDPATH**/ ?>