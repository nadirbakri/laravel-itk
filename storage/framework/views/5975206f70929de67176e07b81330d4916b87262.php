...
<html>
<head>
	<title><?php echo e(__('payroll_calculation.judul')); ?></title>
	...
	<div class="div-payroll">
        <div class="div-navbar sticky-navbar">
            <a href="javascript:void(0)" style="display: none;" id="toolbar-back">
                ...
                <span><?php echo e(__('payroll_calculation.label_back')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-next">
                ...
                <span><?php echo e(__('payroll_calculation.label_next')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-new" target="iframe_dashboard">
                ...
                <span><?php echo e(__('payroll_calculation.label_new')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-edit">
                ...
                <span><?php echo e(__('payroll_calculation.label_edit')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-save">
                ...
                <span><?php echo e(__('payroll_calculation.btn_save')); ?></span>
            </a>
            <a class="list-functionbar-md" href="javascript:void(0)" id="toolbar-active">
                ...
                <span><?php echo e(__('payroll_calculation.label_activate')); ?></span>
            </a>
            <a class="list-functionbar-lg" href="javascript:void(0)" id="toolbar-deactive">
                ...
                <span><?php echo e(__('payroll_calculation.label_deactivate')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-list">
                ...
                <span><?php echo e(__('payroll_calculation.label_list')); ?></span>
            </a>
        </div>
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_calculation.list')); ?></span>
			</a>
		</div>

        <div class="div-table">
			<table id="payroll_calculation_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th><?php echo e(__('payroll_calculation.label_field_name')); ?></th>
						<th><?php echo e(__('payroll_calculation.label_sequence')); ?></th>
                        <th><?php echo e(__('payroll_calculation.label_record_status')); ?></th>
					</tr>
				</thead>
			</table>
		</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_calculation.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#payroll_calculation_table thead tr').clone(true).appendTo('#payroll_calculation_table thead');
        $('#payroll_calculation_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
            var title = $(this).text();
        ...
        load_data_table_payroll_calculation();

        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');

        function load_data_table_payroll_calculation() {
            table = $('#payroll_calculation_table').DataTable({
                processing: true,
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/payroll_calculation/table')); ?>",
                ...
                columns: [
                    ...
                    {data: 'seqProcess', name: 'seqProcess'},
        ...
        $('#payroll_calculation_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#payroll_calculation_table').on('click', 'tr td:first-child', function(e){
            $(this).parent().find('input[type="checkbox"]').trigger('click');
        });

        $("#toolbar-new").on('click', function() {
            $.redirect("<?php echo e(url('payroll/payroll_calculation/detail')); ?>", { 'fieldName' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
        });

        $("#toolbar-edit").on('click', function() {
            var data = table.rows('.selected').data();
            if(data.count() > 0){
                $.redirect("<?php echo e(url('payroll/payroll_calculation/detail')); ?>", { 'fieldName' : data[0].fieldName, 'func' : 'edit' }, "GET", "iframe_dashboard");
            }else{
        ...
        $("#toolbar-active").on('click', function() {
            ...
            if(data.count() > 0){
                $.ajax({
                    url: "<?php echo e(url('payroll/payroll_calculation/status')); ?>",
                    type: "GET",
                    data: { 
                    ...
                    success: function(response) {
                        if(response.status == "true"){
                            ...
                            setTimeout(function(){ 
                                window.location = "<?php echo e(url('payroll/payroll_calculation')); ?>";
                            }, 3000);
                        }else{
                            $('#notification_error').modal('show');
                        ...
                        var oTable = $('#payroll_calculation_table').dataTable();
                        oTable.fnDraw(false);
                    },
        ...
        $('#payroll_calculation_table tbody').on('click', 'tr td:not(:first-child)', function () {
            ...
            $.redirect("<?php echo e(url('payroll/payroll_calculation/detail')); ?>", { 'fieldName' : data.fieldName, 'func' : 'edit' }, "GET", "iframe_dashboard");
        });
    })
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_payroll_calculation.blade.php ENDPATH**/ ?>