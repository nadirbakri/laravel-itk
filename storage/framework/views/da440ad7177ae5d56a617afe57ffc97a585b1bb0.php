...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/jquery.multiselect.css')); ?>">
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_employee_card.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="employee_card_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_employee_card.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_employee_card.label_employee_no_to')); ?></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('personel_employee_card.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('personel_employee_card.label_position')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('personel_employee_card.label_ranking')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('personel_employee_card.label_location')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_list"><?php echo e(__('personel_employee_card.label_include_list')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="family"><?php echo e(__('personel_employee_card.label_family')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="skill"><?php echo e(__('personel_employee_card.label_skill')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="training_records"><?php echo e(__('personel_employee_card.label_training_records')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="formal_education"><?php echo e(__('personel_employee_card.label_formal_education')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="historical_jobs"><?php echo e(__('personel_employee_card.label_historical_jobs')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="language"><?php echo e(__('personel_employee_card.label_language')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="work_experience"><?php echo e(__('personel_employee_card.label_work_experience')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="organization"><?php echo e(__('personel_employee_card.label_organization')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="award"><?php echo e(__('personel_employee_card.label_award')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="project_experience"><?php echo e(__('personel_employee_card.label_project_experience')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="sanction"><?php echo e(__('personel_employee_card.label_sanction')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('personel_employee_card.btn_print')); ?>
            ...
            $("#employee_card_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/employee_card/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_card.blade.php ENDPATH**/ ?>