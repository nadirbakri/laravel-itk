...
<html>
<head>
	<title><?php echo e(__('tm_shift_master_code.judul')); ?></title>
	...
	<div class="div-time_management">
        <div class="div-navbar sticky-navbar">
            <a href="javascript:void(0)" style="display: none;" id="toolbar-back">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_back')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-next">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_next')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-new" target="iframe_dashboard">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_new')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-edit">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_edit')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-save">
                ...
                <span><?php echo e(__('tm_shift_master_code.btn_save')); ?></span>
            </a>
            <a class="list-functionbar-md" href="javascript:void(0)" id="toolbar-active">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_activate')); ?></span>
            </a>
            <a class="list-functionbar-lg" href="javascript:void(0)" id="toolbar-deactive">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_deactivate')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-list">
                ...
                <span><?php echo e(__('tm_shift_master_code.label_list')); ?></span>
            </a>
        </div>
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('tm_shift_master_code.list')); ?></span>
			</a>
		</div>
        <div class="div-table">
			<table id="shift_master_code_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th><?php echo e(__('tm_shift_master_code.label_shift_code')); ?></th>
						<th><?php echo e(__('tm_shift_master_code.label_description')); ?></th>
                        <th><?php echo e(__('tm_shift_master_code.label_group_shift')); ?></th>
                        <th><?php echo e(__('tm_shift_master_code.label_time_in')); ?></th>
                        <th><?php echo e(__('tm_shift_master_code.label_time_out')); ?></th>
                        <th><?php echo e(__('tm_shift_master_code.label_flexy')); ?></th>
                        <th><?php echo e(__('tm_shift_master_code.label_record_status')); ?></th>
					</tr>
				</thead>
			</table>
		</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_shift_master_code.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function load_data_table_shift_master_code() {
            table = $('#shift_master_code_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('time_management/shift_master_code/table')); ?>",
        ...
        $("#toolbar-new").on('click', function() {
            $.redirect("<?php echo e(url('time_management/shift_master_code/detail_data')); ?>", { 'shiftCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
        });
        ...
        $("#toolbar-edit").on('click', function() {
            ...
            if(data.count() > 0){
                ...
                $.redirect("<?php echo e(url('time_management/shift_master_code/detail_data')); ?>", { 'shiftCode' : data[0].shiftCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
            }else{
        ...
        $("#toolbar-active").on('click', function() {
            ...
            if(data.count() > 0){
                $.ajax({
                    url: "<?php echo e(url('time_management/shift_master_code/status')); ?>",
                    type: "GET",
                    data: { 
                    ...
                    success: function(response) {
                        if(response.status == "true"){
                            ...
                            setTimeout(function(){ 
                                window.location = "<?php echo e(url('time_management/shift_master_code')); ?>";
                            }, 3000);
                        }else{
                            $('#notification_error').modal('show');
        ...
        $('#shift_master_code_table tbody').on('click', 'tr td:not(:first-child)', function () {
            ...
            $.redirect("<?php echo e(url('time_management/shift_master_code/detail_data')); ?>", { 'shiftCode' : data.shiftCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        });
    })
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_shift_master_code.blade.php ENDPATH**/ ?>