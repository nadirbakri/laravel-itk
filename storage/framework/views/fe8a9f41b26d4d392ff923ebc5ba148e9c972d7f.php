...
<html>
<head>
    <title><?php echo e(__('data_employee_master.judul_employee_group_reimbursement')); ?></title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('data_employee_group.judul_employee_group_reimbursement')); ?></span>
            </a>
        </div>
        <form id="md_employee_group" method="post">
            ...
            <div class="card" >
                <div class="card-header">
                    <h5><?php echo e(__('data_employee_group.judul_employee_group_reimbursement')); ?></h5>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="exampletwo form-check-label"><b><?php echo e(__('data_employee_group.formgroupname3')); ?></b></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b><?php echo e(__('data_employee_group_detail.formgroupname3')); ?></b></label>
                        </div>
                    </div>
                </div>
...
<script>
   ...
   $('#btn-list').click(()=> {
        ...
        table2 = $('#example').DataTable({
            ...
            orderCellsTop: true,
            ajax: {
                url : "<?php echo e(url('master_data/list_reimbursement/table')); ?>"             
            },
    ...
    $('#group_code').blur(function () {
        if($(this).val() != null && $(this).val() != ''){
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/master_data/get')); ?>",
                data: {
                    'groupCode': $(this).val()
                }
            }).then(function (data) {
        ...
        if ($("#md_employee_group").length > 0) {
                $("#md_employee_group").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('master_data/employee_reimbursement/proses')); ?>",
                            type: "POST",
                            ...
                            success: function (response) {
                                if (response.status == "true"){
                                    ...
                                    setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('master_data/employee_group_reimbursement')); ?>";
                                    }, 3000);
                                } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/master_data/master_data_employee_group_reimbursement.blade.php ENDPATH**/ ?>