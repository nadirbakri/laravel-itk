...
<html>
<head>
    <title><?php echo e(__('payroll_salary_historical_report.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="salary_historical_report_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('payroll_salary_historical_report.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_salary_historical_report.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_salary_historical_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_salary_historical_report.label_group_authorized_code')); ?></label>
                            <span style="color: red">*</span>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_salary_historical_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-preview" id="btn-preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_salary_historical_report.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="send-to-slip" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_salary_historical_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_salary_historical_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#send-to-pdf').click(function (){
            ...
            $('#salary_historical_report_form').submit();
        });
        ...
        if($('#salary_historical_report_form').length > 0){
            $('#salary_historical_report_form').validate({
                rules: {
                    employee_no_from: {
                        required: true
                    },
                ...
                messages: {
                    employee_no_from: {
                        required: "<?php echo e(__('payroll_salary_historical_report.employee_no_from_required')); ?>"
                    },
                    employee_no_to: {
                        required: "<?php echo e(__('payroll_salary_historical_report.employee_no_to_required')); ?>"
                    },
                    group_authorized_code_from: {
                        required: "<?php echo e(__('payroll_salary_historical_report.group_authorized_code_from_required')); ?>"
                    },
                    group_authorized_code_to: {
                        required: "<?php echo e(__('payroll_salary_historical_report.group_authorized_code_to_required')); ?>"
                    }
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-send-to").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_salary_historical_report.btn_send_to")); ?>'
                    );
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/salary_historical_report/print/excel')); ?>",
                            type: "POST",
                            data: $('#salary_historical_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send').prop("disabled", false);
                                $("#btn-send").html(
                                    '<i class="fa fa-print"></i> <?php echo e(__("payroll_severance_report.btn_send_to")); ?>'
                                );
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/salary_historical_report/print')); ?>",
                            type: "POST",
                            data: $('#salary_historical_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send-to').prop("disabled", false);
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_salary_historical_report.blade.php ENDPATH**/ ?>