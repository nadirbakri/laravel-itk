    ...
    <div class="div-payroll">
        <div class="div-title">
            <a href="<?php echo e(url('payroll/salary_component_data')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('payroll_salary_component_data.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="field_name"><?php echo e(__('payroll_salary_component_data.label_field_name')); ?></label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="field_name" name="field_name"
                                placeholder="<?php echo e(__('payroll_salary_component_data.label_field_name')); ?>" readonly>
                        </div>
                        <input type="text" class="form-control" id="record_function" name="record_function" hidden>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="description"><?php echo e(__('payroll_salary_component_data.label_description')); ?></label>
                            <input type="text" class="form-control" id="description" name="description"
                                placeholder="<?php echo e(__('payroll_salary_component_data.label_description')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="field_width"><?php echo e(__('payroll_salary_component_data.label_field_width')); ?></label>
                            <input type="number" class="form-control" id="field_width" name="field_width"
                                placeholder="<?php echo e(__('payroll_salary_component_data.label_field_width')); ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="decimal_point"><?php echo e(__('payroll_salary_component_data.label_decimal_point')); ?></label>
                            <small id="decimal_point_rules" class="text-muted"><?php echo e(__('payroll_salary_component_data.label_decimal_point_rules')); ?></small>
                            <input type="number" class="form-control" id="decimal_point" name="decimal_point"
                                placeholder="<?php echo e(__('payroll_salary_component_data.label_decimal_point')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="include_prorate"><?php echo e(__('payroll_salary_component_data.label_include_prorate')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="group_takehomepay"><?php echo e(__('payroll_salary_component_data.label_group_takehomepay')); ?></label>
                            <select class="form-control select2" id="group_takehomepay" name="group_takehomepay">
                                <option value="" disabled selected><?php echo e(__('payroll_salary_component_data.label_select_group_takehomepay')); ?></option>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group box">
                            <div class="form-check">
                                <label for="display_in"><?php echo e(__('payroll_salary_component_data.label_display_in')); ?></label>
                            </div>
                            <div class="form-check">
                    ...
                    <div class="col-4">
                        <div class="form-group box">
                            <div class="form-check">
                                <label for="field_type"><?php echo e(__('payroll_salary_component_data.label_field_type')); ?></label>
                            </div>
                            <div class="form-check">
                    ...
                    <div class="col-4">
                        <div class="form-group box">
                            <div class="form-check">
                                <label for="tax"><?php echo e(__('payroll_salary_component_data.label_tax')); ?></label>
                            </div>
                            <div class="form-check">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="pension"><?php echo e(__('payroll_salary_component_data.label_pension')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="yearly_update"><?php echo e(__('payroll_salary_component_data.label_yearly_update')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="cummulative_update"><?php echo e(__('payroll_salary_component_data.label_cummulative_update')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-5"></div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="retroactive"><?php echo e(__('payroll_salary_component_data.label_retroactive')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="tax_allowance"><?php echo e(__('payroll_salary_component_data.label_tax_allowance')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="for_limit_medical"><?php echo e(__('payroll_salary_component_data.label_for_limit_medical')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6"></div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="jamsostek"><?php echo e(__('payroll_salary_component_data.label_jamsostek')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="health_insurance"><?php echo e(__('payroll_salary_component_data.label_health_insurance')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="pension_insurance"><?php echo e(__('payroll_salary_component_data.label_pension_insurance')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="overtime_alternative_1"><?php echo e(__('payroll_salary_component_data.label_overtime_alternative_1')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="overtime_alternative_2"><?php echo e(__('payroll_salary_component_data.label_overtime_alternative_2')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('payroll_salary_component_data.btn_save')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('payroll/salary_component_data')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_salary_component_data.btn_cancel')); ?>
    ...
    $(document).ready(function () {
        ...
        if ($("#salary_component_data_form").length > 0) {
            $("#salary_component_data_form").validate({
                ...
                messages: {
                    field_name: {
                        required: "<?php echo e(__('payroll_salary_component_data.field_mandatory')); ?>",
                    }
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/salary_component_data/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/salary_component_data')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_salary_component_form_detail.blade.php ENDPATH**/ ?>