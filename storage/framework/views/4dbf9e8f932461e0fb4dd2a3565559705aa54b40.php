...
<html>
<head>
    <title><?php echo e(__('payroll_import_data_from_excel.judul')); ?></title>
    ...
    <div class="div-payroll">
        <div class="div-title">
            <a href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('payroll_import_data_from_excel.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-7">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="process_period"><?php echo e(__('payroll_import_data_from_excel.label_process_period')); ?></label>
                                    <input type="text" class="form-control" id="process_period" name="process_period"
                                        placeholder="<?php echo e(__('payroll_import_data_from_excel.label_process_period')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="column_a"><?php echo e(__('payroll_import_data_from_excel.label_column_a')); ?></label>
                                    <input type="text" class="form-control" id="column_a" name="column_a"
                                        placeholder="<?php echo e(__('payroll_import_data_from_excel.label_column_a')); ?>" value="Employee No" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="column_b"><?php echo e(__('payroll_import_data_from_excel.label_column_b')); ?></label>
                                    <input type="text" class="form-control" id="column_b" name="column_b"
                                        placeholder="<?php echo e(__('payroll_import_data_from_excel.label_column_b')); ?>" value="Employee Name" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_c"><?php echo e(__('payroll_import_data_from_excel.label_column_c')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_d"><?php echo e(__('payroll_import_data_from_excel.label_column_d')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_e"><?php echo e(__('payroll_import_data_from_excel.label_column_e')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_f"><?php echo e(__('payroll_import_data_from_excel.label_column_f')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_g"><?php echo e(__('payroll_import_data_from_excel.label_column_g')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_h"><?php echo e(__('payroll_import_data_from_excel.label_column_h')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_i"><?php echo e(__('payroll_import_data_from_excel.label_column_i')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_j"><?php echo e(__('payroll_import_data_from_excel.label_column_j')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_k"><?php echo e(__('payroll_import_data_from_excel.label_column_k')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_l"><?php echo e(__('payroll_import_data_from_excel.label_column_l')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="import_file"><?php echo e(__('payroll_import_data_from_excel.label_import_file')); ?></label>
                                    <span style="color: red;">*</span>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="import_file" name="import_file">
                                        <label class="custom-file-label" for="import_file"><?php echo e(__('payroll_import_data_from_excel.label_select_import_file')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                                    <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_import_data_from_excel.btn_process')); ?>

                                </button>
                            </div>
                            <div class="col-4">
                                <button type="button" class="btn btn-danger" name="btn-reset" id="btn-reset" style="width: 100%;">
                                    <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_import_data_from_excel.btn_reset')); ?>

                                </button>
                            </div>
                            <div class="col-4">
                                <button type="button" class="btn btn-primary" name="btn-download-template" id="btn-download-template">
                                    <i class="fa fa-print"></i> <?php echo e(__('payroll_import_data_from_excel.btn_download_template')); ?>
                            ...
                            <div class="col-12">
                                <div class="form-group box">
                                    <div class="form-check">
                                        <label for="transfer_to"><?php echo e(__('payroll_import_data_from_excel.label_transfer_to')); ?></label>
                                    </div>
                                    <div class="form-check">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_import_data_from_excel.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        $('input[type="radio"]').on('change', function () {
            if ($('#bonus_thr').is(':checked')) {
                window.location.href = ("<?php echo e(url('payroll/import_data_from_excel_bonus_thr')); ?>");
        ...
        $('#btn-reset').on('click', function () {
            ...
            $('#import_file').val('');
            $('.custom-file-label').html('<?php echo e(__("payroll_import_data_from_excel.label_select_import_file")); ?>');
        });
        ...
        $("#btn-process").on('click', function () {
            url = "<?php echo e(url('payroll/import_data_from_excel/import')); ?>";
        ...
        $("#btn-download-template").on('click', function () {
            url = "<?php echo e(url('payroll/import_data_from_excel/template')); ?>";
            $(this).prop("disabled", true);
            $(this).html(
                '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...'
            );
        ...
        if ($("#import_data_from_excel_form").length > 0) {
            $("#import_data_from_excel_form").validate({
                ...
                messages: {
                    import_file: {
                        required: "<?php echo e(__('payroll_import_data_from_excel.import_required')); ?>",
                        extension: "<?php echo e(__('payroll_import_data_from_excel.import_extension')); ?>"
                    }
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-process").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_import_data_from_excel.btn_process")); ?>'
                    );
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_import_data_from_excel.blade.php ENDPATH**/ ?>