...
<head>
    <title><?php echo e(__('personel_employee_report_by_status.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_employee_report_by_status.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="employee_report_by_status_form" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_employee_report_by_status.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_employee_report_by_status.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="report_type"><?php echo e(__('personel_employee_report_by_status.label_report_type')); ?></label>
                            <select class="form-control select2" id="report_type" name="report_type">
                                <option hidden>Choose Report Type</option>
                                <option value="terminate" id="terminate"><?php echo e(__('personel_employee_report_by_status.label_select_terminate')); ?></option>
                                <option value="probation" id="probation"><?php echo e(__('personel_employee_report_by_status.label_select_probation')); ?></option>
                                <option value="contract" id="contract"><?php echo e(__('personel_employee_report_by_status.label_select_contract')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('personel_employee_report_by_status.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('personel_employee_report_by_status.label_period_from')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period_from" name="period_from"
                                    placeholder="<?php echo e(__('personel_employee_report_by_status.label_period_from')); ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('personel_employee_report_by_status.label_period_to')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period_to" name="period_to"
                                    placeholder="<?php echo e(__('personel_employee_report_by_status.label_period_to')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('personel_employee_report_by_status.btn_print')); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-print-data").click(function () {
            ...
            $("#employee_report_by_status_form").submit();
        });

        if ($("#employee_report_by_status_form").length > 0) {
            $("#employee_report_by_status_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/employee_report_by_status/print')); ?>",
                        type: "POST",
...
</script><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_report_by_status.blade.php ENDPATH**/ ?>