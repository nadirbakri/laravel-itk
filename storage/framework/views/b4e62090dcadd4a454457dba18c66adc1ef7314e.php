...
<html>
<head>
    <title><?php echo e(__('payroll_reference_payroll.judul')); ?></title>
    ...
    <div class="div-payroll">
        ...
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_reference_payroll.list')); ?></span>
			</a>
		</div>
        <div class="div-form">
            <form id="reference_payroll_form" method="post">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="process_period"><?php echo e(__('payroll_reference_payroll.label_process_period')); ?></label>
                                <input type="number" class="form-control" id="process_period_month" name="process_period_month"
                                    placeholder="<?php echo e(__('payroll_reference_payroll.label_process_period_month')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-0.5">
                        <div class="form-group">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="process_period_year" name="process_period_year"
                                placeholder="<?php echo e(__('payroll_reference_payroll.label_process_period_year')); ?>" readonly>
                        </div>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="process_status"><?php echo e(__('payroll_reference_payroll.label_process_status')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="payroll_payment_period"><?php echo e(__('payroll_reference_payroll.label_payroll_payment_period')); ?></label>
                            <input type="number" class="form-control" id="payroll_payment_period" name="payroll_payment_period"
                                placeholder="<?php echo e(__('payroll_reference_payroll.label_payroll_payment_period')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="company_name"><?php echo e(__('payroll_reference_payroll.label_company_name')); ?></label>
                            <input type="text" class="form-control" id="company_name" name="company_name"
                                placeholder="<?php echo e(__('payroll_reference_payroll.label_company_name')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="address"><?php echo e(__('payroll_reference_payroll.label_address')); ?></label>
                            <input type="text" class="form-control" id="address" name="address"
                                placeholder="<?php echo e(__('payroll_reference_payroll.label_address')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="city"><?php echo e(__('payroll_reference_payroll.label_city')); ?></label>
                            <input type="text" class="form-control" id="city" name="city"
                                placeholder="<?php echo e(__('payroll_reference_payroll.label_city')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <a class="collapsed" data-toggle="collapse" href="#reference-data" aria-expanded="true"
                        ...
                        <div class="card-header">
                            <div class="div-dropdown-title">
                                <span
                                    class="dropdown-title-text"><?php echo e(__('payroll_reference_payroll.label_reference')); ?></span>
                    ...
                    <div id="reference-data" class="collapse show">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="tax_registered_no"><?php echo e(__('payroll_reference_payroll.label_tax_registered_no')); ?></label>
                                        <input type="text" class="form-control" id="tax_registered_no" name="tax_registered_no"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_registered_no')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="jamsostek_no"><?php echo e(__('payroll_reference_payroll.label_jamsostek_no')); ?></label>
                                        <input type="text" class="form-control" id="jamsostek_no" name="jamsostek_no"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_jamsostek_no')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pension_no"><?php echo e(__('payroll_reference_payroll.label_pension_no')); ?></label>
                                        <input type="text" class="form-control" id="pension_no" name="pension_no"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_pension_no')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="retirement_age_limit"><?php echo e(__('payroll_reference_payroll.label_retirement_age_limit')); ?></label>
                                        <input type="number" class="form-control" id="retirement_age_limit" name="retirement_age_limit"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_retirement_age_limit')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="prorate_method"><?php echo e(__('payroll_reference_payroll.label_prorate_method')); ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="maximum_dependents"><?php echo e(__('payroll_reference_payroll.label_maximum_dependents')); ?></label>
                                        <input type="number" class="form-control" id="maximum_dependents" name="maximum_dependents"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_maximum_dependents')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="take_home_pay_rounded_from"><?php echo e(__('payroll_reference_payroll.label_take_home_pay_rounded_from')); ?></label>
                                        <input type="number" class="form-control" id="take_home_pay_rounded_from" name="take_home_pay_rounded_from"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_take_home_pay_rounded_from')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="take_home_pay_rounded_become"><?php echo e(__('payroll_reference_payroll.label_take_home_pay_rounded_become')); ?></label>
                                        <input type="number" class="form-control" id="take_home_pay_rounded_become" name="take_home_pay_rounded_become"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_take_home_pay_rounded_become')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="transaction_rate_type"><?php echo e(__('payroll_reference_payroll.label_transaction_rate_type')); ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="tax_rate_type"><?php echo e(__('payroll_reference_payroll.label_tax_rate_type')); ?></label>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="rounding_method_report"><?php echo e(__('payroll_reference_payroll.label_rounding_method_report')); ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="rounding_decimal_report"><?php echo e(__('payroll_reference_payroll.label_rounding_decimal_report')); ?></label>
                                        <input type="number" class="form-control" id="rounding_decimal_report" name="rounding_decimal_report"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_rounding_decimal_report')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="rounding_method_spt"><?php echo e(__('payroll_reference_payroll.label_rounding_method_spt')); ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="rounding_decimal_spt"><?php echo e(__('payroll_reference_payroll.label_rounding_decimal_spt')); ?></label>
                                        <input type="number" class="form-control" id="rounding_decimal_spt" name="rounding_decimal_spt"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_rounding_decimal_spt')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label
                                                for="check_appreciation_and_employee_service"><?php echo e(__('payroll_reference_payroll.label_appreciation_and_employee_service')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="bonus_cooficient"><?php echo e(__('payroll_reference_payroll.label_bonus_cooficient')); ?></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="bonus_cooficient" name="bonus_cooficient"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_bonus_cooficient')); ?>" readonly>
                            ...
                            <div class="row">
                                <div class="col-3"> 
                                    <div class="form-group">
                                        <label for="tax_allowance"><?php echo e(__('payroll_reference_payroll.label_tax_allowance')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="check_tax_allowance_bonus"><?php echo e(__('payroll_reference_payroll.label_tax_allowance_bonus')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="check_tax_allowance_thr"><?php echo e(__('payroll_reference_payroll.label_tax_allowance_thr')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <a class="collapsed" data-toggle="collapse" href="#jamsostek-data" aria-expanded="true"
                        ...
                        <div class="card-header">
                            <div class="div-dropdown-title">
                                <span
                                    class="dropdown-title-text"><?php echo e(__('payroll_reference_payroll.label_jamsostek')); ?></span>
                                <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                    alt="Triangle">
                            </div>
                        </div>
                    ...
                    <div id="jamsostek-data" class="collapse show">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pension_contribution_employee"><?php echo e(__('payroll_reference_payroll.label_pension_contribution_employee')); ?></label>
                                        ...
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="pension_contribution_employee" name="pension_contribution_employee"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_pension_contribution_employee')); ?>" readonly>
                                            <div class="input-group-prepend">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pension_contribution_employer"><?php echo e(__('payroll_reference_payroll.label_pension_contribution_employer')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="pension_contribution_employer" name="pension_contribution_employer"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_pension_contribution_employer')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="work_related_accident_insurance_one"><?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_one')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="work_related_accident_insurance_one" name="work_related_accident_insurance_one"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_one')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="work_related_accident_insurance_two"><?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_two')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="work_related_accident_insurance_two" name="work_related_accident_insurance_two"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_two')); ?>"readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="work_related_accident_insurance_three"><?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_three')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="work_related_accident_insurance_three" name="work_related_accident_insurance_three"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_work_related_accident_insurance_three')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="non_accidental_death_insurance"><?php echo e(__('payroll_reference_payroll.label_non_accidental_death_insurance')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="non_accidental_death_insurance" name="non_accidental_death_insurance"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_non_accidental_death_insurance')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="health_insurance_company"><?php echo e(__('payroll_reference_payroll.label_health_insurance_company')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="health_insurance_company" name="health_insurance_company"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_health_insurance_company')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="health_insurance_employee"><?php echo e(__('payroll_reference_payroll.label_health_insurance_employee')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="health_insurance_employee" name="health_insurance_employee"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_health_insurance_employee')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="min_calculation_health_insurance"><?php echo e(__('payroll_reference_payroll.label_min_calculation_health_insurance')); ?></label>
                                        <input type="number" class="form-control" id="min_calculation_health_insurance" name="min_calculation_health_insurance"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_min_calculation_health_insurance')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="max_calculation_health_insurance"><?php echo e(__('payroll_reference_payroll.label_max_calculation_health_insurance')); ?></label>
                                        <input type="number" class="form-control" id="max_calculation_health_insurance" name="max_calculation_health_insurance"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_max_calculation_health_insurance')); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pension_insurance_company"><?php echo e(__('payroll_reference_payroll.label_pension_insurance_company')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="pension_insurance_company" name="pension_insurance_company"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_pension_insurance_company')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pension_insurance_employee"><?php echo e(__('payroll_reference_payroll.label_pension_insurance_employee')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="pension_insurance_employee" name="pension_insurance_employee"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_pension_insurance_employee')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="min_calculation_pension_insurance"><?php echo e(__('payroll_reference_payroll.label_min_calculation_pension_insurance')); ?></label>
                                        <input type="number" class="form-control" id="min_calculation_pension_insurance" name="min_calculation_pension_insurance"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_min_calculation_pension_insurance')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="max_calculation_pension_insurance"><?php echo e(__('payroll_reference_payroll.label_max_calculation_pension_insurance')); ?></label>
                                        <input type="number" class="form-control" id="max_calculation_pension_insurance" name="max_calculation_pension_insurance"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_max_calculation_pension_insurance')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="multiplication_factor_daily_worker"><?php echo e(__('payroll_reference_payroll.label_multiplication_factor_daily_worker')); ?></label>
                                        <input type="number" class="form-control" id="multiplication_factor_daily_worker" name="multiplication_factor_daily_worker"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_multiplication_factor_daily_worker')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3"> 
                                    <div class="form-group">
                                        <label for="calculation_method"><?php echo e(__('payroll_reference_payroll.label_calculation_method')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="calculation_method_actual"><?php echo e(__('payroll_reference_payroll.label_calculation_method_actual')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="calculation_method_basic"><?php echo e(__('payroll_reference_payroll.label_calculation_method_basic')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3"> 
                                    <div class="form-group">
                                        <label for="deduction_on_period_jamsostek"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="check_all_period_jamsostek"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period_all_period')); ?></label>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <div class="form-check">
                                            ...
                                            <label
                                                for="check_on_period_jamsostek"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period_period')); ?></label>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="work_insurance_remision_payment_percentage"><?php echo e(__('payroll_reference_payroll.label_work_insurance_remision_payment_percentage')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="work_insurance_remision_payment_percentage" name="work_insurance_remision_payment_percentage"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_work_insurance_remision_payment_percentage')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="work_insurance_remision_end_period"><?php echo e(__('payroll_reference_payroll.label_work_insurance_remision_end_period')); ?></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="work_insurance_remision_end_period" name="work_insurance_remision_end_period"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_work_insurance_remision_end_period')); ?>">
                                            <div class="input-group-prepend">
                ...
                <div class="card">
                    <a class="collapsed" data-toggle="collapse" href="#tax-calculation-data" aria-expanded="true"
                        ...
                        <div class="card-header">
                            <div class="div-dropdown-title">
                                <span
                                    class="dropdown-title-text"><?php echo e(__('payroll_reference_payroll.label_tax_calculation_table')); ?></span>
                                <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                    alt="Triangle">
                            </div>
                        </div>
                    ...
                    <div id="tax-calculation-data" class="collapse show">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-3"> 
                                    <div class="form-group">
                                        <label for="tax_calculation_method"><?php echo e(__('payroll_reference_payroll.label_tax_calculation_method')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="tax_calculation_method_annualized"><?php echo e(__('payroll_reference_payroll.label_tax_calculation_method_annualized')); ?></label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label
                                            for="tax_calculation_method_prorated"><?php echo e(__('payroll_reference_payroll.label_tax_calculation_method_prorated')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        <br>
                                        <label for="non_taxable_income"><?php echo e(__('payroll_reference_payroll.label_non_taxable_income')); ?></label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="non_taxable_income_employee"><?php echo e(__('payroll_reference_payroll.label_non_taxable_income_employee')); ?></label>
                                        <input type="number" class="form-control" id="non_taxable_income_employee" name="non_taxable_income_employee"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_non_taxable_income_employee')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="non_taxable_income_each_dependent"><?php echo e(__('payroll_reference_payroll.label_non_taxable_income_each_dependent')); ?></label>
                                        <input type="number" class="form-control" id="non_taxable_income_each_dependent" name="non_taxable_income_each_dependent"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_non_taxable_income_each_dependent')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        <br>
                                        <label for="occupational"><?php echo e(__('payroll_reference_payroll.label_occupational')); ?></label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="occupational_percentage"><?php echo e(__('payroll_reference_payroll.label_occupational_percentage')); ?></label>
                                        <input type="number" class="form-control" id="occupational_percentage" name="occupational_percentage"
                                            placeholder="<?php echo e(__('payroll_reference_payroll.label_occupational_percentage')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="occupational_maximum"><?php echo e(__('payroll_reference_payroll.label_occupational_maximum')); ?></label>
                                        <small class="text-muted">(0 - 100)</small>
                                        <div class="input-group">
                                            <input type="number" min=0 max=100 class="form-control" id="occupational_maximum" name="occupational_maximum"
                                                placeholder="<?php echo e(__('payroll_reference_payroll.label_occupational_maximum')); ?>" readonly>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span>%</span></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-8 box">
                                    <div class="row">
                                        <div class="col-3">
                                            <h6 for="tax_rate"><?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?></h6>
                                        </div>
                                        <div class="col-3">
                                            <h6 for="taxable_income"><?php echo e(__('payroll_reference_payroll.label_taxable_income')); ?></h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate1" name="tax_rate1" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 1" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate2" name="tax_rate2" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 2" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate3" name="tax_rate3" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 3" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate4" name="tax_rate4" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 4" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate5" name="tax_rate5" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 5" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="tax_rate6" name="tax_rate6" placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate')); ?> 6" readonly />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><span>%</span></span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from1" name="taxable_income_from1" data-seq=1 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 1" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from2" name="taxable_income_from2" data-seq=2 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 2" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from3" name="taxable_income_from3" data-seq=3 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 3" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from4" name="taxable_income_from4" data-seq=4 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 4" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from5" name="taxable_income_from5" data-seq=5 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 5" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_from6" name="taxable_income_from6" data-seq=6 placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 6" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_to1" name="taxable_income_to1" placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 1" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_to2" name="taxable_income_to2" placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 2" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_to3" name="taxable_income_to3" placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 3" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_to4" name="taxable_income_to4" placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 4" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" id="taxable_income_to5" name="taxable_income_to5" placeholder="<?php echo e(__("payroll_reference_payroll.label_taxable_income")); ?> 5" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="and_on_taxable_income"><?php echo e(__('payroll_reference_payroll.label_and_on')); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-4">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label
                                                        for="nearest_taxable_income"><?php echo e(__('payroll_reference_payroll.label_nearest_taxable_income')); ?></label>
                                                </div>
                                                <input type="number" class="form-control" id="nearest_taxable_income" name="nearest_taxable_income"
                                                        placeholder="<?php echo e(__('payroll_reference_payroll.label_nearest_taxable_income')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label
                                                    for="time_test"><?php echo e(__('payroll_reference_payroll.label_time_test')); ?></label>
                                                <input type="number" class="form-control" id="time_test" name="time_test"
                                                    placeholder="<?php echo e(__('payroll_reference_payroll.label_time_test')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="tax_rate_with_time_test"><?php echo e(__('payroll_reference_payroll.label_tax_rate_with_time_test')); ?></label>
                                                <small class="text-muted">(0 - 100)</small>
                                                <div class="input-group">
                                                    <input type="number" min=0 max=100 class="form-control" id="tax_rate_with_time_test" name="tax_rate_with_time_test"
                                                        placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_rate_with_time_test')); ?>" readonly>
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><span>%</span></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label
                                                    for="max_gross_income"><?php echo e(__('payroll_reference_payroll.label_max_gross_income')); ?></label>
                                                <input type="number" class="form-control" id="max_gross_income" name="max_gross_income"
                                                    placeholder="<?php echo e(__('payroll_reference_payroll.label_max_gross_income')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-4 box">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="tax_by_government"><?php echo e(__('payroll_reference_payroll.label_tax_by_government')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="row">
                                        <div class="col-4"> 
                                            <div class="form-group">
                                                <label for="deduction_on_period_tax_calculation_table"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    <label
                                                        for="check_all_period_tax_calculation_table"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period_all_period')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    <label
                                                        for="check_on_period_tax_calculation_table"><?php echo e(__('payroll_reference_payroll.label_deduction_on_period_period')); ?></label>
                                                    <small class="text-muted">(1 - 12)</small>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="tax_penalties"><?php echo e(__('payroll_reference_payroll.label_tax_penalties')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="tax_penalties_salary"><?php echo e(__('payroll_reference_payroll.label_tax_penalties_salary')); ?></label>
                                                <small class="text-muted">(0 - 100)</small>
                                                <div class="input-group">
                                                    <input type="number" min=0 max=100 class="form-control" id="tax_penalties_salary" name="tax_penalties_salary"
                                                        placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_penalties_salary')); ?>" readonly>
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><span>%</span></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="tax_penalties_bonus"><?php echo e(__('payroll_reference_payroll.label_tax_penalties_bonus')); ?></label>
                                                <small class="text-muted">(0 - 100)</small>
                                                <div class="input-group">
                                                    <input type="number" min=0 max=100 class="form-control" id="tax_penalties_bonus" name="tax_penalties_bonus"
                                                        placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_penalties_bonus')); ?>" readonly>
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><span>%</span></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="tax_penalties_thr"><?php echo e(__('payroll_reference_payroll.label_tax_penalties_thr')); ?></label>
                                                <small class="text-muted">(0 - 100)</small>
                                                <div class="input-group">
                                                    <input type="number" min=0 max=100 class="form-control" id="tax_penalties_thr" name="tax_penalties_thr"
                                                        placeholder="<?php echo e(__('payroll_reference_payroll.label_tax_penalties_thr')); ?>" readonly>
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><span>%</span></span>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-8 box">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <h6 for="severance_payment_rate"><?php echo e(__('payroll_reference_payroll.label_severance_payment_rate')); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_from1" name="severance_payment_from1" data-seq="1" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 1" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_from2" name="severance_payment_from2" data-seq="2" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 2" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_from3" name="severance_payment_from3" data-seq="3" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 3" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_from4" name="severance_payment_from4" data-seq="4" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 4" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_from5" name="severance_payment_from5" data-seq="5" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 5" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-0.5">
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_to1" name="severance_payment_to1" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 1" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_to2" name="severance_payment_to2" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 2" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_to3" name="severance_payment_to3" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 3" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_to4" name="severance_payment_to4" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 4" readonly />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="severance_payment_to5" name="severance_payment_to5" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 5" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-0.5">
                                        ...
                                        <div class="col-3">
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="severance_payment_rate1" name="severance_payment_rate1" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 1" readonly />
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><span>%</span></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="severance_payment_rate2" name="severance_payment_rate2" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 2" readonly />
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><span>%</span></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="severance_payment_rate3" name="severance_payment_rate3" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 3" readonly />
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><span>%</span></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="severance_payment_rate4" name="severance_payment_rate4" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 4" readonly />
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><span>%</span></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="severance_payment_rate5" name="severance_payment_rate5" placeholder="<?php echo e(__("payroll_reference_payroll.label_severance_payment_rate")); ?> 5" readonly />
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><span>%</span></span>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_reference_payroll.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var arrDataTM = <?php echo json_encode($data_tm, 15, 512) ?>;
        var arrDataCPY = <?php echo json_encode($data_cpy, 15, 512) ?>;
        var arrDataPR = <?php echo json_encode($data_pr, 15, 512) ?>;
        ...
        if (arrDataTM) {
            ...
            $('#message-notification-error').html("<?php echo e(__('payroll_reference_payroll.error_tm')); ?>");
            window.location =
        ...
        if ($("#reference_payroll_form").length > 0) {
            $("#reference_payroll_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/reference_payroll/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/reference_payroll')); ?>";
                                }, 3000);
                            } else {
                                $("#toolbar-save").prop("disabled", false);
                                $("#toolbar-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_reference_payroll.blade.php ENDPATH**/ ?>