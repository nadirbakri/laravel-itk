...
<html>
<head>
    <title><?php echo e(__('export_business_trip_checking.judul')); ?></title>
    ...
    <style type="text/css">
        .div-export-business-trip-checking {
            max-width: 100%;
            margin: auto;
            /*margin-top: 1%;*/
        }
...
<body>
    <div class="div-form">
        <form id="export_business_trip_checking_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-export-business-trip-checking">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('export_business_trip_checking.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_business_trip_checking.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_business_trip_checking.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_business_trip_checking.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_business_trip_checking.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_business_trip_checking.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="user_id"><?php echo e(__('export_business_trip_checking.label_user_id')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_business_trip_checking.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_business_trip_checking.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
loadDataFirstLastAllBusinessUnit();
        ...
        function loadDataStatus(){
            ...
            $('#status').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/status/func/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        $("#btn-preview").click(function () {
            ...
            $("#export_business_trip_checking_form").submit();
        });

        if ($("#export_business_trip_checking_form").length > 0) {
            $("#export_business_trip_checking_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/business_trip_checking/print')); ?>",
                        type: "POST",
                        data: $('#export_business_trip_checking_form').serialize(),
                        success: function (result, status, xhr) {
                            $("#btn-preview").prop("disabled", false);
                            $("#btn-preview").html(
                                '<i class="fa fa-print"></i> <?php echo e(__("personel_employee_list.btn_print")); ?>'
                            );
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_business_trip_checking.blade.php ENDPATH**/ ?>