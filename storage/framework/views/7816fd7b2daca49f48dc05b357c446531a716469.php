...
<html>
<head>
    <title><?php echo e(__('trans_medical.judul')); ?></title>
    ...
    <div class="div-form">
        <form id="trans_medical_form" method="post">
            ...
            <div class="div-trans-medical">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('trans_medical.list')); ?></span>
                    </a>
                </div>
            <div class="row">
                <div class="col-5">
                    <div class="form-group">
                        <label for="claim_date_from form-check-label"><?php echo e(__('trans_medical.label_claim_date_start')); ?></label>
                    </div>
                    <div class="input-group">
                        <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                            placeholder="<?php echo e(__('trans_medical.label_claim_date_start')); ?>">
                ...
                <div class="col-5">
                    <div class="form-group">
                        <label for="claim_date_to form-check-label"><?php echo e(__('trans_medical.label_claim_date_end')); ?></label>
                    </div>
                    <div class="input-group">
                        <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                            placeholder="<?php echo e(__('trans_medical.label_claim_date_end')); ?>">
                        <div class="input-group-prepend">
            ...
            <div class="row">
                <div class="col-5">
                    <div class="form-group">
                        <label for="reimbursement_type form-check-label"><?php echo e(__('trans_medical.label_reimbursement_type')); ?></label>
                    </div>
                    <select class="form-control select2" id="reimbursement_type" name="reimbursement_type[]"></select>
                </div>
                <div class="col-5">
                    <div class="form-group">
                        <label for="business_unit form-check-label"><?php echo e(__('trans_medical.label_business_unit')); ?></label>
                    </div>
            ...
            <div class="row">
                <div class="col-5">
                    <div class="form-group">
                            <label for="direct_superior form-check-label"><?php echo e(__('trans_medical.employeeno')); ?></label>
                    </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-search" id="btn-search" value="preview" style="width: 100%;">
                            <img src="<?php echo e(url('icons/mob/button/button-search.svg')); ?>" alt="export"> <?php echo e(__('trans_medical.btn_search')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i> <?php echo e(__('trans_medical.btn_upload')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i> <?php echo e(__('trans_medical.btn_list')); ?>
...
<br>
                ...
                <div class="row">
                    <div class="col-6">
                        <p><b><?php echo e(__('trans_medical.list_table')); ?></b></p>
                    </div>
                </div>
                <div class="row">
                    <div class="table-responsive">
                        <table id="medical_table" class="display table-striped table-hover dt-responsive display nowrap" cellspacing="10">
                            <thead>
                                <tr>
                                    <th><?php echo e(__('trans_medical.detail')); ?></th>
                                    <th><?php echo e(__('trans_medical.rdate')); ?></th>
                                    <th><?php echo e(__('trans_medical.tnumber')); ?></th>
                                    <th><?php echo e(__('trans_medical.status')); ?></th>
                                    <th><?php echo e(__('trans_medical.enom')); ?></th>
                                    <th><?php echo e(__('trans_medical.ename')); ?></th>
                                    <th><?php echo e(__('trans_medical.redate')); ?></th>
                                    <th><?php echo e(__('trans_medical.treq')); ?></th>
                                    <th><?php echo e(__('trans_medical.prem')); ?></th>
                                    <th><?php echo e(__('trans_medical.tpaid')); ?></th>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_medical.luser')); ?></h4>
                        ...
                        <table id="example" class="display">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('trans_medical.employeeid')); ?></th>
                                    <th><?php echo e(__('trans_medical.name')); ?></th>
                                    <th><?php echo e(__('trans_medical.div')); ?></th>
                                    <th><?php echo e(__('trans_medical.rank')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
        ...
        <form id="update_approval_medical_history_form" method="post">
            ...
            <div class="modal fade" id="modal_list_detail">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_medical.dreimbursement')); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row detailstatus">
                                    <div class="col-3  ">
                                        <h5><?php echo e(__('trans_medical.rdate')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.redate')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.tnumber')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.status')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.label_business_unit')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.label_reimbursement_type')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.ename')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.pname')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.treq')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.dname')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row approve">
                                    ...
                                    <div class="col-5">
                                            <select name="reimbursement_status" id="reimbursement_status" class="custom-select">
                                                <option value="APPROVED"><?php echo e(__('trans_medical.acc')); ?></option>
                                                <option value="REJECTED"><?php echo e(__('trans_medical.reject')); ?></option>
                                                <option value="PAID"><?php echo e(__('trans_medical.paid')); ?></option>
                                            </select>
                                    </div>
                                </div>
                                <div class="row approve">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.tpaid')); ?></h5>
                                    </div>
                                    <div class="col-5">
                                ...
                                <div class="row approve">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_medical.prem')); ?></h5>
                                    </div>
                                    <div class="col-5">
                                ...
                                <hr>
                                <button class="btn btn-primary btn-block" id="btn-update" type="button"><?php echo e(__('trans_medical.btn_update')); ?></button>
                            </div>
                        </div>
                    </div>
                   </div>
        ...
        <form id="upload_paid_overtime_form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="modal_upload">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_medical.ovt')); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body table-responsive">
                        <div class="card">
                            <div class="col-5">
                                <div class="form-group">
                                    <label for="medical_history form-check-label"><b><?php echo e(__('trans_medical.fovt')); ?></b></label>
                                    ...
                                    <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                                        <?php echo e(__('trans_medical.btn_upload')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('trans_medical.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script>
    ...
    $('#notification_success').on('hide.bs.modal', function () {
        window.location = "<?php echo e(url('transaction/transaction_overtime')); ?>";
    });
    ...
    if ($("#upload_paid_overtime_form").length > 0) {
        $("#upload_paid_overtime_form").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "<?php echo e(url('transaction/update_medical/import')); ?>",
                    type: "POST",
                    processData: false,
                    contentType: false,
                    data: formdata,
                    success: function (response) {
                        if (response[0].status == "true") {
                            ...
                            setTimeout(function () {
                                window.location =
                                    "<?php echo e(url('transaction/transaction_medical_history')); ?>";
                            }, 3000);
                        } else {
                            $("#btn-process").prop("disabled", false);
                            $("#btn-process").html(
...
<script>
    ...
    function update_data(reimbursement_status, totalpaid, ticketNo,direct_superior,approvalremarks){
        $.ajax({
            url: "<?php echo e(url('trans/update_medical/table')); ?>",
            type: "get",
            data: {
...
<script type="text/javascript">
    function load_data_medical_history(claim_date_from, claim_date_to, direct_superior, reimbursement_type, business_unit) {
            table = $('#medical_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url : "<?php echo e(url('trans/medical_history/table')); ?>",
                    data: {
...
<script type="text/javascript">
    ...
    // loadDataFirstLastAllReimbursmentType();
        ...
        $.get("<?php echo e(url('reimbursement_type/medical/api')); ?>", function (data) {
        ...
        $.get("<?php echo e(url('level/api')); ?>", function (data) {      
            ...
            function loadDataExportReimbrusement(){
                ...
                $('#reimbursement_type').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(url('/reimbursement_type/medical/api')); ?>",
                        dataType: 'json',
                        delay: 250,
                        type: "GET",
            ...
            function loadDataFirstLastAllReimbursement () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/reimbursement_type/medical/all/api')); ?>",
                }).then(function (data) {
            ...
            //     $.ajax({
            //         type: 'GET',
            //         url: "<?php echo e(url('/reimbursement_type/all/api')); ?>",
            //     }).then(function (data) {
            //         if (!$('#reimbursement_type').find('option:contains(' + data.value + ')').length)
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/transaction/trc_trans_medical_history.blade.php ENDPATH**/ ?>