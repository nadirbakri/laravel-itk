    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="<?php echo e(url('time_management/absent_code')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_absent_code.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="absent_code_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="record_status"><?php echo e(__('tm_absent_code.label_record_status')); ?></label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="<?php echo e(__('tm_absent_code.label_record_status')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="absent_code"><?php echo e(__('tm_absent_code.label_absent_code')); ?></label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="absent_code" name="absent_code"
                                placeholder="<?php echo e(__('tm_absent_code.label_absent_code')); ?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="description"><?php echo e(__('tm_absent_code.label_description')); ?></label>
                            <input type="text" class="form-control" id="description" name="description"
                                placeholder="<?php echo e(__('tm_absent_code.label_description')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="category"><?php echo e(__('tm_absent_code.label_category')); ?></label>
                            <span class="required">*</span>
                            <select class="form-control" id="category" name="category"
                                placeholder="<?php echo e(__('tm_absent_code.label_category')); ?>"> </select>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="deduct_leave"><?php echo e(__('tm_absent_code.label_deduct_leave')); ?></label>
                            <select class="form-control" id="deduct_leave" name="deduct_leave"
                                placeholder="<?php echo e(__('tm_absent_code.label_deduct_leave')); ?>"> </select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_get_compensation_leave"><?php echo e(__('tm_absent_code.label_get_compensation_leave')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_must_woman"><?php echo e(__('tm_absent_code.label_must_woman')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_deduct_salary"><?php echo e(__('tm_absent_code.label_deduct_salary')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_deduct_allowance"><?php echo e(__('tm_absent_code.label_deduct_allowance')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_warning"><?php echo e(__('tm_absent_code.label_warning')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="times_allowed"><?php echo e(__('tm_absent_code.label_times_allowed')); ?></label>
                            <input type="text" class="form-control" id="times_allowed" name="times_allowed"
                                placeholder="<?php echo e(__('tm_absent_code.label_times_allowed')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_tolerance_request"><?php echo e(__('tm_absent_code.label_tolerance_request')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="back_date"><?php echo e(__('tm_absent_code.label_back_date')); ?></label>
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" id="back_date" name="back_date"
                                    placeholder="<?php echo e(__('tm_absent_code.label_back_date')); ?>" readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label for="max_per_request"><?php echo e(__('tm_absent_code.label_max_per_request')); ?></label>
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" id="max_per_request" name="max_per_request"
                                    placeholder="<?php echo e(__('tm_absent_code.label_max_per_request')); ?>" readonly>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">Day</div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="mobile"><?php echo e(__('tm_absent_code.label_mobile')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="check_display_absent_code"><?php echo e(__('tm_absent_code.label_display_absent_code')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label
                                    for="check_need_attachment"><?php echo e(__('tm_absent_code.label_need_attachment')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="payroll"><?php echo e(__('tm_absent_code.label_payroll')); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('tm_absent_code.btn_save')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('time_management/absent_code')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('tm_absent_code.btn_cancel')); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/absenteeism_type/func/api')); ?>",
                data: {
                    'absentType': "<?php echo e(isset($data[0]->absentType) ? $data[0]->absentType : ''); ?>"
                }
            }).then(function (data) {
                var option = $('<option/>', {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/deduct_leave/func/api')); ?>",
                data: {
                    'deductLeave': "<?php echo e(isset($data[0]->deductLeave) ? $data[0]->deductLeave : ''); ?>"
                }
            }).then(function (data) {
        ...
        function loadDataDeductLeave() {
            ...
            $('#deduct_leave').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/deduct_leave/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        if ($("#absent_code_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    absent_code: {
                        required: "<?php echo e(__('tm_absent_code.absent_code_required')); ?>",
                    },
                    no_of_day: {
                        required: "<?php echo e(__('tm_absent_code.category_required')); ?>",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/absent_code/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('time_management/absent_code')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_absent_code_detail.blade.php ENDPATH**/ ?>