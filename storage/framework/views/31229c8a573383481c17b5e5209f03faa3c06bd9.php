...
<html>
<head>
    <title><?php echo e(__('export_medical.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="export_medical_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-export-medical">
                <div class="div-title">
                    <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('export_medical.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_medical.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_medical.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_medical.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_medical.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="reimbursement_type"><?php echo e(__('export_medical.label_reimbursement_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_medical.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <i class="fa fa-download"></i> <?php echo e(__('export_medical.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_medical.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
// loadDataFirstLastAllReimbursmentType();
    ...
    //     });
        ...
        $("#btn-preview").click(function () {
            ...
            $("#export_medical_form").submit();
        });

        if ($("#export_medical_form").length > 0) {
            $("#export_medical_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/export_medical/print')); ?>",
                        type: "POST",
                        data: $('#export_medical_form').serialize(),
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_medical.blade.php ENDPATH**/ ?>