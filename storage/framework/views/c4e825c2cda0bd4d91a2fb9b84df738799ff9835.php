...
<html>
<head>
    <title><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="export_data_kepesertaan_bpjs_tk_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="btn-send-to" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_export_data_kepesertaan_bpjs_tk.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-send').click(function (){
            ...
            $('#export_data_kepesertaan_bpjs_tk_form').submit();
        });
        ...
        if($('#export_data_kepesertaan_bpjs_tk_form').length > 0){
            $('#export_data_kepesertaan_bpjs_tk_form').validate({
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/export_data_kepesertaan_bpjs_tk_report/print/excel')); ?>",
                            type: "POST",
                            data: $('#export_data_kepesertaan_bpjs_tk_form').serialize(),
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/export_data_kepesertaan_bpjs_tk_report/print')); ?>",
                            type: "POST",
                            data: $('#export_data_kepesertaan_bpjs_tk_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_export_data_kepesertaan_bpjs_tk.blade.php ENDPATH**/ ?>