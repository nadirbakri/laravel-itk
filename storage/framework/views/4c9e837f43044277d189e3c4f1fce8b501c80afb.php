...
<html>
<head>
    <title><?php echo e(__('payroll_absenteeism_overtime_calculation_process.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="process_period"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_process_period')); ?></label>
                                <input type="text" class="form-control" id="process_period_month" name="process_period_month"
                                    placeholder="<?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_process_period_month')); ?>" readonly>
                        </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="process_period_year" name="process_period_year"
                                placeholder="<?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_process_period_year')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="range_employee_no"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_range_employee_no')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_employee_no_from')); ?></label>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_no_to"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_absenteeism_overtime_calculation_process.btn_process')); ?>
                    ...
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard"
                            ...
                            <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_absenteeism_overtime_calculation_process.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_absenteeism_overtime_calculation_process.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#absenteeism_overtime_calculation_process_form").length > 0) {
            $("#absenteeism_overtime_calculation_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/absenteeism_overtime_calculation_process/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-process").html(
                                    '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_absenteeism_overtime_calculation_process.btn_process")); ?>'
                                );
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/absenteeism_overtime_calculation_process')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_absenteeism_overtime_calculation_process.blade.php ENDPATH**/ ?>