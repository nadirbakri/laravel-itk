        ...
        <form id="retroactive_report_form" method="post">
            ...
            <div class="div-payroll">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="as_of_period"><?php echo e(__('payroll_retroactive_report.label_as_of_period')); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="as_of_period" name="as_of_period"
                                    placeholder="<?php echo e(__('payroll_retroactive_report.label_as_of_period')); ?>">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_retroactive_report.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_retroactive_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_retroactive_report.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_retroactive_report.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_retroactive_report.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_retroactive_report.btn_preview')); ?>
                    ...
                    <div class="col-3 desc" id="send-to-report">
                        <div class="dropdown">
                            <button style="width: 100%;" class="btn btn-primary dropdown-toggle" id="btn-send-to" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-print"></i> <?php echo e(__('payroll_retroactive_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_retroactive_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-send').click(function (){
            ...
            $('#retroactive_report_form').submit();
        });
        ...
        if($('#retroactive_report_form').length > 0){
            $('#retroactive_report_form').validate({
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/retroactive_report/excel/print')); ?>",
                            type: "POST",
                            data: $('#retroactive_report_form').serialize(),
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/retroactive_report/print')); ?>",
                            type: "POST",
                            data: $('#retroactive_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_retroactive_report.blade.php ENDPATH**/ ?>