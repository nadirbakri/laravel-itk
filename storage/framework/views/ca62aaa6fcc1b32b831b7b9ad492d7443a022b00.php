...
<html lang="en">
<head>
    <title><?php echo e(__('tm_absenteeism_data_entry_by_date.judul')); ?></title>
    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_absenteeism_data_entry_by_date.list')); ?></span>
            </a> 
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="absenteeism_date"><?php echo e(__('tm_absenteeism_data_entry_by_date.label_absenteeism_date')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absenteeism_date" name="absenteeism_date"
                                    placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_date.label_absenteeism_date')); ?>">
        ...
        <div class="row">
            <div class="col-3">
                <button type="submit" class="btn btn-primary" name="btn-edit" id="btn-edit"
                    style="width: 100%;">
                    <i class="fa fa-pencil"></i> <?php echo e(__('tm_absenteeism_data_entry_by_date.btn_edit')); ?>
            ...
            <div class="col-3">
                <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                    ...
                    <i class="fa fa-floppy-o"></i> <?php echo e(__('tm_absenteeism_data_entry_by_date.btn_save')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_absenteeism_data_entry_by_date.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function load_data(){
            ...
            $.ajax({
                url: "<?php echo e(url('time_management/absenteeism_data_entry_by_date/table')); ?>",
                type: "GET",
                data: {
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        error: function (response) {
                            $("#btn-save").prop("disabled", false);
                            $("#btn-save").html(
                                '<i class="fa fa-print"></i> <?php echo e(__("tm_absenteeism_data_entry_by_date.btn_save")); ?>'
                            );
                            $('#notification_error').modal('show');
                            $('#message-notification-error').html(response);
                        }
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_absenteeism_data_entry_by_date.blade.php ENDPATH**/ ?>