...
<html>
<head>
    <title><?php echo e(__('medical.judul')); ?></title>
	...
	<link rel="stylesheet" href="<?php echo e(asset('css/medical.css')); ?>">
	<style type="text/css">
		.div-medical {
			max-width: 97%;
			margin: auto;
...
<body>
	<div class="div-medical">
		<div class="div-title">
			<img src="<?php echo e(url('icons/sidebar/medical.png')); ?>" alt="Title">
			<span class="title-text"><?php echo e(__('medical.judul')); ?></span>
		</div>
			...
			<a class="collapsed" data-toggle="collapse" href="#<?php echo e($value->pageURL); ?>" aria-expanded="true" aria-controls="<?php echo e($value->pageURL); ?>">
				<div class="card-header">
					<div class="div-dropdown-title">
						<img class="dropdown-logo" src="<?php echo e(url('/icons/medical/' . $value->pageURL . '.svg')); ?>" alt="medical">
							...
							<div class="row div-child-data">
								...
								<div class="col col-3">
									<a href="<?php echo e(url($value3->pageURL)); ?>" target="iframe_dashboard">
										<img src="<?php echo e(url('/icons/medical/submenu-' . $value->pageURL . '.svg')); ?>" alt="Child medical">
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/medical/md_main.blade.php ENDPATH**/ ?>