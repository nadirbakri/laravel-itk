            ...
            <div class="div-trans-business-trip">
                <div class="div-title">
                    <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('trans_active_document.list')); ?></span>
                    </a>
                </div>
            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    ...
                    <div class="col-3">
                        ...
                        style="width: 100%;">
                        <?php echo e(__('trans_business_trip.update')); ?>
                            ...
                            <table id="business_trip_table" class="display table-striped table-hover dt-responsive display nowrap" cellspacing="10">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('trans_business_trip.cpaid')); ?></th>
 ...
 function load_data_businesstrip(claim_date_from, claim_date_to, direct_superior, reimbursement_type, business_unit) {
   ...
   $('#btn-list').click(()=> {
    ...
    $('#notification_success').on('hide.bs.modal', function () {
        window.location = "<?php echo e(url('transaction/transaction_active_document')); ?>";
    });
    ...
    if ($("#trans_business_trip_form").length > 0) {
        $("#trans_business_trip_form").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "<?php echo e(url('transaction/transaction_active_document/proses')); ?>",
                    type: "POST",
                    ...
                    success: function (response) {
                        if (response.status == "true") {
                            ...
                            setTimeout(function () {
                                window.location =
                                    "<?php echo e(url('transaction/transaction_active_document')); ?>";
                            }, 3000);
                        } else {
                            $("#btn-update").prop("disabled", false);
                            $("#btn-update").html(
...
$.get("<?php echo e(url('level/api')); ?>", function (data) {
        ...
        // $.get("<?php echo e(url('status/func/api')); ?>", function (data) {
        //     $.each(data, function (k, v) {
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/transaction/trc_trans_active_document.blade.php ENDPATH**/ ?>