...
<head>
    <title><?php echo e(__('personel_personal_data.judul')); ?></title>
...
<body>
                ...
                <div class="div-profile">
                    <div class="row div-row-profile">
                        <div class="col-2 subdiv-profile-image">
                            <!-- <img src="<?php echo e(isset($data[0]->photo) ? $photo : url('/pictures/profile-picture.png')); ?>"
                                alt="Profile"> -->
                            <img src="<?php echo e('../../photo_profile/' . $photo); ?>" alt="Profile" class="photo rounded-circle" id="photo" name="photo">
                            <label class="btn btn-primary" id=""><i class="fa fa-edit"></i>
                                <?php echo e(__('personel_personal_data.btn_change_picture')); ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="button" class="btn btn-primary" name="btn-save-profile" id="btn-save-profile"
                                        style="width: 100%;">
                                        <i class="fa fa-floppy-o"></i> <?php echo e(__('personel_personal_data.btn_save')); ?>
                ...
                <ul class="nav nav-tabs" id="tab-personal" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="info-tab" data-toggle="tab" href="#info_tab" role="tab"
                            aria-controls="info" aria-selected="true"><?php echo e(__('personel_personal_data.info_tab')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="address-tab" data-toggle="tab" href="#address_tab" role="tab"
                            aria-controls="address"
                            aria-selected="false"><?php echo e(__('personel_personal_data.address_tab')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="employment-tab" data-toggle="tab" href="#employment_tab" role="tab"
                            aria-controls="employment"
                            aria-selected="false"><?php echo e(__('personel_personal_data.employment_tab')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="absenteeism-payroll-tab" data-toggle="tab"
                            ...
                            aria-selected="false"><?php echo e(__('personel_personal_data.absenteeism_payroll_tab')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="family-dependent-tab" data-toggle="tab" href="#family_dependent_tab"
                            ...
                            aria-selected="false"><?php echo e(__('personel_personal_data.family_dependent_tab')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="insurance-tab" data-toggle="tab" href="#insurance_tab" role="tab"
                            aria-controls="insurance"
                            aria-selected="false"><?php echo e(__('personel_personal_data.insurance_tab')); ?></a>
                    </li>
                </ul>
                <div class="tab-content" id="tab-content-personal">
                    <div class="tab-pane fade show active" id="info_tab" role="tabpanel" aria-labelledby="info-tab">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="employee_no_info"><?php echo e(__('personel_personal_data.label_employee_no')); ?></label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" id="employee_no_info"
                                        name="employee_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_employee_no')); ?>">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="fullname_info"><?php echo e(__('personel_personal_data.label_fullname')); ?></label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" id="fullname_info" name="fullname_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_fullname')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="title_info"><?php echo e(__('personel_personal_data.label_title')); ?></label>
                                    <input type="text" class="form-control" id="title_info" name="title_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_title')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="birth_place_info"><?php echo e(__('personel_personal_data.label_birth_place')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="birth_date_info"><?php echo e(__('personel_personal_data.label_birth_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="birth_date_info"
                                            name="birth_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_birth_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="gender_info"><?php echo e(__('personel_personal_data.label_gender')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="blood_type_info"><?php echo e(__('personel_personal_data.label_blood_type')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="marital_status_info"><?php echo e(__('personel_personal_data.label_marital_status')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="religion_info"><?php echo e(__('personel_personal_data.label_religion')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="nationality_info"><?php echo e(__('personel_personal_data.label_nationality')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="id_no_info"><?php echo e(__('personel_personal_data.label_id_no')); ?></label>
                                    <input type="text" class="form-control" id="id_no_info" name="id_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_id_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="passport_no_info"><?php echo e(__('personel_personal_data.label_passport_no')); ?></label>
                                    <input type="text" class="form-control" id="passport_no_info"
                                        name="passport_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_passport_no')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="passport_date_info"><?php echo e(__('personel_personal_data.label_passport_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="passport_date_info"
                                            name="passport_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_passport_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="tax_registered_no_info"><?php echo e(__('personel_personal_data.label_tax_registered_no')); ?></label>
                                    <input type="text" class="form-control" id="tax_registered_no_info"
                                        name="tax_registered_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_tax_registered_no')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="tax_registered_date_info"><?php echo e(__('personel_personal_data.label_tax_registered_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="tax_registered_date_info"
                                            name="tax_registered_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_tax_registered_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="tax_office_info"><?php echo e(__('personel_personal_data.label_tax_office')); ?></label>
                                    <input type="text" class="form-control" id="tax_office_info" name="tax_office_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_tax_office')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="tax_expiry_date_info"><?php echo e(__('personel_personal_data.label_tax_expiry_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="tax_expiry_date_info"
                                            name="tax_expiry_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_tax_expiry_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_car_type_info"><?php echo e(__('personel_personal_data.label_driving_license_car_type')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_car_no_info"><?php echo e(__('personel_personal_data.label_driving_license_car_no')); ?></label>
                                    <input type="text" class="form-control" id="driving_license_car_no_info"
                                        name="driving_license_car_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_driving_license_car_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_car_date_info"><?php echo e(__('personel_personal_data.label_driving_license_car_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="driving_license_car_date_info"
                                            name="driving_license_car_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_driving_license_car_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_car_registration_place_info"><?php echo e(__('personel_personal_data.label_driving_license_car_registration_place')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_car_expiry_date_info"><?php echo e(__('personel_personal_data.label_driving_license_car_expiry_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control"
                                            id="driving_license_car_expiry_date_info"
                                            name="driving_license_car_expiry_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_driving_license_car_expiry_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_motorcycle_no_info"><?php echo e(__('personel_personal_data.label_driving_license_motorcycle_no')); ?></label>
                                    <input type="text" class="form-control" id="driving_license_motorcycle_no_info"
                                        name="driving_license_motorcycle_no_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_driving_license_motorcycle_no')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_motorcycle_date_info"><?php echo e(__('personel_personal_data.label_driving_license_motorcycle_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control"
                                            id="driving_license_motorcycle_date_info"
                                            name="driving_license_motorcycle_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_driving_license_motorcycle_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_motorcycle_registration_place_info"><?php echo e(__('personel_personal_data.label_driving_license_motorcycle_registration_place')); ?></label>
                                    <select class="form-control select2"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="driving_license_motorcycle_expiry_date_info"><?php echo e(__('personel_personal_data.label_driving_license_motorcycle_expiry_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control"
                                            id="driving_license_motorcycle_expiry_date_info"
                                            name="driving_license_motorcycle_expiry_date_info"
                                            placeholder="<?php echo e(__('personel_personal_data.label_driving_license_motorcycle_expiry_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="mother_name_info"><?php echo e(__('personel_personal_data.label_mother_name')); ?></label>
                                    <input type="text" class="form-control" id="mother_name_info"
                                        name="mother_name_info"
                                        placeholder="<?php echo e(__('personel_personal_data.label_mother_name')); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="address_tab" role="tabpanel" aria-labelledby="address-tab">
                        <div class="row">
                            <div class="col-5">
                                <span
                                    class="div-title-text"><?php echo e(__('personel_personal_data.label_home_address')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="address_home"><?php echo e(__('personel_personal_data.label_address')); ?></label>
                                            <textarea class="form-control" id="address_home" name="address_home"
                                                rows="3"
                                                placeholder="<?php echo e(__('personel_personal_data.label_address')); ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="city_select_home"><?php echo e(__('personel_personal_data.label_city')); ?></label>
                                    ...
                                    <div class="col-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="city_text_home"
                                                name="city_text_home"
                                                placeholder="<?php echo e(__('personel_personal_data.label_city')); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="zip_code_select_home"><?php echo e(__('personel_personal_data.label_zip_code')); ?></label>
                                    ...
                                    <div class="col-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="zip_code_text_home"
                                                ...
                                                placeholder="<?php echo e(__('personel_personal_data.label_zip_code')); ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="district_select_home"><?php echo e(__('personel_personal_data.label_district')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="subdistrict_home"><?php echo e(__('personel_personal_data.label_subdistrict')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="phone_number_home"><?php echo e(__('personel_personal_data.label_phone_number')); ?></label>
                                            <input type="text" class="form-control" id="phone_number_home"
                                                name="phone_number_home"
                                                placeholder="<?php echo e(__('personel_personal_data.label_phone_number')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-5">
                                <span
                                    class="div-title-text"><?php echo e(__('personel_personal_data.label_other_address')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="address_other"><?php echo e(__('personel_personal_data.label_address')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="city_select_other"><?php echo e(__('personel_personal_data.label_city')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="zip_code_select_other"><?php echo e(__('personel_personal_data.label_zip_code')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="district_select_other"><?php echo e(__('personel_personal_data.label_district')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="subdistrict_other"><?php echo e(__('personel_personal_data.label_subdistrict')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="phone_number_other"><?php echo e(__('personel_personal_data.label_phone_number')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-5">
                                <span
                                    class="div-title-text"><?php echo e(__('personel_personal_data.label_work_address')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="address_work"><?php echo e(__('personel_personal_data.label_address')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="city_select_work"><?php echo e(__('personel_personal_data.label_city')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="zip_code_select_work"><?php echo e(__('personel_personal_data.label_zip_code')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="phone_number_work"><?php echo e(__('personel_personal_data.label_phone_number')); ?></label>
                            ...
                            <div class="col-5">
                                <span
                                    class="div-title-text"><?php echo e(__('personel_personal_data.label_correspondence_address')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="address_correspondence"><?php echo e(__('personel_personal_data.label_address')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="city_select_correspondence"><?php echo e(__('personel_personal_data.label_city')); ?></label>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label
                                                for="zip_code_select_correspondence"><?php echo e(__('personel_personal_data.label_zip_code')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="phone_number_correspondence"><?php echo e(__('personel_personal_data.label_phone_number')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-5">
                                <span
                                    class="div-title-text"><?php echo e(__('personel_personal_data.label_emergency_contact')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="name_emergency"><?php echo e(__('personel_personal_data.label_name')); ?></label>
                                            <input type="text" class="form-control" id="name_emergency"
                                                name="name_emergency"
                                                placeholder="<?php echo e(__('personel_personal_data.label_name')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="address_emergency"><?php echo e(__('personel_personal_data.label_address')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="phone_number_emergency"><?php echo e(__('personel_personal_data.label_phone_number')); ?></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="relation_emergency"><?php echo e(__('personel_personal_data.label_relation')); ?></label>
                                            <input type="text" class="form-control" id="relation_emergency"
                                                name="relation_emergency"
                                                placeholder="<?php echo e(__('personel_personal_data.label_relation')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="email_emergency"><?php echo e(__('personel_personal_data.label_email')); ?></label>
                                            <input type="text" class="form-control" id="email_emergency"
                                                name="email_emergency"
                                                placeholder="<?php echo e(__('personel_personal_data.label_email')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-5">
                                <span class="div-title-text"><?php echo e(__('personel_personal_data.label_other')); ?></span>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="handphone_no_other"><?php echo e(__('personel_personal_data.label_handphone_no')); ?></label>
                                            <input type="text" class="form-control" id="handphone_no_other"
                                                name="handphone_no_other"
                                                placeholder="<?php echo e(__('personel_personal_data.label_handphone_no')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="personal_email_other"><?php echo e(__('personel_personal_data.label_personal_email')); ?></label>
                                            <input type="text" class="form-control" id="personal_email_other"
                                                name="personal_email_other"
                                                placeholder="<?php echo e(__('personel_personal_data.label_personal_email')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="company_email_other"><?php echo e(__('personel_personal_data.label_company_email')); ?></label>
                                            <input type="text" class="form-control" id="company_email_other"
                                                name="company_email_other"
                                                placeholder="<?php echo e(__('personel_personal_data.label_company_email')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label
                                                for="company_card_id_other"><?php echo e(__('personel_personal_data.label_company_card_id')); ?></label>
                                            <input type="text" class="form-control" id="company_card_id_other"
                                                name="company_card_id_other"
                                                placeholder="<?php echo e(__('personel_personal_data.label_company_card_id')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="employment_tab" role="tabpanel" aria-labelledby="employment-tab">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="employment_status_employment"><?php echo e(__('personel_personal_data.label_employment_status')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="employment_type_employment"><?php echo e(__('personel_personal_data.label_employment_type')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="origin_join_date_employment"><?php echo e(__('personel_personal_data.label_origin_join_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="origin_join_date_employment"
                                            name="origin_join_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_origin_join_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="office_location_employment"><?php echo e(__('personel_personal_data.label_office_location')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="joining_date_employment"><?php echo e(__('personel_personal_data.label_joining_date')); ?></label>
                                    <span class="required">*</span>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="joining_date_employment"
                                            name="joining_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_joining_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="probation_end_date_employment"><?php echo e(__('personel_personal_data.label_probation_end_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="probation_end_date_employment"
                                            name="probation_end_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_probation_end_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="contract_start_date_employment"><?php echo e(__('personel_personal_data.label_contract_start_date')); ?></label>
                                    <span class="required">*</span>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="contract_start_date_employment"
                                            name="contract_start_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_contract_start_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="contract_end_date_employment"><?php echo e(__('personel_personal_data.label_contract_end_date')); ?></label>
                                    <span class="required">*</span>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="contract_end_date_employment"
                                            name="contract_end_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_contract_end_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="termination_date_employment"><?php echo e(__('personel_personal_data.label_termination_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="termination_date_employment"
                                            name="termination_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_termination_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="effective_terminated_employment"><?php echo e(__('personel_personal_data.label_effective_terminated')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="effective_terminated_employment"
                                            name="effective_terminated_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_effective_terminated')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="termination_code_employment"><?php echo e(__('personel_personal_data.label_termination_code')); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="special_reason_resign_employment"><?php echo e(__('personel_personal_data.label_special_reason_resign')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="termination_remarks_employment"><?php echo e(__('personel_personal_data.label_termination_remarks')); ?></label>
                                    <textarea class="form-control" id="termination_remarks_employment"
                                        name="termination_remarks_employment" rows="3"
                                        placeholder="<?php echo e(__('personel_personal_data.label_termination_remarks')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="expatriat_employment"><?php echo e(__('personel_personal_data.label_expatriat')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="license_no_employment"><?php echo e(__('personel_personal_data.label_license_no')); ?></label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" id="license_no_employment"
                                        name="license_no_employment"
                                        placeholder="<?php echo e(__('personel_personal_data.label_license_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="start_date_employment"><?php echo e(__('personel_personal_data.label_start_date')); ?></label>
                                    <span class="required">*</span>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="start_date_employment"
                                            name="start_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_start_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="end_date_employment"><?php echo e(__('personel_personal_data.label_end_date')); ?></label>
                                    <span class="required">*</span>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="end_date_employment"
                                            name="end_date_employment"
                                            placeholder="<?php echo e(__('personel_personal_data.label_end_date')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="commisioner_employment"><?php echo e(__('personel_personal_data.label_commisioner')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <button type="button" class="btn btn-primary" name="btn-add-employment-data"
                                    ...
                                    <i class="fa fa-plus"></i> <?php echo e(__('personel_personal_data.btn_add')); ?>
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-danger" name="btn-remove-employment-data"
                                    ...
                                    <i class="fa fa-times"></i> <?php echo e(__('personel_personal_data.btn_remove')); ?>
                            ...
                            <a class="collapsed" data-toggle="collapse" href="#absenteeism-data" aria-expanded="true"
                                ...
                                <div class="card-header">
                                    <div class="div-dropdown-title">
                                        <span
                                            class="dropdown-title-text"><?php echo e(__('personel_personal_data.label_absenteeism')); ?></span>
                                        <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                            alt="Triangle">
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="absenteeism_type_absenteeism"><?php echo e(__('personel_personal_data.label_absenteeism_type')); ?></label>
                                                <span class="required">*</span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="work_pattern_code_absenteeism"><?php echo e(__('personel_personal_data.label_work_pattern_code')); ?></label>
                                                <span class="required">*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="starting_day_absenteeism"><?php echo e(__('personel_personal_data.label_starting_day')); ?></label>
                                                <span class="required">*</span>
                                                <input type="number" min=1 class="form-control" id="starting_day_absenteeism"
                                                    name="starting_day_absenteeism"
                                                    placeholder="<?php echo e(__('personel_personal_data.label_starting_day')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="absent_not_required_absenteeism"><?php echo e(__('personel_personal_data.label_absent_not_required')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="finger_not_required_absenteeism"><?php echo e(__('personel_personal_data.label_finger_not_required')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <a class="collapsed" data-toggle="collapse" href="#payroll-data" aria-expanded="true"
                                ...
                                <div class="card-header">
                                    <div class="div-dropdown-title">
                                        <span
                                            class="dropdown-title-text"><?php echo e(__('personel_personal_data.label_payroll')); ?></span>
                                        <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                            alt="Triangle">
                                    </div>
                                </div>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_status_payroll"><?php echo e(__('personel_personal_data.label_tax_status')); ?></label>
                                                <span class="required">*</span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_status_next_year_payroll"><?php echo e(__('personel_personal_data.label_tax_status_next_year')); ?></label>
                                                <span class="required">*</span>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_registered_no_payroll"><?php echo e(__('personel_personal_data.label_tax_registered_no')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_registered_date_payroll"><?php echo e(__('personel_personal_data.label_tax_registered_date')); ?></label>
                                                <div class='input-group'>
                                                    <input type="text" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_office_payroll"><?php echo e(__('personel_personal_data.label_tax_office')); ?></label>
                                                <span class="required">*</span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_expiry_date_payroll"><?php echo e(__('personel_personal_data.label_tax_expiry_date')); ?></label>
                                                <div class='input-group'>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="tax_calculation_method_payroll"><?php echo e(__('personel_personal_data.label_tax_calculation_method')); ?></label>
                                                <span class="required">*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="group_npwp_payroll"><?php echo e(__('personel_personal_data.label_group_npwp')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="group_bpjs_payroll"><?php echo e(__('personel_personal_data.label_group_bpjs')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="exclude_payroll_process_payroll"><?php echo e(__('personel_personal_data.label_exclude_payroll_process')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="group_authorize_payroll"><?php echo e(__('personel_personal_data.label_group_authorize')); ?></label>
                        ...
                        <div class="card">
                            <a class="collapsed" data-toggle="collapse" href="#bpjs-data" aria-expanded="true"
                                ...
                                <div class="card-header">
                                    <div class="div-dropdown-title">
                                        <span
                                            class="dropdown-title-text"><?php echo e(__('personel_personal_data.label_bpjs')); ?></span>
                                        <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                            alt="Triangle">
                                    </div>
                                </div>
                            ...
                            <div id="bpjs-data" class="collapse show">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-6">
                                            <span
                                                class="div-title-text"><?php echo e(__('personel_personal_data.label_bpjs_tenaga_kerja')); ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="bpjs_number_tenaga_kerja"><?php echo e(__('personel_personal_data.label_bpjs_number')); ?></label>
                                                <input type="text" class="form-control" id="bpjs_number_tenaga_kerja"
                                                    name="bpjs_number_tenaga_kerja"
                                                    placeholder="<?php echo e(__('personel_personal_data.label_bpjs_number')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="join_tenaga_kerja"><?php echo e(__('personel_personal_data.label_join')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="joining_date_tenaga_kerja"><?php echo e(__('personel_personal_data.label_joining_date')); ?></label>
                                                <div class='input-group'>
                                                    <input type="text" class="form-control"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="payment_period_start_date_tenaga_kerja"><?php echo e(__('personel_personal_data.label_payment_period_start_date')); ?></label>
                                                <div class='input-group'>
                                                    <input type="text" class="form-control"
                                                        id="payment_period_start_date_tenaga_kerja"
                                                        name="payment_period_start_date_tenaga_kerja"
                                                        placeholder="<?php echo e(__('personel_personal_data.label_payment_period_start_date')); ?>">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="non_accidental_death_insurance_tenaga_kerja"><?php echo e(__('personel_personal_data.label_non_accidental_death_insurance')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="pension_by_employer_tenaga_kerja"><?php echo e(__('personel_personal_data.label_pension_by_employer')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="work_related_accident_insurance_tenaga_kerja"><?php echo e(__('personel_personal_data.label_work_related_accident_insurance')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="pension_by_employee_tenaga_kerja"><?php echo e(__('personel_personal_data.label_pension_by_employee')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="work_related_accident_insurance_two_tenaga_kerja"><?php echo e(__('personel_personal_data.label_work_related_accident_insurance_two')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="pension_insurance_tenaga_kerja"><?php echo e(__('personel_personal_data.label_pension_insurance')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="work_related_accident_insurance_three_tenaga_kerja"><?php echo e(__('personel_personal_data.label_work_related_accident_insurance_three')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <span
                                                class="div-title-text"><?php echo e(__('personel_personal_data.label_bpjs_kesehatan')); ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="bpjs_number_kesehatan"><?php echo e(__('personel_personal_data.label_bpjs_number')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="join_kesehatan"><?php echo e(__('personel_personal_data.label_join')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="joining_date_kesehatan"><?php echo e(__('personel_personal_data.label_joining_date')); ?></label>
                                                <div class='input-group'>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="payment_period_start_date_kesehatan"><?php echo e(__('personel_personal_data.label_payment_period_start_date')); ?></label>
                                                <div class='input-group'>
                                                    <input type="text" class="form-control"
                        ...
                        <div class="card">
                            <a class="collapsed" data-toggle="collapse" href="#bank-data" aria-expanded="true"
                                ...
                                <div class="card-header">
                                    <div class="div-dropdown-title">
                                        <span
                                            class="dropdown-title-text"><?php echo e(__('personel_personal_data.label_bank')); ?></span>
                                        <img class="dropdown-triangle" src="<?php echo e(url('/pictures/triangle.png')); ?>"
                                            alt="Triangle">
                                    </div>
                                </div>
                            ...
                            <div id="bank-data" class="collapse show">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-6">
                                            <span
                                                class="div-title-text"><?php echo e(__('personel_personal_data.label_primary')); ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="company_bank_code_primary"><?php echo e(__('personel_personal_data.label_company_bank_code')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="employee_bank_code_primary"><?php echo e(__('personel_personal_data.label_employee_bank_code')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="account_number_primary"><?php echo e(__('personel_personal_data.label_account_number')); ?></label>
                                                <input type="text" class="form-control" id="account_number_primary"
                                                    name="account_number_primary"
                                                    placeholder="<?php echo e(__('personel_personal_data.label_account_number')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="currency_primary"><?php echo e(__('personel_personal_data.label_currency')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="beneficiary_name_primary"><?php echo e(__('personel_personal_data.label_beneficiary_name')); ?></label>
                                                <input type="text" class="form-control" id="beneficiary_name_primary"
                                                    name="beneficiary_name_primary"
                                                    placeholder="<?php echo e(__('personel_personal_data.label_beneficiary_name')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="percentage_primary"><?php echo e(__('personel_personal_data.label_percentage')); ?></label>
                                                <input type="number" min=0 class="form-control" id="percentage_primary"
                                                    name="percentage_primary"
                                                    placeholder="<?php echo e(__('personel_personal_data.label_percentage')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <span
                                                class="div-title-text"><?php echo e(__('personel_personal_data.label_optional_one')); ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="company_bank_code_optional_one"><?php echo e(__('personel_personal_data.label_company_bank_code')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="employee_bank_code_optional_one"><?php echo e(__('personel_personal_data.label_employee_bank_code')); ?></label>
                                                <select class="form-control select2"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="account_number_optional_one"><?php echo e(__('personel_personal_data.label_account_number')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="currency_optional_one"><?php echo e(__('personel_personal_data.label_currency')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="beneficiary_name_optional_one"><?php echo e(__('personel_personal_data.label_beneficiary_name')); ?></label>
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="percentage_optional_one"><?php echo e(__('personel_personal_data.label_percentage')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <span
                                                class="div-title-text"><?php echo e(__('personel_personal_data.label_optional_two')); ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="company_bank_code_optional_two"><?php echo e(__('personel_personal_data.label_company_bank_code')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="employee_bank_code_optional_two"><?php echo e(__('personel_personal_data.label_employee_bank_code')); ?></label>
                                                <select class="form-control select2"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="account_number_optional_two"><?php echo e(__('personel_personal_data.label_account_number')); ?></label>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="currency_optional_two"><?php echo e(__('personel_personal_data.label_currency')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="beneficiary_name_optional_two"><?php echo e(__('personel_personal_data.label_beneficiary_name')); ?></label>
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label
                                                    for="percentage_optional_two"><?php echo e(__('personel_personal_data.label_percentage')); ?></label>
                    ...
                    <div class="tab-pane fade" id="insurance_tab" role="tabpanel" aria-labelledby="insurance-tab">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="insurance_code_insurance"><?php echo e(__('personel_personal_data.label_insurance_code')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="insurance_class_insurance"><?php echo e(__('personel_personal_data.label_insurance_class')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="insurance_date_insurance"><?php echo e(__('personel_personal_data.label_insurance_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="insurance_date_insurance"
                                            name="insurance_date_insurance"
                                            placeholder="<?php echo e(__('personel_personal_data.label_insurance_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="insurance_policy_no_insurance"><?php echo e(__('personel_personal_data.label_insurance_policy_no')); ?></label>
                                    <input type="text" class="form-control" id="insurance_policy_no_insurance"
                                        name="insurance_policy_no_insurance"
                                        placeholder="<?php echo e(__('personel_personal_data.label_insurance_policy_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group">
                                    <label
                                        for="remarks_insurance"><?php echo e(__('personel_personal_data.label_remarks')); ?></label>
                                    <textarea class="form-control" id="remarks_insurance" name="remarks_insurance"
                                        rows="3"
                                        placeholder="<?php echo e(__('personel_personal_data.label_remarks')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_personal_data.title_modal_family_dependent_data')); ?></h5>
                    ...
                    <form id="family_dependent_data_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_family_dependent_data"><?php echo e(__('personel_personal_data.label_seq_no')); ?></label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" id="seq_no_family_dependent_data"
                                        name="seq_no_family_dependent_data"
                                        placeholder="<?php echo e(__('personel_personal_data.label_seq_no')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="name_family_dependent_data"><?php echo e(__('personel_personal_data.label_name')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="relation_family_dependent_data"><?php echo e(__('personel_personal_data.label_relation')); ?></label>
                                    <select class="form-control" id="relation_family_dependent_data"
                                        name="relation_family_dependent_data">
                                        <option value="">
                                            <?php echo e(__('personel_personal_data.label_relation')); ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="birth_date_family_dependent_data"><?php echo e(__('personel_personal_data.label_birth_date')); ?></label>
                                    <div class='input-group'>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="birth_place_family_dependent_data"><?php echo e(__('personel_personal_data.label_birth_place')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="gender_family_dependent_data"><?php echo e(__('personel_personal_data.label_gender')); ?></label>
                                    <select class="form-control" id="gender_family_dependent_data"
                                        name="gender_family_dependent_data">
                                        <option value="">
                                            <?php echo e(__('personel_personal_data.label_gender')); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="blood_type_family_dependent_data"><?php echo e(__('personel_personal_data.label_blood_type')); ?></label>
                                    <select class="form-control" id="blood_type_family_dependent_data"
                                        name="blood_type_family_dependent_data">
                                        <option value="">
                                            <?php echo e(__('personel_personal_data.label_blood_type')); ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="family_card_no_family_dependent_data"><?php echo e(__('personel_personal_data.label_family_card_no')); ?></label>
                                    <input type="text" class="form-control" id="family_card_no_family_dependent_data"
                                        name="family_card_no_family_dependent_data"
                                        placeholder="<?php echo e(__('personel_personal_data.label_family_card_no')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="occupation_family_dependent_data"><?php echo e(__('personel_personal_data.label_occupation')); ?></label>
                                    <input type="text" class="form-control" id="occupation_family_dependent_data"
                                        name="occupation_family_dependent_data"
                                        placeholder="<?php echo e(__('personel_personal_data.label_occupation')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="include_medical_family_dependent_data"><?php echo e(__('personel_personal_data.label_include_medical')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="include_tax_family_dependent_data"><?php echo e(__('personel_personal_data.label_include_tax')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save-family-dependent-data" class="btn btn-primary w-25"><i class="fa fa-floppy-o"></i> <?php echo e(__('personel_personal_data.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_personal_data.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal_add_employment_data"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_personal_data.title_modal_employment_data')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="employment_data_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_employment_data"><?php echo e(__('personel_personal_data.label_seq_no')); ?></label>
                                    <span class="required">*</span>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="benefits_employment_data"><?php echo e(__('personel_personal_data.label_benefits')); ?></label>
                                    <span class="required">*</span>
                                    <select class="form-control" id="benefits_employment_data"
                                        name="benefits_employment_data">
                                        <option value="">
                                            <?php echo e(__('personel_personal_data.label_benefits')); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="description_employment_data"><?php echo e(__('personel_personal_data.label_description')); ?></label>
                                    <input type="text" class="form-control" id="description_employment_data"
                                        name="description_employment_data"
                                        placeholder="<?php echo e(__('personel_personal_data.label_description')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="start_date_employment_data"><?php echo e(__('personel_personal_data.label_start_date')); ?></label>
                                    <div class='input-group'>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="end_date_employment_data"><?php echo e(__('personel_personal_data.label_end_date')); ?></label>
                                    <div class='input-group'>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save-employment-data" class="btn btn-primary w-25"><i class="fa fa-floppy-o"></i> <?php echo e(__('personel_personal_data.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_personal_data.btn_cancel')); ?></button>
                </div>
                </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_personal_data.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var arrData2 = <?php echo json_encode($data2, 15, 512) ?>;
        ...
        if (func == 'new') {
            ...
            $('#fullname_info').val(((typeof arrData2[0].fullName !== 'undefined') ? arrData2[0].fullName : ''));
            $('#title_info').val(((typeof arrData2[0].title !== 'undefined') ? arrData2[0].title : ''));
            
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/city/personal_data/api')); ?>",
                data: {
            ...
            if (arrData2[0].peMasterInfo !== null) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/zip_code/personal_data/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/office_location/func/api')); ?>",
                    data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/work_pattern/personal_data/api')); ?>",
                data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/npwp/personal_data/api')); ?>",
                data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/bpjs/personal_data/api')); ?>",
                data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/group_authorize/personal_data/api')); ?>",
                data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/company_bank_code/personal_data/api')); ?>",
                data: {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/employee_bank_code/personal_data/api')); ?>",
                data: {
...
// ini
        ...
        $('#city_select_home').on('select2:select', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('personnel/city_name/detail')); ?>",
                type: "GET",
                data: {
                    'cityCode': data[0].id
                },
        ...
        $('#zip_code_select_home').on('select2:select', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('personnel/zip_code/detail')); ?>",
                type: "GET",
                data: {
                    'zipCode': data[0].id
                },
        ...
        $.get("<?php echo e(url('gender/api')); ?>", function (data) {
        ...
        $.get("<?php echo e(url('blood/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $.get("<?php echo e(url('religion/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $('#prefix_title_one, #prefix_title_two, #prefix_title_three, #suffix_title_one, #suffix_title_two, #suffix_title_three')
            .inputpicker({
                url: "<?php echo e(url('personnel/personal_data/prefix_title')); ?>",
                fields: [{
                        name: 'title_code',
                        text: 'Title Code'
                    },
        ...
        function loadDataMaritalStatus(){
            ...
            $('#marital_status_info').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/marital_status/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataReligion(){
            ...
            $('#religion_info').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/religion/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataNationality(){
            ...
            $('#nationality_info').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/nationality/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataDrivingLicenseCarType(){
            ...
            $('#driving_license_car_type_info').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/driving_license_car_type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataZipCode(){
            ...
            $zip_code.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/zip_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataDistrict(){
            ...
            $district.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/district/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataSubdistrict(){
            ...
            $district.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/subdistrict/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataRelation(){
            ...
            $('#relation_family_dependent_data').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/relation/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataEmploymentStatus(){
            ...
            $('#employment_status_employment').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/employment/status/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataEmploymentType(){
            ...
            $('#employment_type_employment').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/employment/type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataTerminationCode(){
            ...
            $('#termination_code_employment').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/termination_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataBenefits(){
            ...
            $('#benefits_employment_data').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/benefits/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataAbsenteeismType(){
            ...
            $('#absenteeism_type_absenteeism').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/absenteeism_type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataWorkPatternCode(){
            ...
            $('#work_pattern_code_absenteeism').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/work_pattern_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataTaxStatus(){
            ...
            $tax_status.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/tax_status/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataTaxOffice(){
            ...
            $('#tax_office_payroll').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/tax_office/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataTaxCalculationMethod(){
            ...
            $('#tax_calculation_method_payroll').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/tax_calculation_method/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataGroupAuthorize() {
            ...
            $('#group_authorize_payroll').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/group_authorize/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataCompanyBankCode(){
            ...
            $company_bank.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/company_bank_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataEmployeeBankCode(){
            ...
            $employee_bank_code.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/employee_bank_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataCurrency(){
            ...
            $currency.select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/currency/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataInsuranceCode(){
            ...
            $('#insurance_code_insurance').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/insurance_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataInsuranceClass(){
            ...
            $('#insurance_class_insurance').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/insurance_class/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        //         messages: {
        //             photo_profile: {
        //                 extension: "<?php echo e(__('personel_personal_data.photo_profile_extension')); ?>",
        //             },
        //         },
        ...
        //             $.ajax({
        //                 url: "<?php echo e(url('personnel/employee/photo/proses')); ?>",
        //                 type: "POST",
        //                 processData: false,
        //                 contentType: false,
        //                 data: formdata,
        ...
        //                         setTimeout(function () {
        //                             window.location =
        //                                 "<?php echo e(url('personnel/personal_data')); ?>";
        //                         }, 3000);
        //                     } else {
        //                         $('#notification_error').modal('show');
        ...
        if ($("#personal_data_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    employee_no_info: {
                        required: "<?php echo e(__('personel_personal_data.employee_no_required')); ?>",
                    },
                    fullname_info: {
                        required: "<?php echo e(__('personel_personal_data.fullname_required')); ?>",
                    },
                    joining_date_employment: {
                        required: "<?php echo e(__('personel_personal_data.joining_date_required')); ?>",
                    },
                    contract_start_date_employment: {
                        required: "<?php echo e(__('personel_personal_data.contract_start_date_required')); ?>",
                    },
                    contract_end_date_employment: {
                        required: "<?php echo e(__('personel_personal_data.contract_end_date_required')); ?>",
                    },
                    absenteeism_type_absenteeism: {
                        required: "<?php echo e(__('personel_personal_data.absenteeism_type_required')); ?>",
                    },
                    work_pattern_code_absenteeism: {
                        required: "<?php echo e(__('personel_personal_data.work_pattern_code_required')); ?>",
                    },
                    starting_day_absenteeism: {
                        required: "<?php echo e(__('personel_personal_data.starting_day_required')); ?>",
                    },
                    tax_status_payroll: {
                        required: "<?php echo e(__('personel_personal_data.tax_status_required')); ?>",
                    },
                    tax_status_next_year_payroll: {
                        required: "<?php echo e(__('personel_personal_data.tax_status_next_year_required')); ?>",
                    },
                    tax_office_payroll: {
                        required: "<?php echo e(__('personel_personal_data.tax_office_required')); ?>",
                    },
                    tax_calculation_method_payroll: {
                        required: "<?php echo e(__('personel_personal_data.tax_calculation_method_required')); ?>",
                    }
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/personal_data/proses')); ?>",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formdata,
        ...
        //         messages: {
        //             seq_no_employment_data: {
        //                 required: "<?php echo e(__('personel_personal_data.seq_no_required')); ?>",
        //             },
        //             benefits_employment_data: {
        //                 required: "<?php echo e(__('personel_personal_data.benefits_required')); ?>",
        //             },
        //         },
        //         highlight: function (element) {
        //             $(element).addClass('is-invalid');
        ...
        //             });
        //             $.ajax({
        //                 url: "<?php echo e(url('personnel/position/proses')); ?>",
        //                 type: "POST",
        ...
        //                         setTimeout(function () {
        //                             window.location =
        //                                 "<?php echo e(url('personnel/position')); ?>";
        //                         }, 3000);
        //                     } else {
        //                         $("#btn-save-employment-data").prop("disabled", false);
        //                         $("#btn-save-employment-data").html(
        ...
        //             });
        //             $.ajax({
        //                 url: "<?php echo e(url('personnel/data/family_dependent/proses')); ?>",
        //                 type: "POST",
        ...
        //         serverSide: true,
        //         orderCellsTop: true,
        //         ajax: "<?php echo e(url('personnel/personal_data/dependent/table')); ?>",
...
<?php /**PATH C:\xampp\htdocs\laravel_project_azure\resources\views/personel/personel_personal_data_detail.blade.php ENDPATH**/ ?>