...
<html lang="en">
<head>
    <title><?php echo e(__('tm_period_maintenance.judul')); ?></title>
    ...
    <div class="time_management">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_period_maintenance.list')); ?></span>
            </a> 
        </div>
        <div class="div-table">
    ...
    <div class="row">
        <div class="col-2">
            <button type="button" class="btn btn-primary" name="btn-add" id="btn-add"
                ...
                <i class="fa fa-plus"></i> <?php echo e(__('tm_period_maintenance.btn_add')); ?>
        ...
        <div class="col-2">
            <button type="button" class="btn btn-primary" name="btn-edit" id="btn-edit"
                style="width: 100%;">
                <i class="fa fa-pencil"></i> <?php echo e(__('tm_period_maintenance.btn_edit')); ?>
        ...
        <div class="col-2">
            <button type="button" class="btn btn-danger" name="btn-remove" id="btn-remove"
                style="width: 100%;">
                <i class="fa fa-times-circle"></i> <?php echo e(__('tm_period_maintenance.btn_remove')); ?>

            </button>
            <!-- <a class="btn btn-danger" href="<?php echo e(url('time_management/period_maintenance')); ?>" target="iframe_dashboard"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('tm_period_maintenance.list')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="period_maintenance_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="year"><?php echo e(__('tm_period_maintenance.label_year')); ?></label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="month"><?php echo e(__('tm_period_maintenance.label_month')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group month">
                                        <input type="text" class="form-control" id="month" name="month"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_month')); ?>">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="period"><?php echo e(__('tm_period_maintenance.label_period')); ?></label>
                                    <span class="required">*</span>
                                    <select class="form-control" id="period" name="period">
                                        <option selected value><?php echo e(__('tm_period_maintenance.select_period')); ?></option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="absenteeism_from"><?php echo e(__('tm_period_maintenance.label_absenteeism_from')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="absenteeism_from" name="absenteeism_from"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_absenteeism_from')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="absenteeism_to"><?php echo e(__('tm_period_maintenance.label_absenteeism_to')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="absenteeism_to" name="absenteeism_to"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_absenteeism_to')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="overtime_from"><?php echo e(__('tm_period_maintenance.label_overtime_from')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="overtime_from" name="overtime_from"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_overtime_from')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="overtime_to"><?php echo e(__('tm_period_maintenance.label_overtime_to')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="overtime_to" name="overtime_to"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_overtime_to')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="salary_from"><?php echo e(__('tm_period_maintenance.label_salary_from')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="salary_from" name="salary_from"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_salary_from')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="salary_to"><?php echo e(__('tm_period_maintenance.label_salary_to')); ?></label>
                                    <span class="required">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="salary_to" name="salary_to"
                                            placeholder="<?php echo e(__('tm_period_maintenance.label_salary_to')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" id="btn-save-period-maintenance" class="btn btn-primary w-25"><i class="fa fa-floppy-o"></i> <?php echo e(__('tm_period_maintenance.btn_save')); ?></button>
                        <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                                class="fa fa-times-circle"></i> <?php echo e(__('tm_period_maintenance.btn_cancel')); ?></button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_period_maintenance.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        let pickerMonth = $('#month').flatpickr({
            ...
            onValueUpdate: function(selectedDates, dateStr, instance) {
                ...
                if(year !== "" && month !== ""){
                    $.ajax({
                        url: "<?php echo e(url('/time_management/period_maintenance/data/detail')); ?>",
                        type: "GET",
        ...
        function load_data_table_period_maintenance() {
            table = $('#period_maintenance_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('time_management/period_maintenance/table')); ?>",
        ...
        $("#btn-remove").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('time_management/period_maintenance/remove')); ?>",
                    type: "GET",
                    data: {
                        'data' : data
                    },
        ...
        if ($("#period_maintenance_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    year: {
                        required: "<?php echo e(__('tm_period_maintenance.field_mandatory')); ?>",
                    },
                    month: {
                        required: "<?php echo e(__('tm_period_maintenance.field_mandatory')); ?>",
                    },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-save-period-maintenance").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("tm_period_maintenance.btn_save")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/period_maintenance/proses')); ?>",
                        type: "POST",
...
</html><?php /**PATH D:\File Kerja\Front End\laravel_project_azure\resources\views/time_management/tm_period_maintenance.blade.php ENDPATH**/ ?>