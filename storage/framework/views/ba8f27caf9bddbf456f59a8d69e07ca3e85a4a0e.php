...
<body>
	<div class="div-payroll">
        ...
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_thr_data_entry.list')); ?></span>
			</a>
		</div>
        <div class="div-table">
			<table id="thr_data_entry_table" class="table hover" style="width: 100%">
				<thead>
					<tr>
                        <th></th>
						<th>Employee No</th>
    ...
    <div class="modal fade" id="modal_process_thr_data_entry"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('payroll_thr_data_entry.list')); ?></h5>
                    ...
                    <form id="thr_data_entry_process_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="process_type"><?php echo e(__('payroll_thr_data_entry.label_process_type')); ?></label>
                                    <select class="form-control select2" id="process_type" name="process_type">
                                        <option value="" disabled selected><?php echo e(__('payroll_thr_data_entry.label_select_process_type')); ?></option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="religion_code"><?php echo e(__('payroll_thr_data_entry.label_religion_code')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="thr_cut_off_date"><?php echo e(__('payroll_thr_data_entry.label_thr_cut_off_date')); ?></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="thr_cut_off_date" name="thr_cut_off_date"
                                            placeholder="<?php echo e(__('payroll_thr_data_entry.label_thr_cut_off_date')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="service_month_rounded"><?php echo e(__('payroll_thr_data_entry.label_service_month_rounded')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group" style="margin-bottom: 1px">
                                    <label for="greater_than"><?php echo e(__('payroll_thr_data_entry.label_greater_than')); ?></label>
                                </div>
                                <div class="form-group" style="display: flex">
                                    <input type="number" min=0 max=30 class="form-control" style="width: 50%" id="greater_than" name="greater_than"
                                        placeholder=<?php echo e(__('payroll_thr_data_entry.label_greater_than')); ?>>
                                    <label for="days" style="margin: auto"><?php echo e(__('payroll_thr_data_entry.label_days_become_one_month')); ?></label>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="submit" class="btn btn-process w-25" name="btn-process" id="btn-process">
                        <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_thr_data_entry.btn_process')); ?>

                    </button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                        class="fa fa-times-circle"></i> <?php echo e(__('payroll_thr_data_entry.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    $(document).ready(function () {
        ...
        function loadDataReligionCode(){
            ...
            $('#religion_code').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/religion_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        function load_data_table_thr_data_entry() {
            table = $('#thr_data_entry_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/thr_data_entry/table')); ?>",
        ...
        $('#thr_data_entry_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#thr_data_entry_table').on('click', 'tr td:first-child', function(e){
            $(this).parent().find('input[type="checkbox"]').trigger('click');
        });

        $("#toolbar-new").on('click', function() {
            $.redirect("<?php echo e(url('payroll/thr_data_entry/detail_data')); ?>", 
            { 
                'employeeNo' : null,
                'func' : 'new' 
            }, 
        ...
        $("#toolbar-delete").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('payroll/thr_bonus_data_entry/remove')); ?>",
                    type: "GET",
                    data: {
                        'data' : data
                    },
        ...
        if ($("#thr_data_entry_process_form").length > 0) {
            $("#thr_data_entry_process_form").validate({
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-process").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_thr_data_entry.btn_process")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/thr_data_entry_proses/proses')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_thr_data_entry.blade.php ENDPATH**/ ?>