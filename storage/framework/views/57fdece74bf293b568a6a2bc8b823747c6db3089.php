...
<head>
    <title><?php echo e(__('personel_custom_report_employee.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_custom_report_employee.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="custom_report_employee_form" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_custom_report_employee.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_custom_report_employee.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employment_status"><?php echo e(__('personel_custom_report_employee.label_employment_status')); ?></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('personel_custom_report_employee.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('personel_custom_report_employee.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('personel_custom_report_employee.label_group_authorize_to')); ?></label>
    ...
    <div class="row">
        <div class="col-2">
            <button type="submit" class="btn btn-primary" name="btn-add-field" id="btn-add-field"
                ...
                <i class="fa fa-plus"></i> <?php echo e(__('personel_custom_report_employee.btn_add')); ?>
        ...
        <div class="col-2">
            <button type="submit" class="btn btn-danger" name="btn-remove-data" id="btn-remove-data"
                style="width: 100%;">
                <i class="fa fa-times"></i> <?php echo e(__('personel_custom_report_employee.btn_remove')); ?>
        ...
        <div class="col-2">
            <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                style="width: 100%;">
                    <i class="fa fa-print"></i> <?php echo e(__('personel_custom_report_employee.btn_print')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_custom_report_employee.title_modal_field_name')); ?></h5>
                    ...
                    <form id="field_name_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label
                                            for="field_name"><?php echo e(__('personel_custom_report_employee.label_field_name')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="column_header"><?php echo e(__('personel_custom_report_employee.label_column_header')); ?></label>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save-employment-data" class="btn btn-primary w-25"><i class="fa fa-floppy-o"></i> <?php echo e(__('personel_custom_report_employee.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_custom_report_employee.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function loadDataFirstLastAllEmploymentStatus () {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/employment_status/func/api')); ?>",
            }).then(function (data) {
        ...
        function loadDataEmploymentStatus(){
            ...
            $('#employment_status').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/employment_status/all/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataFieldName() {
            ...
            $('#field_name').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/field_name/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        $("#btn-save-employment-data").click(function () {
            ...
            $(this).html(
                '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_custom_report_employee.btn_save")); ?>'
            );
        ...
        if ($("#custom_report_employee_form").length > 0) {
            $("#custom_report_employee_form").validate({
                ...
                // messages: {
                //     field_name: {
                //         required: "<?php echo e(__('personel_custom_report_employee.field_name_required')); ?>",
                //     },
                //     column_header: {
                //         required: "<?php echo e(__('personel_custom_report_employee.column_header_required')); ?>",
                //     },
                // },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/custom_report_employee/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_custom_report_employee.blade.php ENDPATH**/ ?>