...
<body>
        ...
        <div class="div-form">
            <form id="user_security_maintenance_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="record_status"><?php echo e(__('utilities_user_security_maintenance.label_record_status')); ?></label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="<?php echo e(__('utilities_user_security_maintenance.label_record_status')); ?>"
                                readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="user_id"><?php echo e(__('utilities_user_security_maintenance.label_user_id')); ?></label>
                            <input type="text" class="form-control" id="user_id" name="user_id"
                                placeholder="<?php echo e(__('utilities_user_security_maintenance.label_user_id')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="user_name"><?php echo e(__('utilities_user_security_maintenance.label_user_name')); ?></label>
                            <input type="text" class="form-control" id="user_name" name="user_name"
                                placeholder="<?php echo e(__('utilities_user_security_maintenance.label_user_name')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no"><?php echo e(__('utilities_user_security_maintenance.label_employee_no')); ?></label>
                            <input type="text" class="form-control" id="employee_no" name="employee_no"
                                placeholder="<?php echo e(__('utilities_user_security_maintenance.label_employee_no')); ?>"
                                readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_name"><?php echo e(__('utilities_user_security_maintenance.label_employee_name')); ?></label>
                            <input type="text" class="form-control" id="employee_name" name="employee_name"
                                placeholder="<?php echo e(__('utilities_user_security_maintenance.label_employee_name')); ?>"
                                readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="user_type"><?php echo e(__('utilities_user_security_maintenance.label_user_type')); ?></label>
            ...
            <div class="row">
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-edit-company" id="btn-edit-company"
                        style="width: 100%;">
                        <?php echo e(__('utilities_user_security_maintenance.btn_edit')); ?>
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-add-company" id="btn-add-company"
                        ...
                        <?php echo e(__('utilities_user_security_maintenance.btn_add')); ?>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-danger" name="btn-remove-module" id="btn-remove-module"
                        style="width: 100%;">
                        <?php echo e(__('utilities_user_security_maintenance.btn_remove')); ?>
            ...
            <div class="row">
                <div class="col-4">
                    <button type="button" class="btn btn-primary" name="btn-reset-password" id="btn-reset-password" style="width: 100%;">
                        <?php echo e(__('utilities_user_security_maintenance.btn_reset_password')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_user_security_maintenance.title_modal_add_level')); ?></h5>
                    ...
                    <form id="level_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="level_type"><?php echo e(__('utilities_user_security_maintenance.label_level_type')); ?></label>
                                    <input type="text" class="form-control" id="level_type" name="level_type"
                                        placeholder="<?php echo e(__('utilities_user_security_maintenance.label_level_type')); ?>"
                                        readonly>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="level_name"><?php echo e(__('utilities_user_security_maintenance.label_level_name')); ?></label>
                                    <input type="text" class="form-control" id="level_name" name="level_name"
                                        placeholder="<?php echo e(__('utilities_user_security_maintenance.label_level_name')); ?>"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group">
                                    <label
                                        for="level_authorization"><?php echo e(__('utilities_user_security_maintenance.title_level_authorization')); ?></label>
                                </div>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="submit" id="btn-save-level" class="btn btn-primary w-25"><i
                        ...
                        <?php echo e(__('utilities_user_security_maintenance.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i>
                        <?php echo e(__('utilities_user_security_maintenance.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal_add_company"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_user_security_maintenance.title_modal_add_company')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="company_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6" id="select_company_code">
                                <div class="form-group">
                                    <label
                                        for="company_code"><?php echo e(__('utilities_user_security_maintenance.label_company_code')); ?></label>
                            ...
                            <div class="col-6" id="txt_company_code" style="display: none;">
                                <div class="form-group">
                                    <label
                                        for="company_code_edit"><?php echo e(__('utilities_user_security_maintenance.label_company_code')); ?></label>
                                    <input type="text" class="form-control" id="company_code_edit"
                                        name="company_code_edit"
                                        placeholder="<?php echo e(__('utilities_user_security_maintenance.label_company_code')); ?>"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="company_name"><?php echo e(__('utilities_user_security_maintenance.label_company_name')); ?></label>
                                    <input type="text" class="form-control" id="company_name" name="company_name"
                                        placeholder="<?php echo e(__('utilities_user_security_maintenance.label_company_name')); ?>"
                                        readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label"
                                        for="company_default_checkbox"><?php echo e(__('utilities_user_security_maintenance.label_set_default')); ?></label>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label"
                                        for="company_overtime_app_leader_checkbox"><?php echo e(__('utilities_user_security_maintenance.label_overtime_app_leader')); ?></label>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                        ...
                                        value="true">
                                    <label class="form-check-label"
                                        for="company_overtime_app_hrd_checkbox"><?php echo e(__('utilities_user_security_maintenance.label_overtime_app_hrd')); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="user_type_company"><?php echo e(__('utilities_user_security_maintenance.label_user_type')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="status"><?php echo e(__('utilities_user_security_maintenance.label_status')); ?></label>
    ...
    <div class="modal fade" id="modal_add_module"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_user_security_maintenance.title_modal_add_module')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="module_form" method="post">
                        ...
                        <div class="row" id="select_module_name">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="module_name"><?php echo e(__('utilities_user_security_maintenance.label_module_name')); ?></label>
                        ...
                        <div class="row" id="txt_module_name" style="display: none;">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="module_name_edit"><?php echo e(__('utilities_user_security_maintenance.label_module_name')); ?></label>
                                    <input type="text" class="form-control" id="module_name_edit"
                                        name="module_name_edit"
                                        placeholder="<?php echo e(__('utilities_user_security_maintenance.label_module_name')); ?>"
                                        readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="group_authorization"><?php echo e(__('utilities_user_security_maintenance.label_group_authorization')); ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span
                            class="title-text-notification"><?php echo e(__('utilities_user_security_maintenance.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#user_id').val("<?php echo e(isset($data[0]->userID) ? $data[0]->userID : ''); ?>");
        $('#user_name').val("<?php echo e(isset($data[0]->userName) ? $data[0]->userName : ''); ?>");
        $('#employee_no').val("<?php echo e(isset($data[0]->employeeNo) ? $data[0]->employeeNo : ''); ?>");
        $('#employee_name').val("<?php echo e(isset($data[0]->fullName) ? $data[0]->fullName : ''); ?>");
        $('#user_type').val("<?php echo e(isset($data[0]->userType) ? $data[0]->userType : ''); ?>").trigger('change');

        $('#level_table').DataTable().clear().destroy();
        load_table_level("<?php echo e(isset($data[0]->userID) ? $data[0]->userID : ''); ?>");
        $('#company_table').DataTable().clear().destroy();
        load_table_company("<?php echo e(isset($data[0]->userID) ? $data[0]->userID : ''); ?>");
        $('#module_table').DataTable().clear().destroy();
        load_table_module("<?php echo e(isset($data[0]->userID) ? $data[0]->userID : ''); ?>");
        ...
        function load_table_level(userID = '') {
            level_table = $('#level_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('utilities/user_security_maintenance/level/table')); ?>",
                    data: {
                        userID: userID
                    }
                },
        ...
        function load_table_company(userID = '') {
            company_table = $('#company_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('utilities/user_security_maintenance/company/table')); ?>",
                    data: {
                        userID: userID
                    }
                },
        ...
        function load_table_module(userID = '') {
            module_table = $('#module_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('utilities/user_security_maintenance/module/table')); ?>",
                    data: {
                        userID: userID
                    }
                },
        ...
        function load_table_level_authorization(levelType = '', levelCodeVal = {}) {
            level_auth_table = $('#level_authorization_table').DataTable({
                ...
                aaSorting: [],
                ajax: {
                    url: "<?php echo e(url('utilities/user_security_maintenance/level_authorization/table')); ?>",
                    data: {
                        levelType: levelType
                    }
                },
        ...
        $("#toolbar-active").on('click', function () {
            $.ajax({
                url: "<?php echo e(url('utilities/user/status')); ?>",
                type: "GET",
                data: {
                    'userID': "<?php echo e(isset($data[0]->userID) ? $data[0]->userID : ''); ?>",
                    'func': 'A'
                },
                success: function (response) {
                    if (response.status == "true") {
                        ...
                        setTimeout(function () {
                            window.location =
                                "<?php echo e(url('utilities/user_security_maintenance')); ?>";
                        }, 3000);
                    } else {
        ...
        $.get("<?php echo e(url('status/api')); ?>", function (data) {
        ...
        $('body').on('click', '#btn-add-company', function () {
            ...
            $('#email_company').val("<?php echo e(isset($data[0]->email) ? $data[0]->email : ''); ?>");
        ...
        $('body').on('click', '#btn-edit-module', function () {
            ...
            if (data.count() > 0) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/group_authorize/group/api')); ?>",
                    data: {
        ...
        $("#btn-remove-module").on('click', function () {
            ...
            if (data.count() > 0) {
                $.ajax({
                    url: "<?php echo e(url('utilities/user_security_maintenance/module/remove')); ?>",
                    type: "GET",
                    data: {
        ...
        function loadDataModule(userID = '') {
            ...
            $('#module_name').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/module/user_security_maintenance/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        if ($("#user_security_maintenance_form").length > 0) {
            $("#user_security_maintenance_form").validate({
                ...
                messages: {
                    user_name: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.user_name_required')); ?>",
                    },
                    user_type: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.user_type_required')); ?>",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/user/proses')); ?>",
                        type: "POST",
        ...
        if ($("#level_form").length > 0) {
            $("#level_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/user_security_maintenance/level/proses')); ?>",
                        type: "POST",
                        data: mergeData,
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-save-level").html(
                                    '<i class="fa fa-floppy-o"></i> <?php echo e(__("utilities_user_security_maintenance.btn_save")); ?>'
                                );
        ...
        if ($("#company_form").length > 0) {
            $("#company_form").validate({
                ...
                messages: {
                    company_code: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.company_code_required')); ?>",
                    },
                    company_code_edit: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.company_code_required')); ?>",
                    },
                    status: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.status_required')); ?>",
                    },
                    user_type_company: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.user_type_required')); ?>",
                    },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/user_security_maintenance/company/proses')); ?>",
                        type: "POST",
        ...
        if ($("#module_form").length > 0) {
            $("#module_form").validate({
                ...
                messages: {
                    module_name: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.module_name_required')); ?>",
                    },
                    module_name_edit: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.module_name_required')); ?>",
                    },
                    group_authorization: {
                        required: "<?php echo e(__('utilities_user_security_maintenance.group_authorization_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/user_security_maintenance/module/proses')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_user_security_maintenance_detail.blade.php ENDPATH**/ ?>