        ...
        <div class="div-form">
            <form id="employee_list_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_employee_list.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_employee_list.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('personel_employee_list.label_period')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('personel_employee_list.label_period')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('personel_employee_list.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label
                                for="input_type_show_code"><?php echo e(__('personel_employee_list.label_show_type')); ?></label>
                            <div class="form-radio">
                                <input class="form-radio-input" type="radio" id="input_type_show_code"
                                    name="input_type" value="code" checked>
                                <label class="form-radio-label"
                                    for="input_type_show_code"><?php echo e(__('personel_employee_list.label_input_type_show_code')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <div class="form-radio">
                                ...
                                <label class="form-radio-label"
                                    for="input_type_show_description"><?php echo e(__('personel_employee_list.label_input_type_show_description')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('personel_employee_list.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('personel_employee_list.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('personel_employee_list.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('personel_employee_list.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('personel_employee_list.label_location')); ?></label>
            ...
            $("#employee_list_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/employee_list/print')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_list.blade.php ENDPATH**/ ?>