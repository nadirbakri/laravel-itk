...
<html>
<head>
    <title><?php echo e(__('payroll_journal_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_journal_report.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="journal_period form-check-label"><?php echo e(__('payroll_journal_report.label_journal_period')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="journal_period" name="journal_period"
                                placeholder="<?php echo e(__('payroll_journal_report.label_journal_period')); ?>">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_from form-check-label"><?php echo e(__('payroll_journal_report.label_group_authorized')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_to form-check-label"><?php echo e(__('payroll_journal_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_journal_report.btn_preview')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_journal_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/journal_report/print/excel')); ?>",
                            type: "POST",
                            data: $('#journal_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send-to-report').prop("disabled", false);
                                $("#btn-send-to-report").html(
                                    '<i class="fa fa-print"></i> <?php echo e(__("payroll_journal_report.btn_send_to")); ?>'
                                );
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/journal_report/print')); ?>",
                            type: "POST",
                            data: $('#journal_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send-to-report').prop("disabled", false);
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_journal_report.blade.php ENDPATH**/ ?>