...
<html lang="en">
<head>
    <title><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.judul')); ?></title>
    ...
    <style type="text/css">
        ...
        .select2-dropdown {
            width: 30rem !important; /* Adjust the desired width */
        }
    </style>
</head>
    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.list')); ?></span>
            </a> 
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_no"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_employee_no')); ?></label>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_name"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_employee_name')); ?></label>
                            <input type="text" class="form-control" id="employee_name" name="employee_name"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_employee_name')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="cost_center"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_cost_center')); ?></label>
                            <input type="text" class="form-control" id="cost_center" name="cost_center"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_cost_center')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="period"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_period')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_period')); ?>">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="position"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_position')); ?></label>
                            <input type="text" class="form-control" id="position" name="position"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_position')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="location"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_location')); ?></label>
                            <input type="text" class="form-control" id="location" name="location"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_location')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="work_pattern"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_work_pattern')); ?></label>
                            <input type="text" class="form-control" id="work_pattern" name="work_pattern"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_work_pattern')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="ranking"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_ranking')); ?></label>
                            <input type="text" class="form-control" id="ranking" name="ranking"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_ranking')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="level1"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_level1')); ?></label>
                            <input type="text" class="form-control" id="level1" name="level1"
                                placeholder="<?php echo e(__('tm_absenteeism_data_entry_by_employee_no.label_level1')); ?>" readonly>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="row">
            <div class="col-2">
                <button type="submit" class="btn btn-primary" name="btn-edit" id="btn-edit"
                    style="width: 100%;">
                    <i class="fa fa-pencil"></i> <?php echo e(__('tm_absenteeism_data_entry_by_employee_no.btn_edit')); ?>
            ...
            <div class="col-2">
                <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                    ...
                    <i class="fa fa-floppy-o"></i> <?php echo e(__('tm_absenteeism_data_entry_by_employee_no.btn_save')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_absenteeism_data_entry_by_employee_no.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function load_data(){
            ...
            $.ajax({
                url: "<?php echo e(url('time_management/absenteeism_data_entry_by_employee_no/table')); ?>",
                type: "GET",
                data: {
        ...
        function loadDataDetailDayCode(field = '', dayCode = '') {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/day_code/func/api')); ?>",
                data: {
                    dayCode : dayCode
                }
            }).then(function (data) {
        ...
        function loadDataDetailShiftCode(field = '', shiftCode = '') {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/shift_code/func/api')); ?>",
                data: {
                    shiftCode : shiftCode
                }
            }).then(function (data) {
        ...
        function loadDataDetailCostCenterCode(field = '', costCenterCode = '') {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/cost_center/func/api')); ?>",
                data: {
        ...
        function loadDataDay(field = ''){
            ...
            $(field).select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/day_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataShiftCode(field = '') {
            ...
            $(field).select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/shift_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        if ($("#absenteeism_data_entry_by_employee_no_table_form").length > 0) {
            $("#absenteeism_data_entry_by_employee_no_table_form").validate({
                submitHandler: function (form) {
                    ...
                    // var arrData = [];
                    $.ajax({
                        url: "<?php echo e(url('time_management/absenteeism_data_entry_by_employee_no/proses')); ?>",
                        type: "POST", 
                        ...
                        success: function (response) {
                            ...
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    ...
                                    // window.location =
                                        // "<?php echo e(url('time_management/period_maintenance')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
                        ...
                        error: function (response) {
                            $("#btn-save").prop("disabled", false);
                            $("#btn-save").html(
                                '<i class="fa fa-print"></i> <?php echo e(__("tm_absenteeism_data_entry_by_employee_no.btn_save")); ?>'
                            );
                            $('#notification_error').modal('show');
                            $('#message-notification-error').html(response);
                        }
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_absenteeism_data_entry_by_employee_no.blade.php ENDPATH**/ ?>