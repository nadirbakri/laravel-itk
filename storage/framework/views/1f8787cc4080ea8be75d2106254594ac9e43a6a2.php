...
<head>
    <title><?php echo e(__('tm_monthly_absenteeism_detail.judul')); ?></title>
...
<body>
    <div class="div-time_management">
        <div class="div-title">
            <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_monthly_absenteeism_detail.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="monthly_absenteeism_detail_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('tm_monthly_absenteeism_detail.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('tm_monthly_absenteeism_detail.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_month_from"><?php echo e(__('tm_monthly_absenteeism_detail.label_absent_month_from')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control input-month" id="absent_month_from" name="absent_month_from"
                                    placeholder="<?php echo e(__('tm_monthly_absenteeism_detail.label_absent_month_from')); ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_month_to"><?php echo e(__('tm_monthly_absenteeism_detail.label_absent_month_to')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control input-month" id="absent_month_to" name="absent_month_to"
                                    placeholder="<?php echo e(__('tm_monthly_absenteeism_detail.label_absent_month_to')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('tm_monthly_absenteeism_detail.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="change_header"
                                    name="change_header">
                                <label class="form-check-label"
                                    for="change_header"><?php echo e(__('tm_monthly_absenteeism_detail.label_change_header')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-add-absent-code" id="btn-add-absent-code"
                            ...
                            <i class="fa fa-plus"></i> <?php echo e(__('tm_monthly_absenteeism_detail.btn_add')); ?>
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-danger" name="btn-remove-data" id="btn-remove-data"
                            style="width: 100%;">
                            <i class="fa fa-times"></i> <?php echo e(__('tm_monthly_absenteeism_detail.btn_remove')); ?>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="hour_out"><?php echo e(__('tm_monthly_absenteeism_detail.label_hour_out')); ?></label>
                            <input type="text" class="form-control input-hour" id="hour_out" name="hour_out">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label for="hour_to"><?php echo e(__('tm_monthly_absenteeism_detail.label_hour_to')); ?> &nbsp;&nbsp;</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('tm_monthly_absenteeism_detail.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('tm_monthly_absenteeism_detail.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('tm_monthly_absenteeism_detail.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('tm_monthly_absenteeism_detail.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('tm_monthly_absenteeism_detail.label_location')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('tm_monthly_absenteeism_detail.btn_print')); ?>
    ...
    <div class="modal fade" id="modal_add_absent_code"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('tm_monthly_absenteeism_detail.label_absent_code')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="absent_code_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label
                                            for="absent_code"><?php echo e(__('tm_monthly_absenteeism_detail.label_absent_code')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="description"><?php echo e(__('tm_monthly_absenteeism_detail.label_description')); ?></label>
                                    <input type="text" class="form-control" id="description" name="description"
                                        placeholder="<?php echo e(__('tm_monthly_absenteeism_detail.label_description')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="header_name"><?php echo e(__('tm_monthly_absenteeism_detail.label_header_name')); ?></label>
                                    <input type="text" class="form-control" id="header_name" name="header_name" 
                                        placeholder="<?php echo e(__('tm_monthly_absenteeism_detail.label_header_name')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save-employment-data" class="btn btn-primary w-25"><i 
                            class="fa fa-floppy-o"></i> <?php echo e(__('tm_monthly_absenteeism_detail.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('tm_monthly_absenteeism_detail.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#monthly_absenteeism_detail_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#monthly_absenteeism_detail_table').on('click', 'tr td:first-child', function(e){
        ...
        $("#btn-save-employment-data").click(function () {
            ...
            $(this).html(
                '<i class="fa fa-floppy-o"></i> <?php echo e(__("tm_monthly_absenteeism_detail.btn_save")); ?>'
            );
            ...
            $("#monthly_absenteeism_detail_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('time_management/monthly_absenteeism_detail/print')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_monthly_absenteeism_detail.blade.php ENDPATH**/ ?>