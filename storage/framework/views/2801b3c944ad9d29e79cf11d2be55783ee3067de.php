...
<html>
<head>
	<title><?php echo e(__('payroll_monthly_system_closing.judul')); ?></title>
	...
	<div class="div-payroll">
        <div class="div-title">
			<a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_monthly_system_closing.list')); ?></span>
			</a>
		</div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="period_process"><?php echo e(__('payroll_monthly_system_closing.label_period_process')); ?></label>
                            <div class="input-group month">
                                <input type="text" class="form-control" id="period_process" name="period_process"
                                    placeholder="<?php echo e(__('payroll_monthly_system_closing.label_period_process')); ?>" readonly>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('tm_update_shift_by_date.btn_process')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_monthly_system_closing.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#monthly_closing_process_form").length > 0) {
            $("#monthly_closing_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/monthly_system_closing/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-process").html(
                                    '<i class="fa fa-play-circle-o"></i> <?php echo e(__("payroll_monthly_payroll_closing_process.btn_process")); ?>'
                                );
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/monthly_system_closing')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_monthly_system_closing.blade.php ENDPATH**/ ?>