...
<html>
<head>
    <title><?php echo e(__('trans_business_trip.judul')); ?></title>
            ...
            <div class="div-trans-business-trip">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('trans_business_trip.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('trans_business_trip.label_claim_date_start')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('trans_business_trip.label_claim_date_start')); ?>">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('trans_business_trip.label_claim_date_end')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('trans_business_trip.label_claim_date_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="processed_date form-check-label"><?php echo e(__('trans_business_trip.label_processed_date')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="processed_date" name="processed_date"
                                placeholder="<?php echo e(__('trans_business_trip.label_processed_date')); ?>">
                            <div class="input-group-prepend">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><?php echo e(__('trans_business_trip.label_reimbursement_type')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label"><?php echo e(__('trans_business_trip.label_bu')); ?></label>
                        </div>
                        <select class="form-control select2" id="business_unit" name="business_unit"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                                <label for="direct_superior form-check-label"><?php echo e(__('trans_business_trip.employee')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-search" id="btn-search" value="preview" style="width: 100%;">
                            <img src="<?php echo e(url('icons/mob/button/button-search.svg')); ?>" alt="export"> <?php echo e(__('trans_business_trip.btn_search')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i> <?php echo e(__('trans_business_trip.btn_upload')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i> <?php echo e(__('trans_business_trip.btn_list')); ?>
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-6">
                            <p><b><?php echo e(__('trans_business_trip.list_table')); ?></b></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="table-responsive">
                            <table id="business_trip_table" class="display table-striped table-hover dt-responsive display nowrap" cellspacing="10">
                                <thead>
                                    <tr>
                                        <th><?php echo e(__('trans_business_trip.detail')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.tnom')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.name')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.cname')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.status')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.destination')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.cname')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.pname')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.tpaid')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.treq')); ?></th>
                                        <th><?php echo e(__('trans_business_trip.tujuan')); ?></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div class="modal fade" id="modal_list_mass_leave">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                ...
                <div class="modal-header">
                    <h4 class="modal-little"><?php echo e(__('trans_business_trip.luser')); ?></h4>
                ...
                <div class="modal-body table-responsive">
                    <table id="example" class="display">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo e(__('trans_business_trip.employee')); ?></th>
                                <th><?php echo e(__('trans_business_trip.name')); ?></th>
                                <th><?php echo e(__('trans_business_trip.division')); ?></th>
                                <th><?php echo e(__('trans_business_trip.ranking')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
    ...
    <div class="div-form">
            <div class="modal fade" id="modal_list_detail">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_business_trip.dbtrip')); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <form id="payroll_calculation_detail_modal_form" method="post">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.tnom')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.status')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.label_bu')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.treq')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row detailstatus">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.employee')); ?></h5>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.label_reimbursement_type')); ?></h5>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row approve">
                                    ...
                                    <div class="col-5">
                                            <select name="reimbursement_status" id="reimbursement_status" class="custom-select" required>
                                                <option value="APPROVED"><?php echo e(__('trans_business_trip.approve')); ?></option>
                                                <option value="REJECTED"><?php echo e(__('trans_business_trip.reject')); ?></option>
                                                <option value="PAID"><?php echo e(__('trans_business_trip.paid')); ?></option>
                                            </select>
                                    </div>
                                </div>
                                <div class="row approve">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.tpaid')); ?></h5>
                                    </div>
                                    <div class="col-5">
                                ...
                                <div class="row approve">
                                    <div class="col-3">
                                        <h5><?php echo e(__('trans_business_trip.approvalremarks')); ?></h5>
                                    </div>
                                    <div class="col-5">
                                ...
                                <hr>
                                <button class="btn btn-primary btn-block" id="btn-update" type="button"><?php echo e(__('trans_business_trip.update')); ?></button>
                            </div>
                            </form>
                        </div>
                    </div>
        ...
        <form id="upload_paid_overtime_form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="modal_upload">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_business_trip.upaidbusiness')); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body table-responsive">
                        <div class="card">
                            <div class="col-5">
                                <div class="form-group">
                                    <label for="medical_history form-check-label"><b><?php echo e(__('trans_business_trip.fbusinesstrip')); ?></b></label>
                                    ...
                                    <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                                        <?php echo e(__('trans_business_trip.btn_upload')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('trans_business_trip.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    function load_data_businesstrip(claim_date_from, claim_date_to, direct_superior, reimbursement_type, business_unit) {
            table = $('#business_trip_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url : "<?php echo e(url('trans/businesstrip/table')); ?>",
                    data: {
   ...
   $('#btn-list').click(()=> {
    ...
    if ($("#upload_paid_overtime_form").length > 0) {
        $("#upload_paid_overtime_form").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "<?php echo e(url('transaction/update_businesstrip/import')); ?>",
                    type: "POST",
                    processData: false,
                    contentType: false,
                    data: formdata,
    ...
    $.get("<?php echo e(url('level/api')); ?>", function (data) {
        ...
        $.get("<?php echo e(url('travel_type/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        function loadDataFirstLastAllTravelType () {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/travel_type/all/api')); ?>",
            }).then(function (data) {
        ...
        function loadDataTravelType(){
            ...
            $('#reimbursement_type').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/travel_type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
    ...
    function update_data_approval_businesstrip(reimbursement_status, totalpaid, ticketNo,direct_superior,approvalremarks){
        $.ajax({
            url: "<?php echo e(url('trans/update_approvalbusinesstrip/table')); ?>",
            type: "get",
            data: {
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/transaction/trc_trans_business_trip.blade.php ENDPATH**/ ?>