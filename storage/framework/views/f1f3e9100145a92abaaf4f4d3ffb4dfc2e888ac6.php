...
<html>
<head>
	<title><?php echo e(__('main.judul')); ?></title>
	...
	<div class="d-flex" id="wrapper">
		<div class="border-right active" id="sidebar-wrapper">
			...
			<div class="list-group list-group-flush">
				<a tabindex="0" role="button" data-url="<?php echo e(url($menu->link)); ?>" data-idd="<?php echo e($menu->moduleID); ?>" class="list-group-item list-group-item-action menu">
					...
					<img src="<?php echo e(url('/icons/sidebar/' . $menu->icon)); ?>" alt="Home">
					<img src="<?php echo e(url('/icons/sidebar/' . $menu->icon_name . '-bg.svg')); ?>" class="image-hover" alt="<?php echo e($menu->moduleName); ?>">
					<span><?php echo e($menu->moduleName); ?></span>
					<span class="tooltiptext"><?php echo e($menu->moduleName); ?></span>
				</a>
			</div>
			...
			<footer class="footer" id="footer">
				<div class="container">
					<span class="text-muted">© Copyright <br>PT Intikom Berlian Mustika <br><?php echo e(date('Y')); ?></span>
				</div>
			</footer>
		</div>
		<div class="bg-light" id="page-content-wrapper">
			...
			<nav class="navbar navbar-expand-lg navbar-light border-bottom">
				<a href="#" class="toogle-icon" id="menu-toggle"><img src="<?php echo e(url('/pictures/bars-white.png')); ?>" alt="Toogle"></a>
				...
				<!-- <div id="companyData" class="navbar-collapse company-link" style="display: block !important;">
					<span><?php echo e(Session::get('companyName')); ?></span> 
				</div>
				...
				<div class="navbar-collapse right-link">
					...
					<div class="dropdown-profile">
						...
						<div class="dropdown-profile-content dropdown-menu">
							...
							<p><?php echo e(__('main.welcome')); ?></p>
							<hr>
							<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal_change_language"><img src="<?php echo e(url('/pictures/languages.png')); ?>" alt="Languages"> <span><?php echo e(__('main.bahasa')); ?></span></a>
							<a class="dropdown-item" href="<?php echo e(url('change_password')); ?>" target="iframe_dashboard"><img src="<?php echo e(url('/pictures/password.png')); ?>" alt="Password"> <span><?php echo e(__('main.password')); ?></span></a>
							<a class="dropdown-item" href="<?php echo e(url('logout')); ?>"><img src="<?php echo e(url('/pictures/sign_out.png')); ?>" alt="Logout"> <span><?php echo e(__('main.logout')); ?></span></a>
						</div>
					</div>
				</div>
			</nav>
			<iframe src="<?php echo e(url('/home')); ?>" name="iframe_dashboard" id="iframe_dashboard" class="container-fluid" frameborder="0"></iframe>
		</div>
	</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                	<div class="div-title-notification">
                		...
                		<span class="title-text-notification"><?php echo e(__('main.language_success_title')); ?></span>
                	</div>
                	<div class="div-title-notification">
                    	<span id="message-notification-success"><?php echo e(__('main.language_success')); ?></span>
                	</div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                	<div class="div-title-notification">
                		<img src="<?php echo e(url('/pictures/checklist-green-confirm-password.svg')); ?>" alt="Password">
                		<span class="title-text-notification"><?php echo e(__('main.success_title')); ?></span>
                	</div>
                	<div class="div-title-notification">
                    	<span id="message-notification-success"><?php echo e(__('main.success')); ?></span>
                	</div>
                </div>
            </div>
        </div>
...
<script>
	...
	$(document).ready(function() {
		var companyCode = "<?php echo e(Session::get('companyCode')); ?>";
		...
		$('#iframe_dashboard').load(function() {
			$.ajax({
				url: "<?php echo e(url('home/breadcrumbs')); ?>",
				type: "GET",
			...
			$.ajax({
				url: "<?php echo e(url('session_company/api')); ?>",
				type: "GET",
		...
		$('#select-company').on('change', function () {
			...
			$.ajax({
				url: "<?php echo e(url('session_company/change')); ?>",
				type: "POST",
		...
		if($("#change_language_form").length > 0) {
			$("#change_language_form").validate({
				submitHandler: function(form) {
					...
					$.ajax({
						url: "<?php echo e(url('change_language/proses')); ?>",
						type: "POST",
...
</html><?php /**PATH D:\File Kerja\Front End\laravel_project_azure\resources\views/main.blade.php ENDPATH**/ ?>