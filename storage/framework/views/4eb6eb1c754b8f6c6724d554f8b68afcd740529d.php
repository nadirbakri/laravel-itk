...
<html>
<head>
    <title><?php echo e(__('payroll_salary_calculation_process.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_salary_calculation_process.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="process_period"><?php echo e(__('payroll_salary_calculation_process.label_process_period')); ?></label>
                                <input type="text" class="form-control" id="process_period" name="process_period"
                                    placeholder="<?php echo e(__('payroll_salary_calculation_process.label_process_period')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="loan_payment_process"><?php echo e(__('payroll_salary_calculation_process.label_loan_payment_process')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="retroactive_process"><?php echo e(__('payroll_salary_calculation_process.label_retroactive_process')); ?></label>
                        </div>
                    </div>
                    <div class="col-3 retroactive" hidden>
                        <div class="form-group">
                            <label
                                for="retroactive"><?php echo e(__('payroll_salary_calculation_process.label_retroactive')); ?></label>
                ...
                <div class="row include_probation_period" hidden>
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="include_probation_period"><?php echo e(__('payroll_salary_calculation_process.label_include_probation_period')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row include_jamsostek_retroactive" hidden>
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="include_jamsostek_retroactive"><?php echo e(__('payroll_salary_calculation_process.label_include_jamsostek_retroactive')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="rounded_jamsostek_amount"><?php echo e(__('payroll_salary_calculation_process.label_rounded_jamsostek_amount')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="range"><?php echo e(__('payroll_salary_calculation_process.label_range')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('payroll_salary_calculation_process.label_employee_no_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_to"><?php echo e(__('payroll_salary_calculation_process.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_salary_calculation_process.btn_process')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_salary_calculation_process.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_salary_calculation_process.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#salary_calculation_process_form").length > 0) {
            $("#salary_calculation_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/salary_calculation_process/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-process").html(
                                    '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_salary_calculation_process.btn_process")); ?>'
                                );
                                // $('#div-loading').hide();
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/salary_calculation_process')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_salary_calculation_process.blade.php ENDPATH**/ ?>