...
<body>
		...
		<tr>
			...
			<td width="25%" style="text-align:left;">
				<table style="width: 100%;">
					<tr>
						<td>
							<img class="ml-4" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/pictures/logo_hatten.png')))); ?>" style="width: 90px; height: 90px" alt="Logo">
						</td>
					</tr>
				</table>
			</td>
			...
			<td width="40%" style="text-align:center;">
				<table style="width: 100%; padding: 0; margin: 0;">
					<tr>
						<td style="padding: 0; margin: 0; text-align:center; font-size: 15px; font-weight: 700;"><?php echo e($value->companyName); ?></td>
					</tr>
					<tr>
						<td style="padding: 0; margin: 0; text-align:center; font-size: 15px; font-weight: 700;"><?php echo e($value->slipName); ?></td>
					</tr>
					<tr>
						<td style="padding: 0; margin: 0; text-align:center; font-size: 15px; font-weight: 700;"><?php echo e($period); ?></td>
					</tr>
				</table>
			</td>
			<td width="30%">&nbsp;</td>
	...
	<table style="width:100%; border:1px solid #000; padding:3%;">
		<tr>
			...
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e($value->employeeNo); ?></td>
			<td width="12%" style="font-size: 12px; font-weight: 600; padding-left: 10px;">Position</td>
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e($value->position); ?></td>
			
		</tr>
		<tr>
			<td width="12%" style="font-size: 12px; font-weight: 600;">Employee Name</td>
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e($value->employeeName); ?></td>
			<td width="12%" style="font-size: 12px; font-weight: 600; padding-left: 10px;">Join Date</td>
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e(date('d F Y', strtotime($value->joinDate))); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e($value->custom1); ?></td>
			<?php endif; ?>
			<?php if($value->custom2 != null): ?>
			<td width="12%" style="font-size: 12px; font-weight: 600;">Custom 2</td>
			<td width="20%" style="font-size: 12px; border-bottom: 1px solid black;"><?php echo e($value->custom2); ?></td>
			<?php endif; ?>
		</tr>
	</table>
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_export_payment_slip_portrait.blade.php ENDPATH**/ ?>