...
<head>
    <title><?php echo e(__('tm_template_preparation.judul')); ?></title>
    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="<?php echo e(url('/time_management')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('tm_template_preparation.list')); ?></span>
            </a> 
        </div>
        <div class="div-form">
            <form id="template_preparation_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="processing_period"><?php echo e(__('tm_template_preparation.label_processing_period')); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="processing_period" name="processing_period"
                                    placeholder="<?php echo e(__('tm_template_preparation.label_processing_period')); ?>">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_process form-check-label"><?php echo e(__('tm_template_preparation.label_employee_no_to_process')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-check">
                            <input type="radio" id="all_employee" name="employee_type[]" value="all_employee" checked>
                            <label for="all_employee"><?php echo e(__('tm_template_preparation.label_all_employee')); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="radio" id="new_employee" name="employee_type[]" value="new_employee">
                            <label for="new_employee"><?php echo e(__('tm_template_preparation.label_new_employee')); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="radio" id="range" name="employee_type[]" value="range">
                            <label for="range"><?php echo e(__('tm_template_preparation.label_range')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('tm_template_preparation.label_employee_no_from')); ?></label>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="employee_no_to"><?php echo e(__('tm_template_preparation.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('tm_template_preparation.btn_process')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_template_preparation.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#template_preparation_form").length > 0) {
            $("#template_preparation_form").validate({  
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-process").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("tm_template_preparation.btn_process")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/template_preparation/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('time_management/template_preparation')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_template_preparation.blade.php ENDPATH**/ ?>