...
<html>
<head>
    <title><?php echo e(__('export_reimbursement.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="export_reimbursement_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-export-reimbursement">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('export_reimbursement.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_reimbursement.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_reimbursement.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_reimbursement.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_reimbursement.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="reimbursement_type"><?php echo e(__('export_reimbursement.label_reimbursement_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_reimbursement.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_reimbursement.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_reimbursement.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
loadDataFirstLastAllBusinessUnit ();
        ...
        // $.get("<?php echo e(url('reimbursement_type/export/api')); ?>", function (data) {
    ...
    //     });
        ...
        function loadDataExportReimbrusement(){
            ...
            $('#reimbursement_type').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/reimbursement_type/export/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        function loadDataFirstLastAllReimbursmentType () {
        ...
        $("#btn-preview").click(function () {
            ...
            $("#export_reimbursement_form").submit();
        });

        if ($("#export_reimbursement_form").length > 0) {
            $("#export_reimbursement_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/export_reimbursement/print')); ?>",
                        type: "POST",
                        data: $('#export_reimbursement_form').serialize(),
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_reimbursement.blade.php ENDPATH**/ ?>