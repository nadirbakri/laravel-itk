...
<head>
    <title><?php echo e(__('personel_performance.judul')); ?></title>
...
<body>
                ...
                <div class="row div-row-profile">
                    <div class="col-2 subdiv-profile-image">
                        ...
                        <label class="btn btn-primary" id=""><i class="fa fa-edit"></i>
                            <?php echo e(__('personel_performance.btn_change_picture')); ?>
            ...
            <ul class="nav nav-tabs" id="tab-performance" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="award-tab" data-toggle="tab" href="#award_tab" role="tab"
                        aria-controls="award" aria-selected="true"><?php echo e(__('personel_performance.award_tab')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="sanction-tab" data-toggle="tab" href="#sanction_tab" role="tab"
                        aria-controls="sanction" aria-selected="false"><?php echo e(__('personel_performance.sanction_tab')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="evaluation-tab" data-toggle="tab" href="#evaluation_tab" role="tab"
                        aria-controls="evaluation"
                        aria-selected="false"><?php echo e(__('personel_performance.evaluation_tab')); ?></a>
                </li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <button type="button" class="btn btn-primary" name="btn-add-award" id="btn-add-award"
                                ...
                                <i class="fa fa-plus"></i> <?php echo e(__('personel_performance.btn_add')); ?>
                        ...
                        <div class="col-3">
                            <button type="button" class="btn btn-danger" name="btn-remove-award" id="btn-remove-award"
                                style="width: 100%;">
                                <i class="fa fa-times"></i> <?php echo e(__('personel_performance.btn_remove')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_performance.title_modal_award')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="award_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="seq_no_award"><?php echo e(__('personel_performance.label_seq_no')); ?></label>
                                    <input type="text" class="form-control" id="seq_no_award" name="seq_no_award"
                                        placeholder="<?php echo e(__('personel_performance.label_seq_no')); ?>" readonly>
                                </div>
                                <input type="hidden" class="form-control" id="employee_no_award"
                                    name="employee_no_award" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="event_name"><?php echo e(__('personel_performance.label_event_name')); ?></label>
                                    <input type="text" class="form-control" id="event_name" name="event_name"
                                        placeholder="<?php echo e(__('personel_performance.label_event_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="award_date"><?php echo e(__('personel_performance.label_award_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="award_date" name="award_date"
                                            placeholder="<?php echo e(__('personel_performance.label_award_date')); ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="award_type"><?php echo e(__('personel_performance.label_award_type')); ?></label>
                                    <input type="text" class="form-control" id="award_type" name="award_type"
                                        placeholder="<?php echo e(__('personel_performance.label_award_type')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="award_name"><?php echo e(__('personel_performance.label_award_name')); ?></label>
                                    <input type="text" class="form-control" id="award_name" name="award_name"
                                        placeholder="<?php echo e(__('personel_performance.label_award_name')); ?>">
                                </div>
                            </div>
                        </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="submit" id="btn-save-award" class="btn btn-primary w-25"><i
                        ...
                        <?php echo e(__('personel_performance.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_performance.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal_add_sanction" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_performance.title_modal_sanction')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="sanction_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="seq_no_sanction"><?php echo e(__('personel_performance.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_sanction"
                                    name="employee_no_sanction" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_code"><?php echo e(__('personel_performance.label_decree_code')); ?></label>
                                    <select class="form-control" id="decree_code" name="decree_code">
                                        <option value=""><?php echo e(__('personel_performance.label_select_decree_code')); ?>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_date"><?php echo e(__('personel_performance.label_decree_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="decree_date" name="decree_date"
                                            placeholder="<?php echo e(__('personel_performance.label_decree_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_no"><?php echo e(__('personel_performance.label_decree_no')); ?></label>
                                    <input type="text" class="form-control" id="decree_no" name="decree_no"
                                        placeholder="<?php echo e(__('personel_performance.label_decree_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="sanction_code"><?php echo e(__('personel_performance.label_sanction_code')); ?></label>
                                    <select class="form-control" id="sanction_code" name="sanction_code">
                                        <option value=""><?php echo e(__('personel_performance.label_select_sanction_code')); ?>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="sanction_start_date"><?php echo e(__('personel_performance.label_sanction_start_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="sanction_start_date"
                                            name="sanction_start_date"
                                            placeholder="<?php echo e(__('personel_performance.label_sanction_start_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="sanction_end_date"><?php echo e(__('personel_performance.label_sanction_end_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="sanction_end_date"
                                            name="sanction_end_date"
                                            placeholder="<?php echo e(__('personel_performance.label_sanction_end_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="sanction_remarks"><?php echo e(__('personel_performance.label_sanction_remarks')); ?></label>
                                    <textarea rows="3" class="form-control" id="sanction_remarks"
                                        name="sanction_remarks"
                                        placeholder="<?php echo e(__('personel_performance.label_sanction_remarks')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                </div>
    ...
    <div class="modal fade" id="modal_add_evaluation" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_performance.title_modal_evaluation')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="evaluation_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="seq_no_evaluation"><?php echo e(__('personel_performance.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_evaluation"
                                    name="employee_no_evaluation" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="evaluation_period_from"><?php echo e(__('personel_performance.label_evaluation_period_from')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="evaluation_period_from"
                                            name="evaluation_period_from"
                                            placeholder="<?php echo e(__('personel_performance.label_evaluation_period_from')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="evaluation_period_to"><?php echo e(__('personel_performance.label_evaluation_period_to')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="evaluation_period_to"
                                            name="evaluation_period_to"
                                            placeholder="<?php echo e(__('personel_performance.label_evaluation_period_to')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="evaluation_date"><?php echo e(__('personel_performance.label_evaluation_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="evaluation_date"
                                            name="evaluation_date"
                                            placeholder="<?php echo e(__('personel_performance.label_evaluation_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="evaluator"><?php echo e(__('personel_performance.label_evaluator')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="evaluation_form_code"><?php echo e(__('personel_performance.label_evaluation_form_code')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="result"><?php echo e(__('personel_performance.label_result')); ?></label>
                                    <input type="text" class="form-control" id="result" name="result"
                                        placeholder="<?php echo e(__('personel_performance.label_result')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_performance.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        load_table_award('<?php echo e($data[0]->employeeNo); ?>');
        ...
        $('.nav-tabs a').on('shown.bs.tab', function (e) {
            ...
            if (target == '#award_tab') {
                ...
                load_table_sanction('<?php echo e($data[0]->employeeNo); ?>');
            } else if (target == '#evaluation_tab') {
                $('#evaluation_data_table').DataTable().destroy();
                load_table_evaluation('<?php echo e($data[0]->employeeNo); ?>');
            }
        });
        ...
        function load_table_award(employeeNo = '') {
            table = $('#award_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/performance/award/table')); ?>",
                    data: {
        ...
        function load_table_sanction(employeeNo = '') {
            table = $('#sanction_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/performance/sanction/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_evaluation(employeeNo = '') {
            table = $('#evaluation_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/performance/evaluation/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_evaluation_form_code(formCode = '') {
            table_detail = $('#evaluation_form_code_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/performance/evaluation/form/table')); ?>",
                    data: {
                        'formCode': formCode
                    }
                },
        ...
        $.get("<?php echo e(url('sanction/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $('#evaluation_form_code').on("select2:select", function (e) {
            ...
            var url = "<?php echo e(url('evaluation_form/detail/api/formCode')); ?>";
        ...
        function calculateSumValue() {
            ...
            $.ajax({
                url: "<?php echo e(url('personnel/performance/result/check')); ?>",
                type: "GET",
                data: {
                    'valueSum': sum
                },
        ...
        $("#btn-remove-award").on('click', function () {
            ...
            if (data.count() > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/performance/award/remove')); ?>",
                    type: "GET",
                    data: {
        ...
        $("#btn-remove-sanction").on('click', function () {
            ...
            if (data.count() > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/performance/sanction/remove')); ?>",
                    type: "GET",
                    data: {
                        'employeeNo': data[0].employeeNo,
                        'seqNo': data[0].seqNo,
        ...
        $("#btn-remove-evaluation").on('click', function () {
            ...
            if (data.count() > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/performance/evaluation/remove')); ?>",
                    type: "GET",
                    data: {
                        'employeeNo': data[0].employeeNo,
                        'seqNo': data[0].seqNo
        ...
        function loadDataEvaluationForm() {
            ...
            $('#evaluation_form_code').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/evaluation_form/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        //                         setTimeout(function () {
        //                             window.location =
        //                                 "<?php echo e(url('personnel/performance')); ?>";
        //                         }, 3000);
        //                     } else {
        //                         $('#notification_error').modal('show');
        //                         if (response.message == null || response.message ==
        ...
        if ($("#award_form").length > 0) {
            $("#award_form").validate({
                ...
                messages: {
                    seq_no_award: {
                        required: "<?php echo e(__('personel_performance.seq_no_required')); ?>",
                    },
                    event_name: {
                        required: "<?php echo e(__('personel_performance.event_name_required')); ?>",
                    },
                    award_date: {
                        required: "<?php echo e(__('personel_performance.award_date_required')); ?>",
                    },
                    award_type: {
                        required: "<?php echo e(__('personel_performance.award_type_required')); ?>",
                    },
                    award_name: {
                        required: "<?php echo e(__('personel_performance.award_name_required')); ?>",
                    },
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-save-award").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_performance.btn_save")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/performance/award/proses')); ?>",
                        type: "POST",
        ...
        if ($("#sanction_form").length > 0) {
            $("#sanction_form").validate({
                ...
                messages: {
                    ...
                    decree_code: {
                        required: "<?php echo e(__('personel_performance.decree_code_required')); ?>",
                    },
                    decree_date: {
                        required: "<?php echo e(__('personel_performance.decree_date_required')); ?>",
                    },
                    decree_no: {
                        required: "<?php echo e(__('personel_performance.decree_no_required')); ?>",
                    },
                    sanction_code: {
                        required: "<?php echo e(__('personel_performance.sanction_code_required')); ?>",
                    },
                    sanction_start_date: {
                        required: "<?php echo e(__('personel_performance.sanction_start_date_required')); ?>",
                    },
                    sanction_end_date: {
                        required: "<?php echo e(__('personel_performance.sanction_end_date_required')); ?>",
                    },
                    sanction_remarks: {
                        required: "<?php echo e(__('personel_performance.sanction_remarks_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/performance/sanction/proses')); ?>",
                        type: "POST",
        ...
        if ($("#evaluation_form").length > 0) {
            $("#evaluation_form").validate({
                ...
                messages: {
                    ...
                    evaluation_period_from: {
                        required: "<?php echo e(__('personel_performance.evaluation_period_from_required')); ?>",
                    },
                    evaluation_period_to: {
                        required: "<?php echo e(__('personel_performance.evaluation_period_to_required')); ?>",
                    },
                    evaluation_date: {
                        required: "<?php echo e(__('personel_performance.evaluation_date_required')); ?>",
                    },
                    evaluator: {
                        required: "<?php echo e(__('personel_performance.evaluator_required')); ?>",
                    },
                    evaluation_form_code: {
                        required: "<?php echo e(__('personel_performance.evaluation_form_code_required')); ?>",
                    },
                    result: {
                        required: "<?php echo e(__('personel_performance.result_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/performance/evaluation/proses')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_performance_detail.blade.php ENDPATH**/ ?>