...
<html>
<head>
	<title><?php echo e(__('error_page.judul3')); ?></title>
...
<body>
	<div class="div-time_management">
        <img src="<?php echo e(asset('pictures/401.svg')); ?>" alt="Toogle">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6" style="text-align: center; font-size: 1.5rem; font-family: Montserrat;"><?php echo e(__('error_page.subjudul3')); ?></div>
            <div class="col-3"></div>
        </div>
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6" style="text-align: center; font-size: 1rem;">
                <p><?php echo e(__('error_page.text8')); ?></p>
                <p><?php echo e(__('error_page.text9')); ?></p>
                <br>
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/error/login.blade.php ENDPATH**/ ?>