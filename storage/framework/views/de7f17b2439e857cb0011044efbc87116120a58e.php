    ...
    <div class="div-personel">
        ...
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('personel_personal_data.list')); ?></span>
            </a>
        </div>

        <div class="div-table">
            <table id="personal_data_table" class="table hover text-center">
                <thead>
                    <tr>
                        <th></th>
                        <th>Employee No</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#personal_data_table').DataTable({
            ...
            serverSide: true,
            orderCellsTop: true,
            ajax: "<?php echo e(url('personnel/personal_data/table')); ?>",
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('personnel/personal_data')); ?>";
        })

        $("#toolbar-new").on('click', function () {
            $.redirect("<?php echo e(url('personnel/personal_data/detail_data')); ?>", {
                'employeeNo': null,
                'func': 'new'
        ...
        $("#toolbar-active").on('click', function () {
            ...
            if (data.count() > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/personal_data/status')); ?>",
                    type: "GET",
                    data: {
                        'employeeNo': data[0].employeeNo,
                        'func': 'A'
...
<?php /**PATH D:\File Kerja\Front End\laravel_project_azure\resources\views/personel/personel_personal_data.blade.php ENDPATH**/ ?>