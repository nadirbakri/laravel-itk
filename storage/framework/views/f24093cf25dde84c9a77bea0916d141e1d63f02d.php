...
<html>
<head>
    <title><?php echo e(__('admin_main_announcement.head')); ?></title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('admin_main_announcement.judul')); ?></span>
            </a>
        </div>
        <form id="admin_menu_announcement" method="post" enctype="multipart/form-data">
            ...
            <div class="card" >
                <div class="card-header">
                    <h5><?php echo e(__('admin_main_announcement.formjudul')); ?></h5>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="t_announcement form-check-label"><b><?php echo e(__('admin_main_announcement.form1')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="n_announcement form-check-label"><b><?php echo e(__('admin_main_announcement.form2')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="c_announcement form-check-label"><b><?php echo e(__('admin_main_announcement.form3')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label mr-3" for="pinned_announcement"><?php echo e(__('admin_main_announcement.pinned')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save" style="width: 100%"><?php echo e(__('admin_main_announcement.save')); ?></button>  
                    </div>
                    <!-- <div class="col-2">
                        <button class="btn btn-primary" type="submit" name="btn-delete" id="btn-delete" style="width: 100%"><?php echo e(__('admin_main_menu_news_master.delete')); ?></button>  
                    </div> -->
                    <div class="col-3">
                        <button class="btn btn-outline-primary" onClick="window.location.reload();" value="preview" style="width: 100%"><?php echo e(__('admin_main_announcement.cancel')); ?></button> 
                    </div>
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-list" id="btn-list" data-toggle="modal" data-target="#modal_list_news" style="width: 100%"><?php echo e(__('admin_main_announcement.list')); ?></button>  
                    </div>
                </div>
            </div>
         </form> 
...
<script>
    $('#btn-list').click(()=> {
        ...
        table2 = $('#example').DataTable({
            ...
            orderCellsTop: true,
            ajax: {
                url : "<?php echo e(url('adm_main_menu/announcement/list')); ?>"             
            },
    ...
    const klik = (element) => {
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('/announcement_category/detail/api')); ?>",
            data: {
    ...
    $(document).ready(function () {
        ...
        if ($("#admin_menu_announcement").length > 0) {
            $("#admin_menu_announcement").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('admin_menu/announcement/proses')); ?>",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formdata,
                        success: function (response) {
                            if (response.status == "true"){
                                ...
                                setTimeout(function () {
                                window.location =
                                    "<?php echo e(url('utilities/announcement')); ?>";
                                }, 3000);
                            } else {
                            $("#btn-save").prop("disabled", false);
                            $("#btn-save").html(
                    ...
                    error: function (response) {
                        $("#btn-save").prop("disabled", false);
                        $("#btn-save").html(
                            '<?php echo e(__("md_claim_transaction.btn_save")); ?>'
                        );
        ...
        $.get("<?php echo e(url('announcement_category/api')); ?>", function (data) {
        ...
        function loadDataAnnouncementCategory(){
            ...
            var $announcementCat = $('#n_announcement').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/announcement_category/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/admin_menu/admin_main_announcement.blade.php ENDPATH**/ ?>