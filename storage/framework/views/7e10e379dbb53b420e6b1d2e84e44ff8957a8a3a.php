...
<html>
<head>
    <title><?php echo e(__('payroll_spt_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_spt_report.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_spt_report.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_spt_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="npwp_group form-check-label"><?php echo e(__('payroll_spt_report.label_npwp_group')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="npwp_group_all" name="npwp_group" value="all" checked>
                            <label for="npwp_group_all"><?php echo e(__('payroll_spt_report.label_all')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_spt_report.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="send-to-slip" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_spt_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_spt_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function loadDataNPWPGroup(){
            ...
            var headerIsAppend = false;
            $('#npwp_group_det').on('select2:open', function (e) {
                if (!headerIsAppend) {
                    html = '<div class="row">' +
                        '<div class="col-6"><b>NPWP Code</b></div>' +
                        '<div class="col-6"><b>Company Name</b></div>' +
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/spt_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/spt_report/print')); ?>",
                            type: "POST",
                            data: $('#spt_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_spt_report.blade.php ENDPATH**/ ?>