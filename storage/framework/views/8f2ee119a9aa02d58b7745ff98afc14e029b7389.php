...
<html>
<head>
    <title><?php echo e(__('admin_main_menu_news_master.head')); ?></title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="<?php echo e(url('utilities')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('admin_main_menu_news_master.judul')); ?></span>
            </a>
        </div>
        <form id="admin_menu_news_master" method="post" enctype="multipart/form-data">
            ...
            <div class="card" >
                <div class="card-header">
                    <h5><?php echo e(__('admin_main_menu_news_master.formjudul')); ?></h5>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="t_news form-check-label"><b><?php echo e(__('admin_main_menu_news_master.form1')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="n_category form-check-label"><b><?php echo e(__('admin_main_menu_news_master.form2')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b><?php echo e(__('admin_main_menu_news_master.form3')); ?></b></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save" style="width: 100%"><?php echo e(__('admin_main_menu_news_master.save')); ?></button>  
                    </div>
                    <!-- <div class="col-2">
                    ...
                    <div class="col-3">
                        <button class="btn btn-outline-primary" onClick="window.location.reload();" value="preview" style="width: 100%"><?php echo e(__('admin_main_menu_news_master.cancel')); ?></button> 
                    </div>
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-list" id="btn-list" data-toggle="modal" data-target="#modal_list_news" style="width: 100%"><?php echo e(__('admin_main_menu_news_master.list')); ?></button>  
                    </div>
                </div>
            </div>
         </form> 
...
<script>
    ...
    $('#btn-list').click(()=> {
        ...
        table2 = $('#example').DataTable({
            ...
            orderCellsTop: true,
            ajax: {
                url : "<?php echo e(url('adm_main_menu/news_master/list')); ?>"             
            },
    ...
    const klik = (element) => {
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('/news_category/detail/api')); ?>",
            data: {
      ...
      if ($("#admin_menu_news_master").length > 0) {
              $("#admin_menu_news_master").validate({
                  submitHandler: function (form) {
                      ...
                      $.ajax({
                          url: "<?php echo e(url('admin_menu/news_master/proses')); ?>",
                          type: "POST",
                          processData: false,
                          contentType: false,
                          data: formdata,
                          success: function (response) {
                              if (response.status == "true"){
                                  ...
                                  setTimeout(function () {
                                  window.location =
                                      "<?php echo e(url('admin_menu/news_master')); ?>";
                                  }, 3000);
                              } else {
                              $("#btn-save").prop("disabled", false);
                              $("#btn-save").html(
...
// Delete Button
    ...
    $("#btn-delete").on('click', function () {
            ...
            if ($("#admin_menu_news_master").length> 0) {
                $.ajax({
                    url: "<?php echo e(url('admin_menu/news_master/remove')); ?>",
                          type: "GET",
...
<script>
    ...
    $.get("<?php echo e(url('news_category/api')); ?>", function (data) {
            ...
            function loadDataNewsCategory(){
                ...
                $('#n_category').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(url('/news_category/api')); ?>",
                        dataType: 'json',
                        delay: 250,
                        type: "GET",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/admin_menu/admin_main_menu_news_master.blade.php ENDPATH**/ ?>