...
<html>
<head>
    <title><?php echo e(__('payroll_transfer_data_to_bank.judul')); ?></title>
        ...
        <form id="transfer_data_form" method="post">
            ...
            <div class="div-payroll">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="source_bank"><?php echo e(__('payroll_transfer_data_to_bank.label_source_bank')); ?></label>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="output_file"><?php echo e(__('payroll_transfer_data_to_bank.label_output_file')); ?></label>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="account_number"><?php echo e(__('payroll_transfer_data_to_bank.label_account_number')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="account_number" name="account_number"
                                placeholder="<?php echo e(__('payroll_transfer_data_to_bank.label_account_number')); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <label for="transfer_code"><?php echo e(__('payroll_transfer_data_to_bank.label_transfer_code')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="transfer_code" name="transfer_code"
                                placeholder="<?php echo e(__('payroll_transfer_data_to_bank.label_transfer_code')); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="transfer_date"><?php echo e(__('payroll_transfer_data_to_bank.label_transfer_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="transfer_date" name="transfer_date"
                                placeholder="<?php echo e(__('payroll_transfer_data_to_bank.label_payment_date')); ?>">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from"><?php echo e(__('payroll_transfer_data_to_bank.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_transfer_data_to_bank.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_transfer_data_to_bank.label_group_authorize_code')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_transfer_data_to_bank.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-10 box">
                        <div class="row">
                            <div class="col-12">
                                <label for="data_to_transfer"><?php echo e(__('payroll_transfer_data_to_bank.label_data_to_transfer')); ?></label>
                            </div>
                        </div>
                        <div class="row" id="div_data_to_transfer">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label for="data_to_transfer_transfer_amount"><?php echo e(__('payroll_transfer_data_to_bank.label_transfer_amount')); ?></label>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-check">
                                    <input type="radio" id="data_to_transfer_take_homepay_group" name="data_to_transfer" value="take_homepay_group">
                                    <label for="data_to_transfer_take_homepay_group"><?php echo e(__('payroll_transfer_data_to_bank.label_takehomepay_group')); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 30px;">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label
                                        for="check_transfer_amount_salary"><?php echo e(__('payroll_transfer_data_to_bank.label_salary')); ?></label>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-check">
                        ...
                        <div class="row" style="padding-left: 30px;">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label
                                        for="check_transfer_amount_bonus"><?php echo e(__('payroll_transfer_data_to_bank.label_bonus')); ?></label>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-check">
                        ...
                        <div class="row" style="padding-left: 30px;">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label
                                        for="check_transfer_amount_thr"><?php echo e(__('payroll_transfer_data_to_bank.label_thr')); ?></label>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-check">
                        ...
                        <div class="row" style="padding-left: 30px;">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label
                                        for="check_transfer_amount_pension"><?php echo e(__('payroll_transfer_data_to_bank.label_pension')); ?></label>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-check">
                                    <input type="radio" id="take_homepay_group_none" name="take_homepay_group" value="none" disabled>
                                    <label for="take_homepay_group_none"><?php echo e(__('payroll_transfer_data_to_bank.label_none')); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 30px;">
                            <div class="col-6">
                                <div class="form-check">
                                    ...
                                    <label
                                        for="check_transfer_amount_severance"><?php echo e(__('payroll_transfer_data_to_bank.label_severance')); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_transfer_data_to_bank.btn_process')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('payroll/transfer_data_to_bank/export_to_file')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_transfer_data_to_bank.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_transfer_data_to_bank.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function loadDataOutputFile(bankCode = ''){
            ...
            $('#output_file').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/output_file/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataReport() {
            ...
            $('#report_name').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/report_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
            ...
            $("#transfer_data_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('payroll/transfer_data/proses')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_transfer_data_to_bank_form.blade.php ENDPATH**/ ?>