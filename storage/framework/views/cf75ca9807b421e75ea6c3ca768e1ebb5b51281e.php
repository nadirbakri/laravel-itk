	...
	<div class="div-payroll">
        <div class="div-navbar sticky-navbar">
            <a href="javascript:void(0)" style="display: none;" id="toolbar-back">
                ...
                <span><?php echo e(__('payroll_report_format.label_back')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-next">
                ...
                <span><?php echo e(__('payroll_report_format.label_next')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-new" target="iframe_dashboard">
                ...
                <span><?php echo e(__('payroll_report_format.label_new')); ?></span>
            </a>
            <a href="javascript:void(0)" id="toolbar-edit">
                ...
                <span><?php echo e(__('payroll_report_format.label_edit')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-save">
                ...
                <span><?php echo e(__('payroll_report_format.btn_save')); ?></span>
            </a>
            <a class="list-functionbar-md" href="javascript:void(0)" id="toolbar-active">
                ...
                <span><?php echo e(__('payroll_report_format.label_activate')); ?></span>
            </a>
            <a class="list-functionbar-lg" href="javascript:void(0)" id="toolbar-deactive">
                ...
                <span><?php echo e(__('payroll_report_format.label_deactivate')); ?></span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-list">
                ...
                <span><?php echo e(__('payroll_report_format.label_list')); ?></span>
            </a>
        </div>
        <div class="div-title">
			<a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
				<img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
				<span class="title-text"><?php echo e(__('payroll_report_format.list')); ?></span>
			</a>
		</div>
        <div class="div-table">
			<table id="report_format_table" class="table hover" style="width:100%">
				<thead>
					<tr>
                        <th></th>
						<th><?php echo e(__('payroll_report_format.label_report_code')); ?></th>
						<th><?php echo e(__('payroll_report_format.label_description')); ?></th>
                        <th><?php echo e(__('payroll_report_format.label_font_size')); ?></th>
                        <th><?php echo e(__('payroll_report_format.label_record_status')); ?></th>
					</tr>
				</thead>
			</table>
		</div>
    ...
    $(document).ready(function () {
        ...
        function load_data_table_report_format() {
            table = $('#report_format_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/report_format/table')); ?>",
        ...
        $('#report_format_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#report_format_table').on('click', 'tr td:first-child', function(e){
            $(this).parent().find('input[type="checkbox"]').trigger('click');
        });

        $("#toolbar-new").on('click', function() {
            $.redirect("<?php echo e(url('payroll/report_format/detail_data')); ?>", { 'reportCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
        });

        $("#toolbar-edit").on('click', function() {
            var data = table.rows('.selected').data();
            if(data.count() > 0){
                $.redirect("<?php echo e(url('payroll/report_format/detail_data')); ?>", { 'reportCode' : data[0].reportCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
            }else{
        ...
        $("#toolbar-active").on('click', function() {
            ...
            if(data.count() > 0){
                $.ajax({
                    url: "<?php echo e(url('payroll/report_format/status')); ?>",
                    type: "GET",
                    data: { 
        ...
        $('#report_format_table tbody').on('click', 'tr td:not(:first-child)', function () {
            ...
            $.redirect("<?php echo e(url('payroll/report_format/detail_data')); ?>", { 'reportCode' : data.reportCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        });
    })
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_report_format.blade.php ENDPATH**/ ?>