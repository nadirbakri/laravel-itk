	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('personel_group_code.list')); ?></span>
			</a>
		</div>

		<div class="div-table">
			<table id="group_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>Group Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.div-navbar a.disabled').attr('onclick', 'return false;');
  	...
  	$('#group_table thead tr').clone(true).appendTo('#group_table thead');
    $('#group_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#group_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "<?php echo e(url('personnel/group/table')); ?>",
    ...
    $('#group_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#group_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('personnel/group/detail_data')); ?>", { 'groupCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('personnel/group/detail_data')); ?>", { 'groupCode' : data[0].groupCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('personnel/group/status')); ?>",
                type: "GET",
    ...
    $('#group_table tbody').on('click', 'tr td:not(:first-child)', function () {
    	...
    	$.redirect("<?php echo e(url('personnel/group/detail_data')); ?>", { 'groupCode' : data.groupCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_group_code.blade.php ENDPATH**/ ?>