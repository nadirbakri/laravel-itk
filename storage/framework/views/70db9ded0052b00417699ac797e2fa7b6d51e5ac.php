...
<html>
<head>
	<title><?php echo e(__('payroll_loan_payment.judul')); ?></title>
	...
	<div class="div-payroll">
        ...
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_loan_payment.list')); ?></span>
			</a>
		</div>
        <div class="div-table">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_loan_payment.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function load_data_table_loan_payment() {
            table = $('#loan_payment_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/loan_payment/table')); ?>",
        ...
        $("#toolbar-delete").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('payroll/loan_payment/remove')); ?>",
                    type: "GET",
                    data: {
                        'data' : data
                    },
        ...
        $("#toolbar-delete").on('click', function() {
            ...
            if(data.count() > 0){
                $.redirect("<?php echo e(url('payroll/loan_payment/detail_data')); ?>", 
                { 
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_loan_payment.blade.php ENDPATH**/ ?>