    ...
    <div class="div-personel">
        ...
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('personel_performance.list')); ?></span>
            </a>
        </div>

        <div class="div-table">
            <table id="performance_table" class="table hover">
                <thead>
                    <tr>
                        <th></th>
                        <th>Employee No</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#performance_table thead tr').clone(true).appendTo('#performance_table thead');
        $('#performance_table thead tr:eq(1) th:not(:first-child)').each(function (i) {
            var title = $(this).text();
        ...
        var table = $('#performance_table').DataTable({
            ...
            serverSide: true,
            orderCellsTop: true,
            ajax: "<?php echo e(url('personnel/performance/table')); ?>",
        ...
        function load_data_performance() {
        ...
        $('#performance_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#performance_table').on('click', 'tr td:first-child', function(e){
            $(this).parent().find('input[type="checkbox"]').trigger('click');
        });

        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('personnel/performance')); ?>";
        })

        $("#toolbar-edit").on('click', function () {
            var data = table.rows('.selected').data();
            if (data.count() > 0) {
                $.redirect("<?php echo e(url('personnel/performance/detail_data')); ?>", {
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_performance.blade.php ENDPATH**/ ?>