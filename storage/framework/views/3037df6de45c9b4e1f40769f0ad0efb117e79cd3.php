...
<head>
    <title><?php echo e(__('personel_work_detail.judul')); ?></title>
...
<body>
                ...
                <div class="row div-row-profile">
                    <div class="col-2 subdiv-profile-image">
                        ...
                        <label class="btn btn-primary" id=""><i class="fa fa-edit"></i>
                            <?php echo e(__('personel_work_detail.btn_change_picture')); ?>
            ...
            <ul class="nav nav-tabs" id="tab-work-detail" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="job-history-tab" data-toggle="tab" href="#job_history_tab" role="tab"
                        ...
                        aria-selected="true"><?php echo e(__('personel_work_detail.job_history_tab')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="work-experience-tab" data-toggle="tab" href="#work_experience_tab"
                        role="tab" aria-controls="work-experience"
                        aria-selected="false"><?php echo e(__('personel_work_detail.work_experience_tab')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="free-format-field-tab" data-toggle="tab" href="#free_format_field_tab"
                        ...
                        aria-selected="false"><?php echo e(__('personel_work_detail.free_format_field_tab')); ?></a>
                </li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <button type="button" class="btn btn-warning" name="btn-edit-job-history"
                                ...
                                <i class="fa fa-edit"></i> <?php echo e(__('personel_work_detail.btn_edit')); ?>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <button type="button" class="btn btn-primary" name="btn-add-work-experience"
                                ...
                                <i class="fa fa-plus"></i> <?php echo e(__('personel_work_detail.btn_add')); ?>
                        ...
                        <div class="col-3">
                            <button type="button" class="btn btn-danger" name="btn-remove-work-experience"
                                ...
                                <i class="fa fa-times"></i> <?php echo e(__('personel_work_detail.btn_remove')); ?>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_work_detail.title_modal_job_history')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="job_history_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="seq_no_job_history"><?php echo e(__('personel_work_detail.label_seq_no')); ?></label>
                                    <input type="text" class="form-control" id="seq_no_job_history"
                                        name="seq_no_job_history"
                                        placeholder="<?php echo e(__('personel_work_detail.label_seq_no')); ?>" readonly>
                                </div>
                                <input type="hidden" class="form-control" id="employee_no_job_history"
                                    name="employee_no_job_history" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="company_job_history"><?php echo e(__('personel_work_detail.label_company')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="start_date"><?php echo e(__('personel_work_detail.label_start_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="start_date" name="start_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_start_date')); ?>">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="end_date"><?php echo e(__('personel_work_detail.label_end_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="end_date" name="end_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_end_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="employment_status"><?php echo e(__('personel_work_detail.label_employment_status')); ?></label>
                                    <select class="form-control" id="employment_status" name="employment_status">
                                        <option value=""><?php echo e(__('personel_work_detail.label_select_employment_status')); ?>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="employment_type"><?php echo e(__('personel_work_detail.label_employment_type')); ?></label>
                                    <select class="form-control" id="employment_type" name="employment_type">
                                        <option value=""><?php echo e(__('personel_work_detail.label_select_employment_type')); ?>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="contract_start_date"><?php echo e(__('personel_work_detail.label_contract_start_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="contract_start_date"
                                            name="contract_start_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_contract_start_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="contract_end_date"><?php echo e(__('personel_work_detail.label_contract_end_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="contract_end_date"
                                            name="contract_end_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_contract_end_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_code"><?php echo e(__('personel_work_detail.label_decree_code')); ?></label>
                                    <select class="form-control" id="decree_code" name="decree_code">
                                        <option value=""><?php echo e(__('personel_work_detail.label_select_decree_code')); ?>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_no"><?php echo e(__('personel_work_detail.label_decree_no')); ?></label>
                                    <input type="text" class="form-control" id="decree_no" name="decree_no"
                                        placeholder="<?php echo e(__('personel_work_detail.label_decree_no')); ?>">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="decree_date"><?php echo e(__('personel_work_detail.label_decree_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="decree_date" name="decree_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_decree_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="position_job_history"><?php echo e(__('personel_work_detail.label_position')); ?></label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="ranking_job_history"><?php echo e(__('personel_work_detail.label_ranking')); ?></label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="grade_job_history"><?php echo e(__('personel_work_detail.label_grade')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="location_job_history"><?php echo e(__('personel_work_detail.label_location')); ?></label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="group_job_history"><?php echo e(__('personel_work_detail.label_group')); ?></label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label
                                        for="nature_of_work_job_history"><?php echo e(__('personel_work_detail.label_nature_of_work')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="approved_by"><?php echo e(__('personel_work_detail.label_approved_by')); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="direct_staff"><?php echo e(__('personel_work_detail.label_direct_staff')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="temporary" name="temporary"
                                            value="true">
                                        <label class="form-check-label"
                                            for="temporary"><?php echo e(__('personel_work_detail.label_temporary')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="remarks_job_history"><?php echo e(__('personel_work_detail.label_remarks')); ?></label>
                                    <textarea rows="3" class="form-control" id="remarks_job_history"
                                        name="remarks_job_history"
                                        placeholder="<?php echo e(__('personel_work_detail.label_remarks')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="position_job_description"><?php echo e(__('personel_work_detail.label_position_job_description')); ?></label>
                                    <textarea rows="3" class="form-control" id="position_job_description"
                                        name="position_job_description"
                                        placeholder="<?php echo e(__('personel_work_detail.label_position_job_description')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="submit" id="btn-save-job-history" class="btn btn-primary w-25"><i
                        ...
                        <?php echo e(__('personel_work_detail.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_work_detail.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal_add_work_experience"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_work_detail.title_modal_work_experience')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="work_experience_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_work_experience"><?php echo e(__('personel_work_detail.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_work_experience"
                                    name="employee_no_work_experience" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="company_name_work_experience"><?php echo e(__('personel_work_detail.label_company_name')); ?></label>
                                    <input type="text" class="form-control" id="company_name_work_experience"
                                        name="company_name_work_experience"
                                        placeholder="<?php echo e(__('personel_work_detail.label_company_name')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="join_date"><?php echo e(__('personel_work_detail.label_join_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="join_date" name="join_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_join_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="terminate_date"><?php echo e(__('personel_work_detail.label_terminate_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="terminate_date"
                                            name="terminate_date"
                                            placeholder="<?php echo e(__('personel_work_detail.label_terminate_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="position_name_work_experience"><?php echo e(__('personel_work_detail.label_position_name')); ?></label>
                                    <input type="text" class="form-control" id="position_name_work_experience"
                                        name="position_name_work_experience"
                                        placeholder="<?php echo e(__('personel_work_detail.label_position_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="ranking_name_work_experience"><?php echo e(__('personel_work_detail.label_ranking_name')); ?></label>
                                    <input type="text" class="form-control" id="ranking_name_work_experience"
                                        name="ranking_name_work_experience"
                                        placeholder="<?php echo e(__('personel_work_detail.label_ranking_name')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="nature_of_work_work_experience"><?php echo e(__('personel_work_detail.label_nature_of_work')); ?></label>
                                    <input type="text" class="form-control" id="nature_of_work_work_experience"
                                        name="nature_of_work_work_experience"
                                        placeholder="<?php echo e(__('personel_work_detail.label_nature_of_work')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="line_of_business"><?php echo e(__('personel_work_detail.label_line_of_business')); ?></label>
                                    <input type="text" class="form-control" id="line_of_business"
                                        name="line_of_business"
                                        placeholder="<?php echo e(__('personel_work_detail.label_line_of_business')); ?>">
                                </div>
                            </div>
                        </div>
                </div>
    ...
    <div class="modal fade" id="modal_add_free_format_field"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_work_detail.title_modal_free_format_field')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="free_format_field_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="format_code"><?php echo e(__('personel_work_detail.label_format_code')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_free_format_field"
                                    name="employee_no_free_format_field" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="description_free_format_field"><?php echo e(__('personel_work_detail.label_description')); ?></label>
                                    <input type="text" class="form-control" id="description_free_format_field"
                                        name="description_free_format_field"
                                        placeholder="<?php echo e(__('utilities_audit_trail.label_user_name')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="value_free_format_field"><?php echo e(__('personel_work_detail.label_value')); ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_work_detail.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        load_table_job_history('<?php echo e($data[0]->employeeNo); ?>');
        ...
        $('.nav-tabs a').on('shown.bs.tab', function (e) {
            ...
            if (target == '#job_history_tab') {
                ...
                load_table_work_experience('<?php echo e($data[0]->employeeNo); ?>');
            } else if (target == '#free_format_field_tab') {
                $('#free_format_field_data_table').DataTable().destroy();
                load_table_free_format_field('<?php echo e($data[0]->employeeNo); ?>');
            }
        });
        ...
        function load_table_job_history(employeeNo = '') {
            table = $('#job_history_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/work_detail/job_history/table')); ?>",
                    data: {
        ...
        function load_table_work_experience(employeeNo = '') {
            table = $('#work_experience_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/work_detail/work_experience/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_free_format_field(employeeNo = '') {
            table = $('#free_format_field_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/work_detail/free_format_field/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        $.get("<?php echo e(url('employment/type/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $('body').on('click', '#btn-edit-job-history', function () {
            ...
            if (data.count() > 0) {
                ...
                $.each(data[0].level, function (k, v) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo e(url('/level/detail/api')); ?>",
                        data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/company/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/employee_no/req_detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/position/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/ranking/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/grade/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/location/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/group/detail/api')); ?>",
                    data: {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/nature_of_work/detail/api')); ?>",
                    data: {
        ...
        $("#btn-remove-job-history").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/work_detail/job_history/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-work-experience").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/work_detail/work_experience/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-free-format-field").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/work_detail/free_format_field/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        function loadDataFreeFormat() {
            ...
            $('#format_code').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/free_format_field/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        function loadDataFreeFormatDetail(freeFormatCode = '') {
            ...
            $('#value_free_format_field').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/free_format_field/detail/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        //                         setTimeout(function () {
        //                             window.location =
        //                                 "<?php echo e(url('personnel/work_detail')); ?>";
        //                         }, 3000);
        //                     } else {
        //                         $('#notification_error').modal('show');
        //                         if (response.message == null || response.message ==
        ...
        if ($("#job_history_form").length > 0) {
            $("#job_history_form").validate({
                ...
                messages: {
                    seq_no_job_history: {
                        required: "<?php echo e(__('personel_work_detail.seq_no_required')); ?>",
                    },
                    company_job_history: {
                        required: "<?php echo e(__('personel_work_detail.company_required')); ?>",
                    },
                    start_date: {
                        required: "<?php echo e(__('personel_work_detail.start_date_required')); ?>",
                    },
                    end_date: {
                        required: "<?php echo e(__('personel_work_detail.end_date_required')); ?>",
                    },
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-save-job-history").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_work_detail.btn_save")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/work_detail/job_history/proses')); ?>",
                        type: "POST",
        ...
        if ($("#work_experience_form").length > 0) {
            $("#work_experience_form").validate({
                ...
                messages: {
                    ...
                    company_name_work_experience: {
                        required: "<?php echo e(__('personel_work_detail.company_name_required')); ?>",
                    },
                    join_date: {
                        required: "<?php echo e(__('personel_work_detail.join_date_required')); ?>",
                    },
                    terminate_date: {
                        required: "<?php echo e(__('personel_work_detail.terminate_date_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/work_detail/work_experience/proses')); ?>",
                        type: "POST",
        ...
        if ($("#free_format_field_form").length > 0) {
            $("#free_format_field_form").validate({
                ...
                messages: {
                    format_code: {
                        required: "<?php echo e(__('personel_work_detail.format_code_required')); ?>",
                    },
                    value_free_format_field: {
                        required: "<?php echo e(__('personel_work_detail.value_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/work_detail/free_format_field/proses')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_work_detail_detail.blade.php ENDPATH**/ ?>