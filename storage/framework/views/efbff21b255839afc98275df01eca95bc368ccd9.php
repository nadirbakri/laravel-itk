...
<head>
    <title><?php echo e(__('utilities_user_access_group.judul')); ?></title>
    ...
    <div class="div-utilities">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID('<?php echo e(url()->previous()); ?>')" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('utilities_user_access_group.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="user_access_group_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="record_status"><?php echo e(__('utilities_user_access_group.label_record_status')); ?></label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="<?php echo e(__('utilities_user_access_group.label_record_status')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="group_id"><?php echo e(__('utilities_user_access_group.label_group_id')); ?></label>
                            <input type="text" class="form-control" id="group_id" name="group_id"
                                placeholder="<?php echo e(__('utilities_user_access_group.label_group_id')); ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="group_name"><?php echo e(__('utilities_user_access_group.label_group_name')); ?></label>
                            <input type="text" class="form-control" id="group_name" name="group_name"
                                placeholder="<?php echo e(__('utilities_user_access_group.label_group_name')); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-add-user" id="btn-add-user"
                            ...
                            <i class="fa fa-plus"></i> <?php echo e(__('utilities_user_access_group.btn_add_user')); ?>
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-danger" name="btn-remove-user" id="btn-remove-user"
                            style="width: 100%;">
                            <i class="fa fa-times"></i> <?php echo e(__('utilities_user_access_group.btn_remove_user')); ?>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-save-data" id="btn-save-data"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('utilities_user_access_group.btn_save')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('utilities_user_access_group.add_new_user')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="user_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="user_id"><?php echo e(__('utilities_user_access_group.label_user_id')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="user_name"><?php echo e(__('utilities_user_access_group.label_user_name')); ?></label>
                                    <input type="text" class="form-control" id="user_name" name="user_name"
                                        placeholder="<?php echo e(__('utilities_user_access_group.label_user_name')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save-user" class="btn btn-primary w-25"><i class="fa fa-floppy-o"></i>
                        <?php echo e(__('utilities_user_access_group.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('utilities_user_access_group.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span
                            class="title-text-notification"><?php echo e(__('utilities_user_access_group.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $('#group_id').val("<?php echo e(isset($data[0]->groupAccessID) ? $data[0]->groupAccessID : ''); ?>");
            $('#group_name').val(htmlDecode(
                "<?php echo e(isset($data[0]->groupAccessName) ? $data[0]->groupAccessName : ''); ?>"));
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('utilities/group_user_access')); ?>";
        })
        ...
        //         orderCellsTop: true,
        //         ajax: {
        //             url: "<?php echo e(url('utilities/group_user_access/user/table')); ?>",
        //             data: {
        ...
        if ($("#user_access_group_form").length > 0) {
            $("#user_access_group_form").validate({
                ...
                messages: {
                    group_id: {
                        required: "<?php echo e(__('utilities_user_access_group.group_id_required')); ?>",
                    },
                    group_name: {
                        required: "<?php echo e(__('utilities_user_access_group.group_name_required')); ?>",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/group_user_access/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('utilities/group_user_access')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save-data").prop("disabled", false);
                                $("#btn-save-data").html(
        ...
        if ($("#user_form").length > 0) {
            $("#user_form").validate({
                ...
                messages: {
                    user_id: {
                        required: "<?php echo e(__('utilities_user_access_group.user_id_required')); ?>",
                    },
                    user_name: {
                        required: "<?php echo e(__('utilities_user_access_group.user_name_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/group_user_access/user/add')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                load_table_user(
                                    "<?php echo e(isset($data[0]->groupAccessID) ? $data[0]->groupAccessID : ''); ?>"
                                );
                                $('#modal_add_user').modal('hide');
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_user_access_group_detail.blade.php ENDPATH**/ ?>