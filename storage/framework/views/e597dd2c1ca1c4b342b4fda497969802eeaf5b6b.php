...
<head>
    <title><?php echo e(__('tm_detail_rate_overtime_report.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_detail_rate_overtime_report.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="tm_detail_rate_overtime_report_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('tm_detail_rate_overtime_report.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('tm_detail_rate_overtime_report.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_from"><?php echo e(__('tm_detail_rate_overtime_report.label_absent_date_from')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_from" name="absent_date_from"
                                    placeholder="<?php echo e(__('tm_detail_rate_overtime_report.label_absent_date_from')); ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_to"><?php echo e(__('tm_detail_rate_overtime_report.label_absent_date_to')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_to" name="absent_date_to"
                                    placeholder="<?php echo e(__('tm_detail_rate_overtime_report.label_absent_date_to')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('tm_detail_rate_overtime_report.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('tm_detail_rate_overtime_report.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label
                                for="overtime_code"><?php echo e(__('tm_detail_rate_overtime_report.label_overtime_code')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                        <div class="form-group">
                            <div class="form-radio">
                                ...
                                <label class="form-radio-label"
                                    for="overtime_code"><?php echo e(__('tm_detail_rate_overtime_report.label_overtime_code_all')); ?></label>
                            </div>
                        </div>
                    </div> 
                    <div class="col-2">
                        <div class="form-group">
                            <div class="form-radio">
                                ...
                                <label class="form-radio-label"
                                    for="overtime_code"><?php echo e(__('tm_detail_rate_overtime_report.label_overtime_code_selection')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="div-table col-6">
                        <table id="detail_rate_overtime_report_table" class="table hover  width: 100%">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th><?php echo e(__('tm_detail_rate_overtime_report.label_table_overtime_code')); ?></th>
                                    <th><?php echo e(__('tm_detail_rate_overtime_report.label_table_description')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    ...
                    <div class="form-group ml-4">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label"
                                for="include_resign"><?php echo e(__('tm_detail_rate_overtime_report.label_include_resign')); ?></label>
                        </div>
                    </div>
                </div>    
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('tm_detail_rate_overtime_report.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('tm_detail_rate_overtime_report.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('tm_detail_rate_overtime_report.label_location')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('tm_detail_rate_overtime_report.btn_print')); ?>
    ...
    $(document).ready(function () {
        ...
        function load_data_overtime_code() {
            table = $('#detail_rate_overtime_report_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('time_management/overtime_code/table')); ?>",
            ...
            $("#tm_detail_rate_overtime_report_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('time_management/detail_rate_overtime_report/print')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_detail_rate_overtime_report.blade.php ENDPATH**/ ?>