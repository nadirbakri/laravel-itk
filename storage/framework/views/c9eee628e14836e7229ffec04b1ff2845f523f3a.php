...
<html>
<head>
    <title><?php echo e(__('payroll_bonus_thr_report.judul')); ?></title>
    ...
    <div class="div-payroll">
        <div class="div-title">
            <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('payroll_bonus_thr_report.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="bonus_thr_report_form" method="post">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_report')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="bonus" name="report" value="B" checked>
                            <label for="bonus"><?php echo e(__('payroll_bonus_thr_report.label_bonus')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="thr" name="report" value="T">
                            <label for="thr"><?php echo e(__('payroll_bonus_thr_report.label_thr')); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="payment_date_from form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_payment_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="payment_date_from" name="payment_date_from"
                                placeholder="<?php echo e(__('payroll_bonus_thr_report.label_payment_date')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="payment_date_to form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from"><?php echo e(__('payroll_bonus_thr_report.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('payroll_bonus_thr_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_group_authorized_code')); ?> <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_bonus_thr_report.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_bonus_thr_report.btn_preview')); ?>
                    ...
                    <div class="col-3 desc" id="send-to-report">
                        <div class="dropdown">
                            <button style="width: 100%;" class="btn btn-primary dropdown-toggle" id="btn-send-to" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-print"></i> <?php echo e(__('payroll_bonus_thr_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_bonus_thr_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        if($('#bonus_thr_report_form').length > 0){
            $('#bonus_thr_report_form').validate({
                ...
                messages: {
                    employee_no_from: {
                        required: "<?php echo e(__('payroll_bonus_thr_report.employee_no_from_required')); ?>"
                    },
                    employee_no_to: {
                        required: "<?php echo e(__('payroll_bonus_thr_report.employee_no_to_required')); ?>"
                    },
                    group_authorized_code_from: {
                        required: "<?php echo e(__('payroll_bonus_thr_report.group_authorized_code_from_required')); ?>"
                    },
                    group_authorized_code_to: {
                        required: "<?php echo e(__('payroll_bonus_thr_report.group_authorized_code_to_required')); ?>"
                    }
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-send-to").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_bonus_thr_report.btn_send_to")); ?>'
                    );
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/bonus_thr_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/bonus_thr_report/print')); ?>",
                            type: "POST",
                            data: $('#bonus_thr_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send-to').prop("disabled", false);
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_bonus_thr_report.blade.php ENDPATH**/ ?>