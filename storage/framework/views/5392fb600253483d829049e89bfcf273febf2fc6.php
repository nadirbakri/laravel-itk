...
<body>
	<div class="div-payroll">
        ...
        <div class="div-table">
			<table id="salary_master_table" class="table hover" style="width: 100%">
				<thead>
					<tr>
                        <th></th>
						<th>Employee No</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#salary_master_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
            var title = $(this).text();
        ...
        load_data_table_salary_master();

        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');

        function load_data_table_salary_master() {
            table = $('#salary_master_table').DataTable({
                processing: true,
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/salary_master/table')); ?>",
        ...
        $('#salary_master_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#salary_master_table').on('click', 'tr td:first-child', function(e){
        ...
        $("#toolbar-edit").on('click', function() {
            ...
            if(data.count() > 0){
                $.redirect("<?php echo e(url('payroll/salary_master/detail_data')); ?>", 
                { 
        ...
        $('#salary_master_table tbody').on('click', 'tr td:not(:first-child)', function () {
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_salary_master.blade.php ENDPATH**/ ?>