...
<html>
<head>
    <title><?php echo e(__('payroll_dumtk.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_dumtk.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="as_of_period"><?php echo e(__('payroll_dumtk.label_as_of_period')); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="as_of_period" name="as_of_period"
                                    placeholder="<?php echo e(__('payroll_dumtk.label_as_of_period')); ?>">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_dumtk.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_dumtk.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_dumtk.label_group_authorized_code')); ?></label>
                            <span style="color: red">*</span>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_dumtk.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="bpjs_group_from form-check-label"><?php echo e(__('payroll_dumtk.label_bpjs_group')); ?></label>
                            <span style="color: red">*</span>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="bpjs_group_to form-check-label"><?php echo e(__('payroll_dumtk.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-preview" id="btn-preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_dumtk.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="send-to-slip" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_dumtk.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_dumtk.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function loadDataFirstLastAllBPJSGroup(field = '', func = '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/bpjs/func/api')); ?>",
                data: {
                    'func': func
                }
            }).then(function (data) {
        ...
        if($('#dumtk_form').length > 0){
            $('#dumtk_form').validate({
                ...
                messages: {
                    employee_no_from: {
                        required: "<?php echo e(__('payroll_dumtk.employee_no_from_required')); ?>"
                    },
                    employee_no_to: {
                        required: "<?php echo e(__('payroll_dumtk.employee_no_to_required')); ?>"
                    },
                    group_authorized_code_from: {
                        required: "<?php echo e(__('payroll_dumtk.group_authorized_code_from_required')); ?>"
                    },
                    group_authorized_code_to: {
                        required: "<?php echo e(__('payroll_dumtk.group_authorized_code_to_required')); ?>"
                    },
                    bpjs_group_from: {
                        required: "<?php echo e(__('payroll_dumtk.bpjs_group_from_required')); ?>"
                    },
                    bpjs_group_to: {
                        required: "<?php echo e(__('payroll_dumtk.bpjs_group_to_required')); ?>"
                    }
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-send-to").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_dumtk.btn_send_to")); ?>'
                    );
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/dumtk/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/dumtk/print')); ?>",
                            type: "POST",
                            data: $('#dumtk_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send-to').prop("disabled", false);
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_dumtk.blade.php ENDPATH**/ ?>