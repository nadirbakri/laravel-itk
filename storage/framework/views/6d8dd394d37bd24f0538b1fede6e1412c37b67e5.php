        ...
        <form id="payment_slip_form" method="post">
            ...
            <div class="div-payroll">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="slip_type form-check-label"><?php echo e(__('payroll_payment_slip.label_slip_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <select name="slip_type" id="slip_type" class="form-control select2">
                            <option value="Salary"><?php echo e(__('payroll_payment_slip.label_slip')); ?></option>
                            <option value="THR"><?php echo e(__('payroll_payment_slip.label_thr')); ?></option>
                            <option value="Bonus"><?php echo e(__('payroll_payment_slip.label_bonus')); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="period form-check-label"><?php echo e(__('payroll_payment_slip.label_period')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="period" name="period"
                                placeholder="<?php echo e(__('payroll_payment_slip.label_period')); ?>">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="format_type form-check-label"><?php echo e(__('payroll_payment_slip.label_format')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="landscape" name="format_type" value="landscape" checked>
                            <label for="landscape"><?php echo e(__('payroll_payment_slip.label_landscape')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="portrait" name="format_type" value="portrait">
                            <label for="portrait"><?php echo e(__('payroll_payment_slip.label_portrait')); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="print_date form-check-label"><?php echo e(__('payroll_payment_slip.label_print_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="print_date" name="print_date"
                                placeholder="<?php echo e(__('payroll_payment_slip.label_print_date')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_payment_slip.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_payment_slip.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <!-- <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="sort_by form-check-label"><?php echo e(__('payroll_payment_slip.label_sort_by')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="by_employee_no" name="sort_by" value="by_employee_no" checked>
                            <label for="by_employee_no"><?php echo e(__('payroll_payment_slip.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="by_level" name="sort_by" value="by_level">
                            <label for="by_level"><?php echo e(__('payroll_payment_slip.label_level')); ?></label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_from form-check-label"><?php echo e(__('payroll_payment_slip.label_group_authorize_code')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_to form-check-label"><?php echo e(__('payroll_payment_slip.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="display_logo"><?php echo e(__('payroll_payment_slip.label_display_company_logo')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_payment_slip.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_payment_slip.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_payment_slip.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
            ...
            $('#payment_slip_form').validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('payroll/payment_slip/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project_azure\resources\views/payroll/py_payment_slip.blade.php ENDPATH**/ ?>