...
<head>
    <title><?php echo e(__('md_claim_code.judul')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/medical_detail_data.css')); ?>">
    ...
    <div class="div-medical">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID('<?php echo e(url()->previous()); ?>')" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('md_claim_code.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="claim_code_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="record_status"><?php echo e(__('md_claim_code.label_record_status')); ?></label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="<?php echo e(__('md_claim_code.label_record_status')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="claim_code"><?php echo e(__('md_claim_code.label_claim_code')); ?></label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="claim_code" name="claim_code"
                                placeholder="<?php echo e(__('md_claim_code.label_claim_code')); ?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="claim_name"><?php echo e(__('md_claim_code.label_claim_name')); ?></label>
                            <input type="text" class="form-control" id="claim_name" name="claim_name"
                                placeholder="<?php echo e(__('md_claim_code.label_claim_name')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_include_disease"><?php echo e(__('md_claim_code.label_include_disease')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_process_to_payroll"><?php echo e(__('md_claim_code.label_process_to_payroll')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_must_have_family"><?php echo e(__('md_claim_code.label_must_have_family')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_allow_claim_to_company"><?php echo e(__('md_claim_code.label_allow_claim_to_company')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label
                                    for="check_allow_claim_to_family"><?php echo e(__('md_claim_code.label_allow_claim_to_family')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="limit_type"><?php echo e(__('md_claim_code.label_limit_type')); ?></label>
                            <select class="form-control" id="limit_type" name="limit_type"
                                placeholder="<?php echo e(__('md_claim_code.label_limit_type')); ?>"> </select>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="payment"><?php echo e(__('md_claim_code.label_payment')); ?></label>
                            <input type="number" class="form-control" id="payment" name="payment"
                                placeholder="<?php echo e(__('md_claim_code.label_payment')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('md_claim_code.btn_save')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('medical/claim_code')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('md_claim_code.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('md_claim_code.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $('#claim_code').val("<?php echo e(isset($data[0]->claimCode) ? $data[0]->claimCode : ''); ?>");
            $('#claim_name').val(htmlDecode("<?php echo e(isset($data[0]->claimName) ? $data[0]->claimName : ''); ?>"));
            var include_disease = "<?php echo e(isset($data[0]->flagDisease) ? $data[0]->flagDisease : ''); ?>";
            if(include_disease == 1) {
                $('#check_include_disease').prop('checked', true);
            }else{
                $('#check_include_disease').prop('checked', false);
            }
            var process_to_payroll = "<?php echo e(isset($data[0]->flagPayroll) ? $data[0]->flagPayroll : ''); ?>";
            if(process_to_payroll == 1) {
                $('#check_process_to_payroll').prop('checked', true);
            }else{
                $('#check_process_to_payroll').prop('checked', false);
            }
            var must_have_family = "<?php echo e(isset($data[0]->flagMustHaveFamily) ? $data[0]->flagMustHaveFamily : ''); ?>";
            if(must_have_family == 1) {
                $('#check_must_have_family').prop('checked', true);
            }else{
                $('#check_must_have_family').prop('checked', false);
            }
            var allow_claim_to_company = "<?php echo e(isset($data[0]->flagAllowClaimForCompany) ? $data[0]->flagAllowClaimForCompany : ''); ?>";
            if(allow_claim_to_company == 1) {
                $('#check_allow_claim_to_company').prop('checked', true);
            }else{
                $('#check_allow_claim_to_company').prop('checked', false);
            }
            // var allow_claim_to_insurance = "<?php echo e(isset($data[0]->flagAllowClaimForInsurance) ? $data[0]->flagAllowClaimForInsurance : ''); ?>";
            // if(allow_claim_to_insurance == 1) {
            //     $('#check_allow_claim_to_insurance').prop('checked', true);
            // }else{
            //     $('#check_allow_claim_to_insurance').prop('checked', false);
            // }
            var allow_claim_to_family = "<?php echo e(isset($data[0]->flagAllowClaimForFamily) ? $data[0]->flagAllowClaimForFamily : ''); ?>";
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/medical_limit_type/func/api')); ?>",
                data: {
                    'limitType' : "<?php echo e(isset($data[0]->companyMedicalLimitType) ? $data[0]->companyMedicalLimitType : ''); ?>"
                }
            }).then(function (data2) {
            ...
            $('#payment').val("<?php echo e(isset($data[0]->paymentFromRemainingLimit) ? $data[0]->paymentFromRemainingLimit : ''); ?>");
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('medical/claim_code')); ?>";
        });
        ...
        function loadDataMedicalLimitType() {
            ...
            $('#limit_type').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/medical_limit_type/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        if ($("#claim_code_form").length > 0) {
            $("#claim_code_form").validate({
                ...
                messages: {
                    claim_code: {
                        required: "<?php echo e(__('md_claim_code.claim_code_required')); ?>",
                    },
                    claim_name: {
                        required: "<?php echo e(__('md_claim_code.claim_name_required')); ?>",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('medical/claim_code/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('medical/claim_code')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/medical/md_claim_code_detail.blade.php ENDPATH**/ ?>