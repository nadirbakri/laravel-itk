...
<html>
<head>
    <title><?php echo e(__('export_attendance.judul')); ?></title>
            ...
            <div class="div-export-attendance">
                <div class="div-title">
                    <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('export_attendance.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_attendance.label_claim_date')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_attendance.label_claim_start')); ?>">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_attendance.label_to')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_attendance.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label"><?php echo e(__('export_attendance.label_business_unit')); ?></label>
                        </div>
                        <select class="form-control select2" id="business_unit" name="business_unit"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="employee_status form-check-label"><?php echo e(__('export_attendance.employee_status')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_attendance.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_attendance.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
loadDataFirstLastAllEmployeeStatus();
    ...
    //     });
        ...
        // $.get("<?php echo e(url('employee/status/api')); ?>", function (data) {
        //     $.each(data, function (k, v) {
            ...
            $("#export_attendance_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/export_attendance/print')); ?>",
                        type: "POST",
        ...
        function loadDataEmployeeStatus(){
            ...
            $('#employee_status').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/employee/status/all/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project_azure\resources\views/export/exp_export_attendance.blade.php ENDPATH**/ ?>