	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('personel_city_code.list')); ?></span>
			</a>
		</div>

		<div class="div-table">
			<table id="city_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>City Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.div-navbar a.disabled').attr('onclick', 'return false;');
  	...
  	$('#city_table thead tr').clone(true).appendTo('#city_table thead');
    $('#city_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#city_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "<?php echo e(url('personnel/city/table')); ?>",
    ...
    $('#city_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#city_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('personnel/city/detail_data')); ?>", { 'cityCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('personnel/city/detail_data')); ?>", { 'cityCode' : data[0].cityCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('personnel/city/status')); ?>",
                type: "GET",
    ...
    $('#city_table tbody').on('click', 'tr td:not(:first-child)', function () {
    	...
    	$.redirect("<?php echo e(url('personnel/city/detail_data')); ?>", { 'cityCode' : data.cityCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_city_code.blade.php ENDPATH**/ ?>