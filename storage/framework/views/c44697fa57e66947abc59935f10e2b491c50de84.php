...
<head>
    <title><?php echo e(__('payroll_slip_format.judul')); ?></title>
...
<body>
    <div class="div-payroll">
        <div class="div-title">
            <a href="<?php echo e(url('/payroll')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                <span class="title-text"><?php echo e(__('payroll_slip_format.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="slip_format_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label
                                for="slip_type"><?php echo e(__('payroll_slip_format.label_slip_type')); ?></label>
                                <select class="form-control select2" id="slip_type" name="slip_type">
                                <option value="" disabled selected><?php echo e(__('payroll_slip_format.label_select_slip_type')); ?></option>
                            </select>
                        </div>                        
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <br>
                            <label
                                for="format"><?php echo e(__('payroll_slip_format.label_format')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-radio">
                                ...
                                <label class="form-radio-label"
                                    for="format"><?php echo e(__('payroll_slip_format.label_up_down')); ?></label>
                            </div>
                        </div>
                    </div> 
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-radio">
                                ...
                                <label class="form-radio-label"
                                    for="format"><?php echo e(__('payroll_slip_format.label_left_right')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="font_size"><?php echo e(__('payroll_slip_format.label_font_size')); ?></label>
                            <input type="number" min="0" class="form-control" id="font_size" name="font_size"
                                placeholder="<?php echo e(__('payroll_slip_format.label_font_size')); ?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label
                                for="number_format"><?php echo e(__('payroll_slip_format.label_number_format')); ?></label>
                                <select class="form-control select2" id="number_format" name="number_format">
                                <option value="" disabled selected><?php echo e(__('payroll_slip_format.label_select_number_format')); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no"><?php echo e(__('payroll_slip_format.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                    ...
                    <div class="col-1-5">
                        <div class="form-group">
                            <label for="join_date"><?php echo e(__('payroll_slip_format.label_join_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                    ...
                    <div class="col-1-5">
                        <div class="form-group">
                            ...
                            ><?php echo e(__('payroll_slip_format.label_custom1')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_name"><?php echo e(__('payroll_slip_format.label_employee_name')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                    ...
                    <div class="col-1-5">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('payroll_slip_format.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                    ...
                    <div class="col-1-5">
                        <div class="form-group">
                            ...
                            data-toggle="modal" data-edit="false" data-field="" style="width: 100%;" data-target="#modal_custom"
                            ><?php echo e(__('payroll_slip_format.label_custom2')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            data-target="#modal_allowance"><?php echo e(__('payroll_slip_format.label_allowance')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            data-target="#modal_deduction"><?php echo e(__('payroll_slip_format.label_deduction')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="total_allowance" class="total_allowance" id="total_allowance"><?php echo e(__('payroll_slip_format.label_total_allowance')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="total_deduction" class="total_deduction" id="total_deduction"><?php echo e(__('payroll_slip_format.label_total_deduction')); ?></label>
                        </div>
                    </div>
                    <div class="col-1">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location" class="location" id="location"><?php echo e(__('payroll_slip_format.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <label for="datetime" class="datetime" id="datetime"><?php echo e(__('payroll_slip_format.label_date_time')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label for="employee_name_ttd" class="employee_name_ttd" id="employee_name_ttd"><?php echo e(__('payroll_slip_format.label_employee_name')); ?></label>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('payroll_slip_format.label_custom')); ?></h5>
                    ...
                    <form id="custom_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="custom"><?php echo e(__('payroll_slip_format.label_custom')); ?></label>
                                    <select class="form-control select2" id="custom" name="custom">
                                        <option value="" disabled selected><?php echo e(__('payroll_slip_format.label_select_code')); ?></option>
                                    </select>
                                </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" id="btn-save-custom" class="btn btn-primary w-25"><i 
                                    class="fa fa-floppy-o"></i> <?php echo e(__('payroll_slip_format.btn_save')); ?></button>
                            <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                                    class="fa fa-times-circle"></i> <?php echo e(__('payroll_slip_format.btn_cancel')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="modal_allowance" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('payroll_slip_format.label_allowance')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="allowance_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="field_name_allowance"><?php echo e(__('payroll_slip_format.label_field_name')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="component_allowance"><?php echo e(__('payroll_slip_format.label_component')); ?></label>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-primary" name="btn-add-allowance" id="btn-add-allowance">
                                        <?php echo e(__('payroll_slip_format.btn_add')); ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="field_label_allowance"><?php echo e(__('payroll_slip_format.label_field_label')); ?></label>
                                    <input class="form-control" id="field_label_allowance" name="field_label_allowance"
                                    placeholder="<?php echo e(__('payroll_slip_format.label_field_label')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
    ...
    <div class="modal fade" id="modal_deduction" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('payroll_slip_format.label_deduction')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="deduction_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="field_name_deduction"><?php echo e(__('payroll_slip_format.label_field_name')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="component_deduction"><?php echo e(__('payroll_slip_format.label_component')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="field_label_deduction"><?php echo e(__('payroll_slip_format.label_field_label')); ?></label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#slip_type, input[name="format"]').on('change', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/payroll/slip_format/detail_data')); ?>",
                data: {
                ...
                success: function (response) {      
                    if (!isEmpty(response)) {
                        ...
                        // $("#label_custom1").html(response.headerCustom1 == null ? "<?php echo e(__('payroll_slip_format.label_custom1')); ?>" : response.headerCustom1);
                        // $("#label_custom2").html(response.headerCustom2 == null ? "<?php echo e(__('payroll_slip_format.label_custom2')); ?>" : response.headerCustom2);
                        // $("#allowance1").html(response.allowance1Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance1Field);
                        // $("#allowance2").html(response.allowance2Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance2Field);
                        // $("#allowance3").html(response.allowance3Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance3Field);
                        // $("#allowance4").html(response.allowance4Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance4Field);
                        // $("#allowance5").html(response.allowance5Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance5Field);
                        // $("#allowance6").html(response.allowance6Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance6Field);
                        // $("#allowance7").html(response.allowance7Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance7Field);
                        // $("#allowance8").html(response.allowance8Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance8Field);
                        // $("#allowance9").html(response.allowance9Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance9Field);
                        // $("#allowance10").html(response.allowance10Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.allowance10Field);
                        // $("#deduction1").html(response.deduction1Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction1Field);
                        // $("#deduction2").html(response.deduction2Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction2Field);
                        // $("#deduction3").html(response.deduction3Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction3Field);
                        // $("#deduction4").html(response.deduction4Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction4Field);
                        // $("#deduction5").html(response.deduction5Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction5Field);
                        // $("#deduction6").html(response.deduction6Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction6Field);
                        // $("#deduction7").html(response.deduction7Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction7Field);
                        // $("#deduction8").html(response.deduction8Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction8Field);
                        // $("#deduction9").html(response.deduction9Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction9Field);
                        // $("#deduction10").html(response.deduction10Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.deduction10Field);
                    }
                    else {
                        $("#record_function_custom").val("New");
                        $("#record_function_allowance").val("New");
                        $("#record_function_deduction").val("New");
                        $("#label_custom1").html("<?php echo e(__('payroll_slip_format.label_custom1')); ?>");
                        $("#label_custom2").html("<?php echo e(__('payroll_slip_format.label_custom2')); ?>");
                        $("#allowance1").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance2").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance3").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance4").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance5").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance6").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance7").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance8").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance9").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#allowance10").html("<?php echo e(__('payroll_slip_format.label_allowance')); ?>");
                        $("#deduction1").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction2").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction3").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction4").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction5").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction6").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction7").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction8").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction9").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                        $("#deduction10").html("<?php echo e(__('payroll_slip_format.label_deduction')); ?>");
                    }
                }
            });
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('/employee_no_slip_format/api')); ?>",
            data: {
                'employeeNo': employee
            }
        }).then(function (data) {
        ...
        if ($("#custom_form").length > 0) {
            $("#custom_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/slip_format/custom/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                $("#btn-save-custom").html(
                                    '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_slip_format.btn_save")); ?>'
                                );
                                ...
                                if (!isEmpty(response.data)) {
                                    ...
                                    // $("#label_custom1").html(response.data.headerCustom1 == null ? "<?php echo e(__('payroll_slip_format.label_custom1')); ?>" : response.data.headerCustom1);
                                    // $("#label_custom2").html(response.data.headerCustom2 == null ? "<?php echo e(__('payroll_slip_format.label_custom2')); ?>" : response.data.headerCustom2);
                                    // $("#allowance1").html(response.data.allowance1Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance1Field);
                                    // $("#allowance2").html(response.data.allowance2Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance2Field);
                                    // $("#allowance3").html(response.data.allowance3Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance3Field);
                                    // $("#allowance4").html(response.data.allowance4Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance4Field);
                                    // $("#allowance5").html(response.data.allowance5Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance5Field);
                                    // $("#allowance6").html(response.data.allowance6Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance6Field);
                                    // $("#allowance7").html(response.data.allowance7Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance7Field);
                                    // $("#allowance8").html(response.data.allowance8Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance8Field);
                                    // $("#allowance9").html(response.data.allowance9Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance9Field);
                                    // $("#allowance10").html(response.data.allowance10Field == null ? "<?php echo e(__('payroll_slip_format.label_allowance')); ?>" : response.data.allowance10Field);
                                    // $("#deduction1").html(response.data.deduction1Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction1Field);
                                    // $("#deduction2").html(response.data.deduction2Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction2Field);
                                    // $("#deduction3").html(response.data.deduction3Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction3Field);
                                    // $("#deduction4").html(response.data.deduction4Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction4Field);
                                    // $("#deduction5").html(response.data.deduction5Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction5Field);
                                    // $("#deduction6").html(response.data.deduction6Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction6Field);
                                    // $("#deduction7").html(response.data.deduction7Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction7Field);
                                    // $("#deduction8").html(response.data.deduction8Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction8Field);
                                    // $("#deduction9").html(response.data.deduction9Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction9Field);
                                    // $("#deduction10").html(response.data.deduction10Field == null ? "<?php echo e(__('payroll_slip_format.label_deduction')); ?>" : response.data.deduction10Field);
                                }
                                else {
        ...
        if ($("#allowance_form").length > 0) {
            $("#allowance_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/slip_format/allowance/proses')); ?>",
                        type: "POST",
        ...
        if ($("#deduction_form").length > 0) {
            $("#deduction_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/slip_format/deduction/proses')); ?>",
                        type: "POST",
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_slip_format.blade.php ENDPATH**/ ?>