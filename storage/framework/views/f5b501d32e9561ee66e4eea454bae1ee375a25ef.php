...
<html>
<head>
	<title><?php echo e(__('personel_bpjs_group.judul')); ?></title>
	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('personel_bpjs_group.list')); ?></span>
			</a>
		</div>

		<div class="div-table">
			<table id="bpjs_group_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>BPJS Code</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_bpjs_group.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.div-navbar a.disabled').attr('onclick', 'return false;');
  	...
  	$('#bpjs_group_table thead tr').clone(true).appendTo('#bpjs_group_table thead');
    $('#bpjs_group_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#bpjs_group_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "<?php echo e(url('personnel/bpjs_group/table')); ?>",
        ...
        columns: [
            ...
            {data: 'bpjsCode', name: 'bpjsCode'},
            {data: 'bpjsNo', name: 'bpjsNo'},
    ...
    function load_data_bpjs_group() {
        table = $('#bpjs_group_table').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: "<?php echo e(url('personnel/bpjs_group/table')); ?>",
    ...
    $('#bpjs_group_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#bpjs_group_table').on('click', 'tr td:first-child', function(e){
        $(this).parent().find('input[type="checkbox"]').trigger('click');
    });

    $('#notification_success').on('hide.bs.modal', function () {
        window.location = "<?php echo e(url('personnel/bpjs_group')); ?>";
    })

    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('personnel/bpjs_group/detail_data')); ?>", { 'bpjsCode' : null, 'bpjsNo' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('personnel/bpjs_group/detail_data')); ?>", { 'bpjsCode' : data[0].bpjsCode, 'bpjsNo' : data[0].bpjsNo, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('personnel/bpjs_group/status')); ?>",
                type: "GET",
                ...
                success: function(response) {
                    ...
                    var oTable = $('#bpjs_group_table').dataTable();
                    oTable.fnDraw(false);
                },
    ...
    $('#bpjs_group_table tbody').on('click', 'tr td:not(:first-child)', function () {
    	...
    	$.redirect("<?php echo e(url('personnel/bpjs_group/detail_data')); ?>", { 'bpjsCode' : data.bpjsCode, 'bpjsNo' : data.bpjsNo, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_bpjs_group.blade.php ENDPATH**/ ?>