...
<html>
<head>
    <title><?php echo e(__('export_pdf_business_trip.judul')); ?></title>
            ...
            <div class="div-export-pdf-business-trip">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('export_pdf_business_trip.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_pdf_business_trip.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_pdf_business_trip.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_pdf_business_trip.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_pdf_business_trip.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="travel_type"><?php echo e(__('export_pdf_business_trip.label_travel_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_pdf_business_trip.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_pdf_business_trip.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_pdf_business_trip.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
            ...
            $("#export_pdf_business_trip_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/export_businesstrip_pdf/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_pdf_business_trip.blade.php ENDPATH**/ ?>