...
<html>
<head>
	<title><?php echo e(__('payroll_monthly_payroll_closing_process.judul')); ?></title>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="period_process"><?php echo e(__('payroll_monthly_payroll_closing_process.label_period_process')); ?></label>
                            <div class="input-group month">
                                <input type="text" class="form-control" id="period_process" name="period_process"
                                    placeholder="<?php echo e(__('payroll_monthly_payroll_closing_process.label_period_process')); ?>" readonly>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_monthly_payroll_closing_process.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#monthly_closing_process_form").length > 0) {
            $("#monthly_closing_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/monthly_closing_process/proses')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_monthly_closing_process.blade.php ENDPATH**/ ?>