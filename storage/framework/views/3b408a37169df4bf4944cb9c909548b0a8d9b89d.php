...
<head>
    <title><?php echo e(__('personel_import_export_personal_data.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_import_export_personal_data.list')); ?></span>
            </a>
        </div>
    </div>
    <div class="div-form">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label for="import_export"><?php echo e(__('personel_import_export_personal_data.label_import_export')); ?></label>
                        ...
                        <small id="import_export_help" class="text-muted">
                            <?php echo e(__('personel_import_export_personal_data.help_import_export')); ?>
            ...
            <div class="row">
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-import" id="btn-import"
                        style="width: 100%;">
                        <?php echo e(__('personel_import_export_personal_data.btn-import')); ?>
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-export" id="btn-export"
                        style="width: 100%;">
                        <?php echo e(__('personel_import_export_personal_data.btn-export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_import_export_personal_data.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        $("#btn-export").click(function () {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('personnel/personal_data/export')); ?>",
                type: "POST",
        ...
        $("#btn-download-template").click(function () {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('personnel/personal_data/template')); ?>",
                type: "POST",
                success: function (result, status, xhr) {
        ...
        if ($("#import_export_personal_data_form").length > 0) {
            $("#import_export_personal_data_form").validate({
                ...
                messages: {
                    import_export: {
                        extension: "<?php echo e(__('personel_import_export_personal_data.import_export_extension')); ?>",
                    },
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-import").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_import_export_personal_data.btn-import")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/personal_data/import')); ?>",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formdata,
                        success: function (response) {
                            if (response[0].status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('personnel/import_export_personal_data')); ?>";
                                }, 3000);
                            } else {
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_import_export_personal_data.blade.php ENDPATH**/ ?>