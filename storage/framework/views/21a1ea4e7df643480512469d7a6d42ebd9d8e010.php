			...
			<a class="collapsed" data-toggle="collapse" href="#<?php echo e($value->pageURL); ?>" aria-expanded="true" aria-controls="<?php echo e($value->pageURL); ?>">
				<div class="card-header">
					<div class="div-dropdown-title">
						<img class="dropdown-logo" src="<?php echo e(url('/icons/personnel/' . $value->pageURL . '.svg')); ?>" alt="personel">
...
</html><?php /**PATH D:\File Kerja\Front End\laravel_project_azure\resources\views/personel/personel_main.blade.php ENDPATH**/ ?>