...
<html>
<head>
	<title><?php echo e(__('utilities_organization_structure.judul')); ?></title>
	...
	<link rel="stylesheet" href="<?php echo e(asset('css/utilities_organization_structure.css')); ?>">
	...
	<div class="div-utilities">
		...
		<div class="div-organization">
					...
					<div class="bd-example">
						<div id="chartOrganizationLevelOne" class="carousel slide show-neighbors" data-interval="false" data-wrap="false">
							...
							<a class="carousel-control-prev" href="#chartOrganizationLevelOne" role="button" data-slide="prev">
								<img src="<?php echo e(url('/pictures/previous-slide.png')); ?>" class="d-block" alt="">
								<span class="sr-only">Previous</span>
							</a>
							<a class="carousel-control-next" href="#chartOrganizationLevelOne" role="button" data-slide="next">
								<img src="<?php echo e(url('/pictures/next-slide.png')); ?>" class="d-block" alt="">
			...
			<div class="row">
				<div class="col-4"></div>
                <div class="col-8">
                	<img class="image-chart-line" src="<?php echo e(url('/pictures/line-chart-organization.png')); ?>" class="d-block" alt="">
                </div>
            </div>
            <div class="row">
				<div class="col-4">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		var data2 = [];
		var data3 = [];
		var urlPicture = "<?php echo e(url('/pictures/profile-picture.png')); ?>";
		...
		function load_data_layer_one(supervisorPositionCode = '') {
			$.ajax({
				url: "<?php echo e(url('utilities/organization_chart/get/position')); ?>",
				type: "GET",
				data: {
		...
		function loadDataEmployeeNo(field = '', supervisorPositionCode = '') {
			...
			$(field).select2({
				...
				ajax: {
					url: "<?php echo e(url('/employee_no/supervisor/position/api')); ?>",
					dataType: 'json',
					delay: 250,
					type: "GET",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_organization_structure.blade.php ENDPATH**/ ?>