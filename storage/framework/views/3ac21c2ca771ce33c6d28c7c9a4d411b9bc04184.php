...
<head>
    <title><?php echo e(__('tm_update_absenteeism_data.judul')); ?></title>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="process_date"><?php echo e(__('tm_update_absenteeism_data.label_file_location')); ?></label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="file_location" name="file_location">
                                <label class="custom-file-label" for="file_location"><?php echo e(__('tm_update_absenteeism_data.label_select_file_location')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> <?php echo e(__('tm_update_absenteeism_data.btn_process')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <button type="button" class="btn btn-process" name="btn-export" id="btn-export">
                            <i class="fa fa-download"></i> <?php echo e(__('tm_update_absenteeism_data.btn_download_template')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_update_absenteeism_data.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('time_management/update_absenteeism_data')); ?>";
        });
        ...
        $("#btn-export").click(function () {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('time_management/update_absenteeism_data/download')); ?>",
                type: "POST",
        ...
        if ($("#tm_update_absenteeism_data_form").length > 0) {
            $("#tm_update_absenteeism_data_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/update_absenteeism_data/import')); ?>",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formdata,
                        success: function (response) {
                            if (response[0].status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('time_management/update_absenteeism_data')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_update_absenteeism_data.blade.php ENDPATH**/ ?>