...
<html lang="en">
<head>
<title><?php echo e(__('payroll_export_sipp_online.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_export_sipp_online.judul_form')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_bpjs_code"><?php echo e(__('payroll_export_sipp_online.label_group_bpjs')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" id="btn-print" style="width:100%">
                            <i class="fa fa-download"></i> <?php echo e(__('payroll_export_sipp_online.label_download')); ?>
...
<script src="<?php echo e(asset('js/Blob.js')); ?>"></script>
<script src="<?php echo e(asset('js/FileSaver.js')); ?>"></script>
            ...
            $("#export_sipp_online_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('payroll/export_sipp_online/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_export_sipp_online.blade.php ENDPATH**/ ?>