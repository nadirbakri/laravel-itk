...
<head>
    <title><?php echo e(__('personel_competency.judul')); ?></title>
...
<body>
    <div class="div-personel">
                ...
                <div class="row div-row-profile">
                    <div class="col-2 subdiv-profile-image">
                        <!-- <img src="<?php echo e(isset($data[0]->photo) ? $photo : url('/pictures/profile-picture.png')); ?>"
                            alt="Profile"> -->
                        <img src="<?php echo e(url('/pictures/profile-picture.png')); ?>" alt="Profile">
                        <label class="btn btn-primary" id=""><i class="fa fa-edit"></i>
                            <?php echo e(__('personel_competency.btn_change_picture')); ?>

                            <input type="file" class="form-control" id="photo_profile" name="photo_profile" hidden>
                        </label>
                    </div>
                    <div class="col-9 subdiv-profile">
                        <p><?php echo e(isset($data[0]->fullName) ? $data[0]->fullName : '-'); ?> &emsp; | &emsp;
                            <?php echo e(isset($data[0]->employeeNo) ? $data[0]->employeeNo : '-'); ?></p>
                        <p class="small"><?php echo e(isset($data[0]->companyName) ? $data[0]->companyName : '-'); ?> &emsp; |
                            &emsp; <?php echo e(isset($data[0]->positionName) ? $data[0]->positionName : '-'); ?></p>
                        <p class="small">
                            <?php echo e(isset($data[0]->companyEmailAddress) ? $data[0]->companyEmailAddress : '-'); ?> &emsp; |
                            &emsp; <?php echo e(isset($data[0]->personalHandphone) ? $data[0]->personalHandphone : '-'); ?></p>
                    </div>
                </div>
            </div>
        </form>
        <div class="div-title">
            <a href="<?php echo e(url('personnel/competency')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('personel_competency.list_detail')); ?></span>
            </a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <button type="button" class="btn btn-primary" name="btn-add-formal-education"
                                ...
                                <i class="fa fa-plus"></i> <?php echo e(__('personel_competency.btn_add')); ?>
                        ...
                        <div class="col-3">
                            <button type="button" class="btn btn-danger" name="btn-remove-formal-education"
                                ...
                                <i class="fa fa-times"></i> <?php echo e(__('personel_competency.btn_remove')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_formal_education')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="formal_education_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_formal_education"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                    <input type="text" class="form-control" id="seq_no_formal_education"
                                        name="seq_no_formal_education"
                                        placeholder="<?php echo e(__('personel_competency.label_seq_no')); ?>" readonly>
                                </div>
                                <input type="hidden" class="form-control" id="employee_no_formal_education"
                                    name="employee_no_formal_education" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="education"><?php echo e(__('personel_competency.label_education')); ?></label>
                                    <select class="form-control" id="education" name="education">
                                        <option value=""><?php echo e(__('personel_competency.label_select_education')); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="institution"><?php echo e(__('personel_competency.label_institution')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="major"><?php echo e(__('personel_competency.label_major')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="education_status"><?php echo e(__('personel_competency.label_education_status')); ?></label>
                                    <select class="form-control" id="education_status" name="education_status">
                                        <option value=""><?php echo e(__('personel_competency.label_select_education_status')); ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="graduate_year"><?php echo e(__('personel_competency.label_graduate_year')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="graduate_year" name="graduate_year"
                                            placeholder="<?php echo e(__('personel_competency.label_graduate_year')); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="title"><?php echo e(__('personel_competency.label_title')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="city"><?php echo e(__('personel_competency.label_city')); ?></label>
                                    <select class="form-control select2" id="city" name="city"></select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="gpa"><?php echo e(__('personel_competency.label_gpa')); ?></label>
                                    <input type="text" class="form-control" id="gpa" name="gpa"
                                        placeholder="<?php echo e(__('personel_competency.label_gpa')); ?>">
                                </div>
                            </div>
                        </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="submit" id="btn-save-formal-education" class="btn btn-primary w-25"><i
                        ...
                        <?php echo e(__('personel_competency.btn_save')); ?></button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> <?php echo e(__('personel_competency.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal_add_language"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_language')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="language_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="seq_no_language"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_language"
                                    name="employee_no_language" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="language"><?php echo e(__('personel_competency.label_language')); ?></label>
                                    <select class="form-control" id="language" name="language">
                                        <option value=""><?php echo e(__('personel_competency.label_select_language')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="read"><?php echo e(__('personel_competency.label_read')); ?></label>
                                    <select class="form-control" id="read" name="read">
                                        <option value=""><?php echo e(__('personel_competency.label_select_read')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="speak"><?php echo e(__('personel_competency.label_speak')); ?></label>
                                    <select class="form-control" id="speak" name="speak">
                                        <option value=""><?php echo e(__('personel_competency.label_select_speak')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="write"><?php echo e(__('personel_competency.label_write')); ?></label>
                                    <select class="form-control" id="write" name="write">
                                        <option value=""><?php echo e(__('personel_competency.label_select_write')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal_add_organization" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_organization')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="organization_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_organization"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_organization"
                                    name="employee_no_organization" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="organization_name"><?php echo e(__('personel_competency.label_organization_name')); ?></label>
                                    <input type="text" class="form-control" id="organization_name"
                                        name="organization_name"
                                        placeholder="<?php echo e(__('personel_competency.label_organization_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="position_organization"><?php echo e(__('personel_competency.label_position')); ?></label>
                                    <input type="text" class="form-control" id="position_organization"
                                        name="position_organization"
                                        placeholder="<?php echo e(__('personel_competency.label_position')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="organization_start_date"><?php echo e(__('personel_competency.label_start_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="organization_start_date"
                                            name="organization_start_date"
                                            placeholder="<?php echo e(__('personel_competency.label_start_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="organization_end_date"><?php echo e(__('personel_competency.label_end_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="organization_end_date"
                                            name="organization_end_date"
                                            placeholder="<?php echo e(__('personel_competency.label_end_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="modal_add_reference"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_reference')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="reference_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="seq_no_reference"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_reference"
                                    name="employee_no_reference" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="reference_name"><?php echo e(__('personel_competency.label_reference_name')); ?></label>
                                    <input type="text" class="form-control" id="reference_name" name="reference_name"
                                        placeholder="<?php echo e(__('personel_competency.label_reference_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="phone_number"><?php echo e(__('personel_competency.label_phone_number')); ?></label>
                                    <input type="text" class="form-control" id="phone_number" name="phone_number"
                                        placeholder="<?php echo e(__('personel_competency.label_phone_number')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="company_name"><?php echo e(__('personel_competency.label_company_name')); ?></label>
                                    <input type="text" class="form-control" id="company_name" name="company_name"
                                        placeholder="<?php echo e(__('personel_competency.label_company_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="remarks_reference"><?php echo e(__('personel_competency.label_remarks')); ?></label>
                                    <input type="text" class="form-control" id="remarks_reference"
                                        name="remarks_reference"
                                        placeholder="<?php echo e(__('personel_competency.label_remarks')); ?>">
                                </div>
                            </div>
                        </div>
                </div>
    ...
    <div class="modal fade" id="modal_add_skill"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_skill')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="skill_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="seq_no_skill"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_skill"
                                    name="employee_no_skill" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="skill"><?php echo e(__('personel_competency.label_skill')); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="description_skill"><?php echo e(__('personel_competency.label_description')); ?></label>
                                    <input type="text" class="form-control" id="description_skill"
                                        name="description_skill"
                                        placeholder="<?php echo e(__('personel_competency.label_description')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="proficiency"><?php echo e(__('personel_competency.label_proficiency')); ?></label>
                                    <select class="form-control" id="proficiency" name="proficiency">
                                        <option value=""><?php echo e(__('personel_competency.label_select_proficiency')); ?>
    ...
    <div class="modal fade" id="modal_add_project_experience" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_project_experience')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="project_experience_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_project_experience"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_project_experience"
                                    name="employee_no_project_experience" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="client"><?php echo e(__('personel_competency.label_client')); ?></label>
                                    <input type="text" class="form-control" id="client" name="client"
                                        placeholder="<?php echo e(__('personel_competency.label_client')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="position_project_experience"><?php echo e(__('personel_competency.label_position')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="location"><?php echo e(__('personel_competency.label_location')); ?></label>
                                    <input type="text" class="form-control" id="location" name="location"
                                        placeholder="<?php echo e(__('personel_competency.label_location')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="description_project_experience"><?php echo e(__('personel_competency.label_description')); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="project_experience_start_date"><?php echo e(__('personel_competency.label_start_date')); ?></label>
                                    <div class='input-group'>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="project_experience_end_date"><?php echo e(__('personel_competency.label_end_date')); ?></label>
                                    <div class='input-group'>
    ...
    <div class="modal fade" id="modal_add_training_list" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('personel_competency.title_modal_training_list')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="training_list_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="seq_no_training_list"><?php echo e(__('personel_competency.label_seq_no')); ?></label>
                                ...
                                <input type="hidden" class="form-control" id="employee_no_training_list"
                                    name="employee_no_training_list" value="<?php echo e($data[0]->employeeNo); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="training_name"><?php echo e(__('personel_competency.label_training_name')); ?></label>
                                    <input type="text" class="form-control" id="training_name" name="training_name"
                                        placeholder="<?php echo e(__('personel_competency.label_training_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="organizer"><?php echo e(__('personel_competency.label_organizer')); ?></label>
                                    <input type="text" class="form-control" id="organizer" name="organizer"
                                        placeholder="<?php echo e(__('personel_competency.label_organizer')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="training_list_start_date"><?php echo e(__('personel_competency.label_start_date')); ?></label>
                                    <div class='input-group'>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="training_list_end_date"><?php echo e(__('personel_competency.label_end_date')); ?></label>
                                    <div class='input-group'>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="certificate_name"><?php echo e(__('personel_competency.label_certificate_name')); ?></label>
                                    <input type="text" class="form-control" id="certificate_name"
                                        name="certificate_name"
                                        placeholder="<?php echo e(__('personel_competency.label_certificate_name')); ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="certificate_no"><?php echo e(__('personel_competency.label_certificate_no')); ?></label>
                                    <input type="text" class="form-control" id="certificate_no" name="certificate_no"
                                        placeholder="<?php echo e(__('personel_competency.label_certificate_no')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="certificate_date"><?php echo e(__('personel_competency.label_certificate_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="certificate_date"
                                            name="certificate_date"
                                            placeholder="<?php echo e(__('personel_competency.label_certificate_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="expired_date"><?php echo e(__('personel_competency.label_expired_date')); ?></label>
                                    <div class='input-group'>
                                        <input type="text" class="form-control" id="expired_date" name="expired_date"
                                            placeholder="<?php echo e(__('personel_competency.label_expired_date')); ?>">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label
                                        for="certificate_description"><?php echo e(__('personel_competency.label_certificate_description')); ?></label>
                                    <textarea rows="3" class="form-control" id="certificate_description"
                                        name="certificate_description"
                                        placeholder="<?php echo e(__('personel_competency.label_certificate_description')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="certificate_attachment"><?php echo e(__('personel_competency.label_certificate_attachment')); ?></label>
                                    ...
                                    <small id="certificate_attachment_help" class="text-muted">
                                        <?php echo e(__('personel_competency.help_certificate_attachment')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('personel_competency.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        load_table_formal_education('<?php echo e($data[0]->employeeNo); ?>');
        ...
        function load_table_formal_education(employeeNo = '') {
            table = $('#formal_education_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/formal_education/table')); ?>",
                    data: {
        ...
        function load_table_language(employeeNo = '') {
            table = $('#language_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/language/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_organization(employeeNo = '') {
            table = $('#organization_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/organization/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_reference(employeeNo = '') {
            table = $('#reference_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/reference/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_skill(employeeNo = '') {
            table = $('#skill_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/skill/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_project_experience(employeeNo = '') {
            table = $('#project_experience_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/project_experience/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        function load_table_training_list(employeeNo = '') {
            table = $('#training_list_data_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url: "<?php echo e(url('personnel/competency/training_list/table')); ?>",
                    data: {
                        'employeeNo': employeeNo
                    }
                },
        ...
        $.get("<?php echo e(url('proficiency/api')); ?>", function (data) {
        ...
        $.get("<?php echo e(url('education/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $.get("<?php echo e(url('education_status/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $.get("<?php echo e(url('language/api')); ?>", function (data) {
            $.each(data, function (k, v) {
        ...
        $("#btn-remove-formal-education").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/formal_education/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-language").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/language/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-organization").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/organization/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-reference").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/reference/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-skill").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/skill/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-project-experience").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/project_experience/remove')); ?>",
                    type: "GET",
                    data: {
                        'data': data
                    },
        ...
        $("#btn-remove-training-list").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "<?php echo e(url('personnel/competency/training_list/remove')); ?>",
                    type: "POST",
                    data: {
                        'data': data
                    },
        ...
        function loadDataInstitution() {
            ...
            $('#institution').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/institution/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        if ($("#employee_profile_form").length > 0) {
            $("#employee_profile_form").validate({
                ...
                messages: {
                    photo_profile: {
                        extension: "<?php echo e(__('personel_performance.photo_profile_extension')); ?>",
                    },
                },
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('personnel/competency')); ?>";
                                }, 3000);
                            } else {
                                $('#notification_error').modal('show');
                                if (response.message == null || response.message ==
        ...
        if ($("#formal_education_form").length > 0) {
            $("#formal_education_form").validate({
                ...
                messages: {
                    seq_no_formal_education: {
                        required: "<?php echo e(__('personel_competency.seq_no_required')); ?>",
                    },
                    education: {
                        required: "<?php echo e(__('personel_competency.education_required')); ?>",
                    },
                    institution: {
                        required: "<?php echo e(__('personel_competency.institution_required')); ?>",
                    },
                    major: {
                        required: "<?php echo e(__('personel_competency.major_required')); ?>",
                    },
                    education_status: {
                        required: "<?php echo e(__('personel_competency.education_status_required')); ?>",
                    },
                    graduate_year: {
                        required: "<?php echo e(__('personel_competency.graduate_year_required')); ?>",
                    },
                    title: {
                        required: "<?php echo e(__('personel_competency.title_required')); ?>",
                    },
                    city: {
                        required: "<?php echo e(__('personel_competency.city_required')); ?>",
                    },
                    gpa: {
                        required: "<?php echo e(__('personel_competency.gpa_required')); ?>",
                    },
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-save-formal-education").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("personel_competency.btn_save")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/formal_education/proses')); ?>",
                        type: "POST",
        ...
        if ($("#language_form").length > 0) {
            $("#language_form").validate({
                ...
                messages: {
                    ...
                    language: {
                        required: "<?php echo e(__('personel_competency.language_required')); ?>",
                    },
                    read: {
                        required: "<?php echo e(__('personel_competency.read_required')); ?>",
                    },
                    speak: {
                        required: "<?php echo e(__('personel_competency.speak_required')); ?>",
                    },
                    write: {
                        required: "<?php echo e(__('personel_competency.write_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/language/proses')); ?>",
                        type: "POST",
        ...
        if ($("#organization_form").length > 0) {
            $("#organization_form").validate({
                ...
                messages: {
                    ...
                    organization_name: {
                        required: "<?php echo e(__('personel_competency.organization_name_required')); ?>",
                    },
                    position_organization: {
                        required: "<?php echo e(__('personel_competency.position_required')); ?>",
                    },
                    organization_start_date: {
                        required: "<?php echo e(__('personel_competency.start_date_required')); ?>",
                    },
                    organization_end_date: {
                        required: "<?php echo e(__('personel_competency.end_date_required')); ?>",
                        greaterThan: "A",
                    },
                },
                highlight: function (element) {
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/organization/proses')); ?>",
                        type: "POST",
        ...
        if ($("#reference_form").length > 0) {
            $("#reference_form").validate({
                ...
                messages: {
                    ...
                    reference_name: {
                        required: "<?php echo e(__('personel_competency.reference_name_required')); ?>",
                    },
                    phone_number: {
                        required: "<?php echo e(__('personel_competency.phone_number_required')); ?>",
                    },
                    company_name: {
                        required: "<?php echo e(__('personel_competency.company_name_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/reference/proses')); ?>",
                        type: "POST",
        ...
        if ($("#skill_form").length > 0) {
            $("#skill_form").validate({
                ...
                messages: {
                    ...
                    skill: {
                        required: "<?php echo e(__('personel_competency.skill_required')); ?>",
                    },
                    proficiency: {
                        required: "<?php echo e(__('personel_competency.proficiency_required')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/skill/proses')); ?>",
                        type: "POST",
        ...
        if ($("#project_experience_form").length > 0) {
            $("#project_experience_form").validate({
                ...
                messages: {
                    ...
                    client: {
                        required: "<?php echo e(__('personel_competency.client_required')); ?>",
                    },
                    position_project_experience: {
                        required: "<?php echo e(__('personel_competency.position_required')); ?>",
                    },
                    location: {
                        required: "<?php echo e(__('personel_competency.location_required')); ?>",
                    },
                    project_experience_start_date: {
                        required: "<?php echo e(__('personel_competency.start_date_required')); ?>",
                    },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/project_experience/proses')); ?>",
                        type: "POST",
        ...
        if ($("#training_list_form").length > 0) {
            $("#training_list_form").validate({
                ...
                messages: {
                    ...
                    training_name: {
                        required: "<?php echo e(__('personel_competency.training_name_required')); ?>",
                    },
                    organizer: {
                        required: "<?php echo e(__('personel_competency.organizer_required')); ?>",
                    },
                    training_list_start_date: {
                        required: "<?php echo e(__('personel_competency.start_date_required')); ?>",
                    },
                    ...
                    certificate_name: {
                        required: "<?php echo e(__('personel_competency.certificate_name_required')); ?>",
                    },
                    certificate_no: {
                        required: "<?php echo e(__('personel_competency.certificate_no_required')); ?>",
                    },
                    certificate_date: {
                        required: "<?php echo e(__('personel_competency.certificate_date_required')); ?>",
                    },
                    expired_date: {
                        required: "<?php echo e(__('personel_competency.expired_date_required')); ?>",
                    },
                    certificate_attachment: {
                        extension: "<?php echo e(__('personel_competency.certificate_attachment_extension')); ?>",
                    },
                },
                highlight: function (element) {
                    $(element).addClass('is-invalid');
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('personnel/competency/training_list/proses')); ?>",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formdata,
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_competency_detail.blade.php ENDPATH**/ ?>