...
<html>
<head>
    <title><?php echo e(__('payroll_annual_report.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="annual_report_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('payroll_annual_report.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="year form-check-label"><?php echo e(__('payroll_annual_report.label_year')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <input type="text" class="form-control" id="year" name="year"
                                placeholder="<?php echo e(__('payroll_annual_report.label_year')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_name form-check-label"><?php echo e(__('payroll_annual_report.label_report_name')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-5">
                        <input type="text" class="form-control" id="report_name_det" name="report_name_det" placeholder="<?php echo e(__('payroll_annual_report.label_report_name')); ?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_status form-check-label"><?php echo e(__('payroll_annual_report.label_report_status')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="detail_status" name="report_status" value="detail" checked>
                            <label for="detail_status"><?php echo e(__('payroll_annual_report.label_detail')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="annualy_status" name="report_status" value="annualy">
                            <label for="annualy_status"><?php echo e(__('payroll_annual_report.label_annualy')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row" id="div_report_type">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_type form-check-label"><?php echo e(__('payroll_annual_report.label_report_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="detail_type" name="report_type" value="detail" checked>
                            <label for="detail_type"><?php echo e(__('payroll_annual_report.label_detail')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="summary_type" name="report_type" value="summary">
                            <label for="summary_type"><?php echo e(__('payroll_annual_report.label_summary')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_annual_report.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_annual_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_annual_report.label_group_authorized_code')); ?> <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_annual_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_annual_report.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_annual_report.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_annual_report.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_annual_report.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3 desc" id="btn-send-to" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_annual_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_annual_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/annual_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/annual_report/print')); ?>",
                            type: "POST",
                            data: $('#annual_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_annual_report.blade.php ENDPATH**/ ?>