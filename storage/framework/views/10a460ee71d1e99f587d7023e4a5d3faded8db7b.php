...
<html>
<head>
    <title><?php echo e(__('data_employee_master.judul_employee_group_member')); ?></title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('data_employee_group.judul_employee_group_member')); ?></span>
            </a>
        </div>
        <form id="md_employee_group" method="post">
            ...
            <div class="card-header">
                <h5><?php echo e(__('data_employee_group.judul_employee_group_member')); ?></h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_code form-check-label"><b><?php echo e(__('data_employee_group.formgroupname1')); ?></b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_name form-check-label"><b><?php echo e(__('data_employee_group.formgroupname2')); ?></b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="exampletwo form-check-label"><b><?php echo e(__('data_employee_group_detail.judul2')); ?></b></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        onClick="window.location.reload();" value="preview" style="width: 100%;">
                            <i class="fa fa-times"></i> <?php echo e(__('admin_main_menu_news_master.cancel')); ?>
...
<script>
   ...
   $('#btn-list').click(()=> {
        ...
        table2 = $('#example').DataTable({
            ...
            orderCellsTop: true,
            ajax: {
                url : "<?php echo e(url('master_data/list_detail/table')); ?>"             
            },
    ...
    $('#group_code').blur(function () {
        if($(this).val() != null && $(this).val() != ''){
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/master_data/detail/get')); ?>",
                data: {
                    'groupCode': $(this).val()
                }
            }).then(function (data) {
                ...
                arrApproval = data[0].member;
                load_data_approval_table();
            });
        }
    });

    load_data_approval_detail();

    function load_data_approval_detail(){
        table4 = $('#examplethree').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: {
                url : "<?php echo e(url('master_data/employee_group_detail/get')); ?>"             
            },
            error: function(jqXHR, ajaxOptions, thrownError) {
                alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
            },
    ...
    const klikk = (element) => {
        ...
        // console.log($(element).parent().closest('tr'));
        ...
        if ($("#md_employee_group").length > 0) {
                $("#md_employee_group").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('master_data/employee_group_detail/proses')); ?>",
                            type: "POST",
                            ...
                            success: function (response) {
                                if (response.status == "true"){
                                    ...
                                    setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('master_data/employee_group_detail')); ?>";
                                    }, 3000);
                                } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/master_data/master_data_employee_group_detail.blade.php ENDPATH**/ ?>