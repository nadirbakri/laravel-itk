...
<body>
    <div class="div-personel">
        ...
        <div class="div-title">
            <a href="<?php echo e(route('personnel', ['moduleID' => 'PE'])); ?>" target="iframe_dashboard">
                <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                <span class="title-text"><?php echo e(__('personel_work_detail.list')); ?></span>
            </a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#work_detail_table').DataTable({
            ...
            serverSide: true,
            orderCellsTop: true,
            ajax: "<?php echo e(url('personnel/work_detail/table')); ?>",
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('personnel/work_detail')); ?>";
        })

        $("#toolbar-edit").on('click', function () {
            var data = table.rows('.selected').data();
            if (data.count() > 0) {
                $.redirect("<?php echo e(url('personnel/work_detail/detail_data')); ?>", {
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_work_detail.blade.php ENDPATH**/ ?>