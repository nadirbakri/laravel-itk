...
<html>
<head>
    <title><?php echo e(__('payroll_severance_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_severance_report.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="report_type form-check-label"><?php echo e(__('payroll_severance_report.label_report_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="report" name="report_type" value="report" checked>
                            <label for="report"><?php echo e(__('payroll_severance_report.label_report')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="slip" name="report_type" value="slip">
                            <label for="slip"><?php echo e(__('payroll_severance_report.label_slip')); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="payment_date_from form-check-label"><?php echo e(__('payroll_severance_report.label_payment_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="payment_date_from" name="payment_date_from"
                                placeholder="<?php echo e(__('payroll_severance_report.label_payment_date')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="payment_date_to form-check-label"><?php echo e(__('payroll_severance_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_severance_report.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_severance_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_from form-check-label"><?php echo e(__('payroll_severance_report.label_group_authorized')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_to form-check-label"><?php echo e(__('payroll_severance_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_severance_report.btn_preview')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_severance_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/severance_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/severance_report/print')); ?>",
                            type: "POST",
                            data: $('#severance_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_severance_report.blade.php ENDPATH**/ ?>