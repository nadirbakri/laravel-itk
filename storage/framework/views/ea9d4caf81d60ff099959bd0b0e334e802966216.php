	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('personel_grade_code.list')); ?></span>
			</a>
		</div>

		<div class="div-table">
			<table id="grade_code_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>Grade Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.div-navbar a.disabled').attr('onclick', 'return false;');
  	...
  	$('#grade_code_table thead tr').clone(true).appendTo('#grade_code_table thead');
    $('#grade_code_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#grade_code_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "<?php echo e(url('personnel/grade/table')); ?>",
    ...
    function load_data_grade_code() {
        table = $('#grade_code_table').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: "<?php echo e(url('personnel/grade/table')); ?>",
    ...
    $('#grade_code_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#grade_code_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('personnel/grade/detail_data')); ?>", { 'gradeCode' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('personnel/grade/detail_data')); ?>", { 'gradeCode' : data[0].gradeCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('personnel/grade/status')); ?>",
                type: "GET",
                ...
                success: function(response) {
                    ...
                    var oTable = $('#grade_code_table').dataTable();
                    oTable.fnDraw(false);
                },
    ...
    $('#grade_code_table tbody').on('click', 'tr td:not(:first-child)', function () {
    	...
    	$.redirect("<?php echo e(url('personnel/grade/detail_data')); ?>", { 'gradeCode' : data.gradeCode, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_grade_code.blade.php ENDPATH**/ ?>