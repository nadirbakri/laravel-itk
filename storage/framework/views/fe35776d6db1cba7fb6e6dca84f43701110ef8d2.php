...
<html>
<head>
    <title><?php echo e(__('trans_reimbursement.judul')); ?></title>
            ...
            <div class="div-trans-medical">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('trans_reimbursement.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('trans_reimbursement.label_claim_date_start')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('trans_reimbursement.label_claim_date_start')); ?>">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('trans_reimbursement.label_claim_date_end')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('trans_reimbursement.label_claim_date_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><?php echo e(__('trans_reimbursement.label_reimbursement_type')); ?></label>
                        </div>
                        <select class="form-control select2" id="reimbursement_type" name="reimbursement_type[]"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label"><?php echo e(__('trans_reimbursement.label_business_unit')); ?></label>
                        </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                                <label for="direct_superior form-check-label"><?php echo e(__('trans_reimbursement.employee')); ?></label>
                        </div>
                                <input type="text" class="form-control" id="direct_superior" name="direct_superior" placeholder="<?php echo e(__('trans_reimbursement.employee')); ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <i class="fa fa-search"></i> <?php echo e(__('trans_reimbursement.btn_search')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-upload"></i> <?php echo e(__('trans_reimbursement.btn_upload')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-list"></i> <?php echo e(__('trans_reimbursement.btn_list')); ?>
...
<br>
                ...
                <div class="row">
                    <div class="col-6">
                        <p><b> <?php echo e(__('trans_reimbursement.list_table')); ?></b></p>
                    </div>
                </div>
                <div class="row">
                    <div class="table-responsive">
                        <table id="medical_table" class="display table-striped table-hover dt-responsive display nowrap" cellspacing="10">
                            <thead>
                                <tr>
                                    <th><?php echo e(__('trans_reimbursement.detail')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.receiptdate')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.status')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.ticketno')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.name')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.cname')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.pname')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.pdate')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.treq')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.premarks')); ?></th>
                                    <th><?php echo e(__('trans_reimbursement.tpaid')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script type="text/javascript">
    function load_data_medical_history(claim_date_from, claim_date_to, direct_superior, reimbursement_type, business_unit) {
            table = $('#medical_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url : "<?php echo e(url('trans/reimbursement/table')); ?>",
                    data: {
...
if ($("#upload_paid_overtime_form").length > 0) {
    $("#upload_paid_overtime_form").validate({
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "<?php echo e(url('transaction/update_reimbursement/import')); ?>",
                type: "POST",
                processData: false,
                contentType: false,
                data: formdata,
...
<script type="text/javascript">
    ...
    loadDataFirstLastAllBusinessUnit();
        ...
        $.get("<?php echo e(url('reimbursement_type/reimbursement/api')); ?>", function (data) {
        ...
        $.get("<?php echo e(url('level/api')); ?>", function (data) {      
            ...
            function loadDataExportReimbrusement(){
                ...
                $('#reimbursement_type').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(url('/reimbursement_type/reimbursement/api')); ?>",
                        dataType: 'json',
                        delay: 250,
                        type: "GET",
            ...
            function loadDataFirstLastAllReimbursement () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/reimbursement_type/reimbursement/func/api')); ?>",
                }).then(function (data) {
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/transaction/trc_trans_reimbursement.blade.php ENDPATH**/ ?>