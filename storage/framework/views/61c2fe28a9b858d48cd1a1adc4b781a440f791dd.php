...
<head>
    <title><?php echo e(__('personel_employee_dependents.judul')); ?></title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="<?php echo e(url('/personnel')); ?>" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text"><?php echo e(__('personel_employee_dependents.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="employee_dependents_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('personel_employee_dependents.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('personel_employee_dependents.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('personel_employee_dependents.label_period')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('personel_employee_dependents.label_period')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('personel_employee_dependents.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="include_medical">&nbsp;</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="include_medical" 
                                    id="include_medical" value="true">
                                <label class="form-check-label" 
                                    for="include_medical"><?php echo e(__('personel_employee_dependents.label_include_medical')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="include_payroll">&nbsp;</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="include_payroll" 
                                    id="include_payroll" value="true">
                                <label class="form-check-label" 
                                    for="include_payroll"><?php echo e(__('personel_employee_dependents.label_include_payroll')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('personel_employee_dependents.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('personel_employee_dependents.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('personel_employee_dependents.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('personel_employee_dependents.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('personel_employee_dependents.label_location')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('personel_employee_dependents.btn_print')); ?>
            ...
            $("#employee_dependents_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('personnel/employee_dependents/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/personel/personel_employee_dependents.blade.php ENDPATH**/ ?>