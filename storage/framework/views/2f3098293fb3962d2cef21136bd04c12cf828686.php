...
<html>
<head>
    <title><?php echo e(__('tm_monthly_absenteeism_analysis.judul')); ?></title>
        ...
        <div class="div-form">
            <form id="monthly_absenteeism_analysis_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from"><?php echo e(__('tm_monthly_absenteeism_analysis.label_employee_no_from')); ?></label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to"><?php echo e(__('tm_monthly_absenteeism_analysis.label_employee_no_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('tm_monthly_absenteeism_analysis.label_period')); ?></label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('tm_monthly_absenteeism_analysis.label_period')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign"><?php echo e(__('tm_monthly_absenteeism_analysis.label_include_resign')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from"><?php echo e(__('tm_monthly_absenteeism_analysis.label_group_authorize_from')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to"><?php echo e(__('tm_monthly_absenteeism_analysis.label_group_authorize_to')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position"><?php echo e(__('tm_monthly_absenteeism_analysis.label_position')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking"><?php echo e(__('tm_monthly_absenteeism_analysis.label_ranking')); ?></label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location"><?php echo e(__('tm_monthly_absenteeism_analysis.label_location')); ?></label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('tm_monthly_absenteeism_analysis.btn_print')); ?>
...
// buat ALL
        ...
        $("#btn-print-data").click(function () {
            ...
            $("#monthly_absenteeism_analysis_form").submit();
        });
            ...
            $("#monthly_absenteeism_analysis_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('time_management/monthly_absenteeism_analysis/print')); ?>",
                        type: "POST",
                        data: $('#monthly_absenteeism_analysis_form').serialize(),
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_monthly_absenteeism_analysis.blade.php ENDPATH**/ ?>