...
<html>
<head>
    <title><?php echo e(__('payroll_thr_data_entry.judul')); ?></title>
    ...
    <div class="div-payroll">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID('<?php echo e(url()->previous()); ?>')" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('payroll_thr_data_entry.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="thr_data_entry_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no"><?php echo e(__('payroll_thr_data_entry.label_employee_no')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_name"><?php echo e(__('payroll_thr_data_entry.label_employee_name')); ?></label>
                            <input type="text" class="form-control" id="employee_name" name="employee_name"
                                placeholder="<?php echo e(__('payroll_thr_data_entry.label_employee_name')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="entry_type"><?php echo e(__('payroll_thr_data_entry.label_entry_type')); ?></label>
                            <span class="required">*</span>
                            <select class="form-control select2" id="entry_type" name="entry_type">
                                <option value="" disabled selected><?php echo e(__('payroll_thr_data_entry.label_select_entry_type')); ?></option>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="performance_result"><?php echo e(__('payroll_thr_data_entry.label_performance_result')); ?></label>
                            <span class="required">*</span>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="service_month"><?php echo e(__('payroll_thr_data_entry.label_service_month')); ?></label>
                            <span class="required">*</span>
                            <input type="number" class="form-control" id="service_month" name="service_month"
                                placeholder="<?php echo e(__('payroll_thr_data_entry.label_service_month')); ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="payment_date"><?php echo e(__('payroll_thr_data_entry.label_payment_date')); ?></label>
                            <span class="required">*</span>
                            <div class="input-group">
                                <input type="text" class="form-control" id="payment_date" name="payment_date"
                                    placeholder="<?php echo e(__('payroll_thr_data_entry.label_payment_date')); ?>">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="currency_code"><?php echo e(__('payroll_thr_data_entry.label_currency_code')); ?></label>
                            <span class="required">*</span>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="nominal"><?php echo e(__('payroll_thr_data_entry.label_nominal')); ?></label>
                            <input type="number" class="form-control" id="nominal" name="nominal"
                                placeholder="<?php echo e(__('payroll_thr_data_entry.label_nominal')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('payroll_thr_data_entry.btn_save')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('payroll/thr_data_entry')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('payroll_thr_data_entry.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_thr_data_entry.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/performance_result/bonus_thr_data_entry/api')); ?>",
                data: {
        ...
        function loadDataPerformanceResult(){
            ...
            $('#performance_result').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/performance_result/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        if ($("#thr_data_entry_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    employee_no: {
                        required: "<?php echo e(__('payroll_thr_data_entry.field_mandatory')); ?>",
                    },
                    leave_code: {
                        required: "<?php echo e(__('payroll_thr_data_entry.field_mandatory')); ?>",
                    },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/thr_bonus_data_entry/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/thr_data_entry')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_thr_data_entry_detail.blade.php ENDPATH**/ ?>