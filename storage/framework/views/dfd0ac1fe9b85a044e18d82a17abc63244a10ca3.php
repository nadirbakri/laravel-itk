...
<html lang="en">
<head>
    <title><?php echo e(__('tm_time_recording_reference.judul')); ?></title>
    ...
    <div class="div-time_management">
        <div class="div-navbar sticky-navbar">
            ...
            <a class="list-functionbar-md" href="javascript:void(0)" style="display: none;" id="toolbar-cancel">
                <img src="<?php echo e(url('/icons/functionbar/x.svg')); ?>" alt="Cancel">
                <img src="<?php echo e(url('/icons/functionbar/x.svg')); ?>" class="functionbar-hover"
                    alt="Cancel">
                <span>Cancel</span>
            </a>
        ...
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_time_recording_reference.list')); ?></span>
            </a> 
        </div>
        <div class="div-form">
            <form id="time_recording_reference_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="in_code"><?php echo e(__('tm_time_recording_reference.label_in_code')); ?></label>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label for="out_code"><?php echo e(__('tm_time_recording_reference.label_out_code')); ?></label>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="time_in_record"><?php echo e(__('tm_time_recording_reference.label_time_in_record')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label"
                                    for="time_in_record_earliest"><?php echo e(__('tm_time_recording_reference.label_earliest')); ?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="time_in_record_latest"
                                    name="radiobtn1" value="L">
                                <label class="form-check-label"
                                    for="time_in_record_latest"><?php echo e(__('tm_time_recording_reference.label_latest')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="time_out_record"><?php echo e(__('tm_time_recording_reference.label_time_out_record')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label"
                                    for="time_out_record_earliest"><?php echo e(__('tm_time_recording_reference.label_earliest')); ?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="time_out_record_latest"
                                    name="radiobtn2" value="L" checked>
                                <label class="form-check-label"
                                    for="time_out_record_latest"><?php echo e(__('tm_time_recording_reference.label_latest')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_time_recording_reference.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script text="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?php echo e(url('/time_management/time_recording_reference/table')); ?>",
            type: "GET",
        ...
        if ($("#time_recording_reference_form").length > 0) {
            $("#time_recording_reference_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/time_recording_reference/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('time_management/time_recording_reference')); ?>";
                                }, 3000);
                            } else {
                                $("#toolbar-save").prop("disabled", false);
                                $("#toolbar-save").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/time_management/tm_time_recording_reference.blade.php ENDPATH**/ ?>