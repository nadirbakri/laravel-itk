        ...
        <form id="md_employee_group" method="post">
            ...
            <div class="card" >
                <div class="card-header">
                    <h5><?php echo e(__('data_employee_group.judul_employee_group_permit')); ?></h5>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
...
<script>
 $('#btn-add2').click(()=> {
    ...
    const klikemail = (element) => {
        ...
        let groupname = $(element).parent().siblings('td').eq(1).text().replace("\u00A0", " ");
        // console.log(appCode);
        $('.close').click();
        table5.row.add({
            'no' : '<input class="chk-select" type="checkbox">',
        ...
        if ($("#md_employee_group").length > 0) {
                $("#md_employee_group").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('master_data/employee_group/proses')); ?>",
                            type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/master_data/master_data_employee_group.blade.php ENDPATH**/ ?>