...
<html>
<head>
    <title><?php echo e(__('payroll_csv_espt_report_form.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_csv_espt_report_form.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="periodical"><?php echo e(__('payroll_csv_espt_report_form.label_format')); ?></label>
                            <div class="form-check">
                                <input type="radio" id="periodical" name="format" value="periodical" checked>
                                <label for="periodical"><?php echo e(__('payroll_csv_espt_report_form.label_periodical')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label for="annual"><?php echo e(__('payroll_csv_espt_report_form.label_annual')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label for="final"><?php echo e(__('payroll_csv_espt_report_form.label_final')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="period"><?php echo e(__('payroll_csv_espt_report_form.label_period')); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="<?php echo e(__('payroll_csv_espt_report_form.label_period')); ?>">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="rectification"><?php echo e(__('payroll_csv_espt_report_form.label_rectification')); ?></label>
                            <input type="number" class="form-control" id="rectification" name="rectification"
                                placeholder="<?php echo e(__('payroll_csv_espt_report_form.label_rectification')); ?>" value="0">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="npwp_group"><?php echo e(__('payroll_csv_espt_report_form.label_npwp_group')); ?></label>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="print_date"><?php echo e(__('payroll_csv_espt_report_form.label_print_date')); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="print_date" name="print_date"
                                    placeholder="<?php echo e(__('payroll_csv_espt_report_form.label_print_date')); ?>">
                                <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_csv_espt_report_form.label_group_authorized_code_from')); ?></label>
                            <span style="color: red">*</span>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_csv_espt_report_form.label_group_authorized_code_to')); ?></label>
                            <span style="color: red">*</span>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-export" id="btn-export" value="export" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_csv_espt_report_form.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_csv_espt_report_form.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function loadDataPeriodMonth() {
            var listPeriodMonth = [
                { id: '1', text: "<?php echo e(__('payroll_csv_espt_report_form.period_1')); ?>" },
                { id: '2', text: "<?php echo e(__('payroll_csv_espt_report_form.period_2')); ?>" },
                { id: '3', text: "<?php echo e(__('payroll_csv_espt_report_form.period_3')); ?>" },
                { id: '4', text: "<?php echo e(__('payroll_csv_espt_report_form.period_4')); ?>" },
                { id: '5', text: "<?php echo e(__('payroll_csv_espt_report_form.period_5')); ?>" },
                { id: '6', text: "<?php echo e(__('payroll_csv_espt_report_form.period_6')); ?>" },
                { id: '7', text: "<?php echo e(__('payroll_csv_espt_report_form.period_7')); ?>" },
                { id: '8', text: "<?php echo e(__('payroll_csv_espt_report_form.period_8')); ?>" },
                { id: '9', text: "<?php echo e(__('payroll_csv_espt_report_form.period_9')); ?>" },
                { id: '10', text: "<?php echo e(__('payroll_csv_espt_report_form.period_10')); ?>" },
                { id: '11', text: "<?php echo e(__('payroll_csv_espt_report_form.period_11')); ?>" },
                { id: '12', text: "<?php echo e(__('payroll_csv_espt_report_form.period_12')); ?>" }
            ];
        ...
        if ($("#csv_espt_report_form_form").length > 0) {
            $("#csv_espt_report_form_form").validate({
                ...
                messages: {
                    npwp_group: {
                        required: "<?php echo e(__('payroll_csv_espt_report_form.npwp_group_required')); ?>",
                    },
                    group_authorized_code_from: {
                        required: "<?php echo e(__('payroll_csv_espt_report_form.group_authorized_code_from_required')); ?>",
                    },
                    group_authorized_code_to: {
                        required: "<?php echo e(__('payroll_csv_espt_report_form.group_authorized_code_to_required')); ?>",
                    }
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('payroll/csv_espt_report_form/print/excel')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_csv_espt_report_form.blade.php ENDPATH**/ ?>