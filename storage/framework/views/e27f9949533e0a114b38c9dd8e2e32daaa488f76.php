...
<head>
    <title><?php echo e(__('tm_leave_transaction_by_employee_no.judul')); ?></title>
    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('tm_leave_transaction_by_employee_no.list')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="leave_transaction_by_employee_no_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no"><?php echo e(__('tm_leave_transaction_by_employee_no.label_employee_no')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_name"><?php echo e(__('tm_leave_transaction_by_employee_no.label_employee_name')); ?></label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="employee_name" name="employee_name"
                                placeholder=<?php echo e(__('tm_leave_transaction_by_employee_no.label_employee_name')); ?> disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="leave_code"><?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_code')); ?></label>
                            <span class="required">*</span>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="balance"><?php echo e(__('tm_leave_transaction_by_employee_no.label_balance')); ?></label>
                            <input type="text" class="form-control" id="balance" name="balance"
                                placeholder=<?php echo e(__('tm_leave_transaction_by_employee_no.label_balance')); ?> disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="leave_hour form-check-label"><?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_hour')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label"
                                    for="full_day"><?php echo e(__('tm_leave_transaction_by_employee_no.label_full_day')); ?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="half_day"
                                    name="radiobtn" value="H0">
                                <label class="form-check-label"
                                    for="half_day"><?php echo e(__('tm_leave_transaction_by_employee_no.label_half_day')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="leave_date_from"><?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_date_from')); ?></label>
                            <span class="required">*</span>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="leave_date_from" name="leave_date_from"
                                    placeholder="<?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_date_from')); ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="leave_date_to"><?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_date_to')); ?></label>
                            <span class="required">*</span>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="leave_date_to" name="leave_date_to"
                                    placeholder="<?php echo e(__('tm_leave_transaction_by_employee_no.label_leave_date_to')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('tm_leave_transaction_by_employee_no.btn_save')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('tm_leave_transaction_by_employee_no.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        balance.on("select2:select", function (e) {
            ...
            if (data.length > 0 && data2.length > 0) {
                $.ajax({
                url: "<?php echo e(url('time_management/balance/detail')); ?>",
                type: "GET",
                data: {
        ...
        function loadDataLeaveCode() {
            ...
            $('#leave_code').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/leave_code/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
                    data: function (params) {
        ...
        if ($("#leave_transaction_by_employee_no_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    employee_no: {
                        required: "<?php echo e(__('tm_leave_transaction_by_employee_no.field_mandatory')); ?>",
                    },
                    leave_code: {
                        required: "<?php echo e(__('tm_leave_transaction_by_employee_no.field_mandatory')); ?>",
                    },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('time_management/leave_transaction/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('time_management/leave_transaction_by_employee_no')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
</html><?php /**PATH D:\File Kerja\Front End\laravel_project_azure\resources\views/time_management/tm_leave_transaction_by_employee_no.blade.php ENDPATH**/ ?>