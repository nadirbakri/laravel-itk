    ...
    <div class="div-utilities">
        ...
        <div class="div-title">
            <a href="<?php echo e(url('utilities')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('utilities_user_access_group.list')); ?></span>
            </a>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('utilities_user_access_group.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var table = $('#user_access_group_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "<?php echo e(url('utilities/group_user_access/table')); ?>",
    ...
    $('#user_access_group_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#user_access_group_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("<?php echo e(url('utilities/group_user_access/detail_data')); ?>", { 'groupAccessID' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("<?php echo e(url('utilities/group_user_access/detail_data')); ?>", { 'groupAccessID' : data[0].groupAccessID, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $("#toolbar-active").on('click', function() {
        ...
        if(data.count() > 0){
            $.ajax({
                url: "<?php echo e(url('utilities/group_user_access/status')); ?>",
                type: "GET",
    ...
    $('#user_access_group_table tbody').on('click', 'tr td:not(:first-child)', function () {
        ...
        $.redirect("<?php echo e(url('utilities/group_user_access/detail_data')); ?>", { 'groupAccessID' : data.groupAccessID, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
    
  });
</script>

</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_user_access_group.blade.php ENDPATH**/ ?>