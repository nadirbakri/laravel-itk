...
<html>
<head>
    <title><?php echo e(__('export_overtime.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="export_overtime_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-export-overtime">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('export_overtime.list')); ?></span>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('export_overtime.label_claim_date')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('export_overtime.label_claim_start')); ?>">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('export_overtime.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('export_overtime.label_claim_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="reimbursement_type"><?php echo e(__('export_overtime.label_reimbursement_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit"><?php echo e(__('export_overtime.label_business_unit')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> <?php echo e(__('export_overtime.btn_export')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('export_overtime.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
loadDataFirstLastAllBusinessUnit();
    ...
    $.get("<?php echo e(url('reimbursement_type/overtime/api')); ?>", function (data) {
        ...
        function loadDataExportOvertime(){
            ...
            $('#reimbursement_type').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/reimbursement_type/overtime/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
            ...
            $("#export_overtime_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('export/export_overtime/print')); ?>",
                        type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/export/exp_export_overtime.blade.php ENDPATH**/ ?>