...
<head>
    <title><?php echo e(__('utilities_company_master.judul')); ?></title>
    ...
    <div class="div-utilities">
        <div class="div-title">
            <a href="<?php echo e(url('utilities/company')); ?>" target="iframe_dashboard">
                ...
                <span class="title-text"><?php echo e(__('utilities_company_master.list_detail')); ?></span>
            </a>
        </div>
        <div class="div-form">
            <form id="company_master_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="record_status"><?php echo e(__('utilities_company_master.label_record_status')); ?></label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="<?php echo e(__('utilities_company_master.label_record_status')); ?>" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="company_code"><?php echo e(__('utilities_company_master.label_company_code')); ?></label>
                            <input type="text" class="form-control" id="company_code" name="company_code"
                                placeholder="<?php echo e(__('utilities_company_master.label_company_code')); ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="company_name"><?php echo e(__('utilities_company_master.label_company_name')); ?></label>
                            <input type="text" class="form-control" id="company_name" name="company_name"
                                placeholder="<?php echo e(__('utilities_company_master.label_company_name')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="npwp_no"><?php echo e(__('utilities_company_master.label_npwp_no')); ?></label>
                            <input type="text" class="form-control" id="npwp_no"
                                name="npwp_no"
                                placeholder="<?php echo e(__('utilities_company_master.label_npwp_no')); ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="holding_company"><?php echo e(__('utilities_company_master.label_holding_company')); ?></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="location_code"><?php echo e(__('utilities_company_master.label_location_code')); ?></label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="address"><?php echo e(__('utilities_company_master.label_address')); ?></label>
                            <textarea rows="3" class="form-control" id="address"
                                    name="address"
                                    placeholder="<?php echo e(__('utilities_company_master.label_address')); ?>"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> <?php echo e(__('utilities_company_master.btn_save')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="<?php echo e(url('utilities/company')); ?>" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> <?php echo e(__('utilities_company_master.btn_cancel')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('utilities_company_master.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $('#company_code').val("<?php echo e(isset($data[0]->companyCode) ? $data[0]->companyCode : ''); ?>");
            $('#company_name').val(htmlDecode(
                "<?php echo e(isset($data[0]->companyName) ? $data[0]->companyName : ''); ?>"));
            $('#npwp_no').val(htmlDecode(
                "<?php echo e(isset($data[0]->npwpNo) ? $data[0]->npwpNo : ''); ?>"));
            $('#address').val(htmlDecode(
                "<?php echo e(isset($data[0]->address) ? $data[0]->address : ''); ?>"));
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('/holding_company/detail/api')); ?>",
                data: {
                    'companyCode': "<?php echo e(isset($data[0]->holdingCompany) ? $data[0]->holdingCompany : ''); ?>"
                }
            }).then(function (data) {
            ...
            $.ajax({
                ...
                data: {
                    'locationCode': "<?php echo e(isset($data[0]->locationCode) ? $data[0]->locationCode : ''); ?>"
                }
            }).then(function (data) {
                // var option = new Option(data.positionCode, data.positionCode, true, true);
                var option = $('<option/>', {
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "<?php echo e(url('utilities/company')); ?>";
        });
        ...
        function loadDataHoldingCompany() {
            ...
            $('#holding_company').select2({
                ...
                ajax: {
                    url: "<?php echo e(url('/holding_company/api')); ?>",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        if ($("#company_master_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    company_code: {
                        required: "<?php echo e(__('utilities_company_master.company_code_required')); ?>",
                    },
                    company_name: {
                        required: "<?php echo e(__('utilities_company_master.company_name_required')); ?>",
                    },
                    holding_company: {
                        required: "<?php echo e(__('utilities_company_master.holding_company_required')); ?>",
                    },
                    location_code: {
                        required: "<?php echo e(__('utilities_company_master.location_code_required')); ?>",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('utilities/company/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('utilities/company')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
...
<?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/utilities/utilities_company_master_detail.blade.php ENDPATH**/ ?>