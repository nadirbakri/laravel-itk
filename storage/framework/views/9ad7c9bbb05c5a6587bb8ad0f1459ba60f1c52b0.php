...
<html>
<head>
    <title><?php echo e(__('trans_transport.judul')); ?></title>
            ...
            <div class="div-trans-medical">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('trans_transport.judul')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label"><?php echo e(__('trans_transport.label_claim_date_start')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="<?php echo e(__('trans_transport.label_claim_date_start')); ?>">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label"><?php echo e(__('trans_transport.label_claim_date_end')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="<?php echo e(__('trans_transport.label_claim_date_end')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><?php echo e(__('trans_transport.label_transport_type')); ?></label>
                        </div>
                        <select class="form-control select2" id="reimbursement_type" name="reimbursement_type"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label"><?php echo e(__('trans_transport.label_business_unit')); ?></label>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="processed_date form-check-label"><?php echo e(__('trans_transport.label_processed_date')); ?></label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="processed_date" name="processed_date"
                                placeholder="<?php echo e(__('trans_transport.label_processed_date')); ?>">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i><?php echo e(__('trans_transport.btn_upload')); ?>
                    ...
                    <div class="col-3">
                        ...
                        <i class="fa fa-plus"></i> <?php echo e(__('trans_transport.btn_list')); ?>
...
<br>
                ...
                <div class="row">
                    <div class="col-6">
                        <p><b><?php echo e(__('trans_transport.list_table')); ?></b></p>
                    </div>
                </div>
                <div class="row">
                    <div class="table-responsive">
                        <table id="medical_table" class="display table-striped table-hover dt-responsive display nowrap" cellspacing="10">
                            <thead>
                                <tr>
                                        <th><?php echo e(__('trans_transport.detail')); ?></th>
                                        <th><?php echo e(__('trans_transport.rdate')); ?></th>
                                        <th><?php echo e(__('trans_transport.status')); ?></th>
                                        <th><?php echo e(__('trans_transport.tnom')); ?></th>
                                        <th><?php echo e(__('trans_transport.name')); ?></th>
                                        <th><?php echo e(__('trans_transport.type')); ?></th>
                                        <th><?php echo e(__('trans_transport.cname')); ?></th>
                                        <th><?php echo e(__('trans_transport.sloc')); ?></th>
                                        <th><?php echo e(__('trans_transport.eloc')); ?></th>
                                        <th><?php echo e(__('trans_transport.treq')); ?></th>
                                        <th><?php echo e(__('trans_transport.tpaid')); ?></th>
                                        <th><?php echo e(__('trans_transport.remarks')); ?></th>
                                        <th><?php echo e(__('trans_transport.parking')); ?></th>
                                        <th><?php echo e(__('trans_transport.tol')); ?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
        ...
        <div class="modal fade" id="modal_list_mass_leave">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                ...
                <div class="modal-header">
                    <h4 class="modal-little"><?php echo e(__('trans_transport.luser')); ?></h4>
                ...
                <div class="modal-body table-responsive">
                    <table id="example" class="display">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo e(__('trans_transport.employee')); ?></th>
                                <th><?php echo e(__('trans_transport.fname')); ?></th>
                                <th><?php echo e(__('trans_transport.division')); ?></th>
                                <th><?php echo e(__('trans_transport.ranking')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
    ...
    <div class="modal fade" id="modal_list_detail">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-little"><?php echo e(__('trans_transport.dtransport')); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row detailstatus">
                            <div class="col-3  ">
                                <h5><?php echo e(__('trans_transport.reqdate')); ?></h5>
                            </div>
                            <div class="col-3">
                                <input id="reqdate" name="reqdate" type="hidden" class="form-control" readonly><span id="reqdate_val"></span>
                            </div>
                            <div class="col-3">
                                <h5><?php echo e(__('trans_transport.rdate')); ?></h5>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="row detailstatus">
                            <div class="col-3">
                                <h5><?php echo e(__('trans_transport.label_business_unit')); ?></h5>
                            </div>
                            <div class="col-3">
                                <input id="b_unit" name="b_unit" type="hidden" class="form-control" readonly><span id="b_unit_val"></span>
                            </div>
                            <div class="col-3">
                                <h5><?php echo e(__('trans_transport.type')); ?></h5>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="row approve">
                            ...
                            <div class="col-5">
                                    <select name="reimbursement_status" id="reimbursement_status" class="custom-select">
                                        <option value="APPROVED"><?php echo e(__('trans_transport.approve')); ?></option>
                                        <option value="REJECTED"><?php echo e(__('trans_transport.reject')); ?></option>
                                        <option value="PAID"><?php echo e(__('trans_transport.paid')); ?></option>
                                    </select>
                            </div>
                        </div>
                        <div class="row approve">
                            <div class="col-3">
                                <h5><?php echo e(__('trans_transport.tpaid')); ?></h5>
                            </div>
                            <div class="col-5">
                        ...
                        <div class="row approve">
                            <div class="col-3">
                                <h5><?php echo e(__('trans_transport.remarks')); ?></h5>
                            </div>
                            <div class="col-5">
                        ...
                        <hr>
                        <button class="btn btn-primary btn-block" id="btn-update" type="button"><?php echo e(__('trans_transport.update')); ?></button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <form id="upload_paid_overtime_form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="modal_upload">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                   <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-little"><?php echo e(__('trans_transport.upaid')); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body table-responsive">
                        <div class="card">
                            <div class="col-5">
                                <div class="form-group">
                                    <label for="medical_history form-check-label"><b><?php echo e(__('trans_transport.ftransport')); ?></b></label>
                                    ...
                                    <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                                        <?php echo e(__('trans_transport.btn_upload')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('trans_transport.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    function load_data_medical_history(claim_date_from, claim_date_to, direct_superior, reimbursement_type, business_unit,processed_date) {
        // console.log(claim_date_from)
            table = $('#medical_table').DataTable({
                ...
                orderCellsTop: true,
                ajax: {
                    url : "<?php echo e(url('trans/transport/table')); ?>",
                    data: {
...
<script>
    ...
    function update_data(reimbursement_status, totalpaid, ticketNo,direct_superior,approvalremarks){
        $.ajax({
            url: "<?php echo e(url('trans/update_transport/table')); ?>",
            type: "get",
            data: {
            ...
            success: function (response) {
                        if (response.status == "true") {
                            ...
                            setTimeout(function () {
                                window.location =
                                    "<?php echo e(url('transaction/transaction_transport')); ?>";
                            }, 3000);
                        } else{
                        $("#btn-update").prop("disabled", false);
                        $("#btn-update").html(
...
$('#notification_success').on('hide.bs.modal', function () {
    window.location = "<?php echo e(url('transaction/transaction_transport')); ?>";
});
...
if ($("#upload_paid_overtime_form").length > 0) {
    $("#upload_paid_overtime_form").validate({
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "<?php echo e(url('transaction/update_transport/import')); ?>",
                type: "POST",
                processData: false,
                contentType: false,
                data: formdata,
...
<script type="text/javascript">
    ...
    loadDataFirstLastAllBusinessUnit();
            ...
            $.get("<?php echo e(url('reimbursement_type/transport/api')); ?>", function (data) {
            ...
            function loadDataExportReimbrusement(){
                ...
                $('#reimbursement_type').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(url('/reimbursement_type/transport/api')); ?>",
                        dataType: 'json',
                        delay: 250,
                        type: "GET",
            ...
            function loadDataFirstLastAllReimbursement () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('/reimbursement_type/transport/func/api')); ?>",
                }).then(function (data) {
 ...
 </html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/transaction/trc_trans_transport.blade.php ENDPATH**/ ?>