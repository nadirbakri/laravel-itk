...
<html>
<head>
    <title><?php echo e(__('payroll_spt_pph_report.judul')); ?></title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        ...
                        <span class="title-text"><?php echo e(__('payroll_spt_pph_report.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="spt_type form-check-label"><?php echo e(__('payroll_spt_pph_report.label_spt_type')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="type_pph_1721i" name="spt_type" value="pph_1721i" checked>
                            <label for="type_pph_1721i"><?php echo e(__('payroll_spt_pph_report.label_pph_1721i')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="type_pph_1721a1" name="spt_type" value="pph_1721a1">
                            <label for="type_pph_1721a1"><?php echo e(__('payroll_spt_pph_report.label_pph_1721a1')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row" id="div_report_format">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="report_format form-check-label"><?php echo e(__('payroll_spt_pph_report.label_report_format')); ?></label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="format_periodical" name="report_format" value="periodical" checked>
                            <label for="format_periodical"><?php echo e(__('payroll_spt_pph_report.label_periodical')); ?></label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="format_annual" name="report_format" value="annual">
                            <label for="format_annual"><?php echo e(__('payroll_spt_pph_report.label_annual')); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row" id="div_employee_no">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_spt_pph_report.label_employee_no')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_spt_pph_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row" id="div_period">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="period form-check-label"><?php echo e(__('payroll_spt_pph_report.label_period')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="npwp_group form-check-label"><?php echo e(__('payroll_spt_pph_report.label_npwp_group')); ?></label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label"><?php echo e(__('payroll_spt_pph_report.label_group_authorized_code')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label"><?php echo e(__('payroll_spt_pph_report.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_spt_pph_report.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <button class="btn btn-primary" id="btn-send-to" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_spt_pph_report.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_spt_pph_report.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/spt_pph_report/print/excel')); ?>",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('payroll/spt_pph_report/print')); ?>",
                            type: "POST",
                            data: $('#spt_pph_report_form').serialize(),
                            success: function(result, status, xhr){
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_spt_pph_report.blade.php ENDPATH**/ ?>