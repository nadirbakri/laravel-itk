...
<html>
<head>
    <title><?php echo e(__('payroll_signature_list.judul')); ?></title>
...
<body>
    <div class="div-form">
        <form id="signature_list_form" method="post">
            <?php echo csrf_field(); ?>
            <div class="div-payroll">
                <div class="div-title">
                    <a href="<?php echo e(url()->previous()); ?>" target="iframe_dashboard">
                        <img src="<?php echo e(url('/pictures/arrow-square-left.png')); ?>" alt="Back">
                        <span class="title-text"><?php echo e(__('payroll_signature_list.list')); ?></span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label"><?php echo e(__('payroll_signature_list.label_employee_no')); ?></label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label"><?php echo e(__('payroll_signature_list.label_to')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label"><?php echo e(__('payroll_signature_list.label_position')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label"><?php echo e(__('payroll_signature_list.label_ranking')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label"><?php echo e(__('payroll_signature_list.label_location')); ?></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-preview" id="btn-preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> <?php echo e(__('payroll_signature_list.btn_preview')); ?>

                        </button>
                    </div>
                    <div class="col-3">
                        <button class="btn btn-primary" id="btn-send-to" style="width: 100%;">
                            <i class="fa fa-print"></i> <?php echo e(__('payroll_signature_list.btn_send_to')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_signature_list.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if($('#signature_list_form').length > 0){
            $('#signature_list_form').validate({
                submitHandler: function(form){
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('payroll/signature_list/print')); ?>",
                        type: "POST",
                        data: $('#signature_list_form').serialize(),
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_signature_list.blade.php ENDPATH**/ ?>