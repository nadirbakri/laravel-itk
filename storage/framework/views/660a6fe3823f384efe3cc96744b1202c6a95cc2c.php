...
<html>
<head>
	<title><?php echo e(__('payroll_bonus_data_entry.judul')); ?></title>
	...
	<div class="div-payroll">
        ...
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text"><?php echo e(__('payroll_bonus_data_entry.list')); ?></span>
			</a>
		</div>
        <div class="div-table">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('payroll_bonus_data_entry.list')); ?></h5>
                ...
                <div class="modal-body">
                    <form id="bonus_data_entry_process_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="process_type"><?php echo e(__('payroll_bonus_data_entry.label_process_type')); ?></label>
                                    <select class="form-control select2" id="process_type" name="process_type">
                                        <option value="" disabled selected><?php echo e(__('payroll_bonus_data_entry.label_select_process_type')); ?></option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="bonus_cut_off_date"><?php echo e(__('payroll_bonus_data_entry.label_bonus_cut_off_date')); ?></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="bonus_cut_off_date" name="bonus_cut_off_date"
                                            placeholder="<?php echo e(__('payroll_bonus_data_entry.label_bonus_cut_off_date')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="service_month_rounded"><?php echo e(__('payroll_bonus_data_entry.label_service_month_rounded')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group" style="margin-bottom: 1px">
                                    <label for="greater_than"><?php echo e(__('payroll_bonus_data_entry.label_greater_than')); ?></label>
                                </div>
                                <div class="form-group" style="display: flex">
                                    <input type="number" min=0 max=30 class="form-control" style="width: 50%" id="greater_than" name="greater_than"
                                        placeholder=<?php echo e(__('payroll_bonus_data_entry.label_greater_than')); ?>>
                                    <label for="days" style="margin: auto"><?php echo e(__('payroll_bonus_data_entry.label_days_become_one_month')); ?></label>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="submit" class="btn btn-process w-25" name="btn-process" id="btn-process">
                        <i class="fa fa-play-circle-o"></i> <?php echo e(__('payroll_bonus_data_entry.btn_process')); ?>

                    </button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                        class="fa fa-times-circle"></i> <?php echo e(__('payroll_bonus_data_entry.btn_cancel')); ?></button>
                </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification"><?php echo e(__('payroll_bonus_data_entry.alert_success')); ?></span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        function load_data_table_bonus_data_entry() {
            table = $('#bonus_data_entry_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "<?php echo e(url('payroll/bonus_data_entry/table')); ?>",
        ...
        $("#toolbar-new").on('click', function() {
            $.redirect("<?php echo e(url('payroll/bonus_data_entry/detail_data')); ?>", 
            { 
                'employeeNo' : null,
                'func' : 'new' 
            }, 
        ...
        if ($("#bonus_data_entry_process_form").length > 0) {
            $("#bonus_data_entry_process_form").validate({
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-process").html(
                        '<i class="fa fa-floppy-o"></i> <?php echo e(__("payroll_bonus_data_entry.btn_process")); ?>'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('payroll/bonus_data_entry_proses/proses')); ?>",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "<?php echo e(url('payroll/bonus_data_entry')); ?>";
                                }, 3000);
                            } else {
                                $("#btn-process").prop("disabled", false);
                                $("#btn-process").html(
...
</html><?php /**PATH C:\xampp\htdocs\laravel_project\resources\views/payroll/py_bonus_data_entry.blade.php ENDPATH**/ ?>