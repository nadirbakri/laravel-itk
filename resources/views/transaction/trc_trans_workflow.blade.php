...
<script>
    ...
    const klikdetail = (element) => {
        ...
        if(type == "ER"){
            ...
            $('#start_date_permit_val').html(moment(data.permitDateFrom).format('YYYY-MM-DD'))
            $('#end_date_permit').html(data.permitDateTo)
            $('#end_date_permit_val').html(moment(data.permitDateTo).format('YYYY-MM-DD'))
            ...
            $('#start_date_leave_val').html(moment(data.leaveDateFrom).format('YYYY-MM-DD'))
            $('#end_date_leave').html(data.leaveDateTo)
            $('#end_date_leave_val').html(moment(data.leaveDateTo).format('YYYY-MM-DD'))
    ...
    function load_data_table_workflow_permit() {
        table = $('#permit_table').DataTable({
            ...
            columns: [
                ...
                {data: 'permitEntity.fullNameApprover', name: 'permitEntity.fullNameApprover'},
    ...
    function load_data_table_workflow_leave(){
        table2 = $('#leave_table').DataTable({
            ...
            columns: [
                ...
                {data: 'leaveEntity.fullNameApprover', name: 'leaveEntity.fullNameApprover'},
