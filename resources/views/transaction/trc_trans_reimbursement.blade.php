...
<body>
    <div class="div-form">
        <form id="trans_reimbursement_form" method="post">
            @csrf
            <div class="div-trans-reimbursement">
                <div class="div-title">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="processed_date form-check-label">{{ __('trans_reimbursement.label_processed_date') }}</label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="processed_date" name="processed_date"
                                placeholder="{{ __('trans_reimbursement.label_processed_date') }}">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label">{{ __('trans_reimbursement.label_bu') }}</label>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-upload" id="btn-upload" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-upload.svg') }}" alt="export"> {{ __('trans_reimbursement.btn_upload') }}
                        </button>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <p>{{ __('trans_reimbursement.list_table') }}</p>
                    </div>
                </div>
                <div class="div-table">
                    <table id="reimbursement_list_table" class="table hover">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Request Date</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('trans_reimbursement.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
