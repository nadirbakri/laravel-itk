...
<body>
    <div class="div-form">
        <form id="trans_attendance_form" method="post">
            @csrf
            <div class="div-trans-attendance">
                <div class="div-title">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="user_id form-check-label">{{ __('trans_attendance.label_user_id') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-search" id="btn-search" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-search.svg') }}" alt="search"> {{ __('trans_attendance.btn_search') }}
                        </button>
                    </div>
                    <div class="col-3">
