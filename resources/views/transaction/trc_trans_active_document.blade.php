...
<html>
<head>
    <title>{{ __('trans_active_document.judul') }}</title>
...
<body>
    <div class="div-form">
        <form id="trans_active_document_form" method="post">
            @csrf
            <div class="div-trans-active-document">
                <div class="div-title">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_from form-check-label">{{ __('trans_active_document.label_claim_date_start') }}</label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="{{ __('trans_active_document.label_claim_date_start') }}">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label">{{ __('trans_active_document.label_claim_date_end') }}</label>
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="{{ __('trans_active_document.label_claim_date_end') }}">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label">{{ __('trans_active_document.label_reimbursement_type') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label">{{ __('trans_active_document.label_bu') }}</label>
                        </div>
                        <select class="form-control select2" id="business_unit" name="business_unit"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="status form-check-label">{{ __('trans_active_document.label_status') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-search" id="btn-search" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-search.svg') }}" alt="export"> {{ __('trans_active_document.btn_search') }}
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('trans_active_document.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
