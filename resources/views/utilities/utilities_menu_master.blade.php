...
<body>
        ...
        <div class="div-form">
            <form id="menu_master_form" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="group_id">{{ __('utilities_menu_master.label_group_id') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="menu_title">{{ __('utilities_menu_master.label_menu_title') }}</label>
                            <input type="text" class="form-control" id="menu_title" name="menu_title"
                                placeholder="{{ __('utilities_menu_master.label_menu_title') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" name="btn-configure-menu" id="btn-configure-menu"
                            ...
                            {{ __('utilities_menu_master.btn_configure_menu') }}
                        </button>
                    </div>
                    <div class="col-4">
                        <button type="button" class="btn btn-primary" name="btn-copy-to-another-group"
                            ...
                            {{ __('utilities_menu_master.btn_copy_to_another_group') }}
                        </button>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('utilities_menu_master.btn_configure_menu') }}</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                <label for="module">{{ __('utilities_menu_master.label_module') }}</label>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> {{ __('utilities_menu_master.btn_cancel') }}</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="modal_copy_to_another_group"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('utilities_menu_master.btn_copy_to_another_group') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="copy_to_another_group_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>{{ __('utilities_menu_master.label_copy_from') }}</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_id_copy_from">{{ __('utilities_menu_master.label_group_id') }}</label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_name_copy_from">{{ __('utilities_menu_master.label_group_name') }}</label>
                                    <input type="text" class="form-control" id="group_name_copy_from"
                                        name="group_name_copy_from"
                                        placeholder="{{ __('utilities_menu_master.label_group_name') }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>{{ __('utilities_menu_master.label_copy_destination') }}</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_id_copy_destination">{{ __('utilities_menu_master.label_group_id') }}</label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="group_name_copy_destination">{{ __('utilities_menu_master.label_group_name') }}</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('utilities_menu_master.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
    ...
    $(document).ready(function () {
        ...
        if ($("#copy_to_another_group_form").length > 0) {
            $("#copy_to_another_group_form").validate({
                ...
                messages: {
                    group_id_copy_from: {
                        required: "{{ __('utilities_menu_master.group_id_required') }}",
                    },
                    group_id_copy_destination: {
                        required: "{{ __('utilities_menu_master.group_id_required') }}",
                    }
