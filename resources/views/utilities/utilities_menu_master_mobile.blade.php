...
<body>
	<div class="div-utilities">
		...
		<div class="div-table">
            <table id="menu_master_mobile_table" class="table hover">
                <thead>
                    <tr>
                        <th></th>
                        <th>Menu Name</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('#menu_master_mobile_table thead tr').clone(true).appendTo('#menu_master_mobile_table thead');
    $('#menu_master_mobile_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#menu_master_mobile_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('utilities/menu_master_mobile/table') }}",
    ...
    function load_data_menu_master_mobile() {
        table = $('#menu_master_mobile_table').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: "{{ url('utilities/menu_master_mobile/table') }}",
    ...
    $('#menu_master_mobile_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#menu_master_mobile_table').on('click', 'tr td:first-child', function(e){
    ...
    $("#toolbar-new").on('click', function() {
        $.redirect("{{ url('utilities/menu_master_mobile/detail_data') }}", { 'menuID' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
    });

    $("#toolbar-edit").on('click', function() {
        var data = table.rows('.selected').data();
        if(data.count() > 0){
            $.redirect("{{ url('utilities/menu_master_mobile/detail_data') }}", { 'menuID' : data[0].menuID, 'func' : 'edit' }, "GET", "iframe_dashboard");
        }else{
    ...
    $('#menu_master_mobile_table tbody').on('click', 'tr td:not(:first-child)', function () {
        var data = table.row(this).data();
        $.redirect("{{ url('utilities/menu_master_mobile/detail_data') }}", { 'menuID' : data.menuID, 'func' : 'edit' }, "GET", "iframe_dashboard");
    });
