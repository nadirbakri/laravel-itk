...
<head>
    <title>{{ __('utilities_process_user_id.judul') }}</title>
    ...
    <div class="div-utilities">
        <div class="div-title">
            <a href="{{ route('utilities', ['moduleID' => 'UTI']) }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('utilities_process_user_id.list') }}</span>
            </a>
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-process" id="btn-process"
                            style="width: 100%;">
                            <i class="fa fa-toggle-right"></i> {{ __('utilities_process_user_id.btn_process') }}
                        </button>
                    </div>
                </div>
            </form>
    ...
    $(document).ready(function () {
        ...
        if ($("#process_user_id_form").length > 0) {
            $("#process_user_id_form").validate({
                ...
                messages: {
                    employee_no_from: {
                        required: "{{ __('utilities_process_user_id.employee_no_from_required') }}",
                    },
                    employee_no_to: {
                        required: "{{ __('utilities_process_user_id.employee_no_to_required') }}",
                    },
                },
                ...
                errorPlacement: function (error, element) {
                    ...
                    $("#btn-process").html(
                        '<i class="fa fa-floppy-o"></i> {{ __("utilities_process_user_id.btn_process") }}'
                    );
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('utilities/process_user_id/proses') }}",
                        type: "POST",
