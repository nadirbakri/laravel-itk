...
<html>
<head>
    <title>{{ __('export_business_trip_checking.judul') }}</title>
            ...
            <div class="div-export-business-trip-checking">
                <div class="div-title">
                    <a href="{{ url('export') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('export_business_trip_checking.list') }}</span>
                    </a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="status form-check-label">User ID</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-export.svg') }}" alt="export"> {{ __('export_business_trip_checking.btn_export') }}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('export_business_trip_checking.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
            ...
            $("#export_business_trip_checking_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('export/business_trip_checking/print') }}",
                        type: "POST",
