        ...
        <form id="export_transport_form" method="post">
            ...
            <div class="div-export-transport">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="reimbursement_type">{{ __('export_transport.label_reimbursement_type') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit">{{ __('export_transport.label_business_unit') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-download"></i> {{ __('export_transport.btn_export') }}
                        </button>
                    </div>
                </div>
            </div>
