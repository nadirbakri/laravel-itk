        ...
        <form id="export_workflow_form" method="post">
            ...
            <div class="div-export-workflow">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label">{{ __('export_workflow.label_business_unit') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-export.svg') }}" alt="export"> {{ __('export_workflow.btn_export') }}
                        </button>
                    </div>
                </div>
            </div>
