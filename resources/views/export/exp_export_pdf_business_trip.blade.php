        ...
        <form id="export_pdf_business_trip_form" method="post">
            ...
            <div class="div-export-pdf-business-trip">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="travel_type form-check-label">{{ __('export_pdf_business_trip.label_travel_type') }}</label>
                        </div>
                        <select class="form-control select2" id="travel_type" name="travel_type"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label">{{ __('export_pdf_business_trip.label_business_unit') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-export.svg') }}" alt="export"> {{ __('export_pdf_business_trip.btn_export') }}
                        </button>
                    </div>
                </div>
            </div>
