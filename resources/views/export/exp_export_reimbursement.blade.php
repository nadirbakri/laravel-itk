        ...
        <form id="export_reimbursement_form" method="post">
            ...
            <div class="div-export-reimbursement">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="reimbursement_type">{{ __('export_reimbursement.label_reimbursement_type') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="business_unit">{{ __('export_reimbursement.label_business_unit') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
