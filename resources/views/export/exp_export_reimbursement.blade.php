...
<html>
<head>
    <title>{{ __('export_reimbursement.judul') }}</title>
            ...
            <div class="div-export-reimbursement">
                <div class="div-title">
                    <a href="{{ url('export') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('export_reimbursement.list') }}</span>
                    </a>
                </div>
                    ...
                    <div class="col-5">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="{{ __('export_reimbursement.label_claim_start') }}">
                    ...
                    <div class="col-5">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="{{ __('export_reimbursement.label_claim_end') }}">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label">{{ __('export_reimbursement.label_reimbursement_type') }}</label>
                        </div>
                        <select class="form-control select2" id="reimbursement_type" name="reimbursement_type"></select>
                    </div>
                    <div class="col-5">
                        <div class="form-group">
                            <label for="business_unit form-check-label">{{ __('export_reimbursement.label_business_unit') }}</label>
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <img src="{{ url('icons/mob/button/button-export.svg') }}" alt="export"> {{ __('export_reimbursement.btn_export') }}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('export_reimbursement.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
            ...
            $("#export_reimbursement_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('export/export_reimbursement/print') }}",
                        type: "POST",
