...
<html>
<head>
    <title>{{ __('data_employee_master.judul_employee_group_leave') }}</title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="{{ route('master_data', ['moduleID' => 'MOB']) }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('data_employee_group.judul_employee_group_leave') }}</span>
            </a>
        </div>
        <form id="md_employee_group" method="post">
            ...
            <div class="card-header">
                <h5>{{ __('data_employee_group.judul_employee_group_leave') }}</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
