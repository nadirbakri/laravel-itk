    ...
    <div class="div-form">
        ...
        <form id="bussines_trip_detail_form" method="post">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-10">
                    <table id="bussines_trip_detail_table" class="table table-bordered">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>User ID</th>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b>{{ __('bussines_trip_detail.formgroupname3') }}</b></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    {{ __('bussines_trip_detail.button') }}
                    </button>     
                    <button class="btn btn-primary" name="btn-save" id="btn-save" value="preview">
                    {{ __('bussines_trip_detail.button1') }}
                    </button>     
                    <button class="btn btn-primary" name="btn-save" id="btn-save" value="preview">
                    {{ __('bussines_trip_detail.button2') }}
                    </button>     
                </div>  
            </div>
        </form>
