...
<html>
<head>
    <title>{{ __('data_employee_master.judul_employee_group_business_trip') }}</title>
    ...
    <div class="div-form">
        <div class="div-title">
            <a href="{{ route('master_data', ['moduleID' => 'MOB']) }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('data_employee_group.judul_employee_group_business_trip') }}</span>
            </a>
        </div>
        <form id="md_employee_group" method="post">
            ...
            <div class="card" >
                <div class="card-header">
                    <h5>{{ __('data_employee_group.judul_employee_group_business_trip') }}</h5>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_code form-check-label"><b>{{ __('data_employee_group.formgroupname1') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_name form-check-label"><b>{{ __('data_employee_group.formgroupname2') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="exampletwo form-check-label"><b>{{ __('data_employee_group.formgroupname3') }}</b></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <button class="button btn btn-danger buttonadd" name="btn-delete" id="btn-delete" type="button">
...
{{-- nambah ini --}}
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="exampleemail form-check-label"><b>{{ __('data_employee_group_detail.formgroupname3') }}</b></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <button class="button btn btn-danger buttonadd" name="btn-delete2" id="btn-delete2" type="button">
                        <i class="fa fa-trash"></i>    
                    </button>
                    </div>
                </div> 
