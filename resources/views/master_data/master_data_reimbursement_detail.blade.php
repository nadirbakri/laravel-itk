...
<html>
<head>
    <title>{{ __('reimbursement_detail.head') }}</title>
...
<body>
    <div class="div-form">
        <div class="judul">
            <h1>{{ __('reimbursement_detail.judul') }}</h1>
            <hr>
        </div>
        <form id="trans_mass-leave_form" method="post">
            ...
            <div class="card" >
                ...
                {{ __('reimbursement_detail.judul2') }}
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b>{{ __('reimbursement_detail.formgroupname1') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b>{{ __('reimbursement_detail.formgroupname2') }}</b></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="reimbursement_type form-check-label"><b>{{ __('reimbursement_detail.formgroupname3') }}</b></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    {{ __('reimbursement_detail.button') }}
                    </button>     
                    <button class="btn btn-primary" name="btn-save" id="btn-save" value="preview">
                    {{ __('reimbursement_detail.button1') }}
                    </button>     
                    <button class="btn btn-primary" name="btn-save" id="btn-save" value="preview">
                    {{ __('reimbursement_detail.button2') }}
                    </button>     
                </div>  
            </div>
        </form>
