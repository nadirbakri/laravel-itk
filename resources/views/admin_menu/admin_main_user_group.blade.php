...
<html>
<head>
    <title>{{ __('admin_main_user_group.head') }}</title>
...
<body>
    <div class="div-form">
        <div class="judul">
            <h1>{{ __('admin_main_user_group.judul') }}</h1>
            <hr>
        </div>
        <form id="admin_main_user_group" method="post">
            @csrf
            <div class="card" >
                <div class="card-header">
                {{ __('admin_main_user.user_group') }}
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="record-status form-check-label"><b>{{ __('admin_main_user_group.record_status') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group-code form-check-label"><b>{{ __('admin_main_user_group.groupcode') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group-name form-check-label"><b>{{ __('admin_main_user_group.groupname') }}</b></label>
                        </div>
                    </div>
                    <div class="">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group-paidaccess form-check-label"><b>{{ __('admin_main_user_group.paidaccess') }}</b></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group-division form-check-label"><b>{{ __('admin_main_user_group.division') }}</b></label>
                        </div>
                    </div>
                </div>
                <div class="row">
