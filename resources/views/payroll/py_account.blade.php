	...
	<div class="div-payroll">
        <div class="div-navbar sticky-navbar">
            <a href="javascript:void(0)" style="display: none;" id="toolbar-back">
                ...
                <span>{{ __('py_account.label_back') }}</span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-next">
                ...
                <span>{{ __('py_account.label_next') }}</span>
            </a>
            <a href="javascript:void(0)" id="toolbar-new" target="iframe_dashboard">
                ...
                <span>{{ __('py_account.label_new') }}</span>
            </a>
            ...
            <a class="list-functionbar-md" href="javascript:void(0)" id="toolbar-active">
                ...
                <span>{{ __('py_account.label_activate') }}</span>
            </a>
            <a class="list-functionbar-lg" href="javascript:void(0)" id="toolbar-deactive">
                ...
                <span>{{ __('py_account.label_deactivate') }}</span>
            </a>
            <a href="javascript:void(0)" style="display: none;" id="toolbar-list">
                ...
                <span>{{ __('py_account.label_list') }}</span>
            </a>
        </div>
        <div class="div-title">
			<a href="{{ url('payroll') }}" target="iframe_dashboard">
				<img src="{{ url('/pictures/arrow-square-left.png') }}" alt="Back">
				<span class="title-text">{{ __('py_account.list') }}</span>
			</a>
		</div>
        ...
        <div class="div-table">
			<table id="account_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>{{ __('py_account.label_account_no') }}</th>
						<th>{{ __('py_account.label_account_description') }}</th>
                        <th>{{ __('py_account.label_reference') }}</th>
                        <th>{{ __('py_account.label_record_status') }}</th>
					</tr>
				</thead>
			</table>
		</div>
