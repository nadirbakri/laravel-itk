...
<body>
    <div class="div-form">
        <form id="spt_list_report_form" method="post">
            @csrf
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ route('payroll', ['moduleID' => 'PY']) }}" target="iframe_dashboard">
                        <img src="{{ url('/pictures/arrow-square-left.png') }}" alt="Back">
                        <span class="title-text">{{ __('payroll_spt_list_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="range_employee_no">{{ __('payroll_spt_list_report.label_range_employee_no') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label">{{ __('payroll_spt_list_report.label_employee_no') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('payroll_spt_list_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_npwp form-check-label">{{ __('payroll_spt_list_report.label_group_npwp') }}</label>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="form-check">
                            <input type="radio" id="all_npwp" name="group_npwp" value=false checked>
                            <label for="all_npwp">{{ __('payroll_spt_list_report.label_all_npwp') }}</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" id="by_npwp" name="group_npwp" value=true>
                            <label for="by_npwp">{{ __('payroll_spt_list_report.label_by_npwp') }}</label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> {{ __('payroll_spt_list_report.btn_preview') }}
                        </button>
                    </div>
                    <div class="col-3 desc" id="send-to-slip" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> {{ __('payroll_spt_list_report.btn_send_to') }}
                        </button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_spt_list_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if($('#spt_list_report_form').length > 0){
            $('#spt_list_report_form').validate({
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "{{ url('payroll/spt_list_report/print/excel') }}",
                            type: "POST",
                            data: $('#spt_list_report_form').serialize(),
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "{{ url('payroll/spt_list_report/print') }}",
                            type: "POST",
                            data: $('#spt_list_report_form').serialize(),
                            success: function(result, status, xhr){
                                $('#btn-send').prop("disabled", false);
