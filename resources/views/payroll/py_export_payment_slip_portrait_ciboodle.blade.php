...
<table style="width:100%; padding-left:1%; padding-right:1%;">
		<tr>
            <td width="30%" style="padding-top: 1%; font-size: 12px; text-align:left; font-family: 'Arial Alternates', sans-serif;">PT. CIBOODLE INDONESIA</td>
			@if($display_logo == "1")
            <td width="40%" rowspan="4">&nbsp;</td>
            <td width="30%" rowspan="4" style="text-align:right;">
				<!-- <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/pictures/logo_digima.png'))) }}" style="width: 145px; height: 45px" alt="Logo"> -->
			...
			@else
			<td width="70%" rowspan="4" style="text-align:right; height: 45px">&nbsp;</td>
			@endif
		</tr>
	</table>
