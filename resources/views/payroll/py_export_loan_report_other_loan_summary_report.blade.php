...
<html>
    ...
    <body>
        ...
        <h2 style="text-align:center; font-weight:bold;">OTHER LOAN SUMMARY REPORT</h2>
        ...
        <table class="table table-bordered table-hover responsive table_detail">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td style="border-bottom: 1px solid black; font-weight:bold; text-align:left; padding:4px;" colspan="7">&nbsp;</td>
                </tr>
                @if(isset($value))
                    <tr>
