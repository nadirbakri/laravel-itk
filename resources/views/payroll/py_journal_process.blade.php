...
<html>
<head>
	<title>{{ __('payroll_journal_process.judul') }}</title>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="period_process">{{ __('payroll_journal_process.label_period_process') }}</label>
                            <div class="input-group month">
                                <input type="text" class="form-control" id="period_process" name="period_process"
                                    placeholder="{{ __('payroll_journal_process.label_period_process') }}" readonly>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-process" name="btn-process" id="btn-process">
                            <i class="fa fa-play-circle-o"></i> {{ __('payroll_journal_process.btn_process') }}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_journal_process.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#monthly_closing_process_form").length > 0) {
            $("#monthly_closing_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('payroll/journal_process/proses') }}",
                        type: "POST",
