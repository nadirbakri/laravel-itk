...
<body>
    @if(count($data) > 0)
        ...
        <table>
            <thead>
                <tr>
                    <th colspan="3" style="font-size: 15px;"><b>DATA PESERTA DANA PENSIUN</b></th>
                </tr>
            </thead>
        </table>
        <br>
        ...
        <table style="border-collapse:collapse;">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 200px; vertical-align: center; text-align: center; border:1px solid #000;"><b>Iuran</b></th>
                    <th rowspan="2" style="width: 200px; vertical-align: center; text-align: center; border:1px solid #000;"><b>Total</b></th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-format="#,##0" style="text-align: right; border:1px solid #000; ">{{ $value->iuran }}</td>
                    <td data-format="#,##0" style="text-align: right; border:1px solid #000; ">{{ $value->total }}</td>
                </tr>
                @endforeach
                <tr>
                    <td colspan="6" style="border:1px solid #000; text-align: left;"><b>Total</b></td>
                    <td data-format="#,##0" style="text-align: right; border:1px solid #000;">{{ $data[0]->total }}</td>
                </tr>
            </tbody>
        </table>
        <br><br>
