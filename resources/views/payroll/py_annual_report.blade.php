...
<html>
<head>
    <title>{{ __('payroll_annual_report.judul') }}</title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ route('payroll', ['moduleID' => 'PY']) }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('payroll_annual_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <input type="text" class="form-control" id="report_name_det" name="report_name_det" placeholder="{{ __('payroll_annual_report.label_report_name') }}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="detail_status">{{ __('payroll_annual_report.label_detail') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="annualy_status" name="report_status" value="annualy">
                            <label for="annualy_status">{{ __('payroll_annual_report.label_annualy') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row" id="div_report_type">
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label for="detail_type">{{ __('payroll_annual_report.label_detail') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="summary_type" name="report_type" value="summary">
                            <label for="summary_type">{{ __('payroll_annual_report.label_summary') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('payroll_annual_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label">{{ __('payroll_annual_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_annual_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
