...
<body>
    ...
    <table class="table" style="width:100%; padding-left:5%; padding-right:17%; padding-bottom:1%; font-family: 'Arial Alternates', sans-serif;">
		<tr>
	...
	<table class="table" style="width:100%; padding-left:5%; padding-right:5%; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
		<tr>
			<td width="8%">Nama</td>
			<td width="1%">:</td>
			<td width="29%" style="padding-left: 10px;">{{ $value->employeeName }}</td>
            <td width="20%">&nbsp;</td>
			<td width="8%">No. Rekening</td>
			<td width="1%">:</td>
			<td width="29%" colspan="2">{{ $value->noRekening }}</td>
		</tr>
		<tr>
			<td width="8%">NIK</td>
			<td width="1%">:</td>
			<td width="29%" style="padding-left: 10px;">{{ $value->employeeNo }}</td>
            <td width="20%">&nbsp;</td>
	...
	<table class="table" style="width:100%; padding-left:5%; padding-right:6%; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
    	<tr>
            ...
            <td style="width:16.5%; vertical-align: top;">&nbsp;</td>
			<td style="width:40%; vertical-align: top;">
    	...
    	<tr>
        	<td style="width:40%; padding-top: 1%; padding-bottom: 1%; vertical-align: top;">
				<table style="width:100%; border-collapse: collapse;">
					...
					<tr>
						<td width="40%">TOTAL PENERIMAAN</td>
						<td width="3%">:</td>
                    ...
                    <tr>
						<td width="40%" style="font-weight: 700;">UPAH YANG DITERIMA</td>
			...
			<td style="width:40%; padding-top: 1%; padding-bottom: 1%; vertical-align: top;">
				<table style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
						<td width="40%">Diterima di rekening tgl</td>
						<td width="3%">:</td>
