...
<html>
<head>
	<title>{{ __('py_bonus_data_entry.judul') }}</title>
	...
	<div class="div-payroll">
        ...
        <div class="div-title">
			<a href="{{ url('payroll') }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('py_bonus_data_entry.list') }}</span>
			</a>
		</div>
        <div class="div-table">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('py_bonus_data_entry.list') }}</h5>
                ...
                <div class="modal-body">
                    <form id="bonus_data_entry_process_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="process_type">{{ __('py_bonus_data_entry.label_process_type') }}</label>
                                    <select class="form-control select2" id="process_type" name="process_type">
                                        <option value="" disabled selected>{{ __('py_bonus_data_entry.label_select_process_type') }}</option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="bonus_cut_off_date">{{ __('py_bonus_data_entry.label_bonus_cut_off_date') }}</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="bonus_cut_off_date" name="bonus_cut_off_date"
                                            placeholder="{{ __('py_bonus_data_entry.label_bonus_cut_off_date') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="service_month_rounded">{{ __('py_bonus_data_entry.label_service_month_rounded') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group" style="margin-bottom: 1px">
                                    <label for="greater_than">{{ __('py_bonus_data_entry.label_greater_than') }}</label>
                                </div>
                                <div class="form-group" style="display: flex">
                                    <input type="number" min=0 max=30 class="form-control" style="width: 50%" id="greater_than" name="greater_than"
                                        placeholder={{ __('py_bonus_data_entry.label_greater_than') }}>
                                    <label for="days" style="margin: auto">{{ __('py_bonus_data_entry.label_days_become_one_month') }}</label>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="btn-save" class="btn btn-primary w-25"><i 
                            class="fa fa-floppy-o"></i> {{ __('py_bonus_data_entry.btn_save') }}</button>
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i> {{ __('py_bonus_data_entry.btn_cancel') }}</button>
                </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#toolbar-delete").on('click', function () {
            ...
            if (data.length > 0) {
                $.ajax({
                    url: "{{ url('payroll/bonus_data_entry/remove') }}",
                    type: "GET",
                    data: {
                        'data' : data
                    },
