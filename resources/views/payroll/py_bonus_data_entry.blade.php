...
<body>
	<div class="div-payroll">
        <div class="div-navbar sticky-navbar">
            ...
            <a class="list-functionbar-md" href="javascript:void(0)" id="toolbar-process">
                <img src="{{ url('/icons/functionbar/functionbar-checklist-blue.svg') }}" alt="Process">
                <img src="{{ url('/icons/functionbar/functionbar-checklist-blue.svg') }}" class="functionbar-hover" alt="Process">
                <span>Process</span>
            </a>
        </div>
        <div class="div-title">
...
<script type="text/javascript">
    var table = null;
        ...
        $("#toolbar-new").on('click', function() {
            $.redirect("{{ url('payroll/bonus_data_entry/detail_data') }}", { 'employeeNo' : null, 'func' : 'new' }, "GET", "iframe_dashboard");
        });

        $("#toolbar-edit").on('click', function() {
            var data = table.rows('.selected').data();
            if(data.count() > 0){
                $.redirect("{{ url('payroll/bonus_data_entry/detail_data') }}", { 'employeeNo' : data[0].employeeNo, 'func' : 'edit' }, "GET", "iframe_dashboard");
            }else{
        ...
        $('#bonus_data_entry_table tbody').on('click', 'tr td:not(:first-child)', function () {
            ...
            $.redirect("{{ url('payroll/bonus_data_entry/detail_data') }}", { 'employeeNo' : data.employeeNo, 'func' : 'edit' }, "GET", "iframe_dashboard");
        });
</script>
