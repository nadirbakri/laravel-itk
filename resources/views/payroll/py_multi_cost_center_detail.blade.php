        ...
        <div class="div-form">
            <form id="multi_cost_center_form" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="{{ url('payroll/multi_cost_center') }}" target="iframe_dashboard"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#cost_center_table tbody').on('click', 'input[type="checkbox"]', function(e){
        ...
        $('#cost_center_table').on('click', 'tr td:first-child', function(e){
