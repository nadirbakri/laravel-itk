...
<body>
    ...
    <table class="table" style="width:70%; padding-left:1%; padding-right:1%; padding-bottom:1%; font-family: 'ArialCustomBold', sans-serif;">
		<tr>
			<td style="padding: 0; margin: 0; text-align:left; font-size: 14px; font-weight: 700;">
	...
	<br>
	<table class="table" style="width:70%; font-size: 12px; font-weight: 700; padding-left:1%; padding-right:1%; border-collapse: collapse; font-family: 'ArialCustomBold', sans-serif;">
		<tr>
			<td width="12%">Emp. No</td>
			<td width="1%">:</td>
			<td width="37%" style="padding-left: 10px;">{{ $value->employeeNo }} / {{ $value->employeeName }}</td>
			<td width="27%" style="padding-left: 100px;">Division</td>
			<td width="1%">:</td>
		...
		<tr>
			...
			<td width="1%">:</td>
			<td width="37%" style="padding-left: 10px;">{{ $value->noRekening }}</td>
			<td width="27%" style="padding-left: 100px;">Departemen</td>
			<td width="1%">:</td>
			<td width="22%" style="padding-left: 10px;">{{ $value->departemen }}</td>
		</tr>
		<tr>
			<td width="12%" style="border-bottom: 1px solid black;">Periode</td>
			<td width="1%" style="border-bottom: 1px solid black;">:</td>
			<td width="37%" style="padding-left: 10px; border-right: 1px solid black; border-bottom: 1px solid black;">{{ $periode }}</td>
			<td width="27%" style="padding-left: 100px; border-left: 1px solid black; border-bottom: 1px solid black;">Location</td>
			<td width="1%" style="border-bottom: 1px solid black;">:</td>
	...
	?>
	<table class="table" style="width:70%; font-size: 12px; padding-left:1%; padding-right:1%; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
    	<tr>
	...
	<table class="table" style="width:70%; font-size: 12px; font-weight: 700; padding-left:1%; padding-right:1%; border-collapse: collapse; font-family: 'ArialCustomBold', sans-serif;">
		<tr>
			...
			<td width="1%">:</td>
			<td width="87%" style="padding-left: 10px;">{{ $value->nik }}</td>
		</tr>
	</table>
