...
<html>
<head>
    <title>{{ __('payroll_spt_report.judul') }}</title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ url('/payroll') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('payroll_spt_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('payroll_spt_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_spt_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
