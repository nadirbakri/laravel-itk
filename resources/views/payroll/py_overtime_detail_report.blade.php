...
<body>
    <div class="div-personel">
        ...
        <div class="div-form">
            <form id="overtime_detail_report_form" method="post">
                @csrf
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="no_overtime"
                                    name="no_overtime" value="true">
                                <label
                                    for="no_overtime">{{ __('payroll_overtime_detail_report.label_no_overtime') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2 mt-4">
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="hide_tariff"
                                    name="hide_tariff" value="true">
                                <label
                                    for="hide_tariff">{{ __('payroll_overtime_detail_report.label_hide_tariff') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-2 mt-4">
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="order_by_name"
                                    name="order_by_name" value="true">
                                <label
                                    for="order_by_name">{{ __('payroll_overtime_detail_report.label_order_by_name') }}</label>
                            </div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="increment"
                                    name="increment" value="true">
                                <label
                                    for="increment">{{ __('payroll_overtime_detail_report.label_increment') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="group"
                                    name="group" value="true">
                                <label
                                    for="group">{{ __('payroll_overtime_detail_report.label_group') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('payroll_overtime_detail_report.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('payroll_overtime_detail_report.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('payroll_overtime_detail_report.label_location') }}</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function loadDataGroupBy() {
            ...
            var headerIsAppend = false;
            $('#group_by').on('select2:open', function (e) {
                if (!headerIsAppend) {
                    html = '<div class="row">' +
                        '<div class="col-6"><b>Group Code</b></div>' +
                        '<div class="col-6"><b>Group Desc</b></div>' +
                        '</div>';
                    $('.select2-search--dropdown').append(html);
                    headerIsAppend = true;
                }
