...
<html>
<head>
    <title>{{ __('payroll_salary_master.judul') }}</title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ url('payroll/salary_master') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('payroll_salary_master.list_detail') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no">{{ __('payroll_salary_master.label_employee_no') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_name">{{ __('payroll_salary_master.label_employee_name') }}</label>
                            <input type="text" class="form-control" id="employee_name" name="employee_name"
                                placeholder="{{ __('payroll_salary_master.label_employee_name') }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="month_year">{{ __('payroll_salary_master.label_month_year') }}</label>
                            <input type="text" class="form-control" id="month_year" name="month_year"
                                placeholder="{{ __('payroll_salary_master.label_month_year') }}" readonly>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('payroll_salary_master.label_period') }}</label>
                            <input type="text" class="form-control" id="period" name="period"
                                placeholder="{{ __('payroll_salary_master.label_period') }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="div-table">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header modal-header-notification-warning text-center">
                            <h5 class="modal-title w-100 title-text-notification-warning">{{ __('payroll_salary_master.alert_warning') }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group" style="text-align: center;">
                                        <label for="add_remark">{{ __('payroll_salary_master.label_add_remark') }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="modal-footer justify-content-between">
                                <button type="submit" id="btn-save-remark" name="btn-save-remark" class="btn btn-primary w-25"><i 
                                    class="fa fa-floppy-o"></i> {{ __('payroll_salary_master.btn_save') }}</button>
                                <button type="submit" id="btn-save-no-remark" class="btn btn-primary w-35"><i
                                    class="fa fa-floppy-o"></i> {{ __('payroll_salary_master.btn_save_no_remark') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_salary_master.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
