...
@foreach($data as $key => $value)
	...
	<table class="table" style="width:100%; padding-left:2%; padding-right:2%; border-collapse: collapse;">
    	<tr>
        	<td style="width:50%; vertical-align: top;">
				<table style="width:100%; font-size: 11px; padding-bottom: 1%; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
                    @foreach($value->a as $key2 => $value2)
                        ...
                        <tr>
                            ...
                            <td style="width: 5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                            @endif
                            <td style="width: 50%; text-align: left; padding-top: 0.4%; padding-left: 3%;">{{ $value2->columnLabel }}</td>
                ...
                <table style="width:100%; font-size: 13px; padding-right:2%; padding-bottom:1%; font-family: 'Arial Bold', sans-serif;">
                    <tr>
                        <td style="width: 4.5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 50%; text-align: left; padding-top: 0.4%; padding-left: 3%;"><b>TOTAL PENDAPATAN</b></td>
                        <td style="width: 1%; text-align: left; padding-top: 0.4%; padding-left: 3%;">:</td>
                        <td style="width: 39%; text-align: left; padding-top: 0.4%; padding-right: 17%;">{{ number_format((float) $totalIncome, 0, ',', '.')}}</td>
                    </tr>
                </table>
                <table class="table" style="width:100%; font-size: 13px; padding-right:2%; padding-bottom:1%; font-family: 'Arial Bold', sans-serif;">
                    <tr>
                        <td style="width: 4.5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 50%; text-align: left; padding-top: 0.4%; padding-left: 3%;"><b>Take Home Pay</b></td>
                        <td style="width: 1%; text-align: left; padding-top: 0.4%; padding-left: 3%;">:</td>
                        <td style="width: 39%; text-align: left; padding-top: 0.4%; padding-right: 17%;">{{ number_format((float) ($totalIncome - $totalDeduction), 0, ',', '.')}}</td>
                    </tr>
                </table>
			</td>
			<td style="width:50%; vertical-align: top;">
				<table style="width:100%; font-size: 11px; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
                ...
                <table class="table" style="width:100%; font-size: 13px; padding-right:2%; padding-bottom:1%; font-family: 'Arial Bold', sans-serif;">
                    <tr>
                        <td style="width: 4.5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 50%; text-align: left; padding-top: 0.4%; padding-left: 3%;"><b>TOTAL POTONGAN</b></td>
                        <td style="width: 1%; text-align: left; padding-top: 0.4%; padding-left: 3%;">:</td>
                        <td style="width: 39%; text-align: left; padding-top: 0.4%; padding-right: 17%;">{{ number_format((float) $totalDeduction, 0, ',', '.')}}</td>
                    </tr>
                </table>
			</td>
		</tr>
    ...
    <br><br><br>
    <table class="table" style="width:100%; font-size: 14px; padding-left:5%; padding-right:2%; padding-bottom:1%; font-family: 'Arial Bold', sans-serif;">
		<tr>
