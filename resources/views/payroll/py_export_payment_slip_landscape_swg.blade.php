...
@foreach($data as $key => $value)
    @if($display_logo == "1")
    <table class="table" style="width:100%; padding-left:1.5%; padding-right:2%;">
		<tr>
            <td>
                @if($companyCode == 'SWG')
	...
	<table class="table" style="width:100%; padding-left:2%; padding-right:2%; border-collapse: collapse;">
    	<tr>
        	<td style="width:50%; vertical-align: top;">
				<table style="width:100%; font-size: 12px; padding-bottom: 1%; border-collapse: collapse; font-family: 'Arial Alternates', sans-serif;">
                ...
                <table class="table" style="width:100%; font-size: 12px; padding-right:2%; padding-bottom:1%; font-family: 'Arial Bold', sans-serif;">
                    <tr>
                        <td style="width: 4.5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
                        <td style="width: 5%; text-align: left; padding-top: 0.4%; padding-left: 3%;">&nbsp;</td>
