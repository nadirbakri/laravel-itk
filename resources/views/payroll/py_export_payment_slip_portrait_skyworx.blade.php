...
@foreach($data as $key => $value)
	...
	<div class="div-footer" style="font-family: 'Arial Alternates', sans-serif;">
		<table class="table" style="width:100%; font-size: 12px; padding-left:1%; padding-right:1%; border-collapse: collapse; font-family: 'ArialCustomBold', sans-serif; border-top: 1px solid black;">
			<tr>
