                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="entry_type" name="entry_type">
                                <option value="" disabled selected>{{ __('py_bonus_data_entry.label_select_entry_type') }}</option>
    ...
    $(document).ready(function () {
        ...
        if ($("#bonus_data_entry_form").length > 0) {
            ...
            rules: {
                ...
                messages: {
                    employee_no: {
                        required: "{{ __('py_bonus_data_entry.field_mandatory') }}",
                    },
                    leave_code: {
                        required: "{{ __('py_bonus_data_entry.field_mandatory') }}",
                    },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('payroll/bonus_data_entry/proses') }}",
                        type: "POST",
