	...
	<div class="div-payroll">
        ...
        <div class="div-title">
			<a href="{{ url('payroll') }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('payroll_bonus_formula.list') }}</span>
			</a>
		</div>
        <div class="row">
            <div class="col-3">
                <div class="form-check">
                    <label for="formula_type">{{ __('payroll_bonus_formula.label_formula_type') }}</label>
                </div>
            </div>
            <div class="col-3">
                <div class="form-check">
                    <input type="radio" id="thr" name="radiobtn[]" value=true>
                    <label for="thr">{{ __('payroll_bonus_formula.label_thr') }}</label>
                </div>
            </div>
            <div class="col-3">
                <div class="form-check">
                    <input type="radio" id="bonus" name="radiobtn[]" value=true checked>
                    <label for="bonus">{{ __('payroll_bonus_formula.label_bonus') }}</label>
                </div>
            </div>
        </div>
        <div class="div-table">
    ...
    $(document).ready(function () {
        ...
        function load_data_table_bonus_formula() {
            table = $('#bonus_formula_table').DataTable({
                ...
                serverSide: true,
                orderCellsTop: true,
                ajax: "{{ url('payroll/bonus_formula/table') }}",
        ...
        $("#toolbar-new").on('click', function() {
            $.redirect("{{ url('payroll/bonus_formula/detail_data') }}", 
            { 
                'func' : 'new'
            }, 
