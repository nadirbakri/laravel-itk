...
<html>
<head>
    <title>{{ __('payroll_signature_list.judul') }}</title>
            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ url('payroll') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('payroll_signature_list.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label">{{ __('payroll_signature_list.label_employee_no') }}</label>
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('payroll_signature_list.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label">{{ __('payroll_signature_list.label_position') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label">{{ __('payroll_signature_list.label_ranking') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label">{{ __('payroll_signature_list.label_location') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button class="btn btn-primary" id="btn-send-to" style="width: 100%;">
                            <i class="fa fa-print"></i> {{ __('payroll_signature_list.btn_send_to') }}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_signature_list.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
            ...
            $('#signature_list_form').validate({
                submitHandler: function(form){
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('payroll/signature_list/print') }}",
                        type: "POST",
