...
<html>
<head>
	<title>{{ __('payroll_monthly_payroll_closing_process.judul') }}</title>
	...
	<div class="div-payroll">
        <div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('payroll_monthly_payroll_closing_process.list') }}</span>
			</a>
		</div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="period_process">{{ __('payroll_monthly_payroll_closing_process.label_period_process') }}</label>
                            <div class="input-group month">
                                <input type="text" class="form-control" id="period_process" name="period_process"
                                    placeholder="{{ __('payroll_monthly_payroll_closing_process.label_period_process') }}" readonly>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_monthly_payroll_closing_process.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
        ...
        if ($("#monthly_closing_process_form").length > 0) {
            $("#monthly_closing_process_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('payroll/monthly_closing_process/proses') }}",
                        type: "POST",
