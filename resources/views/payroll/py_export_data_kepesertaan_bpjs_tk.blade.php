            ...
            <div class="div-payroll">
                <div class="div-title">
                    <a href="{{ url('payroll') }}" target="iframe_dashboard">
                        ...
                        <span class="title-text">{{ __('payroll_export_data_kepesertaan_bpjs_tk.list') }}</span>
                    </a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('payroll_export_data_kepesertaan_bpjs_tk.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label">{{ __('payroll_export_data_kepesertaan_bpjs_tk.label_position') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label">{{ __('payroll_export_data_kepesertaan_bpjs_tk.label_ranking') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label">{{ __('payroll_export_data_kepesertaan_bpjs_tk.label_location') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> {{ __('payroll_export_data_kepesertaan_bpjs_tk.btn_preview') }}
                        </button>
                    </div>
                    <div class="col-3 desc" id="btn-send-to" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> {{ __('payroll_export_data_kepesertaan_bpjs_tk.btn_send_to') }}
                        </button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('payroll_export_data_kepesertaan_bpjs_tk.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
                ...
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "{{ url('payroll/export_data_kepesertaan_bpjs_tk_report/print/excel') }}",
                            type: "POST",
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "{{ url('payroll/export_data_kepesertaan_bpjs_tk_report/print') }}",
                            type: "POST",
                            data: $('#export_data_kepesertaan_bpjs_tk_form').serialize(),
                            success: function(result, status, xhr){
