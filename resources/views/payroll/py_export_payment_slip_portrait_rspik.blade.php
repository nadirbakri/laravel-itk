...
<body>
    ...
    <table class="table" style="width:100%; padding-left:5%; padding-right:5%; padding-top:1%; padding-bottom:1%; font-family: 'Arial Alternates', sans-serif;">
		<tr>
			<td colspan="3" style="padding: 0; margin: 0; text-align:left; font-size: 11px;">
                {{ strtoupper($value->namaPerusahaan) }}
			</td>
            <td style="width: 5%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
                &nbsp;
			</td>
            <td style="width: 12%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
                PERIODE
			</td>
            <td style="width: 20%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
                {{ $value->slipPeriod }}
			</td>
            @if($display_logo == "1")
				...
				<table style="width: 100%;">
					<tr>
						<td style="text-align:right;">
							<img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/pictures/logo_rspik.png'))) }}" style="width: 125px; height: 50px" alt="Logo">
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
            ...
            <td style="padding: 0; margin: 0; text-align:left; font-size: 11px;">
                &nbsp;
			</td>
            <td style="padding: 0; margin: 0; text-align:left; font-size: 11px;">
                DEPARTEMEN
        ...
        <tr>
			<td style="width: 10%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
				Emp. No.
			</td>
            <td style="width: 10%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
                {{ $value->employeeNo }}
			</td>
            <td style="width: 15%; padding: 0; margin: 0; text-align:left; font-size: 11px;">
                {{ $value->employeeName }}
			</td>
            <td style="padding: 0; margin: 0; text-align:left; font-size: 11px;">
                &nbsp;
