	...
	@foreach($data as $key => $value)
		...
		<table class="table" style="border-collapse: collapse;">
			...
			<tr>
				...
				<td width="1%">:</td>
				<td width="19%">{{ $value->slipPeriod }}</td>
			...
			<tr>
				<td width="13%">NIP</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->employeeNo }}</td>
				<td width="13%">TANGGAL MASUK</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->joinDate }}</td>
				<td width="33%">{{ $value->noRekening }}</td>
			</tr>
			<tr>
				<td width="13%">NAMA</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->employeeName }}</td>
				<td width="13%">BAGIAN</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->position }}</td>
				<td colspan="3" width="33%">&nbsp;</td>
			</tr>
			<tr>
				<td width="13%">STATUS</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->taxStatus }}</td>
				<td width="13%">DEPARTEMEN</td>
				<td width="1%">:</td>
				<td width="19%">{{ $value->departemen }}</td>
				<td colspan="3" width="33%">&nbsp;</td>
			</tr>
		</table>
		<hr />
