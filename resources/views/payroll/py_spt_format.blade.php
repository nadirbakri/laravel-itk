...
<head>
    <title>{{ __('payroll_spt_format.judul') }}</title>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('payroll_spt_format.list') }}</h5>
                ...
                <div class="modal-body">
                    <form id="modal_spt_format_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="column_no">{{ __('payroll_spt_format.label_column_no') }}</label>
                                    <input class="form-control" id="column_no" name="column_no" 
                                    placeholder="{{ __('payroll_spt_format.label_column_no') }}" disabled>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="field_name">{{ __('payroll_spt_format.label_field_name') }}</label>
                                    <span class="required">*</span>
                                    <input class="form-control" id="field_name" name="field_name"
                                    placeholder="{{ __('payroll_spt_format.label_field_name') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="operator">{{ __('payroll_spt_format.label_operator') }}</label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="field_label">{{ __('payroll_spt_format.label_field_label') }}</label>
                                    <span class="required">*</span>
                                    <input class="form-control" id="field_label" name="field_label"
                                    placeholder="{{ __('payroll_spt_format.label_field_label') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="format">{{ __('payroll_spt_format.label_format') }}</label>
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" id="btn-save" class="btn btn-primary w-25"><i 
                                    class="fa fa-floppy-o"></i> {{ __('payroll_spt_format.btn_save') }}</button>
                                    <button type="button" id="btn-remove" class="btn btn-danger w-25"><i 
                                    class="fa fa-times"></i> {{ __('payroll_spt_format.btn_remove') }}</button>
                            <button type="button" class="btn btn-primary w-25" data-dismiss="modal"><i
                                    class="fa fa-times-circle"></i> {{ __('payroll_spt_format.btn_cancel') }}</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#no1').on('click', function () {
            ...
            $.ajax({
                url: "{{ url('/payroll/spt_format/detail_data') }}",
                type: "GET",
                data: {
