	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/institution_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Institution Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="institution_code" name="institution_code" placeholder="Institution Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="institution_name" name="institution_name" placeholder="Institution Name" disabled>
						</div>
					</div>
				</div>
			</form>
