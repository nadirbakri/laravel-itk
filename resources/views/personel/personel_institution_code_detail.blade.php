...
<head>
    <title>{{ __('personel_institution_code.judul') }}</title>
            ...
            <form id="institution_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="record_status">{{ __('personel_institution_code.label_record_status') }}</label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="{{ __('personel_institution_code.label_record_status') }}" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="institution_code">{{ __('personel_institution_code.label_institution_code') }}</label>
                            <input type="text" class="form-control" id="institution_code" name="institution_code"
                                placeholder="{{ __('personel_institution_code.label_institution_code') }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="institution_name">{{ __('personel_institution_code.label_institution_name') }}</label>
                            <input type="text" class="form-control" id="institution_name" name="institution_name"
                                placeholder="{{ __('personel_institution_code.label_institution_name') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> {{ __('personel_institution_code.btn_save') }}
                        </button>
                    </div>
                    <div class="col-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('personel_institution_code.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $('#institution_code').prop('readonly', false);
        } else if (func == 'edit') {
            $('#record_status').val("{{ isset($data[0]->recordStatus) ? $data[0]->recordStatus : '' }}");
            $('#record_function').val("Edit");
            $('#institution_code').val(
                "{{ isset($data[0]->institutionCode) ? $data[0]->institutionCode : '' }}");
            $('#institution_name').val(htmlDecode(
                "{{ isset($data[0]->institutionName) ? $data[0]->institutionName : '' }}"));
            $('#institution_code').prop('readonly', true);
        }
        ...
        if ($("#institution_form").length > 0) {
            $("#institution_form").validate({
                ...
                messages: {
                    institution_code: {
                        required: "{{ __('personel_institution_code.institution_code_required') }}",
                    },
                    institution_name: {
                        required: "{{ __('personel_institution_code.institution_name_required') }}",
                    },
                },
