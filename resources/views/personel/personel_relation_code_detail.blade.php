	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/relation_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Relation Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="relation_code" name="relation_code" placeholder="Relation Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="relation_description">Relation Description</label>
							<input type="text" class="form-control" id="relation_description" name="relation_description" placeholder="Relation Description" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="relation_type" name="relation_type" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							<label for="relation_type_description">Relation Description</label>
							<input type="text" class="form-control" id="relation_type_description" name="relation_type_description" disabled>
						</div>
					</div>
				</div>
			</form>
