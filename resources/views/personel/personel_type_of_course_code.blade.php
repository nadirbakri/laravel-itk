	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ route('personnel', ['moduleID' => 'PE']) }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_type_of_course_code.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="type_of_course_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('personel_type_of_course_code.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#type_of_course_table thead tr').clone(true).appendTo('#type_of_course_table thead');
    $('#type_of_course_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#type_of_course_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ...
        columns: [
            ...
            {data: 'courseTypeCode', name: 'courseTypeCode'},
            {data: 'courseTypeName', name: 'courseTypeName'},
    ...
    function load_data_type_of_course() {
        table = $('#type_of_course_table').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: "{{ url('personnel/type_of_course/table') }}",
    ...
    $('#type_of_course_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#type_of_course_table').on('click', 'tr td:first-child', function(e){
        ...
        if(data.count() > 0){
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var oTable = $('#type_of_course_table').dataTable();
                    oTable.fnDraw(false);
                },
