...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#zip_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#zip_code_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/zip_code/table') }}",
    ...
    $('#zip_code_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/zip_code/detail_data') }}", { 'zip_code' : data.zip_code }, "GET", "iframe_dashboard");
    });
