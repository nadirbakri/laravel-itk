	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID('{{ url()->previous() }}')" target="iframe_dashboard">
				...
				<span class="title-text">Source Bank List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="bank_source_code">Bank Source Code</label>
							<select class="form-control" id="bank_source_code" name="bank_source_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							<label for="bank_source_description">Bank Source Description</label>
							<input type="text" class="form-control" id="bank_source_description" name="bank_source_description" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="bank_branch_name" name="bank_branch_name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							<label for="currency_description">Currency Description</label>
							<input type="text" class="form-control" id="currency_description" name="currency_description" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="account_no" name="account_no" placeholder="Account No" disabled>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="transfer_code">Transfer Code</label>
							<input type="text" class="form-control" id="transfer_code" name="transfer_code" placeholder="Transfer Code" disabled>
						</div>
					</div>
				</div>
			</form>
