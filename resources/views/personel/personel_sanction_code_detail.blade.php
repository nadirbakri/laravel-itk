	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID('{{ url()->previous() }}')" target="iframe_dashboard">
				...
				<span class="title-text">Sanction Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="sanction_code" name="sanction_code" placeholder="Sanction Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="sanction_name">Sanction Name</label>
							<input type="text" class="form-control" id="sanction_name" name="sanction_name" placeholder="Sanction Name" disabled>
						</div>
					</div>
				</div>
			</form>
