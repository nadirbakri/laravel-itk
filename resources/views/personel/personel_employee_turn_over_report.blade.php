        ...
        <div class="div-form">
            <form id="employee_list_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('personel_employee_turn_over_report.label_evaluation_period_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('personel_employee_turn_over_report.label_evaluation_period_to') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
