	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/city_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">City Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="city_code" name="city_code" placeholder="City Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="city_name" name="city_name" placeholder="City Name" disabled>
						</div>
					</div>
				</div>
			</form>
