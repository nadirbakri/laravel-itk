	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/bpjs_group') }}" target="iframe_dashboard">
				...
				<span class="title-text">BPJS Group List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="bpjs_code">BPJS Code</label>
							<input type="text" class="form-control" id="bpjs_code" name="bpjs_code" placeholder="BPJS Code" disabled>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="no_bpjs">No BPJS</label>
							<input type="text" class="form-control" id="no_bpjs" name="no_bpjs" placeholder="No BPJS" disabled>
						</div>
					</div>
				</div>
				<div class="row">
