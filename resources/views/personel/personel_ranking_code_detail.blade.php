	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/ranking_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Ranking Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="ranking_code">Ranking Code</label>
							<select class="form-control" id="ranking_code" name="ranking_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							<label for="ranking_name">Ranking Name</label>
							<input type="text" class="form-control" id="ranking_name" name="ranking_name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="group_authorization" name="group_authorization">
								<option value="">Choose</option>
							</select>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="group_authorization_description">Description</label>
							<input type="text" class="form-control" id="group_authorization_description" name="group_authorization_description" disabled>
						</div>
					</div>
				</div>
			</form>
