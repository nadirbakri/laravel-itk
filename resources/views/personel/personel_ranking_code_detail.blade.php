...
<head>
    <title>{{ __('personel_ranking_code.judul') }}</title>
        ...
        <div class="div-form">
            <form id="ranking_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="record_status">{{ __('personel_ranking_code.label_record_status') }}</label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="{{ __('personel_ranking_code.label_record_status') }}" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking_code">{{ __('personel_ranking_code.label_ranking_code') }}</label>
                            <input type="text" class="form-control" id="ranking_code" name="ranking_code"
                                placeholder="{{ __('personel_ranking_code.label_ranking_code') }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking_name">{{ __('personel_ranking_code.label_ranking_name') }}</label>
                            <input type="text" class="form-control" id="ranking_name" name="ranking_name"
                                placeholder="{{ __('personel_ranking_code.label_ranking_name') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> {{ __('personel_ranking_code.btn_save') }}
                        </button>
                    </div>
                    <div class="col-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('personel_ranking_code.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $('#ranking_code').val("");
            $('#ranking_name').val("");
            $('#ranking_code').prop('readonly', false);
        } else if (func == 'edit') {
            $('#record_status').val("{{ isset($data[0]->recordStatus) ? $data[0]->recordStatus : '' }}");
            $('#record_function').val("Edit");
            $('#ranking_code').val("{{ isset($data[0]->rankingCode) ? $data[0]->rankingCode : '' }}");
            $('#ranking_name').val(htmlDecode(
                "{{ isset($data[0]->rankingName) ? $data[0]->rankingName : '' }}"));
            $('#ranking_code').prop('readonly', true);
        }
        ...
        if ($("#ranking_form").length > 0) {
            $("#ranking_form").validate({
                rules: {
                    ranking_code: {
                        required: true,
                    },
                ...
                messages: {
                    ranking_code: {
                        required: "{{ __('personel_ranking_code.ranking_code_required') }}",
                    },
                    ranking_name: {
                        required: "{{ __('personel_ranking_code.ranking_name_required') }}",
                    },
                },
