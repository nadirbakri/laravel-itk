...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#nature_of_work_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#nature_of_work_table').DataTable({
        ...
        columns: [
            {data: 'nature_of_work_code', name: 'nature_of_work_code'},
            {data: 'nature_of_work_name', name: 'nature_of_work_name'},
            {data: 'status', name: 'status'}
        ]
    });

    $('#nature_of_work_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/nature_of_work/detail_data') }}", { 'nature_of_work_code' : data.nature_of_work_code }, "GET", "iframe_dashboard");
    });
