	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url()->previous() }}" target="iframe_dashboard">
				...
				<span class="title-text">Education Status Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="education_status_code">Education Status Code</label>
							<input type="text" class="form-control" id="education_status_code" name="education_status_code" placeholder="Education Status Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="education_status_description">Education Status Description</label>
							<input type="text" class="form-control" id="education_status_description" name="education_status_description" placeholder="Education Status Description" disabled>
						</div>
					</div>
				</div>
			</form>
