                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="mutation_type" name="mutation_type">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="decree_code_current_select" name="decree_code_current_select">
                                        <option value="">Choose</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="company_current_one">Company</label>
                                    <input type="text" class="form-control" id="company_current_one" name="company_current_one" disabled>
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
                                    <label for="company_current_two">&nbsp;</label>
                                    <input type="text" class="form-control" id="company_current_two" name="company_current_two" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="work_location_current_select">Work Location</label>
                                    <select class="form-control" id="work_location_current_select" name="work_location_current_select">
                                        <option value="">Choose</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
                                    <label for="work_location_current_text">&nbsp;</label>
                                    <input type="text" class="form-control" id="work_location_current_text" name="work_location_current_text" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="sub_ordinate_current">Sub Ordinate</label>
                                    <input type="text" class="form-control" id="sub_ordinate_current" name="sub_ordinate_current" placeholder="Sub Ordinate">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="company_new_one">Company</label>
                                    <input type="text" class="form-control" id="company_new_one" name="company_new_one" disabled>
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
                                    <label for="company_new_two">&nbsp;</label>
                                    <input type="text" class="form-control" id="company_new_two" name="company_new_two" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="direct_staff_checkbox_current">Direct Staff</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
