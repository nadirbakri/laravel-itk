...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#grade_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    $('#grade_code_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/grade_code/detail_data') }}", { 'grade_code' : data.grade_code }, "GET", "iframe_dashboard");
    });
