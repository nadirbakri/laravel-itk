        ...
        <div class="div-form">
            <form id="plafon_form" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="{{ url('personnel/plafon_tunjangan') }}" target="iframe_dashboard"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('/plafon_tunjangan/func/api') }}",
                data: {
        ...
        if ($("#plafon_form").length > 0) {
            $("#plafon_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('personnel/plafon_tunjangan/proses') }}",
                        type: "POST",
