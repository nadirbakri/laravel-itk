	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/bank_branch') }}" target="iframe_dashboard">
				...
				<span class="title-text">Bank Branch List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="bank_code" name="bank_code" disabled>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="branch_code" name="branch_code" disabled>
								<option value="">Choose</option>
							</select>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="branch_name" name="branch_name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<textarea class="form-control" id="branch_address" name="branch_address" rows="3" placeholder="Branch Address" disabled></textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="bi_code">BI Code</label>
							<input type="text" class="form-control" id="bi_code" name="bi_code" placeholder="BI Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="Phone No" disabled>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="fax_no">Fax No</label>
							<input type="text" class="form-control" id="fax_no" name="fax_no" placeholder="Fax No" disabled>
						</div>
					</div>
				</div>
			</form>
