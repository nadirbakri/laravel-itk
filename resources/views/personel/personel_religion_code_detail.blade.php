		...
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="religion_code">Religion Code</label>
							<input type="text" class="form-control" id="religion_code" name="religion_code" placeholder="Religion Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="religion_name" name="religion_name" placeholder="Religion Name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="thr_date">THR Date</label>
							<div class='input-group'>
								<input type="text" class="form-control" id="thr_date" name="thr_date" placeholder="THR Date">
