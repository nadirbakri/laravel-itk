	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/major_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Major Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="major_code" name="major_code" placeholder="Major Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="major_name" name="major_name" placeholder="Major Name" disabled>
						</div>
					</div>
				</div>
			</form>
