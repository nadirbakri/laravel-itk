...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#personal_data_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    $('#personal_data_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/personal_data/detail_data') }}", { 'employee_no' : data.employee_no, 'employee_name' : data.employee_name }, "GET", "iframe_dashboard");
    });
