...
<body>
	<div class="div-personel">
		...
		<div class="div-table">
			<table id="institution_code_table" class="table hover">
				<thead>
					<tr>
...
<script type="text/javascript">
  $(document).ready(function() {
  	$('#institution_code_table thead tr').clone(true).appendTo('#institution_code_table thead');
    $('#institution_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#institution_code_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/institution_code/table') }}",
    ...
    $('#institution_code_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/institution_code/detail_data') }}", { 'institution_code' : data.institution_code }, "GET", "iframe_dashboard");
    });
