	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ route('personnel', ['moduleID' => 'PE']) }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_institution_code.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="institution_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#institution_table thead tr').clone(true).appendTo('#institution_table thead');
    $('#institution_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    function load_data_institution() {
    ...
    $('#institution_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#institution_table').on('click', 'tr td:first-child', function(e){
        ...
        if(data.count() > 0){
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var oTable = $('#institution_table').dataTable();
                    oTable.fnDraw(false);
                },
