...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#bpjs_group_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#bpjs_group_table').DataTable({
        ...
        columns: [
            {data: 'bpjs_code', name: 'bpjs_code'},
            {data: 'bpjs_no', name: 'bpjs_no'},
    ...
    $('#bpjs_group_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/bpjs_group/detail_data') }}", { 'bpjs_code' : data.bpjs_code }, "GET", "iframe_dashboard");
    });
