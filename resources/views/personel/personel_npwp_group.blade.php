...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#npwp_group_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#npwp_group_table').DataTable({
        ...
        columns: [
            {data: 'npwp_code', name: 'npwp_code'},
            {data: 'pemotong_kuasa', name: 'pemotong_kuasa'},
            {data: 'print_date', name: 'print_date'},
            {data: 'signer_name', name: 'signer_name'},
            {data: 'signer_npwp', name: 'signer_npwp'},
    ...
    $('#npwp_group_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/npwp_group/detail_data') }}", { 'npwp_code' : data.npwp_code }, "GET", "iframe_dashboard");
    });
