	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID('{{ url()->previous() }}')" target="iframe_dashboard">
				...
				<span class="title-text">Education Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="education_code">Education Code</label>
							<input type="text" class="form-control" id="education_code" name="education_code" placeholder="Education Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="education_name" name="education_name" placeholder="Education Name" disabled>
						</div>
					</div>
				</div>
			</form>
