...
<html>
<head>
	<title>{{ __('personel_employee_approval.judul') }}</title>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    var table = $('#employee_approval_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
    ...
    $('#employee_approval_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#employee_approval_table').on('click', 'tr td:first-child', function(e){
