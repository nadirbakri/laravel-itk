	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_evaluation_code.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="evaluation_form_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>Form Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#evaluation_form_table thead tr').clone(true).appendTo('#evaluation_form_table thead');
    $('#evaluation_form_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#evaluation_form_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
    ...
    function load_data_evaluation_form() {
        table = $('#evaluation_form_table').DataTable({
            processing: true,
            serverSide: true,
            orderCellsTop: true,
            ajax: "{{ url('personnel/evaluation_form/table') }}",
    ...
    $('#evaluation_form_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#evaluation_form_table').on('click', 'tr td:first-child', function(e){
