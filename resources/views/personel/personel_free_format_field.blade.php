...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#free_format_field_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#free_format_field_table').DataTable({
        ...
        columns: [
            {data: 'free_format_code', name: 'free_format_code'},
            {data: 'free_format_field_type', name: 'free_format_field_type'},
    ...
    $('#free_format_field_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/free_format_field/detail_data') }}", { 'free_format_code' : data.free_format_code }, "GET", "iframe_dashboard");
    });
