	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/line_of_business') }}" target="iframe_dashboard">
				...
				<span class="title-text">Line of Business List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="line_of_business_code">Line of Business Code</label>
							<input type="text" class="form-control" id="line_of_business_code" name="line_of_business_code" placeholder="Line of Business Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="line_of_business_name">Line of Business Name</label>
							<input type="text" class="form-control" id="line_of_business_name" name="line_of_business_name" placeholder="Line of Business Name" disabled>
						</div>
					</div>
				</div>
			</form>
