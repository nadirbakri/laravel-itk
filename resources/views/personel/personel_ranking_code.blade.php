...
<body>
	<div class="div-personel">
		...
		<div class="div-table">
			<table id="ranking_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>Ranking Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#ranking_table thead tr').clone(true).appendTo('#ranking_table thead');
    $('#ranking_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    $('#ranking_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#ranking_table').on('click', 'tr td:first-child', function(e){
        ...
        if(data.count() > 0){
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var oTable = $('#ranking_table').dataTable();
                    oTable.fnDraw(false);
                },
