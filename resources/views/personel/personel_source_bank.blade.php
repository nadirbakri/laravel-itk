...
<html>
<head>
	<title>{{ __('personel_source_bank.judul') }}</title>
	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel') }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_source_bank.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="source_bank_table" class="table hover">
				<thead>
					<tr>
...
<script type="text/javascript">
  $(document).ready(function() {
  	$('#source_bank_table thead tr').clone(true).appendTo('#source_bank_table thead');
    $('#source_bank_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#source_bank_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ...
        columns: [
            ...
            {data: 'branch_bank_code', name: 'branch_bank_code'},
