	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/nature_of_work') }}" target="iframe_dashboard">
				...
				<span class="title-text">Nature of Work List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="nature_of_work_code">Nature of Work Code</label>
							<select class="form-control" id="nature_of_work_code" name="nature_of_work_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							<label for="nature_of_work_name">Nature of Work Name</label>
							<input type="text" class="form-control" id="nature_of_work_name" name="nature_of_work_name" disabled>
						</div>
					</div>
				</div>
			</form>
