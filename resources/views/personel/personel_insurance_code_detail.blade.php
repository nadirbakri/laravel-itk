	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/insurance_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Insurance Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="insurance_code" name="insurance_code" placeholder="Insurance Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="insurance_description">Insurance Description</label>
							<input type="text" class="form-control" id="insurance_description" name="insurance_description" placeholder="Insurance Description" disabled>
						</div>
					</div>
				</div>
			</form>
