	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url()->previous() }}" target="iframe_dashboard">
				...
				<span class="title-text">Language Ability Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="language_ability_code">Language Ability Code</label>
							<input type="text" class="form-control" id="language_ability_code" name="language_ability_code" placeholder="Language Ability Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="language_ability_description">Language Ability Description</label>
							<input type="text" class="form-control" id="language_ability_description" name="language_ability_description" placeholder="Language Ability Description" disabled>
						</div>
					</div>
				</div>
			</form>
