        ...
        <div class="div-form">
            <form id="company_bank_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="record_status">{{ __('personel_company_bank.label_record_status') }}</label>
                            <input type="text" class="form-control" id="record_status" name="record_status"
                                placeholder="{{ __('personel_company_bank.label_record_status') }}" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="bank_code">{{ __('personel_company_bank.label_bank_code') }}</label>
                            <input type="text" class="form-control" id="bank_code" name="bank_code"
                                placeholder="{{ __('personel_company_bank.label_bank_code') }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="account_no">{{ __('personel_company_bank.label_account_no') }}</label>
                            <input type="text" class="form-control" id="account_no" name="account_no"
                                placeholder="{{ __('personel_company_bank.label_account_no') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="description">{{ __('personel_company_bank.label_description') }}</label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> {{ __('personel_company_bank.btn_save') }}
                        </button>
                    </div>
                    <div class="col-3">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-save").click(function () {
            ...
            $("#company_bank_form").submit();
        });

        if ($("#company_bank_form").length > 0) {
            $("#company_bank_form").validate({
                rules: {
                    bank_code: {
                        required: true,
                    },
                ...
                messages: {
                    bank_code: {
                        required: "{{ __('personel_company_bank.bank_code_required') }}",
                    },
                    account_no: {
                        required: "{{ __('personel_company_bank.account_no_required') }}",
                    },
                },
