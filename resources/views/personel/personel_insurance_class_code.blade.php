...
<html>
<head>
	<title>{{ __('personel_insurance_class_code.judul') }}</title>
	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_insurance_class_code.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="insurance_class_code_table" class="table hover">
				<thead>
					<tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#insurance_class_code_table thead tr').clone(true).appendTo('#insurance_class_code_table thead');
    $('#insurance_class_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#insurance_class_code_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ...
        columns: [
            ...
            {data: 'premium_per_year', name: 'premium_per_year'},
