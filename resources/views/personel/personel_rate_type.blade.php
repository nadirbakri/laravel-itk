...
<html>
<head>
	<title>{{ __('personel_rate_type.judul') }}</title>
	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="javascript:void(0);" onclick="goBackWithModuleID()" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_rate_type.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="rate_type_table" class="table hover">
				<thead>
					<tr>
						<th>Rate Type</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#rate_type_table thead tr').clone(true).appendTo('#rate_type_table thead');
    $('#rate_type_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#rate_type_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ...
        columns: [
            ...
            {data: 'rate_description', name: 'rate_description'},
