	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/position') }}" target="iframe_dashboard">
				...
				<span class="title-text">Position List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="position_code" name="position_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="position_name" name="position_name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="abbreviation" name="abbreviation" placeholder="Abbreviation" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="supervised_by" name="supervised_by" disabled>
								<option value="">Choose</option>
							</select>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="supervised_description">Description</label>
							<input type="text" class="form-control" id="supervised_description" name="supervised_description" disabled>
						</div>
					</div>
				</div>
			</form>
