            ...
            <form id="personel_reference_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="probation_period">{{ __('personel_personel_reference.label_probation_period') }}</label>
                            <select class="form-control" id="probation_period" name="probation_period" disabled>
                                <option value="">{{ __('personel_personel_reference.label_select_probation_period') }}
                                </option>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="cost_center_format">{{ __('personel_personel_reference.label_cost_center_format') }}</label>
                            <input type="number" class="form-control" id="cost_center_format" name="cost_center_format"
                                placeholder="{{ __('personel_personel_reference.label_cost_center_format') }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <span class="div-title-text">{{ __('personel_personel_reference.label_employee') }}</span>
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="need_approval_employee">{{ __('personel_personel_reference.label_need_approval_employee') }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="auto_generate_employee">{{ __('personel_personel_reference.label_auto_generate_employee') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="max_dependent_medical">{{ __('personel_personel_reference.label_max_dependent_medical') }}</label>
                                    <input type="number" class="form-control" id="max_dependent_medical"
                                        name="max_dependent_medical"
                                        placeholder="{{ __('personel_personel_reference.label_max_dependent_medical') }}"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                        for="max_dependent_payroll">{{ __('personel_personel_reference.label_max_dependent_payroll') }}</label>
                                    <input type="number" class="form-control" id="max_dependent_payroll"
                                        name="max_dependent_payroll"
                                        placeholder="{{ __('personel_personel_reference.label_max_dependent_payroll') }}"
                                        disabled>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="level_master_format">{{ __('personel_personel_reference.label_level_master_format') }}</label>
                            <input type="number" class="form-control" id="level_master_format"
                                name="level_master_format"
                                placeholder="{{ __('personel_personel_reference.label_level_master_format') }}"
                                disabled>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span
                            class="title-text-notification">{{ __('personel_personel_reference.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var arrDataLevel = @json($data_level);
        ...
        if ($("#personel_reference_form").length > 0) {
            $("#personel_reference_form").validate({
                ...
                messages: {
                    probation_period: {
                        required: "{{ __('personel_personel_reference.probation_period_required') }}",
                    },
                    level_master_format: {
                        required: "{{ __('personel_personel_reference.level_master_format_required') }}",
                    },
                    "level_description[]": {
                        required: "{{ __('personel_personel_reference.level_description_required') }}",
                    },
                },
