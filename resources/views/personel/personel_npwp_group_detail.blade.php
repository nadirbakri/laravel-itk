	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/npwp_group') }}" target="iframe_dashboard">
				...
				<span class="title-text">NPWP Group List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="npwp_code">NPWP Code</label>
							<input type="text" class="form-control" id="npwp_code" name="npwp_code" placeholder="NPWP Code">
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="tax_preparer">Tax Preparer / Representative</label>
							<select class="form-control" id="tax_preparer" name="tax_preparer">
					...
					<div class="col-6">
						<div class="form-group">
							...
							<div class='input-group'>
								<input type="text" class="form-control" id="print_date" name="print_date" placeholder="Print Date">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="signer_name" name="signer_name" placeholder="Signer Name" disabled>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="signer_npwp">Signer NPWP</label>
							<input type="text" class="form-control" id="signer_npwp" name="signer_npwp" placeholder="Signer NPWP" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" disabled>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="company_npwp">Company NPWP</label>
							<input type="text" class="form-control" id="company_npwp" name="company_npwp" placeholder="Company NPWP" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<textarea class="form-control" id="address" name="address" rows="3" placeholder="Address" disabled></textarea>
						</div>
					</div>
				</div>
			</form>
