	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/bank_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Bank Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="bank_code" name="bank_code" placeholder="Bank Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="number_of_digits">Number of Digits</label>
							<input type="text" class="form-control" id="number_of_digits" name="number_of_digits" placeholder="Number of Digits" disabled>
						</div>
					</div>
				</div>
			</form>
