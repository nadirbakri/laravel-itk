	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/type_of_course_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Type of Course Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="course_type_code">Course Type Code</label>
							<input type="text" class="form-control" id="course_type_code" name="course_type_code" placeholder="Course Type Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="course_type_name">Course Type Name</label>
							<input type="text" class="form-control" id="course_type_name" name="course_type_name" placeholder="Course Type Name" disabled>
						</div>
					</div>
				</div>
			</form>
