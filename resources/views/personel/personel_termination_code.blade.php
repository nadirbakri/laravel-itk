...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var table = $('#termination_code_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/termination_code/table') }}",
    ...
    $('#termination_code_table tbody').on('click', 'tr', function () {
    	...
    	$.redirect("{{ url('personel/termination_code/detail_data') }}", { 'termination_code' : data.termination_code }, "GET", "iframe_dashboard");
    });
