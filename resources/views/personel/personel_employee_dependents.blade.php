    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="{{ route('personnel', ['moduleID' => 'PE']) }}" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text">{{ __('personel_employee_dependents.list') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="employee_dependents_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from">{{ __('personel_employee_dependents.label_employee_no_from') }}</label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to">{{ __('personel_employee_dependents.label_employee_no_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('personel_employee_dependents.label_period') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="{{ __('personel_employee_dependents.label_period') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign">{{ __('personel_employee_dependents.label_include_resign') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" 
                                    for="include_medical">{{ __('personel_employee_dependents.label_include_medical') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" 
                                    for="include_payroll">{{ __('personel_employee_dependents.label_include_payroll') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from">{{ __('personel_employee_dependents.label_group_authorize_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to">{{ __('personel_employee_dependents.label_group_authorize_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('personel_employee_dependents.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('personel_employee_dependents.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('personel_employee_dependents.label_location') }}</label>
