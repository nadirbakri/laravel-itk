	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/cost_center_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Cost Center Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="cost_center_code" name="cost_center_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							<label for="cost_center_description">Cost Center Description</label>
							<input type="text" class="form-control" id="cost_center_description" name="cost_center_description" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							<label for="contra_account_no">Contra Account No</label>
							<input type="text" class="form-control" id="contra_account_no" name="contra_account_no" placeholder="Contra Account No" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="absent_group">Absent Group</label>
							<select class="form-control" id="absent_group" name="absent_group">
								<option value="">Choose </option>
