	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url()->previous() }}" target="iframe_dashboard">
				...
				<span class="title-text">Currency Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="currency_code" name="currency_code" placeholder="Currency Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="division" name="division" placeholder="Division" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="sub_division" name="sub_division" placeholder="Sub Division" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="rounding_method">Rounding Methods</label>
							<select class="form-control" id="rounding_method" name="rounding_method">
								<option value="">Choose Method</option>
								<option value="Half Adjustment">Half Adjustment</option>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="decimal_point" name="decimal_point" placeholder="Decimal Point" disabled>
						</div>
					</div>
				</div>
			</form>
