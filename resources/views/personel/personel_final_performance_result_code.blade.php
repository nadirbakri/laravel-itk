...
<body>
	<div class="div-personel">
		...
		<div class="div-table">
			<table id="final_performance_result_code_table" class="table hover">
				<thead>
					<tr>
						<th>No</th>
						<th>Value</th>
            ...
            <div class="row">
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-add-final-performance-result-code" id="btn-add-final-performance-result-code" style="width: 100%;" data-toggle="modal" data-target="#modal_add_final_performance_result_code">
                        <i class="fa fa-plus"></i> Add
                    </button>
                </div>
                <div class="col-3">
                    <button type="button" class="btn btn-primary" name="btn-edit-final-performance-result-code" id="btn-add-final-performance-result-code" style="width: 100%;">
                        <i class="fa fa-edit"></i> Edit
                    </button>
                </div>
                <div class="col-3">
                    <button type="button" class="btn btn-danger" name="btn-remove-final-performance-result-code" id="btn-remove-final-performance-result-code" style="width: 100%;">
    ...
    <div class="modal fade" id="modal_add_final_performance_result_code" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Performance Result Form</h5>
...
<script type="text/javascript">
  $(document).ready(function() {
    var table = $('#final_performance_result_code_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/final_performance_result_code/table') }}",
