...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#employee_attachment_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#employee_attachment_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/employee_attachment/table') }}",
    ...
    $('#employee_attachment_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/employee_attachment/detail_data') }}", { 'employee_no' : data.employee_no, 'employee_name' : data.employee_name }, "GET", "iframe_dashboard");
    });
