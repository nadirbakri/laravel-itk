	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/skill_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Skill Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="skill_code" name="skill_code" placeholder="Skill Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="skill_description" name="skill_description" placeholder="Skill Description" disabled>
						</div>
					</div>
				</div>
			</form>
