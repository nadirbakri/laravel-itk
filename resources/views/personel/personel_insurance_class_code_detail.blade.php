	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url()->previous() }}" target="iframe_dashboard">
				...
				<span class="title-text">Insurance Class Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="insurance_class_code" name="insurance_class_code" placeholder="Insurance Class Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="insurance_class_description">Insurance Class Description</label>
							<input type="text" class="form-control" id="insurance_class_description" name="insurance_class_description" placeholder="Insurance Class Description" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="premium_per_year">Premium Per Year</label>
							<input type="text" class="form-control" id="premium_per_year" name="premium_per_year" placeholder="Premium Per Year" disabled>
						</div>
					</div>
				</div>
			</form>
