	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/location_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Location Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<select class="form-control" id="location_code" name="location_code" disabled>
					...
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="location_name" name="location_name" disabled>
						</div>
					</div>
				</div>
			</form>
