...
<html>
<head>
	<title>{{ __('personel_line_of_business.judul') }}</title>
	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ route('personnel', ['moduleID' => 'PE']) }}" target="iframe_dashboard">
				...
				<span class="title-text">{{ __('personel_line_of_business.list') }}</span>
			</a>
		</div>

		<div class="div-table">
			<table id="line_of_business_table" class="table hover">
				<thead>
					<tr>
						<th>Line of Business Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
  	$('#line_of_business_table thead tr').clone(true).appendTo('#line_of_business_table thead');
    $('#line_of_business_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#line_of_business_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ...
        columns: [
            {data: 'line_of_business_code', name: 'line_of_business_code'},
            {data: 'line_of_business_name', name: 'line_of_business_name'},
