				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="decree_code" name="decree_code" placeholder="Decree Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							<label for="decree_name">Decree Name</label>
							<input type="text" class="form-control" id="decree_name" name="decree_name" placeholder="Decree Name" disabled>
						</div>
					</div>
				</div>
				<div class="row">
