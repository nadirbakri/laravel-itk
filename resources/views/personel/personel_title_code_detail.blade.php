	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/title_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Title Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="title_code" name="title_code" placeholder="Title Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="title_description" name="title_description" placeholder="Title Description" disabled>
						</div>
					</div>
				</div>
			</form>
