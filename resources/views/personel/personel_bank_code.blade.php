...
<body>
	<div class="div-personel">
		...
		<div class="div-table">
			<table id="bank_table" class="table hover">
				<thead>
					<tr>
                        <th></th>
						<th>Bank Code</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.div-navbar a.disabled').attr('onclick', 'return false;');
  	...
  	$('#bank_table thead tr').clone(true).appendTo('#bank_table thead');
    $('#bank_table thead tr:eq(1) th:not(:first-child)').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#bank_table').DataTable({
        ...
        columns: [
            ...
            {data: 'accountFormat', name: 'accountFormat'},
    ...
    $('#bank_table tbody').on('click', 'input[type="checkbox"]', function(e){
    ...
    $('#bank_table').on('click', 'tr td:first-child', function(e){
