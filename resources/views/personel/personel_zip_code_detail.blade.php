	...
	<div class="div-personel">
		...
		<div class="div-title">
			<a href="{{ url('personel/zip_code') }}" target="iframe_dashboard">
				...
				<span class="title-text">Zip Code List</span>
			</a>
		</div>
		<div class="div-form">
			<form>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="zip_code" name="zip_code" placeholder="Zip Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="subdistrict" name="subdistrict" placeholder="Subdistrict" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="village" name="village" placeholder="Village" disabled>
						</div>
					</div>
				</div>
			</form>
