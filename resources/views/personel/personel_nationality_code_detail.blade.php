				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nationality_code" name="nationality_code" placeholder="Nationality Code" disabled>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nationality_name" name="nationality_name" placeholder="Nationality Name" disabled>
						</div>
					</div>
				</div>
			</form>
