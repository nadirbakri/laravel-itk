...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#location_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#location_code_table').DataTable({
        ...
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/location_code/table') }}",
    ...
    $('#location_code_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/location_code/detail_data') }}", { 'location_code' : data.location_code }, "GET", "iframe_dashboard");
    });
