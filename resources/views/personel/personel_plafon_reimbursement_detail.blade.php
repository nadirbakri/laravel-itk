...
<head>
    <title>{{ __('personel_plafon_reimbursement.judul') }}</title>
    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="{{ url()->previous() }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('personel_plafon_reimbursement.list_detail') }}</span>
            </a>
        </div>
        <div class="div-form">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="year">{{ __('personel_plafon_reimbursement.label_year') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="type">{{ __('personel_plafon_reimbursement.label_type') }}</label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="type" name="type"
                                placeholder="{{ __('personel_plafon_reimbursement.label_type') }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="code">{{ __('personel_plafon_reimbursement.label_code') }}</label>
                            <span class="required">*</span>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="status">{{ __('personel_plafon_reimbursement.label_status') }}</label>
                            <span class="required">*</span>
                            <input type="text" class="form-control" id="status" name="status"
                                placeholder="{{ __('personel_plafon_reimbursement.label_status') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="nominal">{{ __('personel_plafon_reimbursement.label_nominal') }}</label>
                            <span class="required">*</span>
                            <input type="number" class="form-control" id="nominal" name="nominal"
                                placeholder="{{ __('personel_plafon_reimbursement.label_nominal') }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking_code">{{ __('personel_plafon_reimbursement.label_ranking_code') }}</label>
                            <span class="required">*</span>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-save" id="btn-save"
                            style="width: 100%;">
                            <i class="fa fa-floppy-o"></i> {{ __('personel_plafon_reimbursement.btn_save') }}
                        </button>
                    </div>
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="{{ url('personnel/plafon_reimbursement') }}" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> {{ __('personel_plafon_reimbursement.btn_cancel') }}
                        </a>
                    </div>
                </div>
            </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('personel_plafon_reimbursement.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (func == 'new') {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('/plafon_reimbursement/func/api') }}",
                data: {
        ...
        function loadDataPlafonCode() {
            ...
            $('#code').select2({
                ...
                ajax: {
                    url: "{{ url('/plafon_reimbursement/api') }}",
                    dataType: 'json',
                    delay: 250,
                    type: "GET",
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "{{ url('personnel/plafon_reimbursement') }}";
        })
        ...
        if ($("#plafon_form").length > 0) {
            $("#plafon_form").validate({
                ...
                messages: {
                    year: {
                        required: "{{ __('personel_plafon_reimbursement.year_required') }}",
                    },
                    type: {
                        required: "{{ __('personel_plafon_reimbursement.type_required') }}",
                    },
                    code: {
                        required: "{{ __('personel_plafon_reimbursement.code_required') }}",
                    },
                    status: {
                        required: "{{ __('personel_plafon_reimbursement.status_required') }}",
                    },
                    nominal: {
                        required: "{{ __('personel_plafon_reimbursement.nominal_required') }}",
                    },
                    ranking_code: {
                        required: "{{ __('personel_plafon_reimbursement.ranking_code_required') }}",
                    },
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('personnel/plafon_reimbursement/proses') }}",
                        type: "POST",
                        ...
                        success: function (response) {
                            if (response.status == "true") {
                                ...
                                setTimeout(function () {
                                    window.location =
                                        "{{ url('personnel/plafon_reimbursement') }}";
                                }, 3000);
                            } else {
                                $("#btn-save").prop("disabled", false);
                                $("#btn-save").html(
