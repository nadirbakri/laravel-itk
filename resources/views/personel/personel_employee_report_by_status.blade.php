    ...
    <div class="div-personel">
        <div class="div-title">
            <a href="{{ url('personel') }}" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text">{{ __('personel_employee_report_by_status.list') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="employee_report_by_status_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from">{{ __('personel_employee_report_by_status.label_employee_no_from') }}</label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to">{{ __('personel_employee_report_by_status.label_employee_no_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="report_type">{{ __('personel_employee_report_by_status.label_report_type') }}</label>
                            <select class="form-control select2" id="report_type" name="report_type">
                                <option hidden>Choose Report Type</option>
                                <option value="terminate" id="terminate">{{ __('personel_employee_report_by_status.label_select_terminate') }}</option>
                                <option value="probation" id="probation">{{ __('personel_employee_report_by_status.label_select_probation') }}</option>
                                <option value="contract" id="contract">{{ __('personel_employee_report_by_status.label_select_contract') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign">{{ __('personel_employee_report_by_status.label_include_resign') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
