...
<body>
	<div class="div-personel">
		...
		<div class="div-table">
			<table id="skill_code_table" class="table hover">
				<thead>
					<tr>
						<th>Skill Code</th>
...
<script type="text/javascript">
  $(document).ready(function() {
  	$('#skill_code_table thead tr').clone(true).appendTo('#skill_code_table thead');
    $('#skill_code_table thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#skill_code_table').DataTable({
        processing: true,
        serverSide: true,
        orderCellsTop: true,
        ajax: "{{ url('personel/skill_code/table') }}",
    ...
    $('#skill_code_table tbody').on('click', 'tr', function () {
    	var data = table.row(this).data();
    	$.redirect("{{ url('personel/skill_code/detail_data') }}", { 'skill_code' : data.skill_code }, "GET", "iframe_dashboard");
    });
