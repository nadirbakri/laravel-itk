    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="{{ url('/time_management') }}" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text">{{ __('tm_monthly_absenteeism_analysis.list') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="monthly_absenteeism_analysis_form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign">{{ __('tm_monthly_absenteeism_analysis.label_include_resign') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from">{{ __('tm_monthly_absenteeism_analysis.label_group_authorize_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to">{{ __('tm_monthly_absenteeism_analysis.label_group_authorize_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('tm_monthly_absenteeism_analysis.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('tm_monthly_absenteeism_analysis.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('tm_monthly_absenteeism_analysis.label_location') }}</label>
                ...
                <div class="row">
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary" name="btn-print-data" id="btn-print-data"
                            style="width: 100%;">
                            <i class="fa fa-print"></i> {{ __('tm_monthly_absenteeism_analysis.btn_print') }}
                        </button>
                    </div>
                </div>
            </form>
            ...
            $("#monthly_absenteeism_analysis_form").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('time_management/monthly_absenteeism_analysis/print') }}",
                        type: "POST",
