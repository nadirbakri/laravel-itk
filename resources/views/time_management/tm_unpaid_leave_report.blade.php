    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="{{ route('time_management', ['moduleID' => 'TM']) }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('tm_unpaid_leave_report.list') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="unpaid_leave_report_form" method="post">
                @csrf
                <div class="row d-flex gap-4">
                    <div class="form-group" style="padding-left: 15px">
                        <label for="get_employee form-check-label">{{ __('tm_unpaid_leave_report.label_get_employee') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_all" name="get_employee" value="ALL" checked>
                        <label for="get_employee_all">{{ __('tm_unpaid_leave_report.label_all') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_range" name="get_employee" value="RANGE">
                        <label for="get_employee_range">{{ __('tm_unpaid_leave_report.label_range') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_list" name="get_employee" value="LIST">
                        <label for="get_employee_list">{{ __('tm_unpaid_leave_report.label_list') }}</label>
                    </div>
                </div>
                <div class="row" id="employee_range">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from">{{ __('tm_unpaid_leave_report.label_employee_no_from') }}</label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from" disabled></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to">{{ __('tm_unpaid_leave_report.label_employee_no_to') }}</label>
                ...
                <div class="row" id="employee_list">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_list">{{ __('tm_unpaid_leave_report.label_employee_no_list') }}</label>
                ...
                <div class="row d-flex gap-4">
                    <div class="form-group" style="padding-left: 15px">
                        <label for="get_date form-check-label">{{ __('tm_unpaid_leave_report.label_get_date') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_date_period" name="get_date" value="PERIOD" checked>
                        <label for="get_date_period">{{ __('tm_unpaid_leave_report.label_period') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_date_range" name="get_date" value="RANGE_DATE">
                        <label for="get_date_range">{{ __('tm_unpaid_leave_report.label_range') }}</label>
                    </div>
                </div>
                <div class="row" id="date_period">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('tm_unpaid_leave_report.label_period') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="{{ __('tm_unpaid_leave_report.label_period') }}">
                ...
                <div class="row" id="date_range">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_from">{{ __('tm_unpaid_leave_report.label_absent_date_from') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_from" name="absent_date_from"
                                    placeholder="{{ __('tm_unpaid_leave_report.label_absent_date_from') }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_to">{{ __('tm_unpaid_leave_report.label_absent_date_to') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_to" name="absent_date_to"
                                    placeholder="{{ __('tm_unpaid_leave_report.label_absent_date_to') }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="include_resign">{{ __('tm_unpaid_leave_report.label_include_resign') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from">{{ __('tm_unpaid_leave_report.label_group_authorize_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to">{{ __('tm_unpaid_leave_report.label_group_authorize_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('tm_unpaid_leave_report.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('tm_unpaid_leave_report.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('tm_unpaid_leave_report.label_location') }}</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-print-data").click(function () {
            ...
            $("#unpaid_leave_report_form").submit();
        });
            ...
            $("#unpaid_leave_report_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('time_management/unpaid_leave_report/print') }}",
                        type: "POST",
                        data: $('#unpaid_leave_report_form').serialize(),
