        ...
        <div class="div-form">
            <form id="tm_detail_absenteeism_report_form" method="post">
                ...
                <div class="row" id="date_range">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_from">{{ __('tm_detail_absenteeism_report.label_absent_date_from') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_from" name="absent_date_from"
                                    placeholder="{{ __('tm_detail_absenteeism_report.label_absent_date_from') }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_to">{{ __('tm_detail_absenteeism_report.label_absent_date_to') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_to" name="absent_date_to"
                                    placeholder="{{ __('tm_detail_absenteeism_report.label_absent_date_to') }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from">{{ __('tm_detail_absenteeism_report.label_group_authorize_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to">{{ __('tm_detail_absenteeism_report.label_group_authorize_to') }}</label>
                    ...
                    <div class="form-group ml-4">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label"
                                for="include_resign">{{ __('tm_detail_absenteeism_report.label_include_resign') }}</label>
                        </div>
                    </div>
                </div>    
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('tm_detail_absenteeism_report.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('tm_detail_absenteeism_report.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('tm_detail_absenteeism_report.label_location') }}</label>
