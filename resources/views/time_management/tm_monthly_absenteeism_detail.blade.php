            ...
            <form id="monthly_absenteeism_detail_form" method="post">
                ...
                <div class="row d-flex gap-4">
                    <div class="form-group" style="padding-left: 15px">
                        <label for="get_employee form-check-label">{{ __('tm_monthly_absenteeism_detail.label_get_employee') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_all" name="get_employee" value="ALL" checked>
                        <label for="get_employee_all">{{ __('tm_monthly_absenteeism_detail.label_all') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_range" name="get_employee" value="RANGE">
                        <label for="get_employee_range">{{ __('tm_monthly_absenteeism_detail.label_range') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_list" name="get_employee" value="LIST">
                        <label for="get_employee_list">{{ __('tm_monthly_absenteeism_detail.label_list') }}</label>
                    </div>
                </div>
                ...
                <div class="row" id="employee_list">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_list">{{ __('tm_monthly_absenteeism_detail.label_employee_no_list') }}</label>
                ...
                <div class="row d-flex gap-4">
                    <div class="form-group" style="padding-left: 15px">
                        <label for="get_date form-check-label">{{ __('tm_monthly_absenteeism_detail.label_get_date') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_date_period" name="get_date" value="PERIOD" checked>
                        <label for="get_date_period">{{ __('tm_monthly_absenteeism_detail.label_period') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_date_range" name="get_date" value="RANGE_DATE">
                        <label for="get_date_range">{{ __('tm_monthly_absenteeism_detail.label_range') }}</label>
                    </div>
                </div>
                <div class="row" id="date_period">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('tm_monthly_absenteeism_detail.label_period') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="{{ __('tm_monthly_absenteeism_detail.label_period') }}">
                ...
                <div class="row" id="date_range">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_from">{{ __('tm_monthly_absenteeism_detail.label_absent_date_from') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_from" name="absent_date_from"
                                    placeholder="{{ __('tm_monthly_absenteeism_detail.label_absent_date_from') }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="absent_date_to">{{ __('tm_monthly_absenteeism_detail.label_absent_date_to') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="absent_date_to" name="absent_date_to"
                                    placeholder="{{ __('tm_monthly_absenteeism_detail.label_absent_date_to') }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><span class="fa fa-calendar"></span></span>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        if ($("#monthly_absenteeism_detail_form").length > 0) {
            $("#monthly_absenteeism_detail_form").validate({
                ...
                messages: {
                    employee_no_from: {
                        required: "{{ __('tm_monthly_absenteeism_detail.employee_no_from_required') }}",
                    },
                    employee_no_to: {
                        required: "{{ __('tm_monthly_absenteeism_detail.employee_no_to_required') }}",
                    },
                    absent_date_from: {
                        required: "{{ __('tm_monthly_absenteeism_detail.absent_date_from_required') }}",
                    },
                    absent_date_to: {
                        required: "{{ __('tm_monthly_absenteeism_detail.absent_date_to_required') }}",
                    },
                    // group_authorize_from: {
                    //     required: "{{ __('tm_monthly_absenteeism_detail.field_required') }}",
                    // },
                    // group_authorize_to: {
                    //     required: "{{ __('tm_monthly_absenteeism_detail.field_required') }}",
                    // },
                ...
                submitHandler: function (form) {
                    ...
                    if (clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "{{ url('time_management/monthly_absenteeism_detail/excel/print') }}",
                            type: "POST",
                            data: { 
                                'field' : $('#monthly_absenteeism_detail_form').serialize(), 
