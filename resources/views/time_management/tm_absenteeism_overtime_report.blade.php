            ...
            <form id="tm_absenteeism_overtime_report_form" method="post">
                ...
                <div class="row d-flex gap-4">
                    <div class="form-group" style="padding-left: 15px">
                        <label for="get_employee form-check-label">{{ __('tm_absenteeism_overtime_report.label_get_employee') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_all" name="get_employee" value="ALL" checked>
                        <label for="get_employee_all">{{ __('tm_absenteeism_overtime_report.label_all') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_range" name="get_employee" value="RANGE">
                        <label for="get_employee_range">{{ __('tm_absenteeism_overtime_report.label_range') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="get_employee_list" name="get_employee" value="LIST">
                        <label for="get_employee_list">{{ __('tm_absenteeism_overtime_report.label_list') }}</label>
                    </div>
                </div>
                ...
                <div class="row" id="employee_list">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_list">{{ __('tm_absenteeism_overtime_report.label_employee_no_list') }}</label>
                        ...
                        <div class="form-group">
                            <div class="form-radio">
                                <input class="form-radio-input" type="radio" id="absent"
                                    name="report_type" value="absent" checked>
