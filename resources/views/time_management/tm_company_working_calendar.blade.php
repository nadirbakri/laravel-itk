...
<head>
    <title>{{ __('tm_company_working_calendar.judul') }}</title>
    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="{{ url('time_management') }}" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text">{{ __('tm_company_working_calendar.list') }}</span>
            </a>
        </div>
        {{-- <div class="div-form">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('tm_company_working_calendar.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
    ...
    <div class="row">
        <div class="col-2">
            <button type="submit" class="btn btn-primary" name="btn-add-company" id="btn-add-company"
                ...
                <i class="fa fa-plus"></i> {{ __('tm_company_working_calendar.btn_add') }}
            </button>
        </div>
        <div class="col-2">
            <button type="submit" class="btn btn-primary" name="btn-edit-company" id="btn-edit-company"
                style="width: 100%;">
                <i class="fa fa-pencil"></i> {{ __('tm_company_working_calendar.btn_edit') }}
            </button>
        </div>
        <div class="col-2">
            <button type="submit" class="btn btn-danger" name="btn-delete-data" id="btn-delete-data"
                style="width: 100%;">
                <i class="fa fa-times"></i> {{ __('tm_company_working_calendar.btn_delete') }}
            </button>
        </div>
    </div>
    <div class="modal fade" id="modal_add_company_working_calendar" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('tm_company_working_calendar.list') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="calendar_date">{{ __('tm_company_working_calendar.label_date') }}</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="calendar_date" name="calendar_date"
                                            placeholder="{{ __('tm_company_working_calendar.label_date') }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="description">{{ __('tm_company_working_calendar.label_description') }}</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#notification_success').on('hide.bs.modal', function () {
            window.location = "{{ url('time_management/company_working_calendar') }}";
        })
        ...
        function loadDataCalendarType() {
            function formatSelect(data) {
                ...
                if (data.id) {
                    var $result2 = $('<div class="row">' + 
                        '<div class="col-12"><b>Calendar Type</b></div>' +
                        '</div>' +
                        '<div class="row">' +
        ...
        if ($("#company_working_calendar_form").length > 0) {
            $("#company_working_calendar_form").validate({
                ...
                messages: {
                    calendar_date: {
                        required: "{{ __('tm_company_working_calendar.date_required') }}",
                    },
                    location: {
                        required: "{{ __('tm_company_working_calendar.location_required') }}",
                    },
                    calendar_type: {
                        required: "{{ __('tm_company_working_calendar.calendar_type_required') }}",
                    }
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('time_management/company_working_calendar/proses') }}",
                        type: "POST",
