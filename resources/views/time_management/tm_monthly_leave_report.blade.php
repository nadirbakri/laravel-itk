    ...
    <div class="div-time_management">
        <div class="div-title">
            <a href="{{ url('time_management') }}" target="iframe_dashboard" id="toolbar-prev-page">
                ...
                <span class="title-text">{{ __('tm_monthly_leave_report.list') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="monthly_leave_report_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="employee_no_from">{{ __('tm_monthly_leave_report.label_employee_no_from') }}</label>
                            <select class="form-control select2" id="employee_no_from" name="employee_no_from"></select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="employee_no_to">{{ __('tm_monthly_leave_report.label_employee_no_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="period">{{ __('tm_monthly_leave_report.label_period') }}</label>
                            <div class='input-group'>
                                <input type="text" class="form-control" id="period" name="period"
                                    placeholder="{{ __('tm_monthly_leave_report.label_period') }}">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_from">{{ __('tm_monthly_leave_report.label_group_authorize_from') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                for="group_authorize_to">{{ __('tm_monthly_leave_report.label_group_authorize_to') }}</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="position">{{ __('tm_monthly_leave_report.label_position') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="ranking">{{ __('tm_monthly_leave_report.label_ranking') }}</label>
                ...
                <div class="row" id="div-level">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="location">{{ __('tm_monthly_leave_report.label_location') }}</label>
            ...
            $("#monthly_leave_report_form").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('time_management/monthly_leave_report/print') }}",
                        type: "POST",
