...
<body>
    <div class="div-form">
        <form id="claim_report_form" method="post">
            @csrf
            <div class="div-medical">
                <div class="div-title">
                    <a href="{{ url('medical') }}" target="iframe_dashboard">
                        <img src="{{ url('/pictures/arrow-square-left.png') }}" alt="Back">
                        <span class="title-text">{{ __('md_claim_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label">{{ __('md_claim_report.label_employee_no') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('md_claim_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="grand_total">{{ __('md_claim_report.label_grand_total') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="claim_code_from form-check-label">{{ __('md_claim_report.label_claim_code') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_code_to form-check-label">{{ __('md_claim_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="claim_date_from">{{ __('md_claim_report.label_claim_date') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_from" name="claim_date_from"
                                placeholder="{{ __('md_claim_report.label_claim_date') }}">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_date_to form-check-label">{{ __('md_claim_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="claim_date_to" name="claim_date_to"
                                placeholder="{{ __('md_claim_report.label_claim_report') }}">
                            <div class="input-group-prepend">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="currency_code_from form-check-label">{{ __('md_claim_report.label_currency_code') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="currency_code_to form-check-label">{{ __('md_claim_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label">{{ __('md_claim_report.label_group_authorized_code') }} <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label">{{ __('md_claim_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="sort_by_amount">{{ __('md_claim_report.label_sort_by_amount') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="sort_by_amount"
                                name="sort_by_amount" value="true">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label">{{ __('md_claim_report.label_position') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label">{{ __('md_claim_report.label_ranking') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label">{{ __('md_claim_report.label_location') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('md_claim_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let claimDateFrom = $('#claim_date_from').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
            ...
            onReady: function () {
                ...
                $flatPickrInput.siblings("#claim_date_from_calendar").click(function () {
                    flatPickrInstance.toggle();
                });
            }
        });

        let claimDateTo = $('#claim_date_to').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
            ...
            onReady: function () {
                var flatPickrInstance = this;
                var $flatPickrInput = $(flatPickrInstance.element);
                $flatPickrInput.siblings("#claim_date_to_calendar").click(function () {
                    flatPickrInstance.toggle();
                });
            }
        });
        ...
        if($('#claim_report_form').length > 0){
            $('#claim_report_form').validate({
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "{{ url('medical/claim_report/print/excel') }}",
                            type: "POST",
                            data: $('#claim_report_form').serialize(),
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "{{ url('medical/claim_report/print') }}",
                            type: "POST",
                            data: $('#claim_report_form').serialize(),
                            success: function(result, status, xhr){
