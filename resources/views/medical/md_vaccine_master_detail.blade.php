    ...
    <div class="div-medical">
        <div class="div-title">
            <a href="{{ url()->previous() }}" target="iframe_dashboard">
                ...
                <span class="title-text">{{ __('md_vaccine_master.list_detail') }}</span>
            </a>
        </div>
        <div class="div-form">
            <form id="vaccine_master_form" method="post">
                @csrf
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="vaccine_name" name="vaccine_name"
                                placeholder="{{ __('md_vaccine_master.label_vaccine_name') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn btn-outline-primary" href="{{ url('medical/vaccine_master') }}" target="iframe_dashboard"
                            name="btn-cancel" id="btn-cancel" style="width: 100%;">
                            <i class="fa fa-times-circle"></i> {{ __('md_vaccine_master.btn_cancel') }}
                        </a>
                    </div>
                </div>
            </form>
        ...
        if ($("#vaccine_master_form").length > 0) {
            $("#vaccine_master_form").validate({
                ...
                messages: {
                    ...
                    vaccine_name: {
                        required: "{{ __('md_vaccine_master.vaccine_name_required') }}",
                    }
                },
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ url('medical/vaccine_master/proses') }}",
                        type: "POST",
                        data: $('#vaccine_master_form').serialize(),
