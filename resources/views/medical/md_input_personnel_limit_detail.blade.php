        ...
        <div class="div-form">
            <form id="input_personnel_limit_form" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="max_limit_per_claim" name="max_limit_per_claim"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="max_limit_per_year" name="max_limit_per_year"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="max_limit_per_month" name="max_limit_per_month"
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn btn-primary" href="{{ url('medical/input_personnel_limit') }}" target="iframe_dashboard"
