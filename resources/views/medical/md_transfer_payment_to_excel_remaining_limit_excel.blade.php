...
<table style="width: 100%;" class="table table-bordered table-hover responsive table_detail">
        <thead>
            <tr>
                ...
                <th style="text-align:center; border:1px solid #000; padding:4px; background-color: #97d7f7;">Remaining Currency Code</th>
                <th style="text-align:center; border:1px solid #000; padding:4px; background-color: #97d7f7;">Claim To</th>
                <th style="text-align:center; border:1px solid #000; padding:4px; background-color: #97d7f7;">Remaining Amount</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:left; border:1px solid #000;">{{ $value->claimTo }}</td>
                <td style="text-align:left; border:1px solid #000;">{{ $value->remainingAmount }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
