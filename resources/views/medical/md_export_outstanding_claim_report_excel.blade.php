...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="14">{{ $data_company[0]->companyName }}</th>
            </tr>
            <tr>
                <th colspan="14">{{ $data_company[0]->address }}</th>
            </tr>
            <tr></tr>
            <tr>
                <th colspan="14" style="text-align:center; font-weight:bold;"><h3>Outstanding Claim Report {{ ($claim_to == 'C') ? 'By Company' : '' }}{{ ($claim_to == 'I') ? 'By Insurance' : '' }}</h3></th>
            </tr>
        </thead>
    </table>
