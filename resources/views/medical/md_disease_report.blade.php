...
<body>
    <div class="div-form">
        <form id="disease_report_form" method="post">
            @csrf
            <div class="div-medical">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="report_type form-check-label">{{ __('md_disease_report.label_report_type') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="type_detail" name="report_type" value="detail" checked>
                            <label for="type_detail">{{ __('md_disease_report.label_detail') }}</label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input type="radio" id="type_summary" name="report_type" value="summary">
                            <label for="type_summary">{{ __('md_disease_report.label_summary') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label">{{ __('md_disease_report.label_employee_no') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('md_disease_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="disease_from form-check-label">{{ __('md_disease_report.label_disease') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <select class="form-control select2" id="disease_from" name="disease_from"></select>
                    </div>
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="disease_to form-check-label">{{ __('md_disease_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <select class="form-control select2" id="disease_to" name="disease_to"></select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="period_claim_from">{{ __('md_disease_report.label_period_claim') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="period_claim_from" name="period_claim_from"
                                placeholder="{{ __('md_disease_report.label_period_claim') }}">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="period_claim_from_calendar"><span class="fa fa-calendar"></span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="period_claim_to form-check-label">{{ __('md_disease_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="period_claim_to" name="period_claim_to"
                                placeholder="{{ __('md_disease_report.label_period_claim') }}">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="period_claim_to_calendar"><span class="fa fa-calendar"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label">{{ __('md_disease_report.label_group_authorized_code') }} <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label">{{ __('md_disease_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label">{{ __('md_disease_report.label_position') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label">{{ __('md_disease_report.label_ranking') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label">{{ __('md_disease_report.label_location') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('md_disease_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let periodClaimFrom = $('#period_claim_from').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
            ...
            onReady: function () {
                ...
                $flatPickrInput.siblings("#period_claim_from_calendar").click(function () {
                    flatPickrInstance.toggle();
                });
            }
        });

        let periodClaimTo = $('#period_claim_to').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
            ...
            onReady: function () {
                var flatPickrInstance = this;
                var $flatPickrInput = $(flatPickrInstance.element);
                $flatPickrInput.siblings("#period_claim_to_calendar").click(function () {
                    flatPickrInstance.toggle();
                });
            }
        });
        ...
        loadDataDisease('#disease_from');
        loadDataDisease('#disease_to');
        ...
        loadDataFirstLastAllDisease('#disease_from', 'First');
        loadDataFirstLastAllDisease('#disease_to', 'Last');
        ...
        function loadDataFirstLastAllDisease(field = '', func = '') {
            $.ajax({
                type: 'GET',
                url: "{{ url('/disease_code/func2/api') }}",
                data: {
                    'func': func
                }
            }).then(function (data) {
                console.log(data);
                var $newOption = $("<option selected='selected'></option>").val(data.diseaseCode)
                    .text(data.description);
                $(field).append($newOption).trigger('change');
            });
        }

        function loadDataDisease(field = '') {
            function formatSelect(data) {
                if (data.loading) {
                    return $search
                }
