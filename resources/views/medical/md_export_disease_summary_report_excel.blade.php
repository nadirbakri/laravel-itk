...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="3">{{ $data_company[0]->companyName }}</th>
            </tr>
            <tr>
                <th colspan="3">{{ $data_company[0]->address }}</th>
            </tr>
            <tr></tr>
            <tr>
                <th colspan="3" style="text-align:center; font-weight:bold;"><h3>{{ ucfirst($type) }} Disease Report</h3></th>
            </tr>
            <tr>
                <th colspan="3" style="text-align:center; font-weight:bold;"><pre>Period Claim Date : {{ $period }}</pre></th>
            </tr>
        </thead>
    </table>
