...
<html>
<head>
    <title>{{ __('md_remaining_medical_limit_report.judul') }}</title>
...
<body>
    <div class="div-form">
        <form id="remaining_medical_limit_report_form" method="post">
            @csrf
            <div class="div-medical">
                <div class="div-title">
                    <a href="{{ url('medical') }}" target="iframe_dashboard">
                        <img src="{{ url('/pictures/arrow-square-left.png') }}" alt="Back">
                        <span class="title-text">{{ __('md_remaining_medical_limit_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="employee_no_from form-check-label">{{ __('md_remaining_medical_limit_report.label_employee_no') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('md_remaining_medical_limit_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="include_resign">{{ __('md_remaining_medical_limit_report.label_include_resign') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="grand_total">{{ __('md_remaining_medical_limit_report.label_grand_total') }}</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-check">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="claim_code_from form-check-label">{{ __('md_remaining_medical_limit_report.label_claim_code') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="claim_code_to form-check-label">{{ __('md_remaining_medical_limit_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="currency_code_from form-check-label">{{ __('md_remaining_medical_limit_report.label_currency_code') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="currency_code_to form-check-label">{{ __('md_remaining_medical_limit_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="group_authorized_code_from form-check-label">{{ __('md_remaining_medical_limit_report.label_group_authorized_code') }} <span style="color: red">*</span></label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label">{{ __('md_remaining_medical_limit_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="position form-check-label">{{ __('md_remaining_medical_limit_report.label_position') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="ranking form-check-label">{{ __('md_remaining_medical_limit_report.label_ranking') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row" id="div-level">
                    <div class="col-2">
                        <div class="form-group">
                            <label for="location form-check-label">{{ __('md_remaining_medical_limit_report.label_location') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-primary" name="btn-preview" id="btn-preview" value="preview" style="width: 100%;">
                            <i class="fa fa-eye"></i> {{ __('md_remaining_medical_limit_report.btn_preview') }}
                        </button>
                    </div>
                    <div class="col-3 desc" id="send-to-slip" style="display: none;">
                        <button class="btn btn-primary" id="btn-send" style="width: 100%;">
                            <i class="fa fa-print"></i> {{ __('md_remaining_medical_limit_report.btn_send_to') }}
                        </button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('md_remaining_medical_limit_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-send').click(function (){
            ...
            $('#remaining_medical_limit_report_form').submit();
        });
        ...
        if($('#remaining_medical_limit_report_form').length > 0){
            $('#remaining_medical_limit_report_form').validate({
                submitHandler: function(form){
                    ...
                    if(clicked=="DOWNLOAD_XLS"){
                        $.ajax({
                            ...
                            url: "{{ url('medical/remaining_medical_limit_report/print/excel') }}",
                            type: "POST",
                            data: $('#remaining_medical_limit_report_form').serialize(),
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            url: "{{ url('medical/remaining_medical_limit_report/print') }}",
                            type: "POST",
                            data: $('#remaining_medical_limit_report_form').serialize(),
                            success: function(result, status, xhr){
