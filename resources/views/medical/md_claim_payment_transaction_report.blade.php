...
<html>
<head>
    <title>{{ __('md_claim_payment_transaction_report.judul') }}</title>
...
<body>
    <div class="div-form">
        <form id="claim_payment_transaction_report_form" method="post">
            @csrf
            <div class="div-medical">
                <div class="div-title">
                    <a href="{{ url('medical') }}" target="iframe_dashboard">
                        <img src="{{ url('/pictures/arrow-square-left.png') }}" alt="Back">
                        <span class="title-text">{{ __('md_claim_payment_transaction_report.list') }}</span>
                    </a>
                </div>
                <div class="row">
                    <div class="col-2">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="employee_no_to form-check-label">{{ __('md_claim_payment_transaction_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="payment_date_from" name="payment_date_from"
                                placeholder="{{ __('md_claim_payment_transaction_report.label_payment_date') }}">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="payment_date_to form-check-label">{{ __('md_claim_payment_transaction_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                ...
                <div class="row">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="currency_code_to form-check-label">{{ __('md_claim_payment_transaction_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="row">
                    ...
                    <div class="col-0.5">
                        <div class="form-group">
                            <label for="group_authorized_code_to form-check-label">{{ __('md_claim_payment_transaction_report.label_to') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-check">
                            <input type="radio" id="type_report" name="report_type" value="report" checked>
                            <label for="type_report">{{ __('md_claim_payment_transaction_report.label_report') }}</label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="div-title-notification">
                        ...
                        <span class="title-text-notification">{{ __('md_claim_payment_transaction_report.alert_success') }}</span>
                    </div>
                    <div class="div-title-notification">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let periodClaimFrom = $('#payment_date_from').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
        ...
        let periodClaimTo = $('#payment_date_to').flatpickr({
            altInput: true,
            allowInput: true,
            altFormat: "j-M-y",
            dateFormat: "Y-m-d",
