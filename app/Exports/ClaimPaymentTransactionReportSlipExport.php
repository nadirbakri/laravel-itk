...
class ClaimPaymentTransactionReportSlipExport implements FromView, ShouldAutoSize
{
    public function __construct($employeeNoFrom, $employeeNoTo, $paymentDateFrom, $paymentDateTo, $currencyCodeFrom, $currencyCodeTo, $groupAuthorizedCodeFrom, $groupAuthorizedCodeTo, $reportType, $position, $ranking, $location, $dataLevel)
    {
    ...
    public function view(): View
    {
        try {
            ...
            $response = $client->post(env('API_URL').'/mdclaimpaymenttransactionreportandslip/getclaimpaymenttransactionreportandslip', [
