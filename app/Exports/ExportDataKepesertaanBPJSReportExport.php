...
class ExportDataKepesertaanBPJSReportExport implements FromView, ShouldAutoSize
{
    public function __construct($employeeNoFrom, $employeeNoTo, $position, $ranking, $location, $dataLevel)
    {
