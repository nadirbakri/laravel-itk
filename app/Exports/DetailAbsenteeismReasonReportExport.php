...
class DetailAbsenteeismReasonReportExport implements FromView
{
    ...
    public function view(): View
    {
        try {
            ...
            $response = $client->post(env('API_URL') . '/dailyabsenteeismdetailreasonreport/getdailyabsenteeismdetailreasonreport',
