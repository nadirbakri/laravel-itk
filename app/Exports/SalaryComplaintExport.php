...
class SalaryComplaintExport extends DefaultValueBinder implements WithCustomValueBinder, FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        if($arrResult->dataListSet == null){
            return view('export.salary_complaint_export', [
