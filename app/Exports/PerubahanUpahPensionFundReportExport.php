...
class PerubahanUpahPensionFundReportExport extends DefaultValueBinder implements WithCustomValueBinder, FromView, WithEvents, ShouldAutoSize
{
    public function __construct($period, $groupDepartment, $printDate, $groupAuthorizedCodeFrom, $groupAuthorizedCodeTo)
    {
        $this->period = $period;
    ...
    public function view(): View
    {
        try {
            ...
            $param = [
                ...
                "groupAuthFrom" => $this->groupAuthorizedCodeFrom,
                "groupAuthTo" => $this->groupAuthorizedCodeTo,
                "levelMaster" => [[
                    "companyCode" => Session::get('companyCode'),
                    "levelType" => "1",
                    "level" => [[
            ...
            $response = $client->post(env('API_URL').'/payroll/perubahanUpahDanaPensiun', [
