...
class EBupotPeriodicalTemplateExport implements WithMultipleSheets
{
    ...
    {
        $sheets[] = new RekapEBupotPeriodicalSheet(
            $this->format, 
            $this->period,
            $this->rectification,
            $this->npwpGroup,
        ...
        $sheets[] = new DuaSatuEBupotPeriodicalSheet(
            $this->format, 
            $this->period,
            $this->rectification,
            $this->npwpGroup,
        ...
        $sheets[] = new DuaEnamEBupotPeriodicalSheet(
            $this->format, 
            $this->period,
            $this->rectification,
            $this->npwpGroup,
