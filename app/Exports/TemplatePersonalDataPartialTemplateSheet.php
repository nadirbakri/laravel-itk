...
class TemplatePersonalDataPartialTemplateSheet implements FromView, WithTitle, ShouldAutoSize
{
    ...
    {
        return view('personel.personel_export_template_personal_data_partial_template_sheet', [
