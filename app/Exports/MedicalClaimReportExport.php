...
class MedicalClaimReportExport implements FromView, ShouldAutoSize
{
    public function __construct($grandTotal, $employeeNoFrom, $employeeNoTo, $claimCodeFrom, $claimCodeTo, $claimDateFrom, $claimDateTo, $currencyCodeFrom, $currencyCodeTo, $groupAuthorizedCodeFrom, $groupAuthorizedCodeTo, $sortByAmount, $position, $ranking, $location, $dataLevel)
    {
    ...
    public function view(): View
    {
        try {
            ...
            if(!empty($this->claimDateFrom) || !empty($this->claimDateTo)){
                $param['claimDateFrom'] = $this->claimDateFrom;
                $param['claimDateTo'] = $this->claimDateTo;
            }
