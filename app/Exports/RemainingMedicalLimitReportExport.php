...
class RemainingMedicalLimitReportExport implements FromView, ShouldAutoSize
{
    public function __construct($grandTotal, $includeResign, $employeeNoFrom, $employeeNoTo, $claimCodeFrom, $claimCodeTo, $currencyCodeFrom, $currencyCodeTo, $groupAuthorizedCodeFrom, $groupAuthorizedCodeTo, $position, $ranking, $location, $dataLevel)
    {
    ...
    public function view(): View
    {
        try {
            ...
            $response = $client->post(env('API_URL').'/mdremainingmedicallimitreport/getremainingmedicallimitreport', [
