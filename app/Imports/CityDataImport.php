...
class CityDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'City Code is Required',
                '*.0.not_in' => 'City Code cannot be Null',
                '*.1.required' => 'City Name is Required',
                '*.1.not_in' => 'City Name cannot be Null'
            ])->validate();
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "cityCode" => (isset($row[0])) ? (string) trim($row[0]) : null,
