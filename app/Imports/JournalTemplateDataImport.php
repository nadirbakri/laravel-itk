        ...
        try {
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "journalCode" => (isset($row[0])) ? strval($row[0]) : null,
                    "fieldName" => (isset($row[1])) ? strval($row[1]) : null,
                    "debitKredit" => (isset($row[2])) ? strval($row[2]) : null,
                    "operator" => (isset($row[3])) ? strval($row[3]) : null,
                    "costCenter" => (isset($row[4])) ? strval($row[4]) : null,
                    "account" => (isset($row[5])) ? strval($row[5]) : null,
                    "grouping1" => (isset($row[6])) ? strval($row[6]) : null,
                    "grouping2" => (isset($row[7])) ? strval($row[7]) : null,
                    "changedNo" => 0,
