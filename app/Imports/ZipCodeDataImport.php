...
class ZipCodeDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'Propinsi is Required',
                '*.0.not_in' => 'Propinsi cannot be Null',
                '*.1.required' => 'Kabupaten is Required',
                '*.1.not_in' => 'Kabupaten cannot be Null',
                '*.2.required' => 'Kecamatan is Required',
                '*.2.not_in' => 'Kecamatan cannot be Null',
                '*.3.required' => 'Kelurahan is Required',
                '*.3.not_in' => 'Kelurahan cannot be Null',
                '*.4.required' => 'Zip Code is Required',
                '*.4.not_in' => 'Zip Code cannot be Null'
            ])->validate();
