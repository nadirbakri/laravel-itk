...
class NatureofWorkDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'Work Nature Code is Required',
                '*.0.not_in' => 'Work Nature Code cannot be Null',
                '*.1.required' => 'Work Nature Name is Required',
                '*.1.not_in' => 'Work Nature Name cannot be Null'
            ])->validate();
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "workNatureCode" => (isset($row[0])) ? (string) trim($row[0]) : null,
