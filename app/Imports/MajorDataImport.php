...
class MajorDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'Major Code is Required',
                '*.0.not_in' => 'Major Code cannot be Null',
                '*.1.required' => 'Major Name is Required',
                '*.1.not_in' => 'Major Name cannot be Null'
            ])->validate();
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "majorCode" => (isset($row[0])) ? strval($row[0]) : null,
                    "majorName" => (isset($row[1])) ? $row[1] : null,
                    "changedNo" => 0,
