...
class GradeDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'Grade Code is Required',
                '*.0.not_in' => 'Grade Code cannot be Null',
                '*.1.required' => 'Grade Name is Required',
                '*.1.not_in' => 'Grade Name cannot be Null'
            ])->validate();
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "gradeCode" => (isset($row[0])) ? (string) trim($row[0]) : null,
                    "gradeName" => (isset($row[1])) ? (string) $row[1] : null,
                    "changedNo" => 0,
