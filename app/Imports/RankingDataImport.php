...
class RankingDataImport implements ToCollection, SkipsEmptyRows, WithStartRow
{
    private $arrResult = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            Validator::make($rows->toArray(), [
                ...
                '*.0.required' => 'Ranking Code is Required',
                '*.0.not_in' => 'Ranking Code cannot be Null',
                '*.1.required' => 'Ranking Name is Required',
                '*.1.not_in' => 'Ranking Name cannot be Null'
            ])->validate();
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "rankingCode" => (isset($row[0])) ? strval($row[0]) : null,
                    "rankingName" => (isset($row[1])) ? $row[1] : null,
                    "changedNo" => 0,
