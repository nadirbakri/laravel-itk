...
class PersonalDataUpdateImport implements ToCollection, SkipsEmptyRows, WithStartRow, WithChunkReading
{
    /**
    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        try {
            ...
            $response = $client->put(env('API_URL') . '/personel/PeMaster/UpdateBulkPersonalData',
