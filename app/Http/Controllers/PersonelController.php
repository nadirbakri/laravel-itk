...
class PersonelController extends Controller
{
    ...
    public function pagePlafonMedicalPersonel()
    {
    ...
    public function pagePlafonTransportPersonel()
    {
        return view('personel.personel_plafon_transport');
    }

    public function pagePlafonReimbursementPersonel()
    {
        return view('personel.personel_plafon_reimbursement');
    }
    ...
    public function tablePlafonMedicalPersonel(Request $request)
    {
        try {
            $client = new Client([
                'verify' => false,
    ...
    public function tablePlafonTransportPersonel(Request $request)
    {
        try {
            $client = new Client([
                'verify' => false,
    ...
    public function tablePlafonReimbursementPersonel(Request $request)
    {
        try {
            $client = new Client([
                'verify' => false,
    ...
    public function dataDetailPlafonMedicalPersonel(Request $request)
    {
        try {
            $client = new Client([
                'verify' => false,
    ...
    public function dataDetailPlafonReimbursementPersonel(Request $request)
    {
        try {
            $client = new Client([
                'verify' => false,
        ...
        return view('personel.personel_plafon_reimbursement_detail', ['data' => $arrResult->dataListSet, 'func' => $request->func]);
    }
    ...
    public function prosesPersonalDataPersonel(Request $request)
    {
        ...
        try {
            ...
            $param = [
                ...
                "locationCode" => $request->office_location_employment,
            ...
            $datapeMasterInfo = [
                'companyCode' => Session::get('companyCode'),
                'employeeNo' => $request->employee_no_info,
                "nickName" => $request->nickname_info,
    ...
    public function printEmployeeListPersonel(Request $request)
    {
        ...
        try{
            return Excel::download(new EmployeeListExport($request->employee_no_from, $request->employee_no_to, $request->period, isset($request->include_resign) ? (bool) $request->include_resign : false, $request->birth_date_from, $request->birth_date_to, $request->age_from, $request->age_to, $request->gender, $request->input_type, $request->group_authorize_from, $request->group_authorize_to, $request->position, $request->ranking, $request->location, $dataLevel), 'Employee List Report.xlsx');
    ...
    public function prosesPlafonMedicalPersonel(Request $request)
    {
        date_default_timezone_set('Asia/Jakarta');
        try {
            $client = new Client([
    ...
    public function prosesPlafonReimbursementPersonel(Request $request)
    {
        date_default_timezone_set('Asia/Jakarta');
        try {
            $client = new Client([
