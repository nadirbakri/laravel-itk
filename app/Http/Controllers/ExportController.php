...
class ExportController extends Controller
{
    ...
    public function printExportMedical(Request $request)
    {
        ...
        return Excel::download(new MedicalExport($request->claim_date_from, $request->claim_date_to, $request->business_unit, $request->reimbursement_type[0],   $dataLevel), 'Employee List Reimbursement Medical Report.xlsx');
    ...
    public function printExportBusinessTrip(Request $request)
    {
        ...
        if ($request->travel_type[0] == "TTA"){
            return Excel::download(new BusinessTripExport($request->claim_date_from, $request->claim_date_to, $request->travel_type[0],$request->business_unit, $dataLevel), 'Employee List Business Advance Trip Report.xlsx');
        } else {
            return Excel::download(new BusinessTripSeattleExport($request->claim_date_from, $request->claim_date_to, $request->travel_type[0],$request->business_unit, $dataLevel), 'Employee List Business Seattle Trip Report.xlsx');
        }
    ...
    public function printExportBusinessTripPDF(Request $request){
        ...
        if ($request->travel_type[0] == "TTA"){
            return PDF::download(new BusinessTripExportPDF($request->claim_date_from, $request->claim_date_to, $request->travel_type[0],$request->business_unit, $dataLevel), 'Employee List Business Advance Trip Report.xlsx');
        } else {
            return PDF::download(new BusinessTripSeattleExportPDF($request->claim_date_from, $request->claim_date_to, $request->travel_type[0],$request->business_unit, $dataLevel), 'Employee List Business Seattle Trip Report.xlsx');
        }
    }
