...
class ExportController extends Controller
{
    ...
    public function printAttendanceExport(Request $request)
    {
        ...
        return Excel::download(new AttendanceExport($request->claim_date_from, $request->claim_date_to, $request->business_unit, $request->employee_status, $dataLevel), 'ATT-' . $request->business_unit . date('Y-m-d') . '.xlsx');
