    ...
    */
        ...
        try {
            ...
            foreach ($rows as $row) {
                $param[] = [
                    ...
                    "religionCode" => (!is_null($row[8]) && $row[8] != "NULL") ? strval($row[8]) : null,
                    "nationalityCode" => (!is_null($row[9]) && $row[9] != "NULL") ? strval($row[9]) : null,
                    "costCenterCode" => (!is_null($row[10]) && $row[10] != "NULL") ? strval($row[10]) : null,
                    ...
                    "locationCode" => (!is_null($row[21]) && $row[21] != "NULL") ? strval($row[21]) : null,
                    "gradeCode" => (!is_null($row[22]) && $row[22] != "NULL") ? strval($row[22]) : null,
                    "positionCode" => (!is_null($row[23]) && $row[23] != "NULL") ? strval($row[23]) : null,
                    "rankingCode" => (!is_null($row[24]) && $row[24] != "NULL") ? strval($row[24]) : null,
                    "workNatureCode" => (!is_null($row[25]) && $row[25] != "NULL") ? strval($row[25]) : null,
                    "groupCode" => (!is_null($row[26]) && $row[26] != "NULL") ? strval($row[26]) : null,
                    ...
                    "workPatternCode" => (!is_null($row[31]) && $row[31] != "NULL") ? strval($row[31]) : null,
                    ...
                    'peMasterHistoryJob' => [
                        ...
                        "employeeNo" => (!is_null($row[1]) && $row[1] != "NULL") ? strval($row[1]) : null,
                        "seqNo" => 1,
                        "historyCompanyCode" => (!is_null($row[0]) && $row[0] != "NULL") ? strval($row[0]) : null,
                    ...
                    'peMasterInsurance' => [
                        "companyCode" => (!is_null($row[0]) && $row[0] != "NULL") ? strval($row[0]) : null,
                        "employeeNo" => (!is_null($row[1]) && $row[1] != "NULL") ? strval($row[1]) : null,
                        "insuranceCode" => (!is_null($row[124]) && $row[124] != "NULL") ? strval($row[124]) : null,
    ...
    public function customValidationAttributes()
    {
        return [
            ...
            '6' => 'Marital Status',
            '12' => 'Flag is Expat',
            '28' => 'Flag is Commissioner',
            '30' => 'Absenteeism Type',
            '32' => 'Start At Day',
            '33' => 'Flag Not Absent',
            '38' => 'Flag Astek Death Not Accident',
            '39' => 'Flag Astek Work Accident',
            '30' => 'Flag Astek Work Accident 2',
            '41' => 'Flag Astek Work Accident 3',
            '42' => 'Flag Astek Pension Employee',
            '43' => 'Flag Astek Pension Employer',
            '44' => 'Flag Astek Health Insurance',
            '45' => 'Flag Tax By Governent',
            '46' => 'Flag Pension Insurance',
            '49' => 'Flag BPJS Kesehatan',
            '53' => 'Flag BPJS Tenaga Kerja',
            '75' => 'Flag Exclude Payroll',
            '34' => 'Flag Not Finger',
            '129' => 'Leave Code',
        ];
    }
